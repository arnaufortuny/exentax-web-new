 ...
 * scripts/validate-i18n.ts which only validates strings that already
 ...
 *
 * Usage:
 *   npx tsx scripts/find-hardcoded-strings.ts            # full report
 *   npx tsx scripts/find-hardcoded-strings.ts --jsx      # text nodes only
 *   npx tsx scripts/find-hardcoded-strings.ts --attrs    # attributes only
 *   npx tsx scripts/find-hardcoded-strings.ts --json     # machine readable
 *   npx tsx scripts/find-hardcoded-strings.ts --strict   # exit 1 on any
 */
