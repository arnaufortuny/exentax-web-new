 ...
 *
 * Usage:
 *   node scripts/blog/blog-new-article.mjs <slug> "<title-es>" [--cluster=<key>]
 *
...
if (!slug || !titleEs) {
  console.error("Usage: node scripts/blog/blog-new-article.mjs <slug> \"<title-es>\" [--cluster=...] [--category=Fiscalidad|Compliance|Guías|Operativa|Comparativas|Herramientas|Legal]");
  process.exit(1);
}
