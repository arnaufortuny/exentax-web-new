...
lines.push("");
lines.push(`Auto-generado por \`scripts/blog/blog-final-qa.mjs\`. JSON de respaldo en \`reports/seo/blog-final-qa.json\`.`);
lines.push("");
...
lines.push("- `scripts/seo/seo-sitemap-check.mjs` — pega `/sitemap*.xml` en runtime contra el catálogo de URLs.");
lines.push("- `scripts/seo/seo-check-links.mjs` — internal-link graph (≥3 inbound contextual links/post).");
lines.push("- `scripts/blog/blog-link-locale-lint.mjs` — locale leakage en `<a href=>` dentro de blog-content.");
lines.push("");
