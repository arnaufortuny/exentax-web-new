 ...
 *
 * Usage:
 *   node scripts/blog/blog-restructure-non-es.mjs                 # all pending
 *   node scripts/blog/blog-restructure-non-es.mjs --lang en       # one lang
 *   node scripts/blog/blog-restructure-non-es.mjs --slug xyz      # one slug
 *   node scripts/blog/blog-restructure-non-es.mjs --limit 10      # first N pending
 *   node scripts/blog/blog-restructure-non-es.mjs --dry-run       # show plan, no writes
 *   node scripts/blog/blog-restructure-non-es.mjs --force         # ignore checkpoint
 *
