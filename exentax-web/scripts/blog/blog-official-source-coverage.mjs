 ...
 *
 * Wired into `scripts/blog/blog-validate-all.mjs` as the `official-source-coverage`
...
function main() {
  ...
  if (criticals.length) {
    ...
    console.error(
      "\nFix: add at least one inline `<a href=\"https://<official-domain>/...\" target=\"_blank\" rel=\"noopener\">` to each flagged article. Whitelist is defined in scripts/blog/blog-official-source-coverage.mjs (mirrors CONVERSION-MASTERPLAN-REPORT.md §4.2).\n",
    );
