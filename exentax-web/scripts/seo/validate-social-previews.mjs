...
// PNG / JPEG header parsing lives in ./lib/image-header.mjs so the icon /
// favicon validator (validate-icon-assets.mjs, task #27) can reuse the
// exact same intrinsic-dimension reader without duplicating the parser.
