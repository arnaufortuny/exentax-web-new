...
async function writeResumen() {
  ...
  lines.push(`\`scripts/auditoria-rutas-componentes-discord-emails.mjs\` y los 5 reportes`);
  ...
  lines.push("node scripts/auditoria-rutas-componentes-discord-emails.mjs all");
  lines.push("");
  lines.push("# Subcomandos individuales:");
  lines.push("node scripts/auditoria-rutas-componentes-discord-emails.mjs routes");
  lines.push("node scripts/auditoria-rutas-componentes-discord-emails.mjs components");
  lines.push("node scripts/auditoria-rutas-componentes-discord-emails.mjs discord");
  lines.push("node scripts/auditoria-rutas-componentes-discord-emails.mjs emails");
  lines.push("node scripts/auditoria-rutas-componentes-discord-emails.mjs summary");
  lines.push("```");
  lines.push("");
