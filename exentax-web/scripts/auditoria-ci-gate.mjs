 ...
 *
 * Usage:
 *   node scripts/auditoria-ci-gate.mjs
 *   AUDIT_DIR=docs/auditoria-2026-04 node scripts/auditoria-ci-gate.mjs
 */
  ...
  if (unexpected.length > 0) {
    failures.push(
      `Routes missing from sitemap and not in allowlist: ${unexpected.length} ` +
        ...
        `SITEMAP_EXCLUDE_ALLOWLIST in scripts/auditoria-ci-gate.mjs with a justification.`,
    );
  }
  if (allowed.length > 0) {
    console.log(
