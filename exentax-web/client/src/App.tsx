...
const pageImports = {
  ...
  service_llc_nm: () => import("@/pages/services/llc-new-mexico"),
  service_llc_wy: () => import("@/pages/services/llc-wyoming"),
...
const ServiciosPage    = lazy(pageImports.our_services);
...
const ServiceLlcNmPage = lazy(pageImports.service_llc_nm);
const ServiceLlcWyPage = lazy(pageImports.service_llc_wy);
...
const PAGE_COMPONENTS: Record<RouteKey, React.LazyExoticComponent<React.ComponentType>> = {
  ...
  our_services: ServiciosPage,
  about_llc: LLCEstadosUnidos,
  faq: FAQPage,
  book: ReservarPage,
  service_llc_nm: ServiceLlcNmPage,
  service_llc_wy: ServiceLlcWyPage,
