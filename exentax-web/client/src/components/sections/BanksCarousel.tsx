...
export default function BanksCarousel() {
  ...
  return (
    ...
    >
      <h2 className="text-center font-heading font-bold text-[var(--text-1)] tracking-[-0.02em] text-2xl sm:text-3xl mb-6 sm:mb-10">
        {t("common.banksCarouselLabel")}
      </h2>
        ...
        {DUPLICATED.map((b, i) => (
          ...
          >
            <img
              ...
              decoding="async"
              fetchPriority="low"
              className={`${b.height} w-auto object-contain opacity-60 brightness-0`}
