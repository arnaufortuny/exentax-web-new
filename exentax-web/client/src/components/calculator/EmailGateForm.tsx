          ...
          <div className="flex-1 flex flex-col gap-0.5">
            ...
            <input
              ...
              className={`w-full rounded-full px-4 bg-[var(--bg-1)] border focus:outline-none transition-colors placeholder:text-[var(--text-3)] text-[var(--text-1)] ${compact ? "py-2.5 text-xs" : "py-3 text-sm"} ${
                errors.email ? "border-red-500 focus:border-red-400" : "border-[var(--border)] focus:border-[var(--green)]"
              }`}
              data-testid="input-email-gate"
            />
            {errors.email && (
              <p id="email-gate-error" role="alert" className="text-[10px] text-red-500 pl-3" data-testid="text-email-error">{errors.email}</p>
            )}
          </div>
          <div className="flex-1 flex flex-col gap-0.5">
            ...
            />
            {errors.phone && (
              <p id="phone-gate-error" role="alert" className="text-[10px] text-red-500 pl-3" data-testid="text-phone-error">{errors.phone}</p>
            )}
          </div>
        </div>
        <div className={`flex flex-col ${compact ? "gap-1" : "gap-2"}`}>
          ...
          >
            ...
            <span className={`mt-0.5 h-4 w-4 flex-shrink-0 rounded-md border-2 flex items-center justify-center transition-[color,background-color,border-color,opacity,transform] duration-200 ${
              privacyAccepted ? "bg-[var(--green)] border-[var(--green)]" : errors.privacy ? "border-red-500" : "border-[var(--border)] bg-transparent"
            }`}>
              {privacyAccepted && (
