export function BrandTick() {
  return (
    <svg width={22} height={22} viewBox="0 0 22 22" fill="none" aria-hidden="true">
      <circle cx="11" cy="11" r="11" fill="rgba(0,229,16,0.14)" />
      <circle cx="11" cy="11" r="10" stroke="#00E510" strokeWidth="0.8" />
      <path d="M7 11.3l2.8 2.7 5.2-5.2" stroke="#00E510" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
