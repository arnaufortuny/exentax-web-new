...
export default function ReservarPage() {
  ...
  return (
    <><SEO
        ...
        ogTitle={t("reservarPage.ogTitle", { defaultValue: "" }) as string || undefined}
        ogDescription={t("reservarPage.ogDesc", { defaultValue: "" }) as string || undefined}
      ...
      {isBookingSuccess ? (
        <section className="pt-14 lg:pt-20 pb-16 lg:pb-24 min-h-[calc(100svh-72px)]">
          <div className="max-w-[500px] mx-auto px-4 sm:px-6 text-center">
            ...
            <h2 className="font-heading font-bold text-2xl lg:text-3xl text-[var(--text-1)] mb-3">{t("reservar.paymentSuccess.title")}</h2>
        ...
        <section className="pt-14 lg:pt-20 pb-16 lg:pb-24 min-h-[calc(100svh-72px)]">
          <div className="max-w-[500px] mx-auto px-4 sm:px-6 text-center">
            ...
            <h2 className="font-heading font-bold text-2xl lg:text-3xl text-[var(--text-1)] mb-3">{t("reservar.paymentCancelled.title")}</h2>
            ...
            <div className="surface-card p-6 sm:p-8">
              ...
              <div className="flex items-center justify-between mt-8 gap-4">
                ...
                <button
                  ...
                  className="btn-primary px-8 py-3 text-base rounded-full transition-[color,background-color,border-color,box-shadow,opacity,transform] duration-200 disabled:opacity-40 disabled:cursor-not-allowed"
                >
