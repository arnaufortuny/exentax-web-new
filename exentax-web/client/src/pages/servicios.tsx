...
const STATE_KEYS = [
  { key: "nm", i18nKey: "llcUsPage.newMexico" },
  { key: "wy", i18nKey: "llcUsPage.wyoming" },
  { key: "de", i18nKey: "llcUsPage.delaware" },
];
        ...
        <div ref={ref} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-8 sm:pt-10 lg:pt-20">
          <div className="text-center max-w-[800px] mx-auto">
            <div className="reveal">
              ...
              <p className="font-heading font-bold text-[28px] sm:text-4xl lg:text-[clamp(36px,3.5vw,44px)] leading-[1.1] tracking-[-0.025em] mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6 justify-center">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-transparent border border-[#00E510]/40 hover:border-[#00E510]/70 text-[#00E510] font-body font-semibold px-8 py-3.5 text-base rounded-full transition-[color,background-color,border-color,box-shadow,opacity,transform] duration-200"
    ...
    <section className="py-24 lg:py-32 relative bg-[var(--bg-0)]" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 reveal max-w-3xl">
          <span className="text-[13px] uppercase tracking-[0.2em] font-body font-semibold text-[#00E510] mb-4 block">{t("precios.services.label")}</span>
          ...
          {plans.map((plan, i) => (
            ...
            >
              <div className="p-8 flex flex-col flex-1">
                ...
                <h4 className="text-xs font-body font-bold text-[var(--text-1)] uppercase tracking-wider mb-4">{t("precios.services.whatsIncluded")}</h4>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
              <div className="space-y-10">
                <div className="space-y-1.5">
                  <span className="text-xs font-body font-bold text-[#00E510] uppercase tracking-wider">{t("precios.comparativa.labels.jurisdiction")}</span>
...
function MaintenanceSection() {
  ...
  return (
    <section id="mantenimiento" className="section-padding" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 reveal max-w-3xl">
          <span className="text-[13px] uppercase tracking-[0.2em] font-body font-semibold text-[#00E510] mb-4 block">{t("precios.maintenance.label")}</span>
          <h2 className="font-heading font-bold text-[clamp(32px,2.5vw,34px)] leading-[1.12] tracking-[-0.025em] text-[var(--text-1)] mb-4">
  ...
  return (
    <section className="section-padding bg-[var(--bg-0)]" ref={ref}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="mb-16 reveal max-w-3xl">
          <span className="text-[13px] uppercase tracking-[0.2em] font-body font-semibold text-[#00E510] mb-4 block">{t("precios.faq.label")}</span>
          <h2 className="font-heading font-bold text-[clamp(32px,2.5vw,34px)] leading-[1.12] tracking-[-0.025em] text-[var(--text-1)] mb-4">
            {t("precios.faq.h2")}
          </h2>
