...
export default function PrivacidadPage() {
  ...
  return (
    <article><SEO title={t("legal.privacidad.seoTitle")} description={t("legal.privacidad.seoDescription")} path="/legal/privacidad" keywords={t("legal.privacidad.seoKeywords")} />
