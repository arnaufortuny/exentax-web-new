  ...
  return (
    ...
    <div className="min-h-screen relative flex flex-col items-center justify-start px-5 pt-4 pb-10 bg-[var(--bg-0)]">
      ...
      <div className="w-full max-w-[400px] flex flex-col items-center mt-4">
        ...
        <p className="font-body text-[13px] text-[var(--text-2)] mt-3 mb-2 text-center leading-relaxed px-2">
          {t("links.sub1")}
        </p>
        <p className="font-body text-[13px] text-[var(--text-2)] mt-0 mb-6 text-center leading-relaxed px-2">
          {t("links.sub2")}
        </p>
