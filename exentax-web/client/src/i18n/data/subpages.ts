...
export const NAV_SUBPAGES_BY_LANG: Record<SupportedLang, NavSubpagesLabels> = {
  es: {
    ...
    servicesOverviewDesc: "Compara estados y elige el que encaja con tu caso",
    servicesLlcNm: "LLC en Nuevo México",
    servicesLlcNmDesc: "Anonimato total y mantenimiento mínimo. Sin informe anual",
    servicesLlcWy: "LLC en Wyoming",
    servicesLlcWyDesc: "Máxima protección de patrimonio y privacidad real",
    servicesLlcDe: "LLC en Delaware",
    servicesLlcDeDesc: "El estándar para levantar capital y vender SaaS",
    servicesLlcFl: "LLC en Florida",
    servicesLlcFlDesc: "Presencia real en EE.UU. y acceso bancario directo",
  ...
  en: {
    ...
    servicesOverviewDesc: "Compare states and pick the one that fits your case",
    servicesLlcNm: "New Mexico LLC",
    servicesLlcNmDesc: "Full anonymity and minimal upkeep. No annual report",
    servicesLlcWy: "Wyoming LLC",
    servicesLlcWyDesc: "Maximum asset protection and real privacy",
    servicesLlcDe: "Delaware LLC",
    servicesLlcDeDesc: "The standard to raise capital and sell SaaS",
    servicesLlcFl: "Florida LLC",
    servicesLlcFlDesc: "Real US presence and direct banking access",
  ...
  fr: {
    ...
    servicesOverviewDesc: "Comparez les États et choisissez celui qui correspond à votre cas",
    servicesLlcNm: "LLC au Nouveau-Mexique",
    servicesLlcNmDesc: "Anonymat total et maintenance minimale. Sans rapport annuel",
    ...
    servicesLlcDeDesc: "Le standard pour lever des fonds et vendre du SaaS",
    servicesLlcFl: "LLC en Floride",
    servicesLlcFlDesc: "Présence réelle aux États-Unis et accès bancaire direct",
  ...
  de: {
    ...
    servicesOverviewDesc: "Staaten vergleichen und den passenden für Ihren Fall wählen",
    servicesLlcNm: "LLC in New Mexico",
    servicesLlcNmDesc: "Vollständige Anonymität und minimale Verwaltung. Kein Jahresbericht",
    ...
    servicesLlcDeDesc: "Der Standard für Kapitalbeschaffung und SaaS-Verkauf",
    servicesLlcFl: "LLC in Florida",
    servicesLlcFlDesc: "Echte US-Präsenz und direkter Bankzugang",
    servicesItin: "ITIN beantragen",
    servicesItinDesc: "Ihre US-Steuernummer ohne Originalpass per Post",
  },
  pt: {
    servicesOverview: "Ver todos os serviços",
    servicesOverviewDesc: "Compare estados e escolha o que encaixa no seu caso",
    servicesLlcNm: "LLC no Novo México",
    servicesLlcNmDesc: "Anonimato total e manutenção mínima. Sem relatório anual",
    ...
    servicesLlcDeDesc: "O padrão para levantar capital e vender SaaS",
    servicesLlcFl: "LLC na Flórida",
    servicesLlcFlDesc: "Presença real nos EUA e acesso bancário direto",
  ...
  ca: {
    ...
    servicesOverviewDesc: "Compara estats i tria el que encaixa amb el teu cas",
    servicesLlcNm: "LLC a Nou Mèxic",
    servicesLlcNmDesc: "Anonimat total i manteniment mínim. Sense informe anual",
    servicesLlcWy: "LLC a Wyoming",
    servicesLlcWyDesc: "Màxima protecció de patrimoni i privacitat real",
    servicesLlcDe: "LLC a Delaware",
    servicesLlcDeDesc: "L'estàndard per aixecar capital i vendre SaaS",
    servicesLlcFl: "LLC a Florida",
    servicesLlcFlDesc: "Presència real als EUA i accés bancari directe",
