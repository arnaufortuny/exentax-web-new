...
const es: SubpagesBase = {
  ...
  llcWy: {
    ...
    seo: {
      ...
      description: "Wyoming, estándar de oro en privacidad y protección de activos. LLC con EIN, banca americana y agente registrado, sin viajar. Reserva tu llamada.",
  ...
  llcDe: {
    ...
    seo: {
      ...
      description: "Estado preferido por VCs y founders: marco jurídico sólido y prestigio global. LLC con EIN, banca americana y agente registrado. Empieza hoy.",
...
const en: SubpagesBase = {
  llcNm: {
    ...
    seo: {
      ...
      description: "The most cost-efficient US LLC: no annual report, owner off the public record and 0% federal tax. EIN, US banking and agent. Book a free call.",
  ...
  llcWy: {
    ...
    seo: {
      ...
      description: "Wyoming sets the gold standard in privacy and asset protection. LLC with EIN, US banking and registered agent, no US trip needed. Book a free call.",
  ...
  llcDe: {
    ...
    seo: {
      ...
      description: "Delaware is where VCs and founders go: solid legal framework and global prestige. LLC with EIN, US banking and registered agent. Book a free call.",
  ...
  itin: {
    ...
    seo: {
      ...
      description: "Get your IRS ITIN without sending your original passport: we file as a Certifying Acceptance Agent and meet every deadline. Book a free call.",
...
const fr: SubpagesBase = {
  llcNm: {
    ...
    seo: {
      ...
      description: "La LLC US la plus rentable : pas de renouvellement annuel, propriétaire non public, 0 % fédéral. EIN, banque US et agent inclus. Démarrez ici.",
  ...
  llcWy: {
    ...
    seo: {
      ...
      description: "Wyoming, référence en confidentialité et protection des actifs. LLC avec EIN, banque américaine et agent enregistré, sans voyage. Démarrez ici.",
  ...
  llcDe: {
    ...
    seo: {
      ...
      description: "Le Delaware, état préféré des VC et fondateurs : cadre juridique solide et prestige mondial. LLC avec EIN, banque US et agent. Démarrez ici.",
  ...
  llcFl: {
    ...
    seo: {
      ...
      description: "Si vous vendez aux USA ou en LATAM, la Floride est votre base. LLC avec EIN, banque US, agent enregistré et accompagnement réel. Démarrez ici.",
  ...
  itin: {
    ...
    seo: {
      ...
      description: "Votre ITIN IRS sans envoyer le passeport. Nous le déposons en tant que Certifying Acceptance Agent officiel, délais tenus. Réservez un appel.",
...
const de: SubpagesBase = {
  llcNm: {
    ...
    seo: {
      ...
      description: "Die kosteneffizienteste US-LLC: kein Jahresbericht, Inhaber nicht öffentlich, 0 % Bundessteuer. EIN, US-Bankkonto und Agent. Jetzt anfragen.",
  ...
  llcDe: {
    ...
    seo: {
      ...
      description: "Lieblingsstaat von VCs und Foundern: solider Rechtsrahmen und globales Ansehen. Delaware-LLC mit EIN, US-Banking und Agent. Termin vereinbaren.",
  ...
  llcFl: {
    ...
    seo: {
      ...
      description: "Wer in den USA oder LATAM verkauft, hat in Florida die Basis. LLC mit EIN, US-Banking, Registered Agent und Beratung inklusive. Jetzt anfragen.",
...
const pt: SubpagesBase = {
  llcNm: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Posso transferir minha LLC atual para o Novo México?", a: "Sim, por meio de domesticação ou, em alguns casos, dissolvendo a entidade anterior e constituindo uma nova. Na assessoria inicial explicamos a melhor opção." },
      ],
    },
    cta: {
  ...
  llcWy: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Posso combinar Wyoming com outra LLC operacional?", a: "Sim. Estrutura comum: holding em Wyoming como membro único de uma LLC operacional em outro estado. Na assessoria indicamos se agrega valor no seu caso." },
      ],
    },
    cta: {
    ...
    seo: {
      ...
      description: "Wyoming é o padrão de ouro em privacidade e proteção de ativos. LLC com EIN, banca americana e agente registado, sem viagem. Agende sua chamada.",
  ...
  llcDe: {
    ...
    seo: {
      ...
      description: "Estado favorito de VCs e founders: enquadramento jurídico sólido e prestígio global. LLC no Delaware, com EIN e banca americana. Comece hoje.",
  ...
  llcFl: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Posso mudar de Novo México para Flórida depois?", a: "Sim, via domesticação ou constituindo uma nova entidade na Flórida. Orientamos na assessoria conforme sua fase e volume." },
      ],
    },
    cta: {
...
const ca: SubpagesBase = {
  ...
  llcWy: {
    ...
    seo: {
      ...
      description: "Wyoming és l'estàndard d'or en privacitat i protecció d'actius. LLC amb EIN, banca americana i agent registrat, sense viatjar. Comença avui.",
  ...
  llcFl: {
    ...
    seo: {
      ...
      description: "Si vens als EUA o a LATAM, Florida és la teva base. LLC amb EIN, banca americana, agent registrat i assessoria en català inclosa. Comença avui.",
...
export const NAV_SUBPAGES_BY_LANG: Record<SupportedLang, NavSubpagesLabels> = {
  es: {
    ...
    servicesOverviewDesc: "Diagnóstico estratégico para elegir la jurisdicción que mejor encaja con tu modelo de negocio y nivel de facturación",
    servicesLlcNm: "LLC en Nuevo México",
    servicesLlcNmDesc: "Estructura discreta con anonimato registral y carga administrativa mínima, diseñada para operar sin exposición pública",
    servicesLlcWy: "LLC en Wyoming",
    servicesLlcWyDesc: "El estándar global en blindaje patrimonial: privacidad reforzada y separación jurídica de tus activos personales",
    servicesLlcDe: "LLC en Delaware",
    servicesLlcDeDesc: "La jurisdicción de referencia para founders y fondos, exigida en rondas de inversión y operaciones de M&A",
    servicesLlcFl: "LLC en Florida",
    servicesLlcFlDesc: "Domicilio operativo tangible en EE.UU. con acceso bancario directo y posicionamiento para escalar al mercado americano",
    servicesItin: "Tramita tu ITIN",
    servicesItinDesc: "Tu identidad fiscal en EE.UU. para abrir cuentas, firmar contratos y construir historial crediticio internacional",
  },
  en: {
    servicesOverview: "See all services",
    servicesOverviewDesc: "Strategic diagnosis to pick the jurisdiction that best fits your business model and revenue level",
    servicesLlcNm: "New Mexico LLC",
    servicesLlcNmDesc: "Discreet structure with registry anonymity and minimal administrative burden, built to operate without public exposure",
    servicesLlcWy: "Wyoming LLC",
    servicesLlcWyDesc: "The global standard in asset protection: reinforced privacy and legal separation of your personal wealth",
    servicesLlcDe: "Delaware LLC",
    servicesLlcDeDesc: "The reference jurisdiction for founders and funds, required in funding rounds and M&A operations",
    servicesLlcFl: "Florida LLC",
    servicesLlcFlDesc: "Tangible operating domicile in the US with direct banking access and a launchpad to scale into the American market",
    servicesItin: "Apply for your ITIN",
    servicesItinDesc: "Your US tax identity to open accounts, sign contracts and build international credit history",
  },
  fr: {
    servicesOverview: "Voir tous les services",
    servicesOverviewDesc: "Diagnostic stratégique pour choisir la juridiction qui correspond le mieux à votre modèle d'affaires et à votre niveau de chiffre",
    servicesLlcNm: "LLC au Nouveau-Mexique",
    servicesLlcNmDesc: "Structure discrète avec anonymat au registre et charge administrative minimale, conçue pour opérer sans exposition publique",
    servicesLlcWy: "LLC au Wyoming",
    servicesLlcWyDesc: "Le standard mondial en protection du patrimoine : confidentialité renforcée et séparation juridique de vos actifs personnels",
    servicesLlcDe: "LLC au Delaware",
    servicesLlcDeDesc: "La juridiction de référence pour les founders et les fonds, exigée lors des levées et des opérations de M&A",
    servicesLlcFl: "LLC en Floride",
    servicesLlcFlDesc: "Domicile opérationnel tangible aux États-Unis avec accès bancaire direct et tremplin pour conquérir le marché américain",
    servicesItin: "Demandez votre ITIN",
    servicesItinDesc: "Votre identité fiscale aux États-Unis pour ouvrir des comptes, signer des contrats et bâtir un historique de crédit international",
  },
  de: {
    servicesOverview: "Alle Leistungen ansehen",
    servicesOverviewDesc: "Strategische Diagnose zur Wahl der Jurisdiktion, die am besten zu Ihrem Geschäftsmodell und Umsatzniveau passt",
    servicesLlcNm: "LLC in New Mexico",
    servicesLlcNmDesc: "Diskrete Struktur mit Anonymität im Register und minimalem Verwaltungsaufwand, ausgelegt zum Operieren ohne öffentliche Sichtbarkeit",
    servicesLlcWy: "LLC in Wyoming",
    servicesLlcWyDesc: "Der weltweite Standard im Vermögensschutz: verstärkte Privatsphäre und juristische Trennung Ihres Privatvermögens",
    servicesLlcDe: "LLC in Delaware",
    servicesLlcDeDesc: "Die Referenzjurisdiktion für Gründer und Fonds, gefordert in Finanzierungsrunden und M&A-Transaktionen",
    servicesLlcFl: "LLC in Florida",
    servicesLlcFlDesc: "Greifbarer Betriebsstandort in den USA mit direktem Bankzugang und Sprungbrett zur Skalierung im amerikanischen Markt",
    servicesItin: "ITIN beantragen",
    servicesItinDesc: "Ihre US-Steueridentität, um Konten zu eröffnen, Verträge zu unterzeichnen und internationale Bonität aufzubauen",
  },
  pt: {
    servicesOverview: "Ver todos os serviços",
    servicesOverviewDesc: "Diagnóstico estratégico para escolher a jurisdição que melhor encaixa no seu modelo de negócio e nível de faturamento",
    servicesLlcNm: "LLC no Novo México",
    servicesLlcNmDesc: "Estrutura discreta com anonimato registral e carga administrativa mínima, pensada para operar sem exposição pública",
    servicesLlcWy: "LLC no Wyoming",
    servicesLlcWyDesc: "O padrão global em blindagem patrimonial: privacidade reforçada e separação jurídica do seu patrimônio pessoal",
    servicesLlcDe: "LLC em Delaware",
    servicesLlcDeDesc: "A jurisdição de referência para founders e fundos, exigida em rodadas de investimento e operações de M&A",
    servicesLlcFl: "LLC na Flórida",
    servicesLlcFlDesc: "Domicílio operacional tangível nos EUA com acesso bancário direto e posicionamento para escalar no mercado americano",
    servicesItin: "Solicite seu ITIN",
    servicesItinDesc: "Sua identidade fiscal nos EUA para abrir contas, assinar contratos e construir histórico de crédito internacional",
  },
  ca: {
    servicesOverview: "Veure tots els serveis",
    servicesOverviewDesc: "Diagnòstic estratègic per triar la jurisdicció que millor encaixa amb el teu model de negoci i nivell de facturació",
    servicesLlcNm: "LLC a Nou Mèxic",
    servicesLlcNmDesc: "Estructura discreta amb anonimat registral i càrrega administrativa mínima, pensada per operar sense exposició pública",
    servicesLlcWy: "LLC a Wyoming",
    servicesLlcWyDesc: "L'estàndard global en blindatge patrimonial: privacitat reforçada i separació jurídica dels teus actius personals",
    servicesLlcDe: "LLC a Delaware",
    servicesLlcDeDesc: "La jurisdicció de referència per a founders i fons, exigida en rondes d'inversió i operacions de M&A",
    servicesLlcFl: "LLC a Florida",
    servicesLlcFlDesc: "Domicili operatiu tangible als EUA amb accés bancari directe i posicionament per escalar al mercat americà",
    servicesItin: "Tramita el teu ITIN",
    servicesItinDesc: "La teva identitat fiscal als EUA per obrir comptes, signar contractes i construir historial de crèdit internacional",
  },
};
