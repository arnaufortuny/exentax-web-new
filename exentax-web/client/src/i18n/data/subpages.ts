...
export const NAV_SUBPAGES_BY_LANG: Record<SupportedLang, NavSubpagesLabels> = {
  es: {
    ...
    servicesOverviewDesc: "Compara jurisdicciones y elige la estructura ideal para tu modelo",
    servicesLlcNm: "LLC en Nuevo México",
    servicesLlcNmDesc: "Anonimato real y operativa mínima para emprender bajo el radar",
    servicesLlcWy: "LLC en Wyoming",
    servicesLlcWyDesc: "La jurisdicción más sólida del mundo en blindaje de patrimonio",
    servicesLlcDe: "LLC en Delaware",
    servicesLlcDeDesc: "El estándar legal para levantar capital y vender SaaS en EE.UU.",
    servicesLlcFl: "LLC en Florida",
    servicesLlcFlDesc: "Presencia tangible en EE.UU. con acceso bancario directo",
    servicesItin: "Tramita tu ITIN",
    servicesItinDesc: "Tu identidad fiscal en EE.UU. para operar con bancos y crédito",
  },
  en: {
    servicesOverview: "See all services",
    servicesOverviewDesc: "Compare jurisdictions and pick the ideal structure for your model",
    servicesLlcNm: "New Mexico LLC",
    servicesLlcNmDesc: "True anonymity and minimal overhead to operate below the radar",
    servicesLlcWy: "Wyoming LLC",
    servicesLlcWyDesc: "The world's strongest jurisdiction for asset protection",
    servicesLlcDe: "Delaware LLC",
    servicesLlcDeDesc: "The legal standard to raise capital and sell SaaS in the US",
    servicesLlcFl: "Florida LLC",
    servicesLlcFlDesc: "Tangible US presence with direct banking access",
    servicesItin: "Apply for your ITIN",
    servicesItinDesc: "Your US tax identity to operate with banks and access credit",
  },
  fr: {
    servicesOverview: "Voir tous les services",
    servicesOverviewDesc: "Comparez les juridictions et choisissez la structure idéale pour votre modèle",
    servicesLlcNm: "LLC au Nouveau-Mexique",
    servicesLlcNmDesc: "Anonymat réel et gestion minimale pour entreprendre dans la discrétion",
    servicesLlcWy: "LLC au Wyoming",
    servicesLlcWyDesc: "La juridiction la plus solide au monde en protection du patrimoine",
    servicesLlcDe: "LLC au Delaware",
    servicesLlcDeDesc: "Le standard légal pour lever des fonds et vendre du SaaS aux États-Unis",
    servicesLlcFl: "LLC en Floride",
    servicesLlcFlDesc: "Présence tangible aux États-Unis avec accès bancaire direct",
    servicesItin: "Demandez votre ITIN",
    servicesItinDesc: "Votre identité fiscale aux États-Unis pour opérer avec banques et crédit",
  },
  de: {
    servicesOverview: "Alle Leistungen ansehen",
    servicesOverviewDesc: "Jurisdiktionen vergleichen und die ideale Struktur für Ihr Modell wählen",
    servicesLlcNm: "LLC in New Mexico",
    servicesLlcNmDesc: "Echte Anonymität und minimaler Aufwand, um unter dem Radar zu agieren",
    servicesLlcWy: "LLC in Wyoming",
    servicesLlcWyDesc: "Die weltweit solideste Jurisdiktion für Vermögensschutz",
    servicesLlcDe: "LLC in Delaware",
    servicesLlcDeDesc: "Der rechtliche Standard für Kapitalbeschaffung und SaaS-Verkauf in den USA",
    servicesLlcFl: "LLC in Florida",
    servicesLlcFlDesc: "Greifbare US-Präsenz mit direktem Bankzugang",
    servicesItin: "ITIN beantragen",
    servicesItinDesc: "Ihre US-Steueridentität, um mit Banken und Krediten zu operieren",
  },
  pt: {
    servicesOverview: "Ver todos os serviços",
    servicesOverviewDesc: "Compare jurisdições e escolha a estrutura ideal para o seu modelo",
    servicesLlcNm: "LLC no Novo México",
    servicesLlcNmDesc: "Anonimato real e operação mínima para empreender sob o radar",
    servicesLlcWy: "LLC no Wyoming",
    servicesLlcWyDesc: "A jurisdição mais sólida do mundo em proteção patrimonial",
    servicesLlcDe: "LLC em Delaware",
    servicesLlcDeDesc: "O padrão legal para levantar capital e vender SaaS nos EUA",
    servicesLlcFl: "LLC na Flórida",
    servicesLlcFlDesc: "Presença tangível nos EUA com acesso bancário direto",
    servicesItin: "Solicite seu ITIN",
    servicesItinDesc: "Sua identidade fiscal nos EUA para operar com bancos e crédito",
  },
  ca: {
    servicesOverview: "Veure tots els serveis",
    servicesOverviewDesc: "Compara jurisdiccions i tria l'estructura ideal per al teu model",
    servicesLlcNm: "LLC a Nou Mèxic",
    servicesLlcNmDesc: "Anonimat real i operativa mínima per emprendre sota el radar",
    servicesLlcWy: "LLC a Wyoming",
    servicesLlcWyDesc: "La jurisdicció més sòlida del món en blindatge de patrimoni",
    servicesLlcDe: "LLC a Delaware",
    servicesLlcDeDesc: "L'estàndard legal per aixecar capital i vendre SaaS als EUA",
    servicesLlcFl: "LLC a Florida",
    servicesLlcFlDesc: "Presència tangible als EUA amb accés bancari directe",
    servicesItin: "Tramita el teu ITIN",
    servicesItinDesc: "La teva identitat fiscal als EUA per operar amb bancs i crèdit",
  },
};
