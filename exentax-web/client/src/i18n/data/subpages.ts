...
export const NAV_SUBPAGES_BY_LANG: Record<SupportedLang, NavSubpagesLabels> = {
  es: {
    ...
    servicesOverviewDesc: "Compara estados, precios y qué incluye cada plan",
    servicesLlcNm: "LLC en Nuevo México",
    servicesLlcNmDesc: "La opción más barata y anónima. Sin informe anual",
    servicesLlcWy: "LLC en Wyoming",
    servicesLlcWyDesc: "Máxima protección patrimonial y privacidad real",
    servicesLlcDe: "LLC en Delaware",
    servicesLlcDeDesc: "El estándar para levantar capital o vender SaaS",
    servicesLlcFl: "LLC en Florida",
    servicesLlcFlDesc: "Vende al mercado USA con presencia real y bancos accesibles",
    servicesItin: "Tramita tu ITIN",
    servicesItinDesc: "Tu número fiscal en EE.UU. sin enviar el pasaporte original",
  },
  en: {
    servicesOverview: "See all services",
    servicesOverviewDesc: "Compare states, prices and what each plan includes",
    servicesLlcNm: "New Mexico LLC",
    servicesLlcNmDesc: "Cheapest and most anonymous. No annual report",
    servicesLlcWy: "Wyoming LLC",
    servicesLlcWyDesc: "Maximum asset protection and real privacy",
    servicesLlcDe: "Delaware LLC",
    servicesLlcDeDesc: "The standard to raise capital or sell SaaS in the US",
    servicesLlcFl: "Florida LLC",
    servicesLlcFlDesc: "Sell to the US market with real presence and easy banking",
    servicesItin: "Apply for your ITIN",
    servicesItinDesc: "Your US tax ID without mailing your original passport",
  },
  fr: {
    servicesOverview: "Voir tous les services",
    servicesOverviewDesc: "Comparez États, prix et ce qu'inclut chaque formule",
    servicesLlcNm: "LLC au Nouveau-Mexique",
    servicesLlcNmDesc: "La moins chère et la plus anonyme. Sans rapport annuel",
    servicesLlcWy: "LLC au Wyoming",
    servicesLlcWyDesc: "Protection patrimoniale maximale et confidentialité réelle",
    servicesLlcDe: "LLC au Delaware",
    servicesLlcDeDesc: "Le standard pour lever des fonds ou vendre du SaaS aux US",
    servicesLlcFl: "LLC en Floride",
    servicesLlcFlDesc: "Vendez au marché US avec présence réelle et banques accessibles",
    servicesItin: "Demandez votre ITIN",
    servicesItinDesc: "Votre numéro fiscal US sans envoyer votre passeport original",
  },
  de: {
    servicesOverview: "Alle Leistungen ansehen",
    servicesOverviewDesc: "Staaten, Preise und Inhalt jedes Plans im Vergleich",
    servicesLlcNm: "LLC in New Mexico",
    servicesLlcNmDesc: "Am günstigsten und anonymsten. Kein Jahresbericht",
    servicesLlcWy: "LLC in Wyoming",
    servicesLlcWyDesc: "Maximaler Vermögensschutz und echte Privatsphäre",
    servicesLlcDe: "LLC in Delaware",
    servicesLlcDeDesc: "Der Standard für Kapital­beschaffung oder SaaS-Verkauf",
    servicesLlcFl: "LLC in Florida",
    servicesLlcFlDesc: "Verkaufen am US-Markt mit realer Präsenz und Bank­zugang",
    servicesItin: "ITIN beantragen",
    servicesItinDesc: "Ihre US-Steuernummer ohne Original­pass per Post",
  },
  pt: {
    servicesOverview: "Ver todos os serviços",
    servicesOverviewDesc: "Compare estados, preços e o que cada plano inclui",
    servicesLlcNm: "LLC no Novo México",
    servicesLlcNmDesc: "A opção mais barata e anônima. Sem relatório anual",
    servicesLlcWy: "LLC no Wyoming",
    servicesLlcWyDesc: "Máxima proteção patrimonial e privacidade real",
    servicesLlcDe: "LLC em Delaware",
    servicesLlcDeDesc: "O padrão para levantar capital ou vender SaaS nos EUA",
    servicesLlcFl: "LLC na Flórida",
    servicesLlcFlDesc: "Venda ao mercado dos EUA com presença real e bancos acessíveis",
    servicesItin: "Solicite seu ITIN",
    servicesItinDesc: "Seu número fiscal nos EUA sem enviar o passaporte original",
  },
  ca: {
    servicesOverview: "Veure tots els serveis",
    servicesOverviewDesc: "Compara estats, preus i què inclou cada pla",
    servicesLlcNm: "LLC a Nou Mèxic",
    servicesLlcNmDesc: "L'opció més barata i anònima. Sense informe anual",
    servicesLlcWy: "LLC a Wyoming",
    servicesLlcWyDesc: "Màxima protecció patrimonial i privacitat real",
    servicesLlcDe: "LLC a Delaware",
    servicesLlcDeDesc: "L'estàndard per aixecar capital o vendre SaaS",
    servicesLlcFl: "LLC a Florida",
    servicesLlcFlDesc: "Ven al mercat USA amb presència real i bancs accessibles",
    servicesItin: "Tramita el teu ITIN",
    servicesItinDesc: "El teu número fiscal als EUA sense enviar el passaport original",
  },
};
