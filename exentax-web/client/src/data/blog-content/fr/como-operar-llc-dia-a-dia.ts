export default `Vous avez franchi le pas et votre LLC est désormais constituée. Vous avez votre EIN, votre compte Mercury est ouvert et vos documents sont en ordre. Maintenant commence la partie la plus intéressante : gérer votre entreprise comme un professionnel.
