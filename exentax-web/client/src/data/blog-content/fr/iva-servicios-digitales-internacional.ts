export default `TVA sur les services digitaux: sujet où 80 % des indépendants français se plantent, et où une LLC mal pensée ne fait qu'amplifier le bordel. Entre le VAT OSS pour l'UE, les règles B2B/B2C au lieu du preneur, et les US qui imposent la Sales Tax par état, vous n'avez plus une TVA, vous en avez quarante.
...
Pour refermer, quelques lectures connexes qui s'inscrivent dans le prolongement de ce papier: <a href="/fr/blog/impots-avec-des-clients-internationaux-en-espagne-ce-que">Impôts avec des clients internationaux en Espagne: ce que personne ne vous dit</a> et <a href="/fr/blog/les-comptes-bancaires-americains-rapportent-ils-a-votre">Les comptes bancaires américains rapportent-ils à votre administration fiscale? La réponse honnête</a> aident à parachever le contexte.
...
Chez Exentax, nous nous assurons que votre structure fiscale est adaptée à votre type de clients. Si vous croulez sous les déclarations trimestrielles et que vous voulez simplifier votre vie, réservez une consultation pour une consultation gratuite. Nous vous expliquons comment la LLC peut éliminer 90% de votre bureaucratie fiscale.
Chez Exentax on configure la TVA / Sales Tax des clients français, belges et luxembourgeois qui vendent du digital mondialement. Réservez votre consultation gratuite: on cartographie vos flux et on vous dit où collecter, où ne pas collecter, et où déclarer.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Envie d'en parler tout de suite ? Appelez-nous au <a href="tel:+34614916910">+34 614 916 910</a> ou écrivez-nous sur <a href="https://wa.me/34614916910?text=Bonjour%20Exentax%2C%20je%20lis%20l'article%20%22TVA%20sur%20les%20services%20digitaux%3A%20sujet%20o%C3%B9%2080%20%25%20des%20ind%C3%A9pendants%20fran%C3%A7ais%20se%20pla%E2%80%A6%22%20et%20je%20veux%20parler%20%C3%A0%20un%20conseiller%20sur%20mon%20cas.">WhatsApp</a> et nous vous répondons aujourd'hui.</p>
...
<li><span class="font-mono">21%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…CE: - **Cliente empresa en España:** Cobras IVA español al 21%. - **Cliente empresa en la …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…particular en la UE (servicios electrónicos):** Si superas 10.000 €/año en ventas a consum…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…unitarias. - Aplicar el tipo de IVA del país del comprador (19% Alemania, 20% Francia, 22%…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…plicar el tipo de IVA del país del comprador (19% Alemania, 20% Francia, 22% Italia, etc.)…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">22%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…o de IVA del país del comprador (19% Alemania, 20% Francia, 22% Italia, etc.). - Presentar…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…donde resides. Cualquier mensaje del estilo &quot;con LLC pagas 0%&quot; es engañoso. Lo que se cons…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">301.770</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ento de Ejecución (UE) 282/2011. - **EE. UU.** Treas. Reg. §301.7701-3 (clasificación de e…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.603</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…n de entidades, *check-the-box*); IRC §6038A y Treas. Reg. §1.6038A-2 (Form 5472 para LLC …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">IRC §6038</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…§301.7701-3 (clasificación de entidades, *check-the-box*); IRC §6038A y Treas. Reg. §1.603…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…ttps://www.irs.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; (Form 5472 + 1120 pro-forma anu…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">RD 1624/1992</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…84 (reglas de localización e inversión del sujeto pasivo); RD 1624/1992 (RIVA), arts. 79-8…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
