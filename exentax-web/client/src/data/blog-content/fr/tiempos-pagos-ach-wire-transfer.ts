export default `L'une des questions les plus fréquentes quand vous commencez à opérer votre LLC est : "J'ai envoyé de l'argent à un client, quand est-ce qu'il arrive ?" Ou l'inverse : "On va me payer, quand est-ce que je le vois sur mon compte ?"
