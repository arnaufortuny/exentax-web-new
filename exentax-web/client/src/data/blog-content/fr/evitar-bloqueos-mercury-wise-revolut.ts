export default `Le blocage de compte est le cauchemar de tout propriétaire de LLC. Un jour, vous vous connectez à Mercury ou Wise et vous voyez : « Votre compte a été restreint. » Sans avertissement préalable, sans explication claire, et avec votre argent bloqué.
