export default `Si vous avez une LLC aux États-Unis et un compte chez Mercury, Wise ou Relay, il est naturel de se demander : est-ce que l'administration fiscale de mon pays peut voir ce compte ? Savent-ils combien d'argent j'ai là-bas ?
