...
Pour refermer, une lecture connexe qui s'inscrit dans le prolongement de ce papier: <a href="/fr/blog/structure-fiscale-optimale-pour-les-freelancers">Structure fiscale optimale pour les freelancers internationaux: le cadre complet</a> aide à parachever le contexte.
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…odelo 720 requiere reportar cuentas con saldos superiores a 50.000€. **4. Información de t…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…que trabaja como autónomo en España puede estar pagando un 45% efectivo entre IRPF y cuota…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…reportar cuentas financieras en el extranjero que superen $10,000 en cualquier momento del…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 114</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…//www.fincen.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;FinCEN&lt;/a&gt; Form 114) te obliga a reportar…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
