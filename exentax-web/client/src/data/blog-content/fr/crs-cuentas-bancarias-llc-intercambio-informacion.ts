...
Votre compte Mercury entre dans la première catégorie. Si le solde au 31 décembre ou le solde moyen du dernier trimestre dépasse 50 000 €, vous devez le déclarer. Ne pas le faire peut entraîner des sanctions significatives (bien que la jurisprudence européenne ait modéré les sanctions disproportionnées qu'appliquait initialement l'Espagne). On reste calme : chez Exentax, c'est notre routine de la semaine, on boucle ça avant que la lettre n'arrive dans ta boîte.
