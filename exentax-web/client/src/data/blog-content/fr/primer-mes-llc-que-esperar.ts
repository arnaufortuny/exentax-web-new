export default `Vous avez franchi le pas : votre LLC est constituée, vous avez votre EIN et vous êtes prêt à commencer. Mais maintenant vient la question que tout le monde se pose : et maintenant, que se passe-t-il ?
