...
Les erreurs qui génèrent le plus de sanctions : prétendre déduire des repas familiaux comme indemnités, carburant personnel sans usage professionnel documenté, vêtements personnels facturés comme uniforme sans en être, cadeaux clients au-delà de 1% du chiffre d'affaires et surtout charges sans facture. Si votre activité est 100% numérique, une <a href="/fr/blog/llc-comme-alternative-au-statut-dautonomo-en-espagne">LLC américaine</a> permet de documenter des charges selon les critères américains (ordinary and necessary), nettement plus larges et flexibles que les espagnols, tout en gardant la traçabilité complète pour votre déclaration de résidence. C'est exactement pour cela que chez Exentax on garde votre calendrier carré — vous ne pensez plus aux échéances, on les clôt avant qu'elles ne mordent.
...
| Erreur | Conséquence |
|---|---|
| Déduire repas familiaux comme indemnités | Sanction + majoration + requalification |. C'est là qu'Exentax intervient : on dépose le formulaire, on archive l'accusé et, si l'administration demande, votre réponse est déjà sur le bureau.
