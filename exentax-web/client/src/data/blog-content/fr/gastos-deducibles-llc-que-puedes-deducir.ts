...
Si un aspect de cette structure mérite d'être creusé, <a href="/fr/blog/peut-on-payer-0-dimpots-legalement-la-verite-sur">Peut-on payer 0% d'impôts légalement? La vérité sur l'optimisation fiscale</a> détaille un point adjacent que nous réservons d'habitude à un article dédié.
...
Chez Exentax on construit chaque mois la comptabilité déductible de dizaines de LLC françaises. Réservez votre consultation gratuite: on vous montre exactement ce qui passe, ce qui ne passe pas, et comment documenter correctement.
...
## Frais déductibles d'une LLC: ce qui passe vraiment et ce que vous défendrez en contrôle

La règle IRS est trompeusement simple: "ordinary and necessary" pour votre activité. Mais le diable est dans la documentation, le mode de paiement et la cohérence. Voici ce qu'une LLC bien tenue déduit réellement - et les erreurs vues presque chaque semaine.

- **Clairement déductible.** Logiciels (Notion, Figma, frais Stripe, hosting), publicité (Meta, Google, LinkedIn), sous-traitants avec W-9 ou W-8BEN, commissions de plateformes, abonnements professionnels, matériel informatique 100% pro, comptabilité et conseil. Payez depuis le compte LLC, facture au nom de la LLC, stockée sur Drive ou équivalent, taguée par catégorie.
- **Déductions conditionnelles.** Coworking et bureau (entièrement), home office (pourcentage de l'espace dédié exclusivement, avec documentation), voyages d'affaires (billet, hôtel, per diem raisonnable; "moi et ma famille à Bali" ne passe pas), formation liée à l'activité, repas clients (50% déductible fédéral).
- **Problématique sans substance.** Voiture personnelle, vêtements non-uniformes, dépenses personnelles mêlées, "conseil" payé à la famille sans service réel ni W-9, voyages sans agenda documenté. La LLC est transparente pour l'IRS et opaque pour la banque - les deux croisent en contrôle.
- **Disregarded vs C-Corp: la nuance.** En disregarded, les frais réduisent le Schedule C ou revenu attribué. En C-Corp via form 8832, ils réduisent le bénéfice corporatif imposé à 21% fédéral. La documentation est identique.

### Ce qu'on nous demande le plus

**Dois-je garder toutes les factures?** Oui, format numérique suffit. Politique IRS: 3 ans depuis la déclaration, 6 si sous-déclaration >25%, indéfini si non déposée. Drive organisé par année/catégorie.

**Puis-je déduire tout mon loyer en home office?** Non, uniquement le pourcentage utilisé exclusivement et régulièrement pour le travail. Documentation: plan, photos, journal d'usage. Règle stricte, contrôlée.

Chez Exentax nous mettons en place la comptabilité de votre LLC dès le premier mois: plan comptable, politique de dépenses et archive numérique - pour que la déduction soit défendable et pas aspirationnelle.
...
<li><span class="font-mono">20%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…del espacio dedicado a trabajo (ej: si tu oficina ocupa el 20% de tu vivienda, deduces el …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…midas de negocio:** con clientes, socios o en conferencias (50% deducible generalmente) - …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">5,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…illo Un freelancer típico con una LLC suele tener entre **$5,000 y $20,000** en gastos ded…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">20,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…freelancer típico con una LLC suele tener entre **$5,000 y $20,000** en gastos deducibles …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">60,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…cia de forma significativa. Ejemplo práctico: si facturas $60,000/año y tienes $15,000 en …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">15,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ativa. Ejemplo práctico: si facturas $60,000/año y tienes $15,000 en gastos deducibles, so…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">45,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…0/año y tienes $15,000 en gastos deducibles, solo declaras $45,000 de beneficio en tu país…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">3,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…icio en tu país. Si tu tipo efectivo es del 20%, eso son **$3,000 menos de impuestos** sol…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…s/blog/pagar-cero-impuestos-legalmente-llc&quot;&gt;¿Se puede pagar 0% de impuestos legalmente? La…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…as, suscripciones profesionales, equipo informático con uso 100% empresarial, contabilidad…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…con form 8832, reducen el beneficio corporativo gravado al 21% federal. El control documen…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">form 8832</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…en tu Schedule C / income atribuido. Si elegiste C-Corp con form 8832, reducen el benefici…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
