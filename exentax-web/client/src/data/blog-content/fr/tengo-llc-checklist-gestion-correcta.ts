...
La sanction de base pour non-dépôt ou dépôt incomplet est de **25 000 USD par formulaire et par année**, et elle s'accumule. Ce n'est pas une menace abstraite: l'IRS l'applique. Et si un avis tombe, chez Exentax on garde le dossier prêt pour que tu répondes en heures, pas en semaines.
...
Si votre comptable vous a dit "ne déclarez rien parce que c'est imposé aux US", demandez un second avis. Aujourd'hui. C'est là que les sanctions s'accumulent le plus, et elles sont parfaitement évitables avec une bonne planification. On le clôt avec toi depuis Exentax : un appel, le dépôt part, l'archive est faite, et le risque reste sur le papier.
...
| Non-déclaration des revenus LLC dans le pays de résidence | Lors du croisement CRS/DAC, régularisation + sanctions + intérêts |. Chez Exentax on a clôturé sans pénalité des clients arrivés exactement dans cette situation. Parler tôt, ça paie — et ça t'épargne cinq chiffres.
