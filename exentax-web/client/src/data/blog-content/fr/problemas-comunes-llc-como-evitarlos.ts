...
- **Ne pas déclarer la LLC en résidence.** France (IR + 3916), Espagne (720 + IRPF), Italie (IRPEF + RW), Allemagne (ESt + AStG si CFC). Sanction typique 50%-150% de l'impôt éludé. Solution: planifier dès l'ouverture. On le clôt avec toi depuis Exentax : un appel, le dépôt part, l'archive est faite, et le risque reste sur le papier.
