export default `Après avoir géré plusieurs centaines de LLC pour des clients francophones, les mêmes erreurs reviennent en boucle: mélange comptes perso/LLC, 5472 oublié, BOI pas déposé, adresse Registered Agent utilisée comme adresse bancaire, et la fameuse « on verra l'année prochaine » qui finit en pénalité <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> à cinq chiffres.
...
**Le problème:** Depuis l'entrée en vigueur de la CTA, <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> exige que toutes les LLCs déclarent leurs propriétaires bénéficiaires (Beneficial Ownership Information). Les délais et exigences changent fréquemment, et ne pas s'y conformer peut entraîner des conséquences qu'il vaut mieux éviter.
...
Pour refermer, une lecture connexe qui s'inscrit dans le prolongement de ce papier: <a href="/fr/blog/combien-coute-la-creation-dune-llc-americaine-decomposition">Combien coûte la création d'une LLC américaine? Décomposition complète des coûts</a> aide à parachever le contexte.
...
Chez Exentax on corrige ce genre de dérive toutes les semaines. Réservez votre consultation gratuite: on audite votre LLC, on liste les risques actifs et on vous donne un plan concret pour nettoyer.
...
## Les problèmes les plus communs avec une LLC et comment les éviter avant qu'ils n'arrivent

Après des années à gérer des LLC de non-résidents, les problèmes sont toujours les mêmes quatre ou cinq. Tous évitables avec planification, tous chers s'ils se matérialisent.

- **Oublier le 5472 + 1120 annuel.** Pénalité la plus chère et la plus facile à éviter. 25 000$ minimum pour non-dépôt du 5472. Échéance 15 avril, prorogeable au 15 octobre avec Form 7004. Solution: comptabilité dès jour 1.
- **Ne pas déposer le BOI Report au FinCEN.** Sanction 591$/jour. Applique à presque toute nouvelle LLC: 30 jours depuis formation. Solution: inclure BOI initial dans le setup.
- **Mélanger argent personnel et LLC.** Casser la séparation patrimoniale (piercing the corporate veil) permet de vous poursuivre personnellement. Solution: compte séparé strict, draws documentés.
- **Ne pas déclarer la LLC en résidence.** France (IR + 3916), Espagne (720 + IRPF), Italie (IRPEF + RW), Allemagne (ESt + AStG si CFC). Sanction typique 50%-150% de l'impôt éludé. Solution: planifier dès l'ouverture.

### Ce qu'on nous demande le plus

**Si je n'ai rien facturé, dois-je déposer 5472?** Oui, sauf exception très limitée. Toute mouvement owner/LLC est reportable transaction.

**Puis-je régulariser années passées sans déposer?** Oui, par dépôt tardif. Pénalité identique mais réduit la probabilité d'audit agressif.

Chez Exentax nous gérons la compliance intégrale et régularisons les LLC avec historique cassé.
...
<li><span class="font-mono">90%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…entre hacer las cosas bien y hacer las cosas &quot;a medias&quot; El 90% de los problemas que vemos …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">25,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ado:** La multa por no presentación según IRS §6038A es de $25,000 por formulario, por año…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">50,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…formulario, por año. Si llevas dos años sin presentar, son $50,000. Y el IRS no necesita d…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…LLC estaba en &quot;not in good standing&quot; La constitución es el 10% del trabajo. El 90% restant…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">50%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…CFC), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido +…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido + in…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; por no presentar el Form 5472. Cuentas de Mercury c…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…eportables entre tú y la LLC, y lo presentamos junto con el Form 1120 (return informativa)…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
