export default `Le Common Reporting Standard (CRS) est la pièce maîtresse de la fiscalité internationale de la dernière décennie, et peu de gens comprennent ce qu'il signifie réellement pour le propriétaire d'une <a href="/fr/blog/llc-aux-etats-unis-guide-complet-pour-non-residents-en-2026">LLC américaine</a> ou pour qui détient des comptes hors de son pays de résidence. Décortiquons-le avec précision technique.
