...
- **Reporting obligatoire même disregarded.** Une SMLLC à *member* non-résident doit déposer **Form 5472 + 1120 pro forma** annuellement pour toute *reportable transaction* (sanction de base 25 000 USD/an, IRC §6038A). Le reporting est informatif; ne signifie pas payer du tax fédéral. C'est le moment de demander de l'aide. Chez Exentax on ouvre le dossier, on dépose ce qui manque et on répond à l'administration pour toi.
