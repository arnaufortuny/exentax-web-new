...
Selon le volume et le type de transactions, votre banque peut être tenue de présenter des rapports auprès de <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> (Financial Crimes Enforcement Network). Cela ne signifie pas que vous faites l'objet d'une enquête, c'est une procédure de routine.
...
<li><span class="font-mono">10,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…cuando se realizan transacciones en efectivo superiores a $10,000 en un mismo día. Para la…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">9.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…t), fragmentación bajo umbrales de reporte (varios pagos de 9.500$ para evitar el CTR de 1…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…bre el &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt; para entender la…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
