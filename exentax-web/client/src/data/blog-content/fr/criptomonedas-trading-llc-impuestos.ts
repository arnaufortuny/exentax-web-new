export default `Si vous tradez crypto depuis la France, vous êtes déjà familier avec le Formulaire 2086 et la flat tax à 30 % sur les plus-values, plus le fait que le moindre swap DeFi déclenche potentiellement un événement imposable. Monter une LLC pour y loger l'activité crypto n'annule rien de tout ça, mais ça change complètement la photo si c'est structuré correctement.
...
Pour refermer, une lecture connexe qui s'inscrit dans le prolongement de ce papier: <a href="/fr/blog/impots-avec-des-clients-internationaux-en-espagne-ce-que">Impôts avec des clients internationaux en Espagne: ce que personne ne vous dit</a> aide à parachever le contexte.
...
Chez Exentax on voit toutes les semaines des traders français, belges et suisses qui veulent passer leur activité crypto sous LLC. Réservez votre consultation gratuite: on analyse votre cas, on vous dit ce qui tient la route côté DGFiP, et surtout ce qui ne tient pas.
...
Chaque situation fiscale dépend de votre résidence, de l'activité exercée et des contrats en vigueur. Les informations présentées ici sont générales et ne remplacent pas un conseil personnalisé; analysez votre cas particulier avant toute décision structurelle.<!-- exentax:execution-v2 -->
## Comment crypto, LLC et résidence s'agencent dans une déclaration défendable

Le trading crypto dans une LLC américaine semble attrayant: zéro impôt fédéral en SMLLC pass-through avec tout le poids en résidence. Mais le crypto introduit trois complications spécifiques — qualification du revenu, substance de l'activité et traçabilité on-chain — à comprendre avant toute constitution. Voici la lecture que nous faisons chez Exentax.

- **Qualification du revenu.** En Espagne, l'AEAT distingue plus-value (achat-vente crypto) taxée en base d'épargne (19-28%) et revenu d'activité économique (trading habituel avec organisation minimale) taxé en base générale (jusqu'à 47 %). Opérer via SMLLC ne change pas la qualification: organisé et professionnel = activité économique; sporadique = plus-value.
- **Trading vs investissement long terme.** Profil "buy & hold" avec 5-15 opérations/an cadre en plus-value — exploite les taux d'épargne, la SMLLC pass-through apporte peu au-delà de l'ordre opérationnel. Profil daytrading avec 200+ opérations/an en SMLLC exige argumentation d'activité économique et ouvre déductions de frais mais force le marginal.
- **DAC8 et reporting.** Dès actuellement les CASP européens reportent à l'AEAT positions et mouvements des clients. Exchanges non-UE (Coinbase US, Kraken US, Binance US) ne sont pas directement sous DAC8, mais tombent sous CARF (<a href="https://www.oecd.org" target="_blank" rel="noopener">OECD</a> Crypto Reporting Framework) et CRS quand les soldes passent par la banque.
- **On-chain comme preuve.** Les mouvements en wallets propres sont traçables et publics. L'AEAT peut demander preuve du coût d'acquisition et titularité. Maintenir un journal détaillé (Koinly, Cointracking) dès le premier mouvement; reconstruire 3 ans de DEX trading après est disproportionné.

### Ce qu'on nous demande le plus

**Si j'opère crypto dans ma LLC, j'évite le Modelo 721?** Non: le Modelo 721 oblige le résident fiscal espagnol à déclarer cryptoactifs à l'étranger au-dessus de 50 000 €. La titularité nominale par la LLC n'exonère pas — l'AEAT regarde la substance, pas la forme.

**Est-ce que je dois déplacer crypto au Portugal ou aux Émirats?** Seulement avec déménagement réel et séjour majoritaire. Le Portugal garde l'exonération pour holding >365 jours mais l'impôt daytrading récemment introduit limite l'attrait pour les pros. Les Émirats restent sans imposition sur crypto, mais exigent résidence effective.

Chez Exentax nous modélisons l'imputation crypto en résidence, préparons le Modelo 721 et la traçabilité Koinly et, si pertinent, présentons un changement de juridiction avec chiffres à 5 ans.
...
<li><span class="font-mono">6.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…cias patrimoniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.0…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…moniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…se del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 20…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 200.000€: **2…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">27%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…1%** - 50.000€ – 200.000€: **23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…**23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%** Esto aplica a cada opera…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…a LLC para un trader? Depende de tu volumen: - **Menos de 10.000€/año en ganancias:** Prob…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">47 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…l con organización mínima) tributado en base general (hasta 47 %). Operar a través de SMLL…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
