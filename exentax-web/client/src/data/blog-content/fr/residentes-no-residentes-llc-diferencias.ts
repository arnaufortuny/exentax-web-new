...
## Cas pratique pour un résident fiscal en France

Pour un freelance ou consultant résident fiscal en France qui ouvre une LLC US sans ETBUS et sans US-source income, le schéma type est le suivant :

- **Côté US** : la LLC paie **0 % fédéral** (IRC §§871, 882) et **0 % étatique** si elle est constituée à Wyoming, Nouveau-Mexique, Floride ou Texas. Obligation déclarative annuelle : Form 5472 + Form 1120 pro-forma (Treas. Reg. §1.6038A-1), avec sanction de **25 000 USD par formulaire** en cas de retard. Pas d'obligation BOI Report depuis l'IFR FinCEN du 21 mars 2025 pour les LLC formées aux US par des non-résidents.
- **Côté France** : l'administration fiscale applique généralement la **transparence fiscale** sur la SMLLC disregarded (BOI-INT-DG-20-10), traitant les bénéfices comme des revenus directement perçus par l'associé (BNC ou BIC selon l'activité). Le freelance doit déclarer les bénéfices nets de la LLC dans sa déclaration personnelle (formulaire 2042-C-PRO) et payer l'IR au barème progressif (0 % / 11 % / 30 % / 41 % / 45 % en 2024) plus les **cotisations sociales URSSAF** (~22-45 % selon statut et option micro-entrepreneur ou réel).
- **Banque & déclarations** : tout compte bancaire ouvert au nom de la LLC aux US (Mercury, Relay, Wise Business) doit être déclaré annuellement via le **formulaire 3916** (déclaration de comptes ouverts à l'étranger), sans seuil, sous peine d'amende de **1 500 €** par compte non déclaré (10 000 € si dans pays non coopératif). Et si un avis tombe, chez Exentax on garde le dossier prêt pour que vous répondiez en heures, pas en semaines.
- **Convention fiscale** : la **convention France-États-Unis du 31/08/1994** (avenants 2004 et 2009) règle la double imposition. Pour une LLC disregarded sans ETBUS, il n'y a généralement pas de double imposition à éviter (0 % US + IR France), mais l'analyse doit être faite au cas par cas pour les revenus FDAP (dividendes, intérêts, royalties).

L'avantage net pour un résident français : suppression des cotisations RSI/URSSAF sur le chiffre d'affaires brut (qui peuvent dépasser 22 % en micro-entrepreneur), large déductibilité des frais professionnels via la LLC, accès à la banque US et aux passerelles de paiement américaines (Stripe US, PayPal US) avec moins de friction qu'en France.
