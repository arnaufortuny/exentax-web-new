...
- **Banque & déclarations** : tout compte bancaire ouvert au nom de la LLC aux US (Mercury, Relay, Wise Business) doit être déclaré annuellement via le **formulaire 3916** (déclaration de comptes ouverts à l'étranger), sans seuil, sous peine d'amende de **1 500 €** par compte non déclaré (10 000 € si dans pays non coopératif).
