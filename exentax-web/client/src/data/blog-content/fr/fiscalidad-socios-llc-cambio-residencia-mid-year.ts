export default `Changer de pays de résidence fiscale en cours d'année alors que vous êtes membre d'une LLC US est l'un des scénarios les plus complexes à bien gérer. Non pas tant côté US (la LLC reste ce qu'elle était), mais côté répartition des revenus entre deux juridictions sur le même exercice.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…sidencia personal cambia; la LLC no. Eso significa: - El **Form 5472 + 1120 pro-forma** de…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
