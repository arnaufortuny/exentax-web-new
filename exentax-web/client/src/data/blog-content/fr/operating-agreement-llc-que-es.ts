export default `Lorsque vous constituez une LLC, vous recevez les Articles of Organization, le document public qui enregistre votre entreprise dans l'État. Mais il existe un autre document tout aussi important (et que beaucoup ignorent) : l'**Operating Agreement**.
