...
Les États-Unis proposent 4 véhicules principaux : la LLC pass-through à 0 % fédéral, la S-Corp réservée aux résidents, la C-Corp à 21 % fédéral et la sole proprietorship sans bouclier juridique.
...
L'obligation pratique qui demeure : annuelle **Form 5472 + Form 1120 pro-forma** (Treas. Reg. §1.6038A-1, en vigueur depuis 2017) pour SMLLC propriété d'un non-résident avec toute *reportable transaction* avec son unique membre. Sanction de base : **25 000 USD par formulaire et par an** (IRC §6038A(d)) plus **25 000 USD par chaque 30 jours additionnels** après notification de l'IRS. C'est le moment de demander de l'aide. Chez Exentax on ouvre le dossier, on dépose ce qui manque et on répond à l'administration pour vous.
