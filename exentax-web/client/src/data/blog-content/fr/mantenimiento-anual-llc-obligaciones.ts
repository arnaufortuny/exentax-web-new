export default `Beaucoup d'entrepreneurs français nous arrivent avec des LLC créées il y a 18 mois sur LegalZoom, qu'ils n'ont plus jamais touchées. Mauvaise nouvelle: une LLC sans Annual Report, sans 5472 et sans BOI n'est pas « en dormance », elle est en infraction, avec des pénalités <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> qui commencent à 25 000 $.
...
- **Avec notre équipe:** Nous le déposons pour vous. Vous ne vous en rendez même pas compte

### Delaware
- **Annual Report:** Oui, chaque année
- **Taxe annuelle:** franchise tax fixe pour les LLCs
- **Délai:** 1er juin de chaque année
- **Avec notre équipe:** Inclus dans le plan de maintenance
...
- **Avec notre équipe:** Nous demandons l'extension automatiquement et déposons tout avant le 15 octobre. Vous nous envoyez simplement vos informations financières et nous faisons le reste
...
- **Avec notre équipe:** Nous l'incluons dans le service de maintenance
...
**Avec notre équipe:** Le Registered Agent est inclus dans tous nos plans. Nous le renouvelons automatiquement chaque année. Aucun risque qu'il expire.
...
**Comptabilité formelle nécessaire?** Oui, ne serait-ce qu'un livre de caisse simplifié, pour déposer le 5472. Mercury + tableur jusqu’à ~150 k USD/an; au-delà, Quickbooks ou Wave.

**Et si je change de pays de résidence?** Notifiez le Registered Agent (changement d'adresse), mettez à jour Mercury (KYC) et, si la nouvelle résidence est CRS, déclarez le compte en conséquence.

<!-- exentax:execution-v2 -->
## Comment nous bouclons la maintenance annuelle chez Exentax

La maintenance annuelle d'une LLC, c'est six blocs qui se croisent: étatique, fédéral, BOI, banking, résidence et archivage. Si un glisse, les autres bougent. La méthode Exentax les chaîne sur un calendrier unique.

- **Annual report étatique** (Wyoming en février, NM sans annual, Delaware en juin) déposé le premier jour du mois pour ne pas dépendre du dernier.
- **5472 + 1120 pro-forma** prêts avant le 15 avril, avec extrait bancaire consolidé et rapprochement préalable.
- **Mise à jour BOI**: tout changement détecté en banking ou résidence ouvre la fenêtre obligatoire de 30 jours de redépôt.

Pour que nous tenions votre maintenance annuelle ou auditer le dernier exercice clos, lancez la <strong>calculatrice Exentax</strong> ou réservez trente minutes.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">300,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…nimo (aumenta si los activos reportados en Wyoming superan $300,000) - **Plazo:** 60 días …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…Si la suma de tus cuentas financieras en EE.UU. supera los $10,000 en algún momento del añ…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…constituyas tu LLC, estas obligaciones son las mismas: ### Form 5472 + Form 1120 (declarac…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…tu LLC, estas obligaciones son las mismas: ### Form 5472 + Form 1120 (declaración anual al…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 7004</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…puro. - **Plazo original:** 15 de abril - **Con extensión (Form 7004):** 15 de octubre - *…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 114</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…//www.fincen.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;FinCEN&lt;/a&gt; Form 114) Si la suma de tus cu…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
