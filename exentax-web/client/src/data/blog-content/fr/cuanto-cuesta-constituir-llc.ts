...
- Le Form 5472 + 1120 pro-forma se dépose à l'identique dans les trois États ; la sanction en cas d'omission est la même : 25 000 USD par formulaire et par an. On reste calme : chez Exentax, c'est notre routine de la semaine, on boucle ça avant que la lettre n'arrive dans votre boîte.
...
- **États-Unis.** Treas. Reg. §301.7701-3 (classification des entités / *check-the-box*) ; IRC §882 (impôt sur les revenus des étrangers connectés à un US trade or business) ; IRC §871 (FDAP et retenues pour non-résidents) ; IRC §6038A et Treas. Reg. §1.6038A-2 (<a href="https://www.irs.gov/forms-pubs/about-form-5472" target="_blank" rel="noopener">Form 5472</a> pour *25 % foreign-owned* et *foreign-owned disregarded entities*) ; IRC §7701(b) (résidence fiscale, *substantial presence test*) ; 31 U.S.C. §5336 (Corporate Transparency Act, BOI Report auprès de FinCEN).
- **France.** Code général des impôts (CGI), art. 4 A et 4 B (résidence fiscale), art. 209 B (entités contrôlées étrangères, CFC), art. 155 A et art. 1649 A (comptes à l'étranger, **déclaration n° 3916** pour les comptes et **n° 3916-bis** pour les contrats d'assurance-vie et comptes d'actifs numériques détenus à l'étranger) ; Livre des procédures fiscales, art. L. 13 AA (prix de transfert) ; doctrine BOFiP sur la transparence fiscale internationale et la qualification des entités étrangères.
- **Belgique, Luxembourg, Suisse.** Code des impôts sur les revenus 1992 (CIR 92, art. 5/2 transparence) ; **Banque nationale de Belgique — Point de contact central (PCC)** : déclaration annuelle obligatoire des comptes bancaires détenus à l'étranger par les résidents belges ; Loi luxembourgeoise relative à l'impôt sur le revenu (LIR), §134ter ; Loi fédérale sur l'impôt fédéral direct (LIFD) Suisse, art. 10.
- **Canada / Québec.** **Form T1135 — Foreign Income Verification Statement** (Agence du revenu du Canada) obligatoire pour tout résident fiscal canadien détenant des biens étrangers d'un coût total > 100 000 CAD, ce qui inclut la participation dans une LLC américaine ; côté Québec, le formulaire TP-1097 reprend l'information à des fins provinciales.
...
- [Documents LLC : ceux dont vous avez besoin et comment les organiser](/fr/blog/documents-llc-ceux-dont-vous-avez-besoin-et-comment-les)
