...
|---|---|---|---|---|
| Espagne | Visa de télétravail international (Ley 28/2022) | 1 an, renouvelable jusqu'à 5 | Environ 200 % du SMI (~2 762 EUR/mois en vigueur) | Accès régime Beckham à 24 % jusqu'à 600 000 EUR |
| Portugal | Digital Nomad Visa (D8) | 1 an, renouvelable jusqu'à 5 | 4 fois le SMIC (~3 280 EUR/mois en vigueur) | NHR 2.0 limité aux profils R&D plus récemment |
...
> **Quelle est votre meilleure combinaison pays plus LLC à votre niveau de CA?** Calculez l'économie nette dans le <strong>calculateur fiscal Exentax</strong>.
...
<li><span class="font-mono">20%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…o actualmente. La nueva versión ofrece: - Tipo reducido del 20% sobre rendimientos de trab…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…os últimos 5 años ### 2. Emiratos Árabes Unidos (Dubai) - 0% impuesto sobre la renta perso…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">1%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…icios, seguros) ### 3. Georgia - &quot;Small Business Status&quot;: 1% sobre facturación hasta 500.0…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">500.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…rgia - &quot;Small Business Status&quot;: 1% sobre facturación hasta 500.000 GEL (~170.000€) - Fácil…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">170.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…Business Status&quot;: 1% sobre facturación hasta 500.000 GEL (~170.000€) - Fácil obtener resid…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…de días mínimos para el estatus fiscal ### 4. Paraguay - 10% IRPF máximo sobre rentas de f…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…el país de residencia elegido. Y lo mejor: todo se gestiona 100% en remoto. En Exentax dis…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">200 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…rnacional (Ley 28/2022) | 1 año, renovable hasta 5 | Aprox. 200 % SMI mensual (~2.762 EUR/…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.762</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…22) | 1 año, renovable hasta 5 | Aprox. 200 % SMI mensual (~2.762 EUR/mes vigente) | Acces…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">24 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ual (~2.762 EUR/mes vigente) | Acceso al régimen Beckham al 24 % hasta 600.000 EUR | | Por…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">600.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…EUR/mes vigente) | Acceso al régimen Beckham al 24 % hasta 600.000 EUR | | Portugal | Digi…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">3.280</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…8) | 1 año, renovable hasta 5 | 4 veces el salario mínimo (~3.280 EUR/mes vigente) | NHR 2…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">4.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ás recientemente | | Estonia | Digital Nomad Visa | 1 año | 4.500 EUR/mes brutos | Tributa…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">22 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ón territorial al residir; OÜ con Distributed Profit Tax al 22 % | | Croacia | Digital Nom…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">2.870</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…it Tax al 22 % | | Croacia | Digital Nomad Permit | 1 año | 2.870 EUR/mes | Exención de IR…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">28.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…| | Italia | Visto per Nomadi Digitali | 1 año, renovable | 28.000 EUR anuales y seguro mé…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…28.000 EUR anuales y seguro médico | Régimen impatriados al 50 % o 60 % según condiciones …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">60 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…EUR anuales y seguro médico | Régimen impatriados al 50 % o 60 % según condiciones | | Emi…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…tos Árabes | Virtual Working Programme | 1 año, renovable | 3.500 USD/mes | 0 % IRPF, 9 % …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…tual Working Programme | 1 año, renovable | 3.500 USD/mes | 0 % IRPF, 9 % Corporate Tax so…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">9 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ng Programme | 1 año, renovable | 3.500 USD/mes | 0 % IRPF, 9 % Corporate Tax sobre benefi…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">375.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…00 USD/mes | 0 % IRPF, 9 % Corporate Tax sobre beneficios &gt; 375.000 AED | | Georgia | Remo…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">2.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…&gt; 375.000 AED | | Georgia | Remotely from Georgia | 1 año | 2.000 USD/mes | Régimen Small …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">1 %</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…| 1 año | 2.000 USD/mes | Régimen Small Business Status al 1 % hasta 500.000 GEL | | Méxic…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…FF | | Costa Rica | Rentista / Nómada | 2 años, renovable | 2.500-3.000 USD/mes | Sistema …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…Costa Rica | Rentista / Nómada | 2 años, renovable | 2.500-3.000 USD/mes | Sistema territo…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
