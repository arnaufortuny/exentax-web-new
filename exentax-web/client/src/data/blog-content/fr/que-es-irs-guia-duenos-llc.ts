...
Si certains aspects de cette structure méritent d'être creusés, <a href="/fr/blog/llc-americaine-pour-agences-de-marketing-digital-structure">LLC américaine pour agences de marketing digital: structure, facturation et croissance</a> et <a href="/fr/blog/llc-americaine-pour-developpeurs-de-logiciels-et-fondateurs">LLC américaine pour développeurs de logiciels et fondateurs SaaS: guide complet</a> détaillent des points adjacents que nous réservons d'habitude à des articles dédiés.
...
L'IRS est l'autorité fiscale fédérale des États-Unis. Pour un propriétaire de LLC non-résident, ce n'est ni plus ni moins bureaucratique que n'importe quel fisc européen - mais procédural et prévisible.

- **Comment l'IRS vous identifie.** Comme individu par ITIN (si demandé avec W-7) ou par absence. Comme entité par l'EIN de votre LLC (Form SS-4). L'EIN est à vie; on change l'adresse avec Form 8822-B.
- **Ce qu'il exige d'une single-member LLC non-résidente.** Form 5472 + Form 1120 pro forma annuels (15 avril, prorogation 15 octobre avec Form 7004). Le 5472 reporte les « reportable transactions » entre LLC et owner étranger.
- **Quand il exige W-8BEN-E.** Pas l'IRS directement, mais tout payer US (Stripe, Amazon, broker) pour ne pas retenir 30%. Vit 3 ans.
- **Comment l'IRS communique.** Par courrier postal à l'adresse de la LLC. JAMAIS par email, téléphone non sollicité ou WhatsApp. Toute communication digitale est phishing. Les vraies lettres ont un numéro CP vérifiable sur irs.gov.

### Ce qu'on nous demande le plus

**Dois-je avoir ITIN obligatoirement?** Non, sauf besoins spécifiques (W-9, K-1, 1040-NR). Pour disregarded single-member LLC, EIN suffit.

**Si l'IRS m'envoie une lettre incompréhensible?** Ne répondez pas à chaud. Identifiez le code CP, cherchez le modèle sur irs.gov, calculez le délai (typiquement 30 jours), consultez EA ou CPA.

Chez Exentax nous agissons comme votre interlocuteur IRS.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…los ingresos son de fuente extranjera, lo que resulta en **0% de impuesto federal**. ### P…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…nancieras fuera de EE.UU. con un saldo agregado superior a $10,000 en cualquier momento de…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ite documentar tu estatus de no residente para no retenerte 30%. La W-8BEN-E vive 3 años o…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…r el **&lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt; + Form 1120** an…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt; + Form 1120** ante el IRS. Es un…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 7004</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…esto que pagar). Es básicamente un sobre para el 5472. ### Form 7004, la extensión automát…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 114</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…//www.fincen.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;FinCEN&lt;/a&gt; Form 114) Si la LLC tiene cuen…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 8822</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…l constituir). El EIN es de por vida; cambias dirección con Form 8822-B, no con el EIN. La…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
