...
Pour la majorité des profils que nous accompagnons, une <a href="/fr/blog/fiscalite-transparente-pour-llc-comment-ca-fonctionne-et">LLC américaine en pass-through</a> offre une meilleure fiscalité effective, une banque plus opérationnelle et des coûts d'entretien moindres. Si vous voulez comparer des chiffres concrets pour votre cas, chez Exentax nous pouvons le faire sans engagement. Chez Exentax nous étudions votre cas avec des données réelles : <a href="/fr/reserver">réservez une consultation gratuite</a> de 30 minutes.
...
**Et si je vis au Portugal avec NHR actif?** NHR exonère dividendes de source étrangère sous certaines conditions. NHR + OÜ a fonctionné dans beaucoup de cas, mais le régime NHR est restreint pour nouveaux arrivants après 2024 - vérifier éligibilité avant.

Chez Exentax nous modélisons Estonie OÜ avec votre résidence et plan d'extraction réels - si le différé apporte ou si LLC US ou statut indépendant couvrent mieux sans la complexité estonienne.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…racias a la e-Residency, su digitalización y la promesa de &quot;0% sobre beneficios reinvertid…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ial mínimo: 0,01 EUR desde la última reforma (anteriormente 2.500 EUR exigibles a la prime…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «….500 EUR exigibles a la primera distribución). Constitución 100% online en 1-3 días con e-…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">22%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ciedad reparte dividendos a los socios, Estonia aplica el **22% nominal**, calculado como …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">7.800</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…sobre el importe neto distribuido. Es decir, para entregar 7.800 EUR netos al socio, la so…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…egar 7.800 EUR netos al socio, la sociedad debe disponer de 10.000 EUR (7.800 al socio + 2…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.200</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…, la sociedad debe disponer de 10.000 EUR (7.800 al socio + 2.200 de impuesto). Sobre el b…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">14%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…carga efectiva es del 22%. - Existe un tipo reducido del **14% (calculado como 14/86)** pa…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…- Los dividendos recibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…idendos recibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EU…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hast…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…butan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">23%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% has…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…horro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">27%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…sta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000 EUR, 28% por…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">300.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000 EUR, 28% por encima. -…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…a 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000 EUR, 28% por encima. - El convenio …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…nio España-Estonia limita la retención en origen estonia al 5% sobre dividendos para parti…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…a al 5% sobre dividendos para participaciones inferiores al 25%, y existe deducción por do…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…doble imposición. - Carga combinada típica: en torno al 25-30% según renta total. Si eres …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…**Declaración mensual de IVA** si está registrada (umbral: 40.000 EUR/año en EEE). - **Dec…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…do contabilidad, domicilio, contact person y annual report: 1.500-3.500 EUR. ## Banca: el …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">3.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…tabilidad, domicilio, contact person y annual report: 1.500-3.500 EUR. ## Banca: el cuello…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…fica el valor del régimen. **Caso 2: consultor europeo con 80.000 EUR/año que necesita el …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…cios queden en la sociedad, 0% de impuestos. Al distribuir, 20% (22% efectivo según el eje…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…España: TFI/CFC aplica si tributación efectiva estonia es &lt;50% de la española y la socieda…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
