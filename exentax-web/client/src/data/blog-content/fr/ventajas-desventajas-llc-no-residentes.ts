export default `Avant de monter une LLC depuis la France, il faut regarder la photo complète, pas seulement les slides de vente. Oui, la protection du patrimoine et le pass-through sont réels, mais le 5472 à 25 000 $ de pénalité, la déclaration 3916 française, l'exigence BOI et la friction bancaire sont tout aussi réels. Un choix adulte se fait sur les deux colonnes.
...
Pour refermer, quelques lectures connexes qui s'inscrivent dans le prolongement de ce papier: <a href="/fr/blog/auto-entrepreneur-en-espagne-vs-llc-aux-etats-unis">Auto-entrepreneur en Espagne vs LLC aux États-Unis: comparaison fiscale</a> et <a href="/fr/blog/pourquoi-ne-pas-ouvrir-une-entreprise-en-estonie-la-llc">Pourquoi ne pas ouvrir une entreprise en Estonie: la LLC américaine l'emporte</a> aident à parachever le contexte.
...
Chez Exentax on donne les deux colonnes à chaque prospect francophone avant de commencer. Réservez votre consultation gratuite: on liste avantages et inconvénients appliqués à votre vrai profil.
...
## Avantages et inconvénients de la LLC pour non-résidents: tableau honnête avant de décider

### Avantages réels

- **Accès au système financier US.** Stripe, PayPal US, Mercury/Wise USD, Brex, contrats B2B corporates US.
- **Imposition 0% fédéral sans ETBUS ni US-source.** Conception légale US pour non-résidents.
- **Professionnalisation et crédibilité.** LLC ouvre des portes qu'un freelance solo n'ouvre pas.
- **Flexibilité de planification.** Timing des retraits, séparation d'activités, restructuration future.

### Inconvénients réels

- **Coût opérationnel récurrent réel.** Comptabilité mensuelle (~80-150$), 5472/1120 annuel (300-600$), BOI (150-300$), agent (50-100$/an). Année 1: 1 500-3 000$.
- **Conformité lourde et amendes brutales.** Oublier 5472 = 25 000$ min. BOI = 591$/jour.
- **Banque plus compliquée que vendu.** Mercury rejette, Stripe ferme, gels inattendus.
- **Pas d'économie fiscale réelle en France/Espagne/Italie.** LLC attribuée, imposition identique au freelance.

### Quand la LLC convient

Encaissements US récurrents, expansion marché nord-américain, marketplace exigeant entité US, restructuration patrimoniale planifiée.
...
**La LLC me protège-t-elle dans un procès?** Limite responsabilité aux actifs de la LLC avec séparation rigoureuse.

**Puis-je fermer facilement?** Oui, mais dissolution formelle obligatoire.

Chez Exentax nous modélisons pour/contre avec votre cas réel.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…) Una Single-Member LLC con propietario no residente paga **0% de impuesto federal** en EE…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…a optimizar la carga fiscal **hasta un 0%**, frente al **40-47%** que pagas como autónomo.…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…tido? - Freelancers digitales con ingresos superiores a **$2,000/mes** - Emprendedores con…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…# ¿Para quién NO tiene sentido? - Autónomos con **clientes 100% nacionales**: si todos tus…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">1.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…$100/año), banco con fees variables. Total realista año 1: $1.500-$3.000. Si tu margen no …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…o), banco con fees variables. Total realista año 1: $1.500-$3.000. Si tu margen no soporta…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ar BOI = $591/día. Olvidar declarar en residencia = sanción 50%-150% del impuesto eludido.…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…OI = $591/día. Olvidar declarar en residencia = sanción 50%-150% del impuesto eludido. Una…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…uales: &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472 + 1120&lt;/a&gt;, FBAR (si…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
