export default `Si vous êtes résident fiscal en Espagne et que vous avez une <a href="/fr/blog/llc-aux-etats-unis-guide-complet-pour-non-residents-en-2026">LLC américaine</a>, un compte Wise ou Mercury, un broker à l'étranger ou tout solde notable en cryptomonnaies hors d'un exchange espagnol, deux déclarations marquent la frontière entre être en règle et avoir un vrai problème: le **Modelo 720** et le **Modelo 721**. Presque tous les autres articles de ce blog les citent en passant; celui-ci est l'article de référence pour les comprendre en profondeur.
...
| Bloc | Contenu | Seuil |
| --- | --- | --- |
| Bloc I: Comptes | Comptes courants, d'épargne, de dépôt, de crédit et tout autre compte dans des établissements financiers situés à l'étranger | 50 000 € (solde au 31/12 ou solde moyen du 4e trimestre) |
| Bloc II: Valeurs, droits, assurances et rentes | Actions, parts de fonds, obligations, droits représentatifs, assurances vie ou invalidité, rentes viagères ou temporaires | 50 000 € (valeur au 31/12) |
| Bloc III: Immeubles et droits immobiliers | Immeubles et droits réels sur des immeubles situés à l'étranger | 50 000 € (valeur d'acquisition) |
...
- Les **bénéficiaires effectifs** (controlling persons), même si la propriété juridique formelle appartient à une autre personne ou entité. C'est là que la LLC américaine prend tout son sens: si vous êtes bénéficiaire effectif d'une <a href="/fr/blog/llc-aux-etats-unis-guide-complet-pour-non-residents-en-2026">LLC américaine</a> et que la LLC détient un compte Wise ou Mercury, vous êtes personnellement tenu de déclarer ce compte comme bien situé à l'étranger.
...
Le régime de sanctions initial du 720 était l'un des plus sévères de l'UE: 5 000 € par donnée omise (minimum 10 000 €), imprescriptibilité des revenus non déclarés requalifiés en gain patrimonial non justifié (art. 39.2 LIRPF) et sanction de 150 % sur la cotisation.

L'**arrêt de la CJUE du 27 janvier 2022, affaire C-788/19**, l'a déclaré contraire au droit de l'Union pour disproportion et atteinte à la libre circulation des capitaux. La loi 5/2022 du 9 mars a supprimé ces sanctions spécifiques.
...
- Le **régime général LGT** pour les cotisations dues au titre de l'IRPF si des revenus non déclarés sont découverts: art. 191 (sanction de 50 à 150 % de la cotisation), avec **prescription de 4 ans**.
...
Coinbase, Kraken, Binance international, KuCoin, Bybit, etc.: ce sont des prestataires non résidents. Solde agrégé au 31/12 supérieur à 50 000 € → **Modelo 721**. Avec DAC8 à partir du 1er janvier 2026, le recoupement deviendra encore plus rapide (voir <a href="/fr/blog/dac8-et-cryptomonnaies-le-nouveau-reporting-fiscal">DAC8 et reporting crypto</a>).
...
Le Modelo 720 et le Modelo 721 sont des obligations informatives, pas des impôts. Elles ne coûtent rien en elles-mêmes, mais leur omission, oui: sanction de l'art. 198 LGT, régularisation des cotisations avec les majorations de l'art. 191 et, sur les soldes non justifiés, le levier classique de l'art. 39 LIRPF (atténué par la CJUE mais pas supprimé). Le recoupement avec CRS et, à partir du 1er janvier 2026, avec DAC8, rend l'empreinte de plus en plus visible pour l'AEAT.
...
- **Régime sanctionnateur actuel.** Après l'arrêt CJUE de janvier 2022 (C-788/19) et la réforme, l'ancien régime spécifique 720 fut déclaré contraire au droit UE. Sanctions actuelles: régime général LGT.
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…re tres bloques separados, cada uno con su propio umbral de 50.000 € agregados: | Bloque |…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">20.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…bloque concreto se ha producido un **incremento superior a 20.000 €** respecto al saldo de…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…el 720 fue uno de los más severos del ordenamiento europeo: 5.000 € por dato omitido (míni…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…del ordenamiento europeo: 5.000 € por dato omitido (mínimo 10.000 €), imprescriptibilidad …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…patrimonial no justificada (art. 39.2 LIRPF) y sanción del 150% sobre la cuota. La **Sente…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">120.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…(art. 305 CP) si la cuota defraudada en un ejercicio supera 120.000 €. La sentencia europe…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">30.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…de la LLC no cambia la obligación informativa. 3. **&quot;Tengo 30.000 € en Wise y 25.000 € en …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">25.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…a la obligación informativa. 3. **&quot;Tengo 30.000 € en Wise y 25.000 € en Mercury, no llego …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">55.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…al es **agregado** dentro de cada bloque. 30.000 + 25.000 = 55.000 € → obligado a declarar…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ut, brokers extranjeros o cripto fuera de España y no estás 100% seguro de tu posición fre…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">18.400</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…de un freelancer residente en Madrid con: Wise EUR balance 18.400 €, Mercury Personal Savi…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">22.300</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…id con: Wise EUR balance 18.400 €, Mercury Personal Savings 22.300 USD, broker Interactive…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">41.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…Savings 22.300 USD, broker Interactive Brokers con cartera 41.000 €, Kraken con 6.200 € en…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">6.200</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…broker Interactive Brokers con cartera 41.000 €, Kraken con 6.200 € en BTC y ETH. Bloque c…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">39.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…H. Bloque cuentas: 18.400 + 22.300 USD convertidos al BCE = 39.000 € aprox., por debajo de…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">35.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…mbral de 50.000 €, **no obliga**. Si al año siguiente añade 35.000 € a Mercury, el bloque …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">74.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…iguiente añade 35.000 € a Mercury, el bloque cuentas pasa a 74.000 € y dispara la obligaci…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…superior a 50.000 € → **Modelo 721**. Si además operas con DAC8 recientemente, el cruce se…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
