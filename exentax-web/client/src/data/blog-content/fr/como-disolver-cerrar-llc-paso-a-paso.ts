...
- **Conserver la comptabilité** (factures émises et reçues, relevés bancaires, justificatifs) au moins **sept ans**. Horizon raisonnable pour audits, intérêts et demandes éventuelles. On reste calme : chez Exentax, c'est notre routine de la semaine, on boucle ça avant que la lettre n'arrive dans ta boîte.
...
- **Étape 5 - BOI Final Report.** FinCEN exige un rapport final de BOI à la cessation de l'entité, dans les 30 jours suivant la dissolution étatique. Sans cela, sanctions civiles possibles. Respire : chez Exentax c'est de la routine, on te remet à jour et le prochain contrôle se clôt en un tour, sans drame.
