export default `Une sanction type de l'AEAT pour mauvaise déclaration de TVA démarre à 150 € et grimpe facilement au-dessus de 3 000 € lorsqu'elle dépasse 50 % du montant impayé (art. 191 LGT). On le clôt avec vous depuis Exentax : un appel, le dépôt part, l'archive est faite, et le risque reste sur le papier.
...
| TVA incorrecte | Amendes de 150-600 € |. C'est exactement pour cela que chez Exentax on garde votre calendrier carré — vous ne pensez plus aux échéances, on les clôt avant qu'elles ne mordent.
