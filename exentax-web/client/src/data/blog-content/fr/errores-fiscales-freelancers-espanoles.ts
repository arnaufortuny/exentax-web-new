export default `Après avoir conseillé des centaines de freelances espagnols, nous avons identifié un schéma clair : les mêmes erreurs fiscales se répètent encore et encore. Et ce ne sont pas des erreurs mineures, nous parlons de milliers d'euros perdus chaque année par méconnaissance ou mauvais conseil.
