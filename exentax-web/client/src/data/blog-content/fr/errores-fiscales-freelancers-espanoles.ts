export default `Une sanction type de l'AEAT pour mauvaise déclaration de TVA démarre à 150 € et grimpe facilement au-dessus de 3 000 € lorsqu'elle dépasse 50 % du montant impayé (art. 191 LGT). On le clôt avec toi depuis Exentax : un appel, le dépôt part, l'archive est faite, et le risque reste sur le papier.
...
| TVA incorrecte | Amendes de 150-600 € |. On reste calme : chez Exentax, c'est notre routine de la semaine, on boucle ça avant que la lettre n'arrive dans ta boîte.
...
- **Faire confiance au "rien venu encore".** Prescription IRPF: 4 ans depuis le 30 juin suivant - mais les inspections internationales tirent des comptes étrangers et du modelo 720 avec délais spéciaux. Ce que vous ne trouvez pas, le Trésor le trouve via CRS, FATCA ou DAC7 deux ans plus tard. Chez Exentax on a clôturé sans pénalité des clients arrivés exactement dans cette situation. Parler tôt, ça paie — et ça t'épargne cinq chiffres.

### Ce qu'on nous demande le plus

**Comment régulariser volontairement sans déclencher d'inspection?** Déclaration complémentaire avec majoration (15% sous 12 mois, 20% après) sans sanction. Arriver avant l'AEAT change totalement le dénouement. On reste calme : chez Exentax, c'est notre routine de la semaine, on boucle ça avant que la lettre n'arrive dans ta boîte.
