export default `Amazon US a généré plus de 600 milliards de dollars de ventes brutes lors de son dernier exercice clos, et 100 % de ces versements passent par un prestataire qui exige un EIN et un compte bancaire américain avant de vous verser quoi que ce soit.
