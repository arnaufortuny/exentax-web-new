...
Le BOI Report (Beneficial Ownership Information) est une déclaration auprès de <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> qui identifie les propriétaires effectifs de la LLC. Depuis le 1er janvier 2024, toutes les LLCs doivent le déposer (bien que FinCEN ait temporairement suspendu l'application des sanctions).
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…autorizado a trabajar en EE.UU. para tener una LLC. Todo es 100% remoto - **Dirección físi…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…strarte en Stripe/PayPal, presentar declaraciones fiscales (Form 5472 + 1120) y operar con…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
