export default `Si vous envisagez de quitter l'Espagne, ou si vous l'avez déjà fait, et que vous détenez un patrimoine significatif en cryptomonnaies, un compte chez Interactive Brokers ou des parts dans une LLC américaine, vous devez connaître la **taxe de sortie** avant que l'administration fiscale espagnole (AEAT) ne vous le rappelle. L'article 95 bis de la loi espagnole de l'impôt sur le revenu des personnes physiques (LIRPF, Loi 35/2006) établit une imposition sur les plus-values latentes au moment où un résident fiscal cesse de l'être.
...
| Seuil | Condition |
|-------|-----------|
| **Seuil 1** | Valeur de marché des actions/participations **≥ 4.000.000 €** |
| **Seuil 2** | Participation **≥ 25%** dans une entité **ET** valeur de marché **≥ 1.000.000 €** |
...
<!-- exentax:lote26-native-v1:exit-tax-espana-llc-cripto-interactive-brokers-fr -->
...
- [Crypto et trading avec une LLC américaine : guide fiscal complet](/fr/blog/cryptomonnaies-et-trading-avec-llc-guide-fiscal-complet-pour)
