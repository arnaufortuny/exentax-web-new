...
- Les critères se sont durcis ces dernières années, surtout depuis la pression <a href="https://www.oecd.org" target="_blank" rel="noopener">OCDE</a>/BEPS et les changements introduits récemment sur les revenus passifs étrangers (régime FSIE).
...
Le plancher réaliste pour maintenir une société basique: 4 000 à 7 000 USD par an. Bien loin du coût de maintenance d'une <a href="/fr/blog/combien-coute-la-creation-dune-llc-americaine-decomposition">LLC américaine</a>, qui tourne autour de 500 à 800 USD par an.
...
- **Fiscalité**: 0 % fédéral aux États-Unis pour les non résidents, sans demandes ou claims à gérer année après année (<a href="/fr/blog/fiscalite-transparente-pour-llc-comment-ca-fonctionne-et">pass-through</a>).
- **Coût annuel**: 500-800 USD contre 4 000-7 000 USD à Hong Kong.
- **Banque**: Mercury, Wise, Wallester, Slash, Relay, ouvertes à distance et opérant en USD dès le premier jour.
...
C'est de plus en plus difficile. HSBC, Hang Seng et Standard Chartered exigent une visite en personne. Quelques EMI (Airwallex, Currenxie, Statrys) permettent une ouverture à distance, mais avec des limites opérationnelles.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…punto de constituir una Hong Kong Limited atraídas por el &quot;0% offshore&quot;. Antes de dar el p…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…cos días con cualquier despacho local. El coste va de 800 a 2.000 USD según el proveedor, …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ong, etc. - Si la IRD rechaza la offshore claim, pagas el 8,25% sobre los primeros 2 millo…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…pagas el 8,25% sobre los primeros 2 millones de HKD y el 16,5% sobre el resto. En la práct…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.150</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…: - **Business Registration Certificate**: aproximadamente 2.150 HKD anuales (unos 270 USD…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…Registry: 105 HKD. - **Company Secretary** residente: 600 a 1.500 USD anuales. - **Domicil…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…PA: desde 1.500 USD para empresas pequeñas, en muchos casos 2.500 a 5.000 USD. - **Profits…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…e 1.500 USD para empresas pequeñas, en muchos casos 2.500 a 5.000 USD. - **Profits Tax Ret…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">4.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ez. El suelo realista para mantener una empresa básica son 4.000 a 7.000 USD al año. Muy l…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">7.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…suelo realista para mantener una empresa básica son 4.000 a 7.000 USD al año. Muy lejos de…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…entes, evidencia de actividad real. - Saldos mínimos altos: 50.000 HKD a 1 millón de HKD s…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…atoria**: la LLC no tiene que auditar cuentas. Basta con un Form 5472 anual. ¿Hay casos en…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
