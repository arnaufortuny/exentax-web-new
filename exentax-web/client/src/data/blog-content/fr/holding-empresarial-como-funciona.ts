...
Constituer une holding par mode ajoute comptabilité, déclarations, coûts et exposition à inspection, sans contrepartie.
...
- Audit si dépassement de seuils: 3 000-10 000 EUR/an.
...
- **Mélanger patrimoine personnel et holding**: casse la protection et complique les audits.
...
<!-- exentax:cta-v1 -->
Création, EIN, BOI, banque et maintenance : une seule équipe qui comprend votre dossier de bout en bout. <a href="/fr/services/llc-wyoming">Voir tous les services</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…vidades en España: - **Holding (S.L. patrimonial)**: posee 100% de las filiales. - **Filia…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…iscal aplicable: - Las filiales tributan por sociedades al 25% sobre sus beneficios. - Cua…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">95%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…lding, opera la **exención por doble imposición interna del 95%** (artículo 21 LIS), siemp…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…del 95%** (artículo 21 LIS), siempre que el holding posea ≥5% de la filial y ≥1 año de ant…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…físicas, esos dividendos tributan en el IRPF del ahorro (19-28% según tramo). El ahorro fi…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…recurrente que conviene presupuestar: - Constitución: 500-3.000 EUR según jurisdicción. - …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…UR según jurisdicción. - Domicilio social y secretaría: 500-2.000 EUR/año. - Contabilidad …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…taría: 500-2.000 EUR/año. - Contabilidad y cuentas anuales: 1.500-5.000 EUR/año. - Auditor…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…500-2.000 EUR/año. - Contabilidad y cuentas anuales: 1.500-5.000 EUR/año. - Auditoría si s…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…1.500-5.000 EUR/año. - Auditoría si supera umbrales: 3.000-10.000 EUR/año. - Asesoría fisc…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">8.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «….000-10.000 EUR/año. - Asesoría fiscal especializada: 2.000-8.000 EUR/año. Suelo realista …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">4.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…especializada: 2.000-8.000 EUR/año. Suelo realista anual: 4.000-12.000 EUR para un holding…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">12.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…ializada: 2.000-8.000 EUR/año. Suelo realista anual: 4.000-12.000 EUR para un holding inte…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">300.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…plica **Caso 1: empresa familiar con beneficios anuales de 300.000 EUR.** Holding clásica …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">40%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…edio y profesionaliza la sucesión. Ahorro real estimado: 25-40% del impacto fiscal sin hol…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…go plazo. **Caso 2: emprendedor con SaaS en crecimiento de 100.000 EUR/año.** Holding aún …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…consolidar la operativa primero y replantear cuando supere 200.000 EUR. **Caso 3: profesio…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
