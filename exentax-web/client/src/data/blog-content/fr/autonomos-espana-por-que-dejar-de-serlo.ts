export default `Soyons directs : si vous êtes auto-entrepreneur en Espagne et que la majorité de vos revenus proviennent de l'étranger, des clients aux États-Unis, au Royaume-Uni, en Allemagne ou dans n'importe quel autre pays, vous payez probablement beaucoup plus que nécessaire. Et pas qu'un peu.
