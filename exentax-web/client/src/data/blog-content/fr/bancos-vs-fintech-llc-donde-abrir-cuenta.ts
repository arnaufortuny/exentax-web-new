export default `Quand vous ouvrez votre LLC, l'une des premières décisions est de savoir où ouvrir le compte bancaire. Et c'est là que la confusion commence : Mercury n'est pas une banque. Wise non plus. Relay non plus. Mais tous vous offrent un compte, une carte et un routing number.
