...
- **Correspondance de l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>**: bien que l'IRS envoie généralement au domicile fiscal enregistré
- **Documents du <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>**: notifications liées au BOI Report
...
Quelques lectures voisines à garder sous la main: <a href="/fr/blog/llc-americaine-pour-createurs-de-contenu-youtube-twitch-et">LLC américaine pour créateurs de contenu: YouTube, Twitch et au-delà</a> et <a href="/fr/blog/combien-coute-la-creation-dune-llc-americaine-decomposition">Combien coûte la création d'une LLC américaine? Décomposition complète des coûts</a>, qui affinent précisément les bords de ce qu'explique ce guide.
...
Pour vérifier votre agent actuel ou le changer sans perdre l'ancienneté, lancez la <strong>calculatrice Exentax</strong> ou réservez trente minutes.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…ntienden que tu LLC es de un extranjero, no saben qué es el Form 5472, y no pueden orienta…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
