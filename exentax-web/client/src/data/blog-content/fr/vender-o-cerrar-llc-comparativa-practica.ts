...
| Aspect | Fermer | Asset sale | Equity sale |
|---|---|---|---|
| Acheteur requis | Non | Oui | Oui |
| Délai typique | 2-4 mois | 1-3 mois | 2-6 mois |
| Coût pro typique | 800-2 500 USD | 1 500-5 000 USD | 3 000-10 000+ USD |
### Quand fermer
...
Procédure standard: décision interne, liquidation bancaire, déclarations finales <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> (5472 + 1120 marqués final), Articles of Dissolution, annulation EIN, BOI final.
### Quand asset sale
...
|---|---|
| Acheteur identifié, valorisation > 1× ARR | Envisager la vente |
| Pas d'acheteur, activité faible | Dissoudre |
| Changement d'associés | Restructurer (ne pas fermer) |
| Relocalisation géographique | Dissoudre et ouvrir une nouvelle dans l'État optimal |
...
Pour savoir ce qui convient à votre cas réel, lancez la <strong>calculatrice Exentax</strong> ou réservez trente minutes.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Envie d'en parler tout de suite ? Appelez-nous au <a href="tel:+34614916910">+34 614 916 910</a> ou écrivez-nous sur <a href="https://wa.me/34614916910?text=Bonjour%20Exentax%2C%20je%20lis%20l'article%20%22Il%20arrive%20un%20moment%20dans%20beaucoup%20de%20LLC%20o%C3%B9%20la%20question%20est%20la%20m%C3%AAme%3A%20je%20la%20fe%E2%80%A6%22%20et%20je%20veux%20parler%20%C3%A0%20un%20conseiller%20sur%20mon%20cas.">WhatsApp</a> et nous vous répondons aujourd'hui.</p>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…| 1-3 meses | 2-6 meses | | Coste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…| 2-6 meses | | Coste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…meses | | Coste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD |…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…oste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD | | Document…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…rofesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD | | Documentación …»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">28%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…rticipación social y tributar como ganancia patrimonial (19-28%). Consulta caso a caso. &lt;!…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
