...
Ce que nous voyons en pratique : régularisation sur la période non prescrite + intérêts de retard + sanction minimale de 50 % (qui peut grimper).
...
- **Modèles informatifs espagnols.** Comptes bancaires aux États-Unis avec solde moyen ou final supérieur à 50 000 € : **Modèle 720** (Loi 5/2022 après l'arrêt CJUE C-788/19 du 27/01/2022, sanctions désormais alignées sur le régime général LGT). Opérations liées avec la LLC et dividendes rapatriés : **Modèle 232**. Crypto-actifs en garde aux États-Unis : **Modèle 721**.
...
- **Revolut Business** : lorsqu'il est associé à une **LLC américaine**, le montage habituel passe par Revolut Payments USA ; les IBAN européens (lituaniens, BE) **ne sont pas émis par défaut** à une LLC : ils le sont à des clients européens de la banque européenne du groupe. Si on vous propose un IBAN européen, vérifiez à quelle entité juridique ce compte est rattaché et sous quel régime elle déclare.
