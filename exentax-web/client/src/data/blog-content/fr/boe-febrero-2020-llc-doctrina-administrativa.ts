...
- **Les exonérations pour double imposition de dividendes ne s'appliquent pas.** Seul le crédit d'impôt étranger fondé sur l'impôt effectivement payé aux États-Unis est admis (équivalent de l'art. 80 LIRPF en Espagne, du dispositif de la convention France–USA en France, etc.). Pour une Disregarded Entity, ce crédit est typiquement de **0 $** au niveau fédéral (voir <a href="/fr/blog/fiscalite-transparente-pour-llc-comment-ca-fonctionne-et">la fiscalité pass-through</a>).
...
Plus de détails dans <a href="/fr/blog/deductions-fiscales-pour-votre-llc-ce-que-vous-pouvez">les charges déductibles de votre LLC</a>.
...
2. **Concevoir la structure pour qu'elle s'impose efficacement.** Décisions à prendre : apports en capital, charges affectées, rémunération de l'associé, autres montages possibles (S.L. espagnole + LLC opérationnelle, SARL française + LLC opérationnelle, holding belge SoParFi luxembourgeoise, etc.). Voir <a href="/fr/blog/conception-dune-structure-fiscale-internationale-solide">la conception d'une structure internationale solide</a>.
3. **Considérer votre activité concrète.** Le régime pratique varie pour les services, l'e-commerce, les redevances et le trading. Nous le développons dans <a href="/fr/blog/imposition-de-la-llc-selon-lactivite-economique-services">l'imposition de la LLC selon votre activité économique</a>.
...
Pour refermer, une lecture connexe qui s'inscrit dans le prolongement de cet article : <a href="/fr/blog/fiscalite-internationale-pour-entrepreneurs-numeriques-guide">Fiscalité internationale pour entrepreneurs numériques : tout ce que vous devez savoir</a> est utile pour finir de poser le contexte.
...
- **Modèles informatifs espagnols.** Comptes bancaires aux États-Unis avec solde moyen ou final supérieur à 50 000 € : **Modèle 720** (Loi 5/2022 après l'arrêt CJUE C-788/19 du 27/01/2022, sanctions désormais alignées sur le régime général LGT). Opérations liées avec la LLC et dividendes rapatriés : **Modèle 232**. Crypto-actifs en garde aux États-Unis : **Modèle 721**. Et si un avis tombe, chez Exentax on garde le dossier prêt pour que tu répondes en heures, pas en semaines.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Envie d'en parler tout de suite ? Écrivez-nous sur <a href="https://wa.me/34614916910?text=Bonjour%20Exentax%2C%20je%20viens%20de%20l'article%20%22BOE%20f%C3%A9vrier%202020%20-%20doctrine%20administrative%20LLC%22%20et%20je%20souhaite%20parler%20%C3%A0%20un%20conseiller%20de%20mon%20cas.">WhatsApp</a> et nous vous répondons dès aujourd'hui.</p>
