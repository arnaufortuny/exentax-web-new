...
1. **Le Registered Agent**, si votre nouveau prestataire propose un RA différent.
2. **L'adresse de notifications**, si celle du prestataire précédent figurait comme mailing address.
3. **Le responsable du dépôt** du prochain cycle: 5472, BOI, Annual Report.
...
Pas de pénalité, pas de réinitialisation, rien ne se "perd". La seule chose perdue est l'inertie avec le prestataire qui ne vous servait plus.
...
<li><span class="font-mono">Form 8822</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…figura como dirección de la LLC ante el IRS, presenta un **Form 8822-B** para actualizarla…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
