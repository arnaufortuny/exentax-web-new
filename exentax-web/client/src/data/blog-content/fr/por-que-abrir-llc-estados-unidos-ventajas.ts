...
- **BOI Report:** déclaration des bénéficiaires effectifs auprès de <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>
...
- **Obtention de l'EIN** auprès de l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>
...
Si un aspect de cette structure mérite d'être creusé, <a href="/fr/blog/documents-llc-ceux-dont-vous-avez-besoin-et-comment-les">Documents LLC: ceux dont vous avez besoin et comment les organiser</a> détaille un point adjacent que nous réservons d'habitude à un article dédié.
...
<li><span class="font-mono">250,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…iones con QuickBooks, Xero, Stripe - Protección FDIC hasta $250,000 - Apertura 100% remota…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…s, Xero, Stripe - Protección FDIC hasta $250,000 - Apertura 100% remota **Relay (respaldad…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">80,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…Cada gasto legítimo reduce tu base imponible. Si facturas $80,000 al año y tienes $20,000 …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">20,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…uce tu base imponible. Si facturas $80,000 al año y tienes $20,000 en gastos deducibles, s…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">60,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…y tienes $20,000 en gastos deducibles, solo tributas sobre $60,000. Así de directo. ### En…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…arketer o cualquier profesional digital que factura más de $2,000 al mes a clientes intern…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…estructura para muchos perfiles digitales. - **Tributación 0% en US para no residente sin …»</span> <strong>[NON VÉRIFIÉ]</strong></li>
...
<li><span class="font-mono">IRC §864</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…u renta no es US-source. Esto está expresamente diseñado en IRC §864 y sucesivos. Lo que e…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…(tributación pass-through) - **Obligaciones informativas:** Form 1120 + &lt;a href=&quot;/es/blog/…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…** Form 1120 + &lt;a href=&quot;/es/blog/como-operar-llc-dia-a-dia&quot;&gt;Form 5472&lt;/a&gt;, fecha límite 15…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 7004</span> <span class="opacity-70">(référence légale)</span> <span class="text-xs italic">— «…20-como-solicitarla&quot;&gt;extensión hasta 15 de octubre mediante Form 7004&lt;/a&gt;) - **&lt;a href=&quot;/e…»</span> <strong>[REVISIÓN MANUAL — source suggérée: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
