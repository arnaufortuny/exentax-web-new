...
- **Form 5472 + 1120 pro forma.** Toujours obligatoire pour une SMLLC de non-résident avec toute *reportable transaction*. Sanction de base **25 000 USD par formulaire et par an** (IRC §6038A). Exercice 2025 → échéance **15 avril**, prolongation via **Form 7004** jusqu'au **15 octobre**. C'est exactement pour cela que chez Exentax on garde ton calendrier carré — tu ne penses plus aux échéances, on les clôt avant qu'elles ne mordent.
