...
<li><span class="font-mono">30%</span> <span class="opacity-70">(chiffre)</span> <span class="text-xs italic">— «…s con la primera entrada significativa - es donde se cae el 30% de las cuentas. Es la fase…»</span> <strong>[NON VÉRIFIÉ]</strong></li>
