export default `Un second tour de KYC chez Mercury, Wise ou Relay se résout favorablement dans 75 % des cas si vous fournissez les relevés des 6 derniers mois et un contrat de prestation signé avec un client.
