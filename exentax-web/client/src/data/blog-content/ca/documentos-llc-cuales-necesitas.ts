...
L'EIN (Employer Identification Number) és el número d'identificació fiscal de la teva LLC davant l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>. Equival al NIF/CIF espanyol o al RFC mexicà, però per a entitats americanes. La carta CP 575 de l'IRS confirma oficialment l'assignació del teu EIN.
...
A Exentax acompanyem cada setmana la recollida i certificació dels documents correctes per a clients catalans. Reserva la teva assessoria gratuïta: t'enviem la checklist exacta per al teu cas i t'estalviem anades i vingudes.
...
**Quina diferència hi ha entre CP-575 i 147C?** El CP-575 és la carta original que l'IRS emet en assignar l'EIN; s'imprimeix només una vegada. Si l'has perdut, demanes un 147C trucant l'IRS - triga 5-10 dies i compleix la mateixa funció bancària.
...
A Exentax mantenim aquest expedient viu dins del retainer anual i el lliurem en format llest per a banca o due diligence quan ho necessitis.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Per%20constituir%20una%20LLC%20des%20de%20Catalunya%20no%20necessites%20la%20meitat%20dels%20document%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…autorizado a trabajar en EE.UU. para tener una LLC. Todo es 100% remoto - **Dirección físi…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…strarte en Stripe/PayPal, presentar declaraciones fiscales (Form 5472 + 1120) y operar con…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
