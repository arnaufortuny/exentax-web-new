...
Per tancar, lectures relacionades que encaixen al costat d'aquest article: <a href="/ca/blog/autonom-a-espanya-vs-llc-als-eua-comparativa-fiscal-completa">Autònom a Espanya vs LLC als EUA: comparativa fiscal completa</a> i <a href="/ca/blog/per-que-no-obrir-una-empresa-a-estonia-la-llc-americana">Per què no obrir una empresa a Estònia: la LLC americana guanya per a la majoria</a> ajuden a arrodonir el context.
...
A Exentax posem les dues columnes davant de cada client potencial abans de començar. Reserva la teva assessoria gratuïta: llistem avantatges i inconvenients aplicats al teu perfil real.
...
## Avantatges i desavantatges de la LLC per a no residents: quadre honest abans de decidir

### Avantatges reals

- **Accés al sistema financer US.** Stripe, PayPal US, Mercury/Wise USD, Brex, contractes B2B corporates US.
- **Tributació 0% federal sense ETBUS i sense US-source income.** Disseny legal US per a no residents.
- **Professionalització i credibilitat.**
- **Flexibilitat de planificació.**
...
### Quan SÍ convé una LLC

Cobraments US recurrents, expansió al mercat nord-americà, marketplace que exigeix entitat US, reestructuració patrimonial planificada.
...
**La LLC em protegeix en una demanda?** Limita responsabilitat als actius de la LLC amb separació rigorosa.

**Puc tancar-la fàcilment?** Sí, amb dissolució formal.

A Exentax modelem pros/contres amb el teu cas real.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Abans%20de%20muntar%20una%20LLC%20des%20de%20Catalunya%20cal%20veure%20la%20fotografia%20completa%2C%20no%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…) Una Single-Member LLC con propietario no residente paga **0% de impuesto federal** en EE…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…a optimizar la carga fiscal **hasta un 0%**, frente al **40-47%** que pagas como autónomo.…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…tido? - Freelancers digitales con ingresos superiores a **$2,000/mes** - Emprendedores con…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…# ¿Para quién NO tiene sentido? - Autónomos con **clientes 100% nacionales**: si todos tus…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">1.500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…$100/año), banco con fees variables. Total realista año 1: $1.500-$3.000. Si tu margen no …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…o), banco con fees variables. Total realista año 1: $1.500-$3.000. Si tu margen no soporta…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ar BOI = $591/día. Olvidar declarar en residencia = sanción 50%-150% del impuesto eludido.…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…OI = $591/día. Olvidar declarar en residencia = sanción 50%-150% del impuesto eludido. Una…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…uales: &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472 + 1120&lt;/a&gt;, FBAR (si…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
