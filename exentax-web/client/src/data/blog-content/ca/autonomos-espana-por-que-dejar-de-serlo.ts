export default `Aquest article parla dels autònoms espanyols, però el diagnòstic encaixa perfectament amb el panorama a Catalunya: quota d'autònoms progressiva, tram autonòmic de l'IRPF al 50 %, i un sostre de facturació que frena qualsevol intent de créixer seriosament.
...
Sí. Totalment. Una LLC americana és una estructura empresarial reconeguda internacionalment. No és una offshore opaca a les Illes Caiman. és una empresa registrada en un estat dels EUA, amb EIN (número fiscal), Registered Agent, i declaracions anuals a l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>.
...
**Total pagat:** 12.000€ + 1.400€ (manteniment LLC) = **13.400€ → 18,6% efectiu**
...
Si et reconeixes en l'autònom que no pot escalar o en la SL que es menja la teva energia en burocràcia, la LLC sol ser la sortida més neta, sempre que estigui ben plantejada. A Exentax fem el diagnòstic en 30 minuts: reserva la teva assessoria gratuïta i et direm clarament si et compensa.
...
## El càlcul honest de quan el règim d'autònoms deixa de tenir sentit

Deixar de ser autònom no és una decisió ideològica, és una decisió de números. I els números canvien de forma significativa a partir d'un cert llindar de facturació, d'una certa proporció de clients estrangers i d'una certa intenció de continuïtat. Aquests són els criteris amb què a Exentax revisem cada cas abans de proposar qualsevol moviment.

- **Llindar de facturació.** Per sota de 30.000-40.000 € nets l'any, el RETA amb la quota reduïda del primer tram i les despeses deduïbles habituals sol continuar sent raonable. A partir de 60.000-80.000 € nets amb clients exteriors, una LLC americana correctament declarada en residència comença a marcar diferència neta després del cost de manteniment.
- **Composició de clients.** Si el 70 % o més dels teus clients són fora d'Espanya i operen en USD/EUR/GBP, una LLC elimina retencions, simplifica facturació internacional i obre comptes multidivisa. Si el 70 % són espanyols, la LLC afegeix complexitat sense avantatge real.
- **Horitzó temporal.** Una estructura LLC té sentit quan penses mantenir activitat internacional almenys 3-5 anys. Si estàs provant el mercat sis mesos, queda't com a autònom.
- **Patrimoni en risc.** El RETA no separa patrimoni personal i professional; una LLC sí, cosa que té valor en perfils amb exposició a litigis, devolucions massives o responsabilitat creuada.

### El que més ens pregunten

**Puc ser autònom i alhora tenir una LLC?** Sí, són figures compatibles si la LLC no competeix amb l'activitat declarada com a autònom i si la imputació de rendes es fa correctament en el teu IRPF. Ho recomanem en transicions progressives, no com a estat permanent.

**I si em dono de baixa del RETA i després he de tornar?** Tornar és trivial administrativament; el que convé tenir cura és el forat de cobertura per contingències comunes i el càlcul de carència per a la jubilació. Ho modelem abans de la baixa en cada cas.

A Exentax no proposem baixa del RETA per defecte: fem el càlcul amb els teus números reals, et diem si compensa i, si la resposta és sí, t'acompanyem també en el calendari perquè no hi hagi llacunes.
...
<li><span class="font-mono">5.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…un minuto. Hagamos números reales. Supongamos que facturas 5.000€ al mes (60.000€ al año):…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…amos números reales. Supongamos que facturas 5.000€ al mes (60.000€ al año): - **Cuota de …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.600</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…es (60.000€ al año): - **Cuota de autónomos:** ~300€/mes (~3.600€/año con la base mínima n…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">24%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…(~3.600€/año con la base mínima nueva) - **IRPF:** Entre el 24% y el 37% sobre tu benefici…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">37%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…año con la base mínima nueva) - **IRPF:** Entre el 24% y el 37% sobre tu beneficio neto - …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…** Entre el 24% y el 37% sobre tu beneficio neto - **IVA:** 21% que cobras y luego ingresa…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">32.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…l) El resultado: de esos 60.000€, te pueden quedar entre **32.000€ y 38.000€** después de …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">38.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ultado: de esos 60.000€, te pueden quedar entre **32.000€ y 38.000€** después de impuestos…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">35.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ridad - **El IRPF es progresivo y despiadado**: a partir de 35.000€ ya estás en el tramo d…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…a estás en el tramo del 37%. A partir de 60.000€, llegas al 45% - **Pagos fraccionados**: …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…as al 45% - **Pagos fraccionados**: cada trimestre pagas un 20% de tu beneficio estimado. …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ales con clientes internacionales es la más eficiente: - **0% de impuesto federal en EE.UU…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">8.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…mo sin optimizar tu estructura, dejas sobre la mesa entre **8.000€ y 20.000€** que podrías…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">20.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…timizar tu estructura, dejas sobre la mesa entre **8.000€ y 20.000€** que podrías estar ah…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…podrías estar ahorrando legalmente. En cinco años, eso son 40.000-100.000€. ## ¿Cómo funci…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…s estar ahorrando legalmente. En cinco años, eso son 40.000-100.000€. ## ¿Cómo funciona ex…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">72.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…r ahí ### Ejemplo con números reales **Ingresos brutos:** 72.000€/año **Gastos deducibles …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">18.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…**Ingresos brutos:** 72.000€/año **Gastos deducibles LLC:** 18.000€/año (software, hardwar…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">54.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ción, viajes, servicios) **Beneficio neto (pass-through):** 54.000€/año **Carga fiscal en …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">12.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…/año **Carga fiscal en país de residencia sobre 54.000€:** ~12.000€ (tipo efectivo ~22%) *…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">22%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…aís de residencia sobre 54.000€:** ~12.000€ (tipo efectivo ~22%) **Total pagado:** 12.000€…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">1.400</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…~12.000€ (tipo efectivo ~22%) **Total pagado:** 12.000€ + 1.400€ (mantenimiento LLC) = **1…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">13.400</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…**Total pagado:** 12.000€ + 1.400€ (mantenimiento LLC) = **13.400€ → 18,6% efectivo** **Co…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…do:** 12.000€ + 1.400€ (mantenimiento LLC) = **13.400€ → 18,6% efectivo** **Como autónomo:…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">62.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…vo** **Como autónomo:** 72.000€ - gastos limitados = base ~62.000€ **IRPF ~35%:** ~21.700€…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">35%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ónomo:** 72.000€ - gastos limitados = base ~62.000€ **IRPF ~35%:** ~21.700€ + cuota autóno…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21.700</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…72.000€ - gastos limitados = base ~62.000€ **IRPF ~35%:** ~21.700€ + cuota autónomos 3.600…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">25.300</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…2.000€ **IRPF ~35%:** ~21.700€ + cuota autónomos 3.600€ = **25.300€ → 35.1% efectivo** **D…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">1%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…~35%:** ~21.700€ + cuota autónomos 3.600€ = **25.300€ → 35.1% efectivo** **Diferencia:** 1…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">11.800</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…omos 3.600€ = **25.300€ → 35.1% efectivo** **Diferencia:** 11.800€/año más en tu bolsillo.…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">30.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ier movimiento. - **Umbral de facturación.** Por debajo de 30.000-40.000 € netos al año, e…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…abituales suele seguir siendo razonable. A partir de 60.000-80.000 € netos con clientes en…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">70 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…oste de mantenimiento. - **Composición de clientes.** Si el 70 % o más de tus clientes est…»</span> <strong>[NO VERIFICAT]</strong></li>
