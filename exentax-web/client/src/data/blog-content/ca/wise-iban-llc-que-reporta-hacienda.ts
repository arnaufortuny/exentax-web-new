export default `L'IBAN belga que Wise assigna a una LLC entra a l'intercanvi CRS de més de 120 jurisdiccions, i per a un resident fiscal a Espanya l'AEAT rep el saldo a 31 de desembre cada setembre.

Quan es parla de Wise, IBAN estrangers i LLC als EUA, circulen dos extrems igualment equivocats: d'una banda, el discurs de "Wise no reporta res i Hisenda no se n'assabenta", i de l'altra, la por que cada moviment estigui essent enviat en directe a l'Agència Tributària. La realitat està força més matisada i val la pena entendre-la abans de muntar la teva estructura, sobretot si combines una <a href="/ca/blog/llc-estats-units-guia-completa-no-residents-2026">LLC americana</a> amb un compte Wise i les targetes associades.
...
L'IBAN belga del seu compte Wise per a la LLC ja estava dins del perímetre CRS d'origen, però el paquet OCDE reforça tant el detall com la due diligence: amb el CRS 2.0 en vigor, el que surt de Bèlgica cap a la seva hisenda arriba més complet i amb molt menys marge per a una classificació laxa de l'entitat.
...
És aquí on circulen més mites. Un emprenedor amb residència fiscal a Catalunya (o en LATAM) constitueix una <a href="/ca/blog/llc-estats-units-guia-completa-no-residents-2026">LLC als Estats Units</a>, obre Mercury com a compte principal i Wise Business com a compte secundari multidivisa. Quan completa l'autodeclaració CRS de Wise per a la LLC ha d'indicar:
...
- **Encreuament amb declaració a la residència.** Espanya: Modela 720 per a comptes estrangers si suma >50k€. Si Hisenda rep via CRS el saldo i no presentes 720, procediment d'imputació. Sanció típica: 50% del saldo no declarat. Tranquil: a Exentax això és la nostra rutina setmanal, ho tanquem abans que la carta arribi a la teva bústia.
