...
- **Andorra (Llei 95/2010 IS, Llei 5/2014 IRPF).** Per a residents fiscals a Andorra, una LLC americana operativa s'integra en el règim general de l'IRPF a tipus marginals màxims del 10 %, amb possibilitat d'aplicar la deducció per doble imposició internacional pel que ja s'hagi pagat als EUA (típicament zero per a no residents sense ECI). El règim de transparència fiscal internacional andorrà està previst a l'art. 35 de la Llei 95/2010 de l'Impost sobre Societats i s'activa quan la filial estrangera tributa a un tipus inferior a la meitat del que correspondria a Andorra (és a dir, per sota del 5 %) i obté principalment rendes passives — interessos, dividends, royalties o guanys patrimonials sense substància econòmica. Les obligacions informatives passen pel Departament de Tributs i de Fronteres del Govern d'Andorra (declaracions anuals i registre de titulars no residents) i, en banca estrangera, per la declaració D-6 al Ministeri d'Indústria espanyol quan el resident andorrà manté residència fiscal espanyola anterior pendent de tancament.
- **Catalunya i la resta de l'Estat espanyol.** S'aplica la mateixa normativa estatal (LIRPF/LIS) descrita anteriorment; a Catalunya s'hi suma el tram autonòmic de l'IRPF (que pot situar el marginal màxim al voltant del 50 % combinant tram estatal i autonòmic català per a rendes superiors a 175.000 €) i les particularitats del Registre de Béns i Drets del contribuent quan la suma de comptes als EUA supera els llindars del Model 720 (>50.000 €), i del Model 721 per a criptoactius custodiats fora d'Espanya (>50.000 €). La declaració informativa D-6 al Ministeri d'Indústria, Comerç i Turisme cobreix la titularitat indirecta de valors estrangers per part del soci, mentre que el Model 232 captura les operacions vinculades amb la pròpia LLC. Tarragona, Lleida, Girona i Balears segueixen els mateixos llindars; els règims forals de País Basc i Navarra apliquen normativa pròpia (Norma Foral d'IRPF) que cal revisar per separat.
...
- [Quotes autònoms Espanya 2026: guia completa](/ca/blog/quotes-autonoms-espanya-2026-guia-completa)
- [LLC com a alternativa a ser autònom a Espanya](/ca/blog/llc-com-a-alternativa-a-ser-autonom-a-espanya)
- [LLC als Estats Units: guia completa](/ca/blog/llc-estats-units-guia-completa-no-residents-2026)
<!-- /exentax:cross-refs-v1 -->
