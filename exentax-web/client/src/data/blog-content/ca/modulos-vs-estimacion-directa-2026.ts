...
L'estimació directa, en la seva variant simplificada (rendiments fins a 600.000 euros) o normal (per sobre), calcula el teu IRPF com a ingressos menys despeses deduïbles. És el règim estàndard per a freelancers digitals, assessors, professionals liberals i la majoria de pimes. Portes llibres d'ingressos, despeses, béns d'inversió i, si escau, provisions. La simplificada permet una deducció addicional del 5% del rendiment net positiu en concepte de despeses de difícil justificació, amb un màxim anual de 2.000 euros. És el que fan servir més del 90% dels autònoms professionals a Espanya.
