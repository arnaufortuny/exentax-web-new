...
## El cas específic del resident fiscal a Catalunya o l'Estat espanyol i a Andorra
  ...
  A l'Estat espanyol, la solidesa d'una estructura internacional descansa en l'**article 16 de la Llei 27/2014 de l'IS** sobre operacions vinculades, en l'aplicació del règim de **transparència fiscal internacional de l'article 100 LIRPF / 100 LIS** i en la documentació exigida pel **RD 634/2015** (Master File i Local File quan s'assoleixen els llindars).
