...
**Activitat econòmica**, <a href="/ca/blog/tributacio-de-la-llc-segons-lactivitat-economica-serveis">tributació per activitat</a>. **Residència fiscal real**, <a href="/ca/blog/nomada-digital-on-pagar-impostos-i-com-triar-la-residencia">residència nòmada</a>. Diagnòstic patrimonial. Objectiu a 5 anys.
...
- **Single-Member LLC US Disregarded**: serveis B2B. <a href="/ca/blog/nou-mexic-vs-wyoming-vs-delaware-quin-estat-per-a-la-teva">NM vs WY vs DE</a>.
- **Multi-Member Partnership**.
- **LLC check-the-box C-Corp**.
- **SL espanyola**: activitat ES.
- **Holding ES + filial**.
- **OÜ Estònia, HK, Singapur, BVI**: específics. OÜ sobrevalorada, <a href="/ca/blog/per-que-no-obrir-una-empresa-a-estonia-la-llc-americana">per què no Estònia</a>.
### Pas 4: Substància
...
**EUA**: <a href="/ca/blog/que-es-lirs-i-com-afecta-la-teva-llc-americana">Form 5472</a> + 1120, BOI, Annual Report, Form 5472, <a href="/ca/blog/boi-report-2026-guia-completa-per-a-la-declaracio-fincen">BOI</a>, <a href="/ca/blog/manteniment-anual-de-la-llc-obligacions-que-no-pots-ignorar">manteniment anual</a>.
...
Saltar el pas 1; canviar només sobre paper; vehicle per moda; sense substància; barrejar; no revisar. <a href="/ca/blog/riscos-fiscals-duna-mala-estructuracio-internacional">riscos</a>.
### En resum
...
Si algun aspecte d'aquesta estructura t'ha deixat amb ganes de més detall, <a href="/ca/blog/els-comptes-bancaris-americans-informen-a-la-teva-autoritat">Els comptes bancaris americans informen a la teva autoritat fiscal? La resposta honesta</a> aprofundeix en una peça veïna que normalment reservem per a un article a part.
...
## El framework Exentax per dissenyar una estructura fiscal internacional

Una estructura fiscal internacional sòlida no es compra; es dissenya a partir de cinc capes en l'ordre correcte. Saltar-se l'ordre és la causa més comuna d'estructures que fracassen al primer requeriment. Aquest és el framework amb què treballem a Exentax cada cas.

- **Capa 1 - Diagnòstic personal honest.** Inventari de residència fiscal actual, ciutadania, actius per jurisdicció, fonts de renda i dependents. L'estructura d'un solter amb renda digital no s'assembla a la d'un casat amb fills escolaritzats o a la d'algú amb actius immobiliaris concentrats. Dissenyar sense això és enginyeria cega.
- **Capa 2 - Selecció de jurisdicció de residència.** La palanca més impactant de les cinc. Andorra, Portugal amb NHR-IFICI, Itàlia amb règim impatriats, Emirats, Paraguai, Uruguai, Xipre, Malta. Cadascuna amb el seu règim, substància exigida, conveni amb el teu país d'origen i operativa real. Sense aquesta capa tancada, l'estructura societària és secundària.
- **Capa 3 - Estructura societària.** LLC americana per a flux operacional internacional, holding andorrana o emiratí per a acumulació, societat operativa local quan hi ha substància física, ETVE espanyola en supòsits qualificats. El criteri: la societat serveix el resident, no a l'inrevés. Una societat maca amb resident mal posicionat és una estructura defectuosa.
- **Capa 4 - Bancarització i passarel·les de pagament.** Mercury + Wise Business com a parell operacional USD-EUR, banc local a jurisdicció de residència per a despesa quotidiana, broker FX si el volum ho justifica, passarel·les Stripe/Paddle/DoDo segons mix de clients. Cada moviment de diner entre capes ha de poder explicar-se contra una clàusula de conveni.
- **Capa 5 - Compliance recurrent.** 5472 + 1120 pro-forma, BOI report, annual report estatal, declaracions de residència (IRPF/IS local), CRS/DAC7/DAC8 implícits, Modelos 720/721 espanyols si aplica. Sense calendari integrat, l'estructura més elegant es desmorona en 3 anys.

### El que més ens pregunten

**Quant triga a dissenyar-se una estructura completa?** Entre 6 i 16 setmanes segons complexitat. Capa 1 (diagnòstic) 1-2 setmanes; capa 2 (residència) 3-9 mesos si requereix mudança efectiva; capes 3-4 (constitució i banca) en paral·lel 4-8 setmanes; capa 5 (compliance) lliurada com a manual tancat al client.

**I si la meva situació canvia en 3 anys?** L'estructura es dissenya amb clàusules de sortida i frontisses de mudança perquè un canvi (matrimoni, fills, venda d'empresa, jubilació parcial) no impliqui refer-ho tot. La modularitat està en el disseny des de la capa 1, no s'afegeix després.

A Exentax fa anys que apliquem aquest framework amb clients d'Europa i Llatam. No venem estructures prefabricades; executem cinc capes en l'ordre correcte i deixem el client amb un disseny defensable documentalment i operatiu des del dia u.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Dissenyar%20una%20estructura%20internacional%20no%20%C3%A9s%20triar%20el%20pa%C3%ADs%20m%C3%A9s%20ex%C3%B2tic%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">80.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…fil 1: Consultor freelance B2B residente en España, factura 80.000-150.000 €/año, sin equi…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">150.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…Consultor freelance B2B residente en España, factura 80.000-150.000 €/año, sin equipo.** E…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…Perfil 2: E-commerce en Amazon Europa, residente en España, 200.000-500.000 €/año.** Estru…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">500.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…: E-commerce en Amazon Europa, residente en España, 200.000-500.000 €/año.** Estructura re…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…7. **Perfil 3: SaaS B2B internacional, residente en LATAM, 100.000 € arr.** LLC + Mercury …»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…- **EE.UU.**: &lt;a href=&quot;/es/blog/que-es-irs-guia-duenos-llc&quot;&gt;Form 5472&lt;/a&gt; + Form 1120 pro-…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…href=&quot;/es/blog/que-es-irs-guia-duenos-llc&quot;&gt;Form 5472&lt;/a&gt; + Form 1120 pro-forma anual, BOI …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…Modelo 721 para cripto, Modelo 100/130, posible Modelo 238 (DAC7) si vendes en plataformas…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…a fiscal, sustancia, stack bancario, normativa nueva (DAC7, DAC8, MiCA, cambios CDI), umbr…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
