...
**Mercury** és un Money Transmitter que fa servir partner banks (Choice Financial Group i Evolve Bank & Trust principalment; Column N.A. en comptes heretats) com a custodis. Opera exclusivament als EUA i reporta a l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> segons les obligacions americanes. No té obligacions CRS perquè els EUA no hi participen.
...
Si ets ciutadà o resident fiscal dels EUA (cosa que no aplica a la majoria dels nostres clients), el FBAR (<a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> Form 114) t'obliga a reportar comptes financers a l'estranger que superin $10.000 en qualsevol moment de l'any.
...
Per tancar, una lectura relacionada que encaixa al costat d'aquest article: <a href="/ca/blog/estructura-fiscal-optima-per-a-freelancers-internacionals-el">Estructura fiscal òptima per a freelancers internacionals: el framework complet</a> ajuda a arrodonir el context.
...
A Exentax estructurem LLCs partint de la realitat CRS + FATCA i del criteri concret de l'AEAT. Reserva la teva assessoria gratuïta i t'expliquem què arriba realment a Hisenda i què no.
...
## La veritat operativa sobre CRS i els teus comptes bancaris de la LLC

CRS (Common Reporting Standard) és un sistema d'intercanvi automàtic entre 110+ jurisdiccions, però els EUA no el van signar mai: utilitzen el seu propi FATCA en sentit entrant. Aquesta asimetria és la peça clau que fa que els comptes d'una LLC americana es comportin diferent d'un compte obert en una jurisdicció CRS. Aquesta és la mecànica real, sense alarmisme.

- **Mercury, Relay, Wise Business i CRS.** Mercury i Relay operen via banca americana (Choice Financial, Evolve, Column N.A.); els EUA no participen al CRS. Wise Business, en canvi, manté comptes a Bèlgica, Singapur, Regne Unit i Austràlia - totes intercanvien. Si la teva Wise té saldo EUR superior a 250 USD/mes actiu, aquest compte entra al reporting belga al país de residència del titular.
- **FATCA en sentit invers.** Els EUA envien a alguns països (acords IGA Model 1) informació limitada sobre comptes mantinguts pels seus residents en bancs americans. Espanya va signar IGA Model 1 el 2013, però el reporting americà cap a Espanya ha estat històricament parcial i inconsistent, especialment per a entitats transparents.
- **Titularitat LLC vs. personal.** En CRS, la titularitat del compte determina el reporting. Un compte a nom de la LLC es reporta com a compte d'entitat, amb identificació de la controlling person (tu). En jurisdicció CRS, el teu país de residència rep informació tant de la LLC com de la controlling person. Els EUA no apliquen aquesta lògica.
- **Modelo 720 i 721 espanyols.** Independents del CRS: si ets resident fiscal a Espanya i la LLC té comptes amb saldo combinat >50.000 €, hi ha obligació declarativa pròpia, independentment que els EUA comparteixin o no. L'AEAT creuarà tard o d'hora la declaració amb dades bancàries disponibles.

### El que més ens pregunten

**Mercury comparteix les meves dades amb Hisenda?** No automàticament, perquè opera als EUA i no participa al CRS. El que sí pot passar és que l'AEAT sol·liciti informació específica via MAP del conveni EUA-Espanya, procés llarg (12-24 mesos) i motivat.

**Si obro Wise Business perdo "discreció"?** Parcialment sí, en el vessant europeu. Per això molts dels nostres clients reserven Mercury per a operativa primària USD i utilitzen Wise només per a conversió i pagament final, sense saldos durmients elevats.

A Exentax deixem dissenyada l'arquitectura bancària amb coherència entre el que es reporta i el que es declara, eliminant el risc de descabdellament que és el que realment obre revisions.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22El%20CRS%20de%20l'a%20href%3Dhttps%3A%2F%2Fwww%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…odelo 720 requiere reportar cuentas con saldos superiores a 50.000€. **4. Información de t…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…que trabaja como autónomo en España puede estar pagando un 45% efectivo entre IRPF y cuota…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…reportar cuentas financieras en el extranjero que superen $10,000 en cualquier momento del…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 114</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…//www.fincen.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;FinCEN&lt;/a&gt; Form 114) te obliga a reportar…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
