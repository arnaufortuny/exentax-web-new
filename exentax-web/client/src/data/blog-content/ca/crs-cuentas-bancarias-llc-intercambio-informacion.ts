...
El quadre del CRS aplicat als comptes bancaris de la seva LLC s'actualitza amb el paquet OCDE: les EMI i els productes de diner electrònic entren de ple en el perímetre i la due diligence sobre controlling persons es reforça. El que Wise Europe SA o Revolut Bank UAB ja reportaven es manté, amb criteris més estrictes i més granularitat en cada autodeclaració.
...
Un dia, Hisenda t'envia un requeriment demanant informació sobre la teva activitat internacional. No és una inspecció. és una sol·licitud d'informació. És el moment de demanar ajuda. A Exentax obrim el cas, presentem el que falta i responem a l'administració per tu.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22El%20CRS%20de%20l'a%20href%3Dhttps%3A%2F%2Fwww%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
