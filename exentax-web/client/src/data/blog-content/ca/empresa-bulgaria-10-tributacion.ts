...
- Auditoria externa si superes determinats llindars. I si arriba un requeriment, a Exentax mantenim el dossier preparat perquè responguis en hores, no en setmanes.
...
- **Sancions per comptabilitat incorrecta**: el sistema sanciona errors formals amb multes rellevants. És el moment de demanar ajuda. A Exentax obrim el cas, presentem el que falta i responem a l'administració per tu.
...
Bulgària no aporta res. Sense residència búlgara, els beneficis tributen a Espanya al tipus corresponent més sancions potencials. La LLC americana és alternativa més simple i eficient. Ho tanquem amb tu des d'Exentax: una trucada, presentació feta, arxiu llest, i el risc es queda al paper.
...
## I si l'AEAT li pregunta per la seva LLC?
  ...
  L'error que sí enfonsa una inspecció no és tenir una LLC; és no haver atribuït la renda correctament a l'IRPF, no haver presentat el Model 720 sobre els comptes als EUA quan el saldo a 31/12 supera els 50.000 € o no haver documentat les operacions vinculades soci-LLC al Model 232. Aquests tres fronts es tanquen abans del requeriment, no després. I si arriba un requeriment, a Exentax mantenim el dossier preparat perquè responguis en hores, no en setmanes.
