export default `Després de gestionar diversos centenars de LLCs per a clients catalans, els errors es repeteixen: barreja de comptes personal/LLC, 5472 oblidat, BOI no presentat, adreça del Registered Agent usada com a adreça bancària, i el clàssic „ja ho faré l'any que ve” que acaba en sanció <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> de cinc xifres.
...
**Com ho evitem:** A l'assessoria inicial expliquem les regles del joc. Configurem la teva operació perquè el flux de diners sigui net des del primer dia: factures per a cada ingrés, distributions documentades, separació estricta de fons personals i del negoci. A Exentax revisem el teu cas amb dades reals: <a href="/ca/agendar">agenda una consulta gratuïta</a> de 30 minuts.
...
**El problema:** Des de l'entrada en vigor de la CTA, <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> exigeix que totes les LLCs reportin els seus propietaris beneficiaris (Beneficial Ownership Information). Els terminis i requisits canvien amb freqüència, i no complir pot portar conseqüències que convé evitar.
...
Per tancar, una lectura relacionada que encaixa al costat d'aquest article: <a href="/ca/blog/quant-costa-constituir-una-llc-americana-analisi-completa">Quant costa constituir una LLC americana? Anàlisi completa dels costos</a> ajuda a arrodonir el context.
...
A Exentax corregim aquestes desviacions cada setmana. Reserva la teva assessoria gratuïta: auditem la teva LLC, llistem els riscos actius i et donem un pla concret per netejar-ho.
...
## Els problemes més comuns amb una LLC i com evitar-los abans que passin

Després d'anys portant LLCs de no residents, els problemes són sempre els mateixos quatre o cinc. Tots evitables amb planificació.

- **Oblidar-se del 5472 + 1120 anual.** La multa més cara i la més fàcil d'evitar. $25.000 mínim per no presentar el 5472. Termini 15 d'abril, prorrogable al 15 d'octubre. Solució: bookkeeping des del dia 1.
- **No presentar el BOI Report al FinCEN.** Sanció $591/dia. Aplica a gairebé tota LLC nova: 30 dies des de la formació. Solució: incloure BOI inicial al setup.
- **Barrejar diners personals i de la LLC.** Trencar la separació patrimonial (piercing the corporate veil) permet a un creditor demandar-te personalment. Solució: compte separat estricte, draws documentats.
- **No declarar la LLC a la residència.** Espanya (720 + IRPF), França (IR + 3916), Itàlia (IRPEF + RW), Alemanya (ESt + AStG si CFC). Sanció típica 50%-150% de l'impost eludit. Solució: planificar des de l'obertura.

### El que més ens pregunten

**Si no he facturat res, he de presentar 5472?** Sí, llevat d'excepció molt limitada. Qualsevol moviment owner/LLC és reportable transaction.

**Puc regularitzar anys passats sense presentar?** Sí, per presentació tardana. Multa igual però redueix probabilitat d'auditoria agressiva.

A Exentax portem compliment integral i regularitzem LLCs amb històric trencat.
<!-- /exentax:execution-v2 -->
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Despr%C3%A9s%20de%20gestionar%20diversos%20centenars%20de%20LLCs%20per%20a%20clients%20catalans%2C%20els%20e%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">90%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…entre hacer las cosas bien y hacer las cosas &quot;a medias&quot; El 90% de los problemas que vemos …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">25,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ado:** La multa por no presentación según IRS §6038A es de $25,000 por formulario, por año…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">50,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…formulario, por año. Si llevas dos años sin presentar, son $50,000. Y el IRS no necesita d…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…LLC estaba en &quot;not in good standing&quot; La constitución es el 10% del trabajo. El 90% restant…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">50%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…CFC), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido +…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido + in…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; por no presentar el Form 5472. Cuentas de Mercury c…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…eportables entre tú y la LLC, y lo presentamos junto con el Form 1120 (return informativa)…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
