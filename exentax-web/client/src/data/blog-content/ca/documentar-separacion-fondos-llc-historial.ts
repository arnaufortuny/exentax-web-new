...
- **Documentació viva, no arxiu mort.** Carpeta compartida amb Operating Agreement signat, actes anuals, expense reports, contractes de serveis intra-grup. És el primer que demana un banc en KYC reforçat i el primer que sol·licita una inspecció. A Exentax hem tancat sense sanció clients exactament en aquesta situació. Parlar aviat val or — i t'estalvia cinc xifres.
