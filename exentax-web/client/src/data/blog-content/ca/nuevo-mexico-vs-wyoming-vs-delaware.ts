...
## Florida: el quart estat a considerar

Florida s'ha popularitzat per l'absència de state income tax i per la seva reputació pro-negocis. Per a un no resident, però, convé tenir clars els matisos.
...
- **L'EIN és el mateix tipus de número**: l'emet l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>, no l'estat
...
## Actualització Exentax avui: la comparativa d'estats al tancament avui

Els tres estats continuen sent l'opció raonable per a una LLC de no resident; matisos avui:

- **Wyoming:** filing 100 USD, **Annual Report 60 USD** (renovació el dia abans de l'aniversari), **sense state income tax**, privacitat alta. Idoni per a operativa estàndard i *holdings* petits.
- **Delaware:** filing 110 USD, **Franchise Tax 300 USD anuals** (venciment 1 de juny), Court of Chancery amb jurisprudència consolidada. Cost més alt però lectura preferida per inversors VC i compradors corporatius.
- **New Mexico:** filing 50 USD, **sense Annual Report**, **sense state income tax**, màxima privacitat pública. Cost anual mínim (només RA, ~125 USD). Ideal per a *side-projects*, perfils minimalistes i proves.

### Preguntes freqüents avui

**Quin escullo si venc SaaS internacional?** Wyoming per defecte. Delaware només si planeges captar VC als EUA en els pròxims 24 mesos.

**New Mexico bloqueja Mercury o Stripe?** No. Mercury, Relay, Wise i Stripe accepten els tres estats. La diferència és cost i reputació, no accés.

**Puc redomiciliar d'un estat a un altre?** Sí, via *conversion* o *domestication*: la LLC manté EIN, data de constitució i comptes bancaris. Cost 200-600 USD segons estat.
<!-- exentax:overhaul-avui-v1 end -->

<!-- exentax:execution-v2 -->
## Com triem l'estat a Exentax: cas d'ús, no moda

La tria d'estat no es guanya amb comparatives de tarifes: depèn de l'ús. El que apliquem a Exentax cada setmana és una eliminació per ús real, no publicitat de registered agents.

- **Wyoming** per a operativa estàndard de freelancer no resident amb ingressos digitals: privacitat raonable, annual report estable i banca acceptada a Mercury, Wise i Relay.
- **New Mexico** quan es busca privacitat màxima al registre públic i sense annual report, sabent que alguns bancs seran més estrictes al KYC.
- **Delaware** només si reps inversió, obres holding multinivell o uses Series LLC; franchise tax i costos més alts, no compensen per a freelancer.

Per al cost i el pla en cada estat per al teu cas, obre la <strong>calculadora Exentax</strong> o reserva trenta minuts.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Quan%20comences%20a%20investigar%20sobre%20LLCs%20des%20de%20Catalunya%2C%20sempre%20acaba%20apareixe%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<!-- exentax:cta-v1 -->
Comparem Nou Mèxic, Wyoming, Delaware i Florida sobre el teu cas real, sense vendre't l'estat de moda. <a href="/ca/serveis">Comparar el meu cas amb un assessor</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">80%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…na | ### ¿Cuál elegir? Nuestra recomendación clara Para el 80% de los freelancers y empren…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…ticas**: &lt;a href=&quot;/es/blog/documentos-llc-cuales-necesitas&quot;&gt;Form 5472&lt;/a&gt;, Form 1120, &lt;a h…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…f=&quot;/es/blog/documentos-llc-cuales-necesitas&quot;&gt;Form 5472&lt;/a&gt;, Form 1120, &lt;a href=&quot;/es/blog/c…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
