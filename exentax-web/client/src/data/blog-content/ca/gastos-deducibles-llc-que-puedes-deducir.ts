...
- **Multes i sancions**: multes de trànsit, sancions de l'IRS. Aquí entra Exentax: presentem el formulari, arxivem l'acús i, si l'administració pregunta, la resposta ja està llesta.
...
- **Problemàtic sense substància.** Cotxe personal, roba no-uniforme, despeses personals barrejades, "assessoria" pagada a familiars sense servei real ni W-9, viatges sense agenda documentada. La LLC és transparent per a l'IRS i opaca per al banc - tots dos creuen dades en una inspecció. Per això, a Exentax et portem el calendari al dia — tu deixes de pensar en terminis i nosaltres els tanquem abans que mosseguin.
