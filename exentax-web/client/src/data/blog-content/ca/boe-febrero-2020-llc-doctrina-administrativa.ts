...
Més detall a <a href="/ca/blog/deduccions-fiscals-per-a-la-teva-llc-que-pots-deduir-i-com">despeses deduïbles a la teva LLC</a>. Pensa que la càrrega de la prova recau sempre sobre el contribuent: el justificant ha de ser doble (factura + pagament traçable des d'un compte de la LLC) i la correlació amb l'ingrés ha de ser clara.
...
Si feia anys que declaraves els fluxos de la teva LLC com a dividends a la base de l'estalvi (19-28%) i l'AEAT els requalifica com a activitat econòmica imputada (base general 24-47%, fins al 50% conjunt a Catalunya), la diferència pot ser molt rellevant. Període de prescripció: **4 anys**. Sancions: art. 191-195 LGT.

El que veiem: regularitzacions pel període no prescrit + interessos de demora + sanció mínima del 50% (que pot pujar fins al 150% si concorren agreujants com l'ocultació o l'ús de mitjans fraudulents). En casos amb imports rellevants i conducta dolosa, l'expedient pot acabar al jutjat penal per delicte fiscal (art. 305 CP) si la quota defraudada per any supera els 120.000 €.
...
2. **Dissenyar l'estructura perquè tributi eficientment.** Decisions: aportacions de capital, despeses assignades, retribució del soci, altres estructures possibles (S.L. catalana + LLC operativa, etc.). Vegeu <a href="/ca/blog/disseny-duna-estructura-fiscal-internacional-solida-marc-pas">disseny d'estructura internacional sòlida</a>.
3. **Considerar la teva activitat concreta.** Règim pràctic distint per a serveis, e-commerce, royalties, trading. Ho desenvolupem a <a href="/ca/blog/tributacio-de-la-llc-segons-lactivitat-economica-serveis">tributació de la LLC segons la teva activitat econòmica</a>.
...
5. **Evitar la simulació.** Si la LLC no té substància i els serveis els presta materialment la persona física resident, l'AEAT pot aplicar simulació (art. 16 LGT), que comporta una sanció més gran i possible derivació penal segons imports.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vinc%20de%20l%27article%20%22boe%20febrer%202020%20llc%20doctrina%20administrativa%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>

Si prefereixes parlar-ne en directe, <a href="/ca/agendar">reserva una sessió gratuïta</a> i revisem el teu cas real en trenta minuts.
<!-- /exentax:cta-conv-v1 -->
