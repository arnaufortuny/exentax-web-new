export default `Si resideixes fiscalment a Espanya i tens una <a href="/ca/blog/llc-als-estats-units-guia-completa-per-a-no-residents-el-2026">LLC americana</a>, la qüestió clau és la **doctrina administrativa espanyola**.
