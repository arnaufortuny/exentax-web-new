...
<li><span class="font-mono">30%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…s con la primera entrada significativa - es donde se cae el 30% de las cuentas. Es la fase…»</span> <strong>[NO VERIFICAT]</strong></li>
