...
Un cop constituïda la LLC, necessites l'**EIN** (Employer Identification Number), el número fiscal de la teva empresa davant de l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>.
...
Des de l'1 de gener de 2024, totes les LLCs han de reportar els seus propietaris reals davant de <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>. Tens **90 dies** des de la constitució per presentar aquest informe.
...
## Actualització Exentax avui: el procés de constitució, sense sorpreses

El flux de constitució s'ha estabilitzat el recent years; les tres claus operatives són:

- **Terminis reals avui.** Wyoming lliura Articles en **24-48 h online** (taxa 100 USD), New Mexico en **3-5 dies hàbils** (50 USD), Delaware en **5-10 dies hàbils** (110 USD, *expedited* +50 a +1.000 USD).
- **EIN sense SSN.** L’IRS continua processant el **Form SS-4 per fax al +1-855-215-1627** en **4-6 setmanes**. Online només per a sol·licitants amb SSN/ITIN. Conserva la **CP 575** original; si la perds, demana una **147C** trucant a l’IRS Business Line.
- **Operating Agreement signat el dia 1.** Els bancs (Mercury, Relay) el demanen al KYC inicial des del gener de 2024. Sense OA, l'alta de compte es bloqueja. Plantilla SMLLC de no resident, signada i arxivada digitalment.

### Preguntes freqüents avui

**Quin és l'ordre òptim?** Articles → EIN (fax SS-4) → OA signat → Mercury/Relay → comptabilitat. Saltar passos endarrereix la primera factura cobrada en USD.

**Necessito BOI després de la rule de març de 2025?** Si la LLC és 100 % formada als EUA i els beneficial owners no són nord-americans, no. Si la LLC és foreign, sí. Verifica el dia de la presentació.

**Quins costos anuals he de pressupostar?** Wyoming ~225 USD/any (RA + 60 USD Annual Report), Delaware ~450 USD (RA + 300 USD), New Mexico ~125 USD (només RA, sense Annual Report).
<!-- exentax:overhaul-avui-v1 end -->

<!-- exentax:execution-v2 -->
## Com constituïm una LLC a Exentax perquè no es trenqui el primer mes

Constituir és la part fàcil; el difícil és no trencar-la els primers trenta dies per descuits que es converteixen en multes o tancament de comptes. El mètode Exentax munta els cinc blocs en ordre i deixa registre de cada pas.

- **Estat correcte abans dels Articles of Organization**: Wyoming, New Mexico o Delaware segons ús real (banca, holding, ecommerce), no segons moda de YouTube.
- **EIN, BOI i Operating Agreement** signats i arxivats abans d'obrir banca; sense OA, Mercury i Relay rebutgen el compte.
- **Stack bancari coherent** amb mateix titular i adreça en tots els KYC per evitar bloquejos en la primera transferència rebuda.

Per veure el cost exacte i el calendari abans de decidir, obre la <strong>calculadora Exentax</strong> o reserva trenta minuts: enviem la proposta i el pla de constitució per escrit.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Has%20decidit%20obrir%20una%20LLC%20des%20de%20Catalunya%20i%20vols%20veure%20el%20proc%C3%A9s%20sencer%20aban%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…una LLC en Estados Unidos siendo no residente es un proceso 100% online que se puede compl…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">1.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…e **5-10 días hábiles** (filing 110 USD, *expedited* +50 a +1.000 USD según urgencia). - *…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">100 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…**¿Necesito BOI tras la rule de marzo 2025?** Si la LLC es 100 % formada en EE. UU. y tus …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
