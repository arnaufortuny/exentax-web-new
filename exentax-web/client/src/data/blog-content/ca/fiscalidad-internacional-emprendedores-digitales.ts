export default `La fiscalitat internacional és un dels temes més importants, i més mal entesos, per a emprenedors digitals. Si vens serveis o productes digitals a clients de diversos països, necessites entendre com funciona el sistema fiscal global per prendre les millors decisions per al teu negoci.
