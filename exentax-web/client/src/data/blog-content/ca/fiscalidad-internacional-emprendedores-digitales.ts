export default `Des de Catalunya, la fiscalitat internacional de l'emprenedor digital no es redueix al clàssic „me'n vaig a Dubai”. L'AEAT mira centre d'interessos vitals, 183 dies, nucli familiar, i el conveni Espanya-EUA és més favorable del que sembla, si la LLC està ben estructurada.
...
L'<a href="https://www.oecd.org" target="_blank" rel="noopener">OCDE</a> està treballant en el marc BEPS 2.0 (Pillar One i Pillar Two) per adaptar el sistema fiscal internacional a l'economia digital. Aquests canvis afectaran principalment grans multinacionals, però és important que els emprenedors digitals estiguin al corrent de les evolucions normatives.

Per continuar aquest fil, <a href="/ca/blog/estructura-fiscal-optima-per-a-freelancers-internacionals-el">Estructura fiscal òptima per a freelancers internacionals: el framework complet</a> completa un matís que aquí només hem tocat de passada.
...
A Exentax desmuntem aquest trencaclosques cada setmana per a emprenedors catalans. Reserva la teva assessoria gratuïta i et diem què aguanta realment en la teva situació, no en el vídeo d'un gurú.
...
- **Capa 1 - residència personal.** Determina el teu IRPF, la teva obligació TFI/CFC i el teu accés a règims especials (Beckham Espanya, NHR Portugal, Andorra, Xipre Non-Dom, Itàlia 100k Flat Tax). És la decisió més impactant: canviar residència mou la fiscalitat personal sencera, mentre que canviar la societat només mou el wrapper. Si vius a Madrid, cap wrapper offshore et lliura de l'IRPF espanyol sobre les teves rendes mundials.
- **Capa 2 - societat operativa.** LLC US, Estònia OÜ, EOOD búlgara, UK Ltd, Andorra SL - cadascuna amb el seu perfil de cost, substància, banca i compatibilitat amb el teu mercat. L'elecció depèn del mix de clients (B2B/B2C, UE/global), del volum i de si necessites extreure cash o reinvertir. Sense clients UE B2C: simplifiques amb LLC US. Amb molts B2C UE: estructura europea amb OSS pesa.
- **Capa 3 - mercats i compliance per país.** IVA OSS/IOSS per a B2C UE, sales tax US si tens nexus, retencions de royalties per convenis bilaterals, registre IVA en països amb llindars especials (Austràlia, UK post-Brexit, Suïssa, Noruega). Aquesta capa freqüentment s'ignora fins a la primera carta - i és on es concentra la major part del risc operatiu real.
...
**Quina és la "menys dolenta" per començar si encara visc a Espanya?** LLC US single-member + autònom a Espanya amb dividends imputats, OSS si hi ha B2C UE. Permet extreure experiència sense trencar residència, escala bé fins a 200-300k anuals i es pot transicionar després si decideixes moure't físicament.

**Quan té sentit moure's físicament per a optimitzar?** Quan l'estalvi fiscal anual net supera 20-30k EUR consistentment i la teva activitat permet mobilitat real. Abans, el cost personal/familiar del trasllat supera l'avantatge fiscal - i tenir residència "de paper" en jurisdicció on no ets és on més casos veiem acabar malament en inspecció.

A Exentax mapem les tres capes amb la teva situació real i proposem estructura coordinada - sense receptes genèriques i sense vendre't trasllats que no t'aportin més que problemes.
