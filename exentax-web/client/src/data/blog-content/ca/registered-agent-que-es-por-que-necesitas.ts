...
- **Correspondència de l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>**: tot i que l'IRS sol enviar al domicili fiscal registrat
- **Documents de <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>**: notificacions relacionades amb el BOI Report
...
A Exentax integrem un Registered Agent sòlid ja en la constitució per a clients catalans. Reserva la teva assessoria gratuïta: validem la teva cobertura i, si no aguanta, la canviem.
...
## Actualització Exentax avui: Registered Agent al tancament avui

Sense Registered Agent actiu no hi ha LLC viable; les claus operatives vigents:

- **Funció legal.** Rebre notificacions del Secretary of State i de l’IRS, i *service of process* en cas de demanda. Sense RA actiu, la LLC passa a *Delinquent* i, en 60-90 dies, a *Forfeited*.
- **Cost avui.** Mercat estable en **100-150 USD/any** per a serveis estàndard (Northwest, Harvard Business, IncFile/Bizee). Packs "primer any gratis" solen pujar a **125-200 USD** des del segon any; calcula el cost real a 3 anys.
- **Canvi de RA.** Tràmit simple davant del Secretary of State amb tarifa típica **25-50 USD**. El nou RA sol gestionar el canvi sense cost. Cal notificar-ho formalment; no n'hi ha prou amb deixar de pagar a l'anterior.

### Preguntes freqüents avui

**Puc ser jo mateix Registered Agent?** Només si tens adreça física a l'estat de la LLC i disponibilitat horària laboral (9-17). Per a no residents no és pràctic; el RA professional és l'opció raonable.

**Què passa si el RA tanca o desapareix?** L'estat passa la LLC a *Delinquent*. Detecta-ho monitoritzant el portal del Secretary of State 1-2 vegades a l'any o subscrivint alertes si el RA n'ofereix.

**RA diferent per estat si la LLC opera en diversos?** Sí, si la LLC es registra com *foreign LLC* en altres estats. Cada estat exigeix el seu propi RA local.
<!-- exentax:overhaul-avui-v1 end -->

<!-- exentax:execution-v2 -->
## Com triem el registered agent a Exentax

El registered agent és el contacte físic legal de la teva LLC a l'estat i, si falla, l'estat pot declarar la LLC inactiva o dissoldre-la administrativament sense avisar. El mètode Exentax usa sempre un agent auditat amb digitalització immediata.

- **Adreça física real** a l'estat de constitució, no apartat postal, amb escaneig digital de qualsevol notificació en menys de 24 hores.
- **Continuïtat multi-anual** amb renovació automàtica i avís anticipat de canvis o pujades de tarifa per evitar lapses.
- **Coherència amb banca i BOI**: nom i adreça de l'agent coincidint en tots els registres per no obrir alarmes en KYC posteriors.

Si vols revisar el teu agent actual o canviar-lo sense perdre antiguitat, obre la <strong>calculadora Exentax</strong> o reserva trenta minuts.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22A%20Catalunya%20no%20hi%20ha%20un%20equivalent%20directe%20al%20Registered%20Agent%3A%20%C3%A9s%20una%20barrej%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…ntienden que tu LLC es de un extranjero, no saben qué es el Form 5472, y no pueden orienta…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
