export default `Les 15 accions BEPS de l'OCDE, amb BEPS 2.0 ja en desplegament, han neutralitzat al voltant del 80 % de les estructures offshore que funcionaven fa una dècada.
