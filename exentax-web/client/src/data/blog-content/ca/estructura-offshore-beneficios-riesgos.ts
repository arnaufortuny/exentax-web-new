...
Per a freelancers, consultors, agències digitals, SaaS, ecommerce i creadors que resideixen a Catalunya, Espanya, LatAm o Europa i tenen ingressos internacionals, una <a href="/ca/blog/llc-als-estats-units-guia-completa-per-a-no-residents-el">LLC americana</a> resol el cas mitjà millor que qualsevol alternativa offshore tradicional:
...
A Exentax podem analitzar la teva situació i proposar l'estructura mínima viable que cobreixi els teus objectius sense assumir riscos innecessaris. A Exentax revisem el teu cas amb dades reals: <a href="/ca/agendar">agenda una consulta gratuïta</a> de 30 minuts.
...
> **El teu setup actual t'exposa a alguna d'aquestes llistes?** Passa el cas per la <strong>calculadora fiscal d'Exentax</strong>.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…0; equivalentes en LatAm). No hacerlo es delito. - **&quot;Pagar 0% a nivel personal&quot;**: tu paí…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…cionado**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domici…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…o**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domicilios, …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ncia, SaaS, ecommerce y creadores. - **Reino Unido (Ltd)**: 25% impuesto de sociedades per…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…en Estonia o necesitas IBAN europeo. - **Bulgaria (OOD)**: 10% de impuesto de sociedades, …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…de tu país. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, int…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">200%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ís. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, intereses y…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">RD 1080/1991</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…febrero de 2023)**, modificada posteriormente. Sustituyó al RD 1080/1991 e introdujo crite…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
