...
2. Declaració correcta (guanys 19-28% Espanya). Vegeu <a href="/ca/blog/criptomonedes-i-trading-amb-llc-guia-fiscal-completa-per-a">cripto i trading</a>.
3. Modelo 721.
4. Coherència DAC8.
...
- "Hi poso la LLC i ja està", risc CFC/simulació (<a href="/ca/blog/riscos-fiscals-duna-mala-estructuracio-internacional">riscos</a>).
### En resum
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…os en plataformas extranjeras: - Saldo a 31 de diciembre &gt; 50.000 €: **Modelo 721** inform…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…érdidas patrimoniales por transmisión, escala del ahorro 19-28%).** Lo introducimos en &lt;a …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">Form 1099</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…sarrollando su propio marco bajo el infrastructure act y el Form 1099-DA, pero el intercam…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…export default &#96;La **DAC8** es la pieza que completa el sistema de información tribut…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC2</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…cicio fiscal 2026. DAC8 es para criptoactivos lo que CRS / DAC2 es para depósitos bancario…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…a href=&quot;/es/blog/dac7-plataformas-digitales-reporting-2026&quot;&gt;DAC7&lt;/a&gt; es para plataformas d…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
