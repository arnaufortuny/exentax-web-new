...
| **CRS 2.0** (OCDE, juny de 2023) | L'anterior + diner electrònic (EMI i *Specified Electronic Money Products*), due diligence reforçada sobre controlling persons, productes digitals assimilables a dipòsit | Les mateixes RFI més EMI i prestadors assimilats | A partir del gener de 2027 sobre dades de l'exercici 2026, segons la transposició de cada país |
| **CARF** (OCDE, juny de 2023) | Criptoactius: exchanges, custodis, plataformes de derivats cripto, certs proveïdors DeFi amb element centralitzat | Reporting Crypto-Asset Service Providers (RCASP) | Gener de 2027 sobre dades de l'exercici 2026 a la UE, via DAC8 |
...
- **Residència fiscal del titular com a variable mestra**. La residència no s'escull, es determina per fets (dies de presència, centre d'interessos econòmics, nucli familiar). Pretendre amagar la residència real a l'empara de l'asimetria FATCA-CRS és, a més d'un error tècnic, una infracció tipificada a la majoria de jurisdiccions europees i llatinoamericanes amb sancions severes. Per això, a Exentax et portem el calendari al dia — tu deixes de pensar en terminis i nosaltres els tanquem abans que mosseguin.

<!-- exentax:lote16-native-v1:crs-2-0-carf-por-que-usa-no-firmara-llc-ca -->
...
<!-- exentax:lote34-native-v1:crs-2-0-carf-por-que-usa-no-firmara-llc-ca -->
## Com llegir l'abast de CRS 2.0 i de CARF com un mapatge jurisdiccional estable en lloc d'un objectiu en moviment
...
<!-- exentax:conv-fill-v1 -->
O escriu-nos per <a href="https://wa.me/34614916910">WhatsApp al +34 614 916 910</a> i et responem avui mateix.

<!-- /exentax:conv-fill-v1 -->
<!-- /exentax:cta-conv-v1 -->

<!-- exentax:lote16-native-v1:crs-2-0-carf-por-que-usa-no-firmara-llc-ca-bis -->
...
- [CRS i els teus comptes bancaris LLC: el que es comparteix amb el teu país](/ca/blog/crs-i-els-teus-comptes-bancaris-llc-el-que-es-comparteix-amb)
...
- [IBAN Wise amb la teva LLC: el que es reporta realment a Hisenda](/ca/blog/wise-iban-i-llc-que-es-reporta-realment-a-hisenda)
<!-- /exentax:cross-refs-v1 -->
