...
Constituir una LLC costa de 0 $ a 50 $ de taxa estatal a Nou Mèxic, 100 $ a Wyoming i 90 $ a Delaware; amb servei professional el cost total del primer any queda entre 400 $ i 1.500 $.
...
## Quin estat encaixa amb el seu perfil? Comparativa honesta per cas real

Els preus de taula no trien l'estat per vostè. L'estat correcte depèn d'a què es dedica, de quant factura i de si vol buscar inversor, vendre l'empresa o simplement operar tranquil. Aquesta és la lectura honesta que donem en cada trucada d'Exentax quan un client dubta entre Nou Mèxic, Wyoming i Delaware:
...
- **Mes 12**: manteniment anual Exentax (Form 5472 + 1120 pro-forma, renovació del Registered Agent, monitorització BOI, coordinació amb el seu assessor fiscal de residència).
...
Total real a 24 mesos: **constitució més cara + dos cicles d'Annual Report + dues quotes Exentax.** L'escenari més car, justificat quan va a captar capital o vendre l'empresa: es recupera la prima el dia que un VC obre la seva cap table sense obligar-lo a redomiciliar.

### El que NO canvia entre els tres escenaris

- El Form 5472 + 1120 pro-forma es presenta igual als tres estats; la sanció per omissió també és la mateixa: 25.000 USD per formulari i any. I si arriba un requeriment, a Exentax mantenim el dossier preparat perquè responguis en hores, no en setmanes.
...
- La seva obligació de declarar la LLC en residència (AEAT, ATC, Departament de Tributs d'Andorra, AT a Portugal, Finanzamt a Alemanya) no canvia amb la tria de l'estat: la tributació efectiva del propietari depèn de la residència, no de Delaware vs NM.

## El cost de NO tenir LLC

Aquí està el número que la majoria ignora: el cost de **no tenir LLC** quan hauries de tenir-ne.

Si factures 60.000 €/any com a autònom a Catalunya amb clients internacionals i la seva càrrega efectiva (IRPF + cotitzacions) està al voltant del 35-45 %, són **21.000-27.000 €** d'impost. Amb una LLC ben estructurada i una planificació de residència neta, el cantó federal dels EUA queda a **0 % d'impost federal** sobre aquests fluxos; només queda la tributació de residència, que es pot optimitzar via atribució o dividend segons la regla local.

La diferència és real i el cost de la LLC s'amortitza el primer mes. Llegeixi la nostra <a href="/ca/blog/autonom-a-espanya-vs-llc-als-eua-comparativa-fiscal-completa">comparativa autònom a Catalunya vs LLC dels EUA</a> per a números treballats.

## "Però no hi ha serveis que ho fan per 49 dòlars?"

Sí, n'hi ha. I fan exactament una feina mecànica: omplen un formulari i l'envien. Sense assessorament fiscal, sense Operating Agreement adaptat al seu cas, sense suport postconstitució, sense preparació de declaracions, sense ningú que li expliqui què fer després.

Constituir la LLC és el pas fàcil. El difícil — i el que marca la diferència — és operar-la correctament perquè la seva estructura fiscal funcioni de debò.
...
És aquí on tanquem el cercle i ajuntem en un sol bloc el que en altres webs apareix dispers en cinc bullets de màrqueting: què fem exactament, què cobreix la quota anual, què s’estalvia i què no li cobrarem com a extra a posteriori. Tot al mateix lloc, pressupost tancat per escrit abans de començar.

**A la constitució (mes 0):**
- Filing legal a l'estat òptim per al seu perfil (Nou Mèxic, Wyoming, Delaware o Florida) amb Articles of Organization presentats al Secretary of State i filing fee estatal pagat per nosaltres.
- Obtenció de l'EIN federal via SS-4 davant l'IRS — sense cues, sense haver d'explicar a Washington què és un no resident.
- Operating Agreement personalitzat per al seu cas real, no una plantilla descarregada d'un blog.
...
- Coordinació amb el seu assessor fiscal de residència perquè la declaració local reflecteixi correctament l'atribució o el dividend.
- Suport escrit continu tot l'any, amb responsable assignat al seu cas.

**El que s’estalvia enfront de fer-ho pel seu compte:** un 5472 mal presentat són 25.000 USD per formulari i any (IRC §6038A); un BOI fora de termini, quan aplica, són 591 USD/dia acumulatius; un ITIN rebutjat el deixa sense banca operativa durant mesos. El valor Exentax no és només fer el tràmit, és que surti bé a la primera i tenir un assessor responsable quan l'IRS o l'AEAT preguntin.

Zero extres, zero "ah, això no estava inclòs", zero sorpreses a la factura. Reservi una assessoria gratuïta i li donem els números exactes per al seu cas concret.
...
- [Documents de la LLC: quins necessites i com organitzar-los](/ca/blog/documents-de-la-llc-quins-necessites-i-com-organitzar-los)
...
**I què cobreix el manteniment anual?** Registered Agent, Annual Report de l'estat, 5472 + 1120 pro forma presentats a l'IRS, monitorització BOI i coordinació amb el seu assessor fiscal al país de residència. Calendari anual complet cobert.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vol parlar-ne ara? Escrigui’ns per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Parlem%20de%20diners%2C%20directament%20i%20sense%20embuts%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i li responem avui mateix.</p>

Si vol veure el detall del procés complet, consulta la nostra <a href="/ca/serveis">pàgina de serveis</a> amb tot el que cobrim.
