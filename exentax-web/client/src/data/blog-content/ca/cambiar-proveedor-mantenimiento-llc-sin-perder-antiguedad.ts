...
Abans d'explicar com es fa, fixem el que es queda intacte. Canviar de proveïdor **no toca**:

- **La LLC en si.** Continua sent la mateixa persona jurídica registrada al mateix estat, amb el mateix nom i la mateixa data de constitució. La teva antiguitat es manté.
- **L'EIN.** El número fiscal assignat per l'IRS no es canvia salvat transformacions molt concretes.
- **Els Articles of Organization.** El document fundacional roman tal qual.
- **L'historial bancari.** Mercury, Wise, Relay no requereixen cap acció llevat que el RA o adreça figurin al perfil.
- **L'historial fiscal.** Les declaracions a l'IRS i <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> continuen vàlides i al teu nom.
### El que sí canvia

Tres coses, totes operatives:

1. **El Registered Agent**, si el nou proveïdor ofereix RA diferent.
2. **L'adreça de notificacions**, si la de l'anterior figurava com a mailing address.
3. **El responsable de presentar formularis** del proper cicle (5472, BOI, Annual Report).

Res d'això no afecta l'entitat.
## Procediment pas a pas

### Pas 1. Diagnòstic

Abans de tocar res, identifica què està en mans del proveïdor actual: és ell el RA a l'estat? la seva adreça figura a l'IRS? té credencials als portals? té còpies dels teus documents?

### Pas 2. Recuperar documents

Articles, EIN Letter (CP 575) o 147C, OA signat, BOI confirmation, últim Annual Report o Franchise Tax, últimes còpies 5472 + 1120 pro-forma. Si el proveïdor actual es nega, tens dret legal a obtenir-los. Insisteix. Hi ha vies administratives (147C IRS, good standing estat, confirmació BOI FinCEN).

### Pas 3. Designar el nou Registered Agent

Canvi via **Statement of Change of Registered Agent** al Secretary of State. Cost estàndard: 10-50 USD, processat en dies. El nou RA t'ha d'haver acceptat formalment abans de la presentació.

### Pas 4. Actualitzar mailing address IRS si escau

Si l'adreça de l'anterior figura com a adreça de la LLC a l'IRS, presenta **Form 8822-B**. Formulari d'una pàgina.

### Pas 5. Actualitzar el BOI si canvia alguna cosa

Si el canvi implica nova mailing address o alteració d'info del beneficiari, 30 dies per actualitzar BOI al FinCEN. Online, gratuït.

### Pas 6. Comunicar a banca i plataformes (només si cal)

Mercury, Wise, Relay no necessiten saber del canvi de RA. Si l'adreça registrada ha canviat: actualitza-la a cada plataforma per evitar incoherències en KYC.

### Pas 7. Tancament net amb el proveïdor anterior

Confirma per escrit la data de fi, demana devolució proporcional si escau, guarda el correu. Tanca el cicle i evita "càrrecs automàtics" l'any següent.
### Quant triga i quant costa

Un canvi ben executat es completa en **2-4 setmanes** i costa:

- Statement of Change of RA: 10-50 USD per estat
- Form 8822-B: gratis
- Actualització BOI: gratis
- Honoraris del nou proveïdor: segons paquet

Sense sanció, sense reinici, sense res que es "perdi".
### Quan NO canviar (encara)

Dos moments per esperar:

- **A poques setmanes del tancament fiscal**, si el proveïdor actual prepara el teu 5472. Acaba aquest cicle i canvia després.
- **Amb BOI o 5472 endarrerits en regularització** gestionats per l'actual. Acaba aquest expedient primer.
### Com ho fem a Exentax

A Exentax rebem cada mes clients que canvien de proveïdor. El procés és exactament el descrit. Ens fem càrrec del canvi de RA, del 8822-B, de l'actualització del BOI si escau, i comencem a operar el cicle següent sense perdre un dia de cobertura.

Si fa temps que penses que el teu proveïdor actual no respon a l'alçada i vols veure si encaixem, reserva una sessió inicial gratuïta a la nostra pàgina d'agendament. Et diem amb honestedat si convé canviar ara, esperar al tancament o no canviar.
...
## La veritat operativa sobre canviar de proveïdor de manteniment

L'antiguitat d'una LLC viu a l'estat de constitució i als registres de l'IRS, no al panell del teu proveïdor actual. Canviar de proveïdor és un tràmit administratiu, no una refundació. La confusió neix perquè alguns proveïdors presenten el canvi com a traumàtic per retenir el client. Aquestes són les cinc peces que importen, per ordre.

- **Registered agent.** Únic element legalment vinculant a l'estat. Es canvia amb un formulari curt al Secretary of State (Wyoming, New Mexico o Delaware: al voltant de 10-25 USD). Efecte immediat i la data de constitució no canvia.
- **Annual report i franchise tax.** Els terminis els marca l'estat, no el proveïdor. Si l'anterior deixava passar dates, el problema era operatiu, no estructural. Després del canvi, el nou proveïdor (o tu directament) gestiona el proper annual report amb el mateix venciment.
- **EIN i registres IRS.** L'EIN és permanent i va lligat a la LLC, no al proveïdor. Només canvia la "responsible party" si assumeixes el rol; es notifica amb Form 8822-B, sense cost ni reinici.
- **Compte bancari i adreça comercial.** Si l'adreça del proveïdor figurava a Mercury, cal actualitzar-la amb la nova adreça comercial (o personal si així ho decideixes). Mercury ho aplica en 24-48 hores amb un comprovant simple.
- **5472 i BOI.** El canvi no genera obligació extra de Form 5472, però convé incloure el canvi d'adreça/responsible party al proper BOI report a FinCEN dins dels 30 dies que preveu la regla.

### El que més ens pregunten

**Perdo historial bancari o credit profile si canvio?** No. Mercury només veu el canvi com a alteració d'adreça. L'historial transaccional roman intacte i l'antiguitat del compte es manté.

**L'IRS marca la LLC com a sospitosa per canvi d'agent?** No. Els canvis de registered agent són rutinaris i se'n processen milers cada setmana a cada estat. El que marca una LLC com a sospitosa és no presentar el 5472 o tenir anys d'annual reports impagats - tots dos independents del canvi.

A Exentax rebem LLCs cada setmana en migració de proveïdor i deixem agent, adreça, calendari i notificació BOI en marxa sense que el client escrigui ni un sol correu.
<!-- /exentax:execution-v2 -->

## El que NO canvia quan canvies de proveïdor
...
### Pas 4. Actualitzar la mailing address de l'IRS si escau
...
### Pas 5. Actualitzar el BOI Report si canvia alguna cosa

Apunt concret dels nostres expedients: així passa de debò, no com ho descriu una pàgina comercial. Els números i el calendari pesen - fallar en un fa desmuntar la resta.

### Pas 6. Comunicar a la banca i plataformes (només si escau)
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Canviar%20de%20prove%C3%AFdor%20de%20manteniment%20de%20la%20teva%20LLC%20%C3%A9s%20una%20de%20les%20decisions%20qu%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">Form 8822</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…figura como dirección de la LLC ante el IRS, presenta un **Form 8822-B** para actualizarla…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
