export default `Si vols vendre productes (físics o digitals) a Amazon, Shopify, Etsy o qualsevol plataforma d'ecommerce, tenir una LLC als Estats Units t'obre portes que des del teu país probablement estan tancades, o limitades amb restriccions i retencions.
