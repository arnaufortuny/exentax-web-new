...
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…el miembro**: nombre completo, porcentaje de participación (100% para Single-Member) - **P…»</span> <strong>[NO VERIFICAT]</strong></li>
