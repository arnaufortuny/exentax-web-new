...
<li><span class="font-mono">80 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…el día a día, qué pasa cuando una pieza falla, y por qué el 80 % de los bloqueos que vemos…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">70 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…a 14 días sin operativa mientras compliance revisa. - En el 70 % de los casos, cuenta rest…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">30 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…visa. - En el 70 % de los casos, cuenta restablecida. En el 30 %, **cierre con devolución …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">35 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ípico, la primera sigue operando. ### 3. Tax buffer del 25-35 % Cada vez que entra dinero …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">25 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…o en la cuenta operativa, **separa automáticamente entre un 25 % y un 35 %** a una cuenta …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">10 %</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…aras en EUR/GBP/MXN, las fluctuaciones FX te pueden comer 5-10 % de margen en un mal trime…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…legue el primer pago Cada vez que entra una transferencia &gt;5.000 USD de un cliente nuevo, …»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">4%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…Mercury cierra mañana, Wise sigue operando 24h. FX típico 0.4% (vs 1%-3% de bancos tradici…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">1%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…cierra mañana, Wise sigue operando 24h. FX típico 0.4% (vs 1%-3% de bancos tradicionales).…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">3%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…erra mañana, Wise sigue operando 24h. FX típico 0.4% (vs 1%-3% de bancos tradicionales). T…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…tú vives en EUR, optimizar el momento de conversión vale 0.5%-1% anual sobre el flujo tota…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">95%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…recurrente ~$50-$100 si volumen &lt;100k$/año. Con esto cubres 95% de escenarios sin tener qu…»</span> <strong>[NO VERIFICAT]</strong></li>
