export default `El Model 991 obliga Visa, Mastercard i American Express a reportar a l'AEAT espanyola qualsevol cobrament o pagament amb targeta superior a 25.000 € per titular i any, així com els comptes associats a l'estranger.
...
La regla general és que **el compte i la titularitat estan ben cobertes**, mentre que el **detall transacció a transacció** no s'envia d'ofici: es reconstrueix només en una inspecció concreta. Respira: a Exentax això és rutina, et posem al dia i la propera revisió es tanca en una volta, sense sotracs.
...
5. **"Millor pagar sempre amb la targeta del banc estranger per no deixar rastre."** El rastre existeix i, a més, una operativa dissenyada per no deixar rastre és exactament el patró que més ràpid dispara alarmes en una inspecció. Aquí entra Exentax: presentem el formulari, arxivem l'acús i, si l'administració pregunta, la resposta ja està llesta.
