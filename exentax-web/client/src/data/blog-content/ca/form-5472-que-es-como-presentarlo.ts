...
A més, es presenta en paper (no electrònicament) juntament amb el Form 1120, enviat per correu a l'IRS. Sí, en ple avui, l'IRS segueix demanant paper per a això. Benvingut a la burocràcia americana.
...
## Actualització Exentax avui: Form 5472 al detall
...
## Com presentem el Form 5472 a Exentax

El 5472 és la peça més cara si s'omet: multa mínima de 25 000 USD per exercici. La presentació va sempre amb un 1120 pro-forma i exigeix coherència amb BOI, EIN i banca. El mètode Exentax el munta cada any en una setmana de calendari.

- **Reportable transactions reals**: cada moviment entre la LLC i el beneficiari (aportacions, distribucions, préstecs) documentat i conciliat amb extractes bancaris abans d'omplir cap camp.
- **1120 pro-forma coherent** amb l'exercici i el mètode comptable declarats al SS-4 quan es va obtenir l'EIN.
- **Comprovant i arxiu**: còpia signada, número de transmissió i proof of mailing arxivats al repositori del client, no al correu de l'operador.

Si vols que el presentem o només revisar l'últim, obre la <strong>calculadora Exentax</strong> o reserva trenta minuts.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">25,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ntar incorrectamente el Form 5472 son significativas: - **$25,000 de sanción base** por ca…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…&#96;Si tienes una LLC en Estados Unidos como no residente, el Form 5472 es una declaración in…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…la personal), documentar esto es pan comido. ## Form 5472 y Form 1120: la pareja inseparab…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 7004</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…rtar transacciones LLC-owner | No, es informativo | IRS | | Form 7004 | Solicitar extensió…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
