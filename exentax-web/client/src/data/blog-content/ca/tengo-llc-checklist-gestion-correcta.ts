...
Aquest article és una checklist sense embuts. Si respons "no" o "no ho sé" a diverses preguntes, hauries de revisar la teva estructura abans que ho faci Hisenda o l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> per tu.

## Per què molts propietaris de LLC operen malament sense saber-ho

El problema no és la LLC en si. És la **gestió contínua**. La majoria de serveis que constitueixen una LLC deixen el client amb tres documents (Articles of Organization, EIN letter, Operating Agreement) i un "ja està, ja pots operar". Però gestionar una LLC correctament implica:

- Compliance anual amb l'IRS i amb l'estat on es va constituir
- Compliance amb <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> (BOI Report)
- Coherència entre la fiscalitat nord-americana i la del teu país de residència
- Banca operativa real, separada del patrimoni personal
- Reports automàtics (CRS, DAC7, DAC8) que ja són en marxa

Si al teu cap la LLC encara és "una empresa offshore on no es reporta res", la teva informació té diversos anys de retard. La realitat de avui és molt diferent.
## La checklist en 7 blocs

### 1. La teva LLC està classificada correctament davant de l'IRS?

Per defecte, una LLC és una **disregarded entity** si té un únic membre, o una **partnership** si en té diversos. No paga impost federal per si mateixa: els ingressos passen al soci.

Pregunta't:
- Saps amb certesa si la teva LLC és Single-Member (disregarded) o Multi-Member (partnership)?
- Tens la carta de l'EIN de l'IRS confirmant la classificació?
- En algun moment s'ha fet una elecció S-Corp o C-Corp (Form 8832 / 2553) sense que ho sàpigues?

Una classificació errònia canvia completament les teves obligacions declaratives i la teva fiscalitat real. En el dubte, verifica-ho.

### 2. Estàs presentant Form 5472 + Form 1120 cada any?

Si ets no resident, propietari únic d'una LLC, i hi ha hagut qualsevol transacció entre tu i la LLC (retirades, aportacions, pagaments), estàs obligat a presentar **Form 5472 acompanyat d'un Form 1120 pro-forma**. Cada any. Sense excepcions rellevants per a la majoria de perfils.

La sanció base per no presentar o presentar incomplet és de **25 000 USD per formulari i any**, i s'acumula. No és una amenaça abstracta: l'IRS l'aplica.

Consulta la nostra <a href="/ca/blog/form-5472-que-es-qui-lha-de-presentar-i-com-complir">guia completa del Form 5472</a> per als detalls. Si no recordes haver-lo presentat els darrers anys, no estàs "fora del radar": estàs generant un passiu silenciós.

### 3. Tens el BOI Report al dia amb FinCEN?

El **Beneficial Ownership Information Report** és la declaració a FinCEN sobre qui és el beneficiari real de la teva LLC. És obligatori des de l'entrada en vigor de la CTA per a la gran majoria de LLCs, amb un règim sancionador agressiu: fins a **591 USD per dia de retard** més sancions penals en casos greus.

Pregunta't:
- La teva LLC entra en l'àmbit vigent del BOI Report (després de la interim final rule de FinCEN de març de 2025, el BOI només s'aplica a "foreign reporting companies": entitats constituïdes fora dels EUA i registrades en un estat; verifica a FinCEN.gov)? Si sí, vas presentar el BOI inicial en constituir la LLC?
- L'has actualitzat després de qualsevol canvi (adreça, document, beneficiari)?
- Saps qui monitoritza aquests canvis per tu?

Si no recordes haver-ho fet, revisa-ho avui. No és paperassa opcional.

### 4. El teu Registered Agent i els filings de l'estat estan vigents?

Cada LLC necessita un **Registered Agent actiu** al seu estat de constitució i, segons l'estat, ha de presentar un **Annual Report** o pagar una **franchise tax**. Si deixes caducar l'agent o no presentes el report anual, la teva LLC passa a "delinquent" o fins i tot a "dissolved" i deixa d'existir legalment.

Senyals d'alerta:
- No saps el nom del teu Registered Agent ni el contacte
- No tens recordatoris automàtics dels deadlines de l'estat
- Fa més de 12 mesos que no reps cap comunicació oficial de l'estat

Si la teva LLC va ser dissolta i segueixes facturant amb el seu EIN, totes les factures poden ser qüestionades i la separació patrimonial es trenca.

### 5. Separes diners personals i de la LLC?

Aquest és **l'error més comú i més car**. Si fas servir el compte de la LLC per a despeses personals o cobres factures de la LLC al compte personal, estàs trencant el **corporate veil**. Conseqüència: la LLC ja no protegeix el teu patrimoni personal i, en una inspecció, sou tractats com una mateixa cosa.

Detalls al nostre article sobre <a href="/ca/blog/separar-diners-personals-i-de-la-llc-per-que-es-important">separar finances personals i de la LLC</a>.

Checklist mínim:
- Compte bancari de la LLC (Mercury, Relay, Wise Business…) separat del personal
- Owner's draws documentats amb data i referència
- Aportacions de capital identificades com a tals
- Zero pagaments personals amb la targeta de la LLC

### 6. Reportes correctament al teu país de residència?

És aquí on més estructures peten. Que la LLC no pagui impost federal als EUA **no vol dir que tu no hagis de declarar res al teu país**. Si ets resident fiscal a Espanya, els ingressos de la LLC s'imputen al teu IRPF com a rendiments d'activitat econòmica (vegeu doctrina administrativa, incloent la línia reforçada al <a href="/ca/blog/doctrina-administrativa-espanyola-sobre-la-llc-americana">febrer de 2020</a>).

Pregunta't:
- Declares efectivament els ingressos de la LLC al teu IRPF?
- Has presentat les declaracions d'actius/comptes a l'estranger aplicables (Modelo 720/721)?
- El teu assessor local entén com funciona una LLC americana?

Si el teu assessor et va dir "no declaris res perquè tributa als EUA", busca segona opinió. Avui. És on més s'acumulen sancions i són totalment evitables.

### 7. La teva banca, brokers i exchanges estan alineats amb CRS i DAC?

Wise, Mercury, Relay, Interactive Brokers i els exchanges de cripto **reporten automàticament** a les autoritats fiscals sota CRS, DAC7 i, recentment, DAC8. No és "el que diuen a internet", és a la seva política pública.

Vol dir que la teva banca i els teus brokers envien dades de saldos, ingressos i operacions a l'Hisenda del teu país. Si la teva declaració no encaixa amb el que reporten, salta la incoherència.

Comprova:
- Saps quina jurisdicció reporta cada compte (Wise reporta des de Bèlgica, no des dels EUA)
- La residència fiscal declarada a cada plataforma és correcta i consistent
- Les declaracions anuals són coherents amb aquests reports automàtics
### Senyals que alguna cosa va malament

Més enllà de la checklist, aquests són els patrons quan algú arriba a Exentax amb una estructura mal gestionada:

- **No recorda en quin estat** està constituïda la LLC ni qui és el seu Registered Agent
- **Mai no ha presentat Form 5472** ni sap què és
- **Mai no va presentar el BOI Report** o no l'ha actualitzat
- **Barreja comptes** personals i de la LLC
- El seu **assessor local** li va dir que la LLC "no es declara" al seu país
- Té **cripto, brokers o comptes a l'estranger** sense reportar
- No té **Operating Agreement** signat, o no sap on és
- **Rep cartes de l'IRS o de l'estat** i no sap què signifiquen

Si tres o més s'apliquen, no estàs "fora del radar", acumules un passiu que tard o d'hora surt.
### Errors que veiem cada setmana

| Error | Per què és greu |
|---|---|
| No presentar Form 5472 durant anys | 25 000 USD de sanció per formulari, acumulativa |
| BOI Report no actualitzat | Fins a 591 USD/dia de sanció |
| Comptes personals i de LLC barrejats | Trenca la separació patrimonial |
| No declarar ingressos LLC al país de residència | Quan salta el creuament CRS/DAC: regularització + sancions + interessos |
| Wise/Mercury/Brokers amb residència fiscal incorrecta | Report CRS al país equivocat, cosa que dispara revisions rutinàries |
| Operar amb LLC dissolta | Factures qüestionables, contractes nuls |
| Confiar en "no es reporta res" | actualment ja no funciona així. CRS, DAC7 i DAC8 són actius |
### Què fer si detectes problemes

Primer: **no entris en pànic i no deixis passar més temps**. La majoria de situacions són recuperables si actues amb cap.

Passos típics d'una regularització:

1. **Diagnòstic real** de l'estructura i dels anys no presentats
2. **Estratègia ordenada**: què presentar abans, què actualitzar, què comunicar al país de residència
3. **Presentacions endarrerides** davant l'IRS i FinCEN
4. **Actualització davant l'estat** i reactivació si la LLC va ser dissolta
...
Si després d'aquesta checklist et queden dubtes, el raonable és revisar ara, abans que aparegui el problema. A Exentax no venem LLCs: estructurem operativa real, gestionem compliance i coordinem banca, inversió i fiscalitat internacional. Si ja tens una LLC i no tens clar si està ben estructurada, **la revisem amb tu** i et diem què cal tocar i què està bé.

Reserva la teva assessoria gratuïta de 30 minuts i ho mirem junts. Millor detectar avui el que calgui ordenar que esperar la carta de l'IRS o d'Hisenda.
...
## Actualització Exentax avui: checklist viva

Mantenir una LLC ben gestionada actualment implica un calendari operatiu que convé fixar a l'agenda:

- **Mensual.** Conciliació bancària Mercury/Slash (tancament del mes), categorització de despeses, còpia de seguretat xifrada d'extractes, revisió de Stripe/PayPal/DoDo (disputes, retencions).
- **Trimestral.** Revisió de subscripcions (eliminar les inactives redueix soroll al 5472), pagament a un mateix (*owner draw*) documentat amb concepte i referència, comprovació de fons disponibles per a impostos.
- **Anual (calendari fiscal avui).** **15 de gener**: reserva una assessoria amb el teu assessor per preparar 5472. **15 de febrer**: tancament comptable de l'any. **15 de març**: 1042-S si emets pagaments a relacionats (poc habitual SMLLC). **15 d'abril**: 5472 + 1120 pro forma o **Form 7004** per estendre al 15 d'octubre. **Mes d'aniversari**: Annual Report estatal + renovació Registered Agent. **30 dies després de qualsevol canvi**: BOI Update si la teva LLC segueix en àmbit.

### Documentació a conservar 7 anys

1. Articles of Organization, EIN Letter (CP 575 o 147C), Operating Agreement signat.
2. Confirmacions de presentació: 5472, BOI, Annual Report, Franchise Tax.
3. Extractes bancaris i de passarel·les mes a mes.
4. Factures emeses i rebudes (format PDF + llibre).
5. Justificants de *owner draws* (transferències amb concepte explícit).

### Preguntes freqüents avui

**Cal comptabilitat formal amb Pla General?** No, la LLC no exigeix PGC. Sí necessites un *single ledger* net que suporti el 5472 i un eventual KYC bancari.

**I si l'exercici tanca sense operacions?** El 5472 només és obligatori si hi va haver *reportable transactions* entre tu i la LLC. Tot i això, convé declarar si hi va haver aportació inicial o pagament de Registered Agent des de fons propis.

**Puc gestionar-ho sol o necessito assessor?** Sol, si entens 5472, BOI i Annual Report. Assessor, si el teu volum supera ~50 factures/any o si vens als EUA (risc PE/ECI).
<!-- exentax:overhaul-avui-v1 end -->

<!-- exentax:execution-v2 -->
## Checklist anual operativa de la LLC, mètode Exentax

Tenir LLC és tenir calendari; sense calendari, tard o d'hora cauen 5472 o BOI. La checklist Exentax cap en un full i cobreix els dotze moments de l'any on alguna cosa es mou.

- **T1**: BOI vigent, annual report estatal, conciliació banca prèvia al 5472, pagament/extensió federal abans del 15 d'abril.
- **T2-T3**: revisió de canvis societaris o d'adreça que disparin update BOI, auditoria de passarel·les i MCC, conciliació trimestral.
- **T4**: tancament comptable, planificació de distribucions, pressupost de l'any següent i verificació de coherència EIN/CP-575/OA abans del nou exercici.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Tens%20una%20LLC%20als%20EUA%20i%20tot%20sembla%20funcionar%3A%20factures%20als%20teus%20clients%2C%20mous%20%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">Form 8832</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…- ¿Algún momento se ha hecho una elección S-Corp o C-Corp (Form 8832 / 2553) sin que lo se…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…enes claro, no asumas: revísalo. ### 2. ¿Estás presentando Form 5472 + Form 1120 cada año?…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…no asumas: revísalo. ### 2. ¿Estás presentando Form 5472 + Form 1120 cada año? Si eres no …»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…rada de tu patrimonio personal - Reportes automáticos (CRS, DAC7, DAC8) que ya están en ma…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…e tu patrimonio personal - Reportes automáticos (CRS, DAC7, DAC8) que ya están en marcha S…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
