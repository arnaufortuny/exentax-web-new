...
- **Modelo 720 i 721**: comptes bancaris als US amb saldo mig o final superior a **50.000 €** han de declarar-se al **Modelo 720** (RD 1065/2007 art. 42 bis). Tras la STJUE C-788/19 (27/01/2022) i la **Llei 5/2022**, les sancions s'han reduït al règim general LGT (multes proporcionals a la quota deixada d'ingressar i sense recàrrec confiscatori). Criptoactius custodiats als US: **Modelo 721** (Ordre HFP/887/2023). Operacions vinculades amb la LLC: **Modelo 232**. I si arriba un requeriment, a Exentax mantenim el dossier preparat perquè responguis en hores, no en setmanes.
