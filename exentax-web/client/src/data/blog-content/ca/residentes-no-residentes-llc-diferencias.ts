export default `No és el mateix tenir una LLC sent resident dels Estats Units que sent no resident. L'estructura legal és la mateixa, però la **fiscalitat i les obligacions** canvien radicalment.
