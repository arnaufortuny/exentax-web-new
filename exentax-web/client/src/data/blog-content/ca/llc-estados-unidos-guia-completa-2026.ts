...
- **Form 5472 + 1120 pro forma.** Continua obligatori per a SMLLC de no resident amb qualsevol *reportable transaction*. Sanció base **25.000 USD per formulari i any** (IRC §6038A). Exercici 2025 → venciment **15 d'abril de avui**, extensió via **Form 7004** fins al **15 d'octubre de avui**. Respira: a Exentax això és rutina, et posem al dia i la propera revisió es tanca en una volta, sense sotracs.
...
- **Arquitectura bancària en cascada** (Mercury o Relay + Wise + passarel·la alternativa) perquè cap tancament per compliance et deixi sense operativa.
