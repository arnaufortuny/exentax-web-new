export default `Passar un negoci digital de 5.000 a 50.000 € mensuals des de Catalunya destapa un problema que cap coach de LinkedIn t'explica: a partir de cert volum, els mòduls deixen d'encaixar, l'estimació directa es menja en quota d'autònoms i IRPF, i la SL comença a costar més del que aporta. La LLC, aquí, canvia l'equació.
...
El manteniment anual és senzill: unes declaracions davant l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> (que nosaltres presentem per tu) i la renovació de l'agent registrat. La resta del temps, et dediques a fer créixer el teu negoci.
...
A Exentax acompanyem el salt a les sis xifres per a emprenedors catalans. Reserva la teva assessoria gratuïta i et mostrem com escalar sense que t'enxampi l'AEAT.
...
## Escalar sense que l'estructura et freni: el pla de creixement al voltant de la LLC

Una LLC ben muntada aguanta de 0 a ~500.000 USD anuals sense canvis estructurals. Més enllà comencen a aparèixer colls d'ampolla - banca, passarel·les, fiscalitat per mercats, talent - que convé anticipar abans de xocar-los. Aquesta és la fulla de ruta que apliquem en escalar negocis digitals.

- **Tram 0-100k USD: simplicitat guanyadora.** Una LLC, un compte Mercury, una passarel·la Stripe, comptabilitat mensual amb A2X o Synder. Qualsevol complexitat afegida en aquest tram (segona LLC, holding, segona jurisdicció) destrueix agilitat i no aporta. Focus en producte, vendes i separació de fons.
- **Tram 100-500k USD: redundància i bookkeeping seriós.** Mercury + Relay com a comptes paral·lels, Stripe + Paddle/DoDo com a passarel·les en cascada, programari comptable connectat (no Excel), declaració 5472 amb pròrroga sistemàtica (Form 7004 abans del 15 d'abril), i primera revisió seriosa de la posició d'IVA OSS/IOSS segons mix de clients. És el tram on més LLC es trenquen per creixement sense estructura.
- **Tram 500k-2M USD: professionalització de l'equip i compliance.** Bookkeeper extern o intern dedicat, primera persona contractada via 1099 contractor o W-8 si està fora d'EUA, contractes model de SaaS o serveis revisats, calendari fiscal amb dos checkpoints anuals (juny i desembre), avaluació de holding intermèdia si hi ha socis o IP rellevant.
- **Tram 2M+ USD: estructura escalable i blindatge.** Holding LLC + operating LLC, IP separada, banca multinivell (Mercury operativa, Brex targetes equip, banc tradicional per a reserves), assegurança D&O, primer pla d'exit en 5-7 anys amb due diligence permanent preparada. Ja no és "una LLC" - és una arquitectura.

### Què ens pregunten més

**Quan és el moment de passar a S-Corp o C-Corp?** Generalment quan l'owner és US person i el self-employment tax pesa més que la complexitat S-Corp (rang 100-150k de profit). Per a non-US owners, la single-member LLC continua sent el vehicle òptim en gairebé tots els volums - el canvi aporta poc i resta flexibilitat.

**Crear una segona LLC per a una nova línia de negoci?** Sí quan la nova línia té risc legal diferent (productes físics, regulat), un mix de socis diferent o es prepara per a venda separada. No per estètica. Cada LLC suma 1-2k anuals de manteniment.

A Exentax acompanyem l'escalada tram a tram, anticipem els colls d'ampolla abans que apareguin i ajustem l'estructura sense reincorporar de zero.
...
<!-- exentax:cta-v1 -->
Constitució, EIN, BOI, banca i manteniment: un sol equip que entén el teu cas de cap a peus. <a href="/ca/serveis/llc-delaware">Veure tots els serveis</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">500.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…o alrededor de la LLC Una LLC bien montada aguanta de 0 a ~500.000 USD anuales sin cambios…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">Form 1099</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…no un banco; pero complementa perfectamente a Mercury) - **Form 1099**: Si contratas a fre…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
