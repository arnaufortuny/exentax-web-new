export default `Quan sol·licites un compte bancari empresarial per a la teva LLC als Estats Units, el banc no simplement t'obre un compte. Realitza un procés de due diligence (diligència deguda) per verificar que la teva empresa és legítima i que tu ets qui dius ser.
