export default `Els bancs i fintechs dels EUA fan avui una due diligence molt més exigent del que un empresari català està acostumat amb CaixaBank, Sabadell o N26. Passaport més adreça del Registered Agent ja no basta: volen una història coherent entre el que declares a Hisenda, el teu web, les teves factures i l'origen dels fons.
...
- **EIN Confirmation Letter**: la carta de l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> confirmant el teu número fiscal
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Els%20bancs%20i%20fintechs%20dels%20EUA%20fan%20avui%20una%20due%20diligence%20molt%20m%C3%A9s%20exigent%20del%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…tu LLC y tus datos personales. En Mercury, este proceso es 100% online. ### 2. Verificació…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">250,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…regulado por la FDIC. Tus depósitos están asegurados hasta $250,000, con cobertura extendi…»</span> <strong>[NO VERIFICAT]</strong></li>
