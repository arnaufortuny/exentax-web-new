export default `
El CRS mou saldos bancaris entre més de 120 països des del 2017, i un resident fiscal a Espanya amb compte a Andorra, Suïssa o Mèxic veurà aquestes dades arribar a Hisenda cada setembre.
...
1. **Declarar correctament.** El creuament ja existeix; intentar amagar és perdre temps i exposar-se a sancions. I si arriba un requeriment, a Exentax mantenim el dossier preparat perquè responguis en hores, no en setmanes.
