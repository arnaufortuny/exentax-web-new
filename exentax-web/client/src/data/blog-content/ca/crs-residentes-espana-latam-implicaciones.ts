export default `El **Common Reporting Standard (CRS)** és la peça més important de compliance fiscal internacional de la darrera dècada, i pocs entenen què significa per al titular d'una <a href="/ca/blog/llc-als-estats-units-guia-completa-per-a-no-residents-el-2026">LLC americana</a> o per a qui té comptes fora del seu país de residència.
