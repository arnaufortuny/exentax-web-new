export default `Quan obres la teva LLC, una de les primeres decisions és on obrir el compte bancari. I aquí és on comença la confusió: Mercury no és un banc. Wise tampoc. Relay tampoc. Però tots t'ofereixen un compte, una targeta i un routing number.
