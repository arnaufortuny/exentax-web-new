...
El BOI Report davant <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> exigeix que declaris els "beneficial owners", els propietaris reals, no els nominals. Si poses el teu cosí com a owner però tu ets qui controla el negoci, estàs proporcionant informació falsa a una agència federal encarregada de combatre delictes financers.
...
A Exentax rebutgem aquest tipus de muntatge i expliquem per què. Reserva la teva assessoria gratuïta: construïm una estructura al teu propi nom, completament legal, sense apanyos que cauen a la primera inspecció.
...
- **El sistema et troba de tres maneres.** BOI exigeix UBO real sota amenaça penal; KYC bancari pregunta source of funds; CRS/FATCA encreuen amb la residència.
...
<li><span class="font-mono">10.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…US tipifica falsedad documental en el BOI report con hasta $10.000 de multa civil + 2 años…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…o presentas el &lt;a href=&quot;/es/blog/como-operar-llc-dia-a-dia&quot;&gt;Form 5472&lt;/a&gt;, reportas transa…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
