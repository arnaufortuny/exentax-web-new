export default `Fer servir homes de palla per ocultar la titularitat d'una LLC és delicte de simulació contractual i fiscal a Espanya (art. 305 CP), amb penes d'1 a 5 anys de presó i multes de fins a 6 vegades la quota defraudada. A Exentax hem tancat sense sanció clients exactament en aquesta situació. Parlar aviat val or — i t'estalvia cinc xifres.
...
No parlarem de xifres específiques de sancions perquè no és el nostre estil. Però sí que serem directes: les conseqüències d'utilitzar testaferros poden incloure. És el moment de demanar ajuda. A Exentax obrim el cas, presentem el que falta i responem a l'administració per tu.
