...
La clau de l'optimització fiscal amb una LLC és la seva classificació com a "Disregarded Entity" per l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>:
...
Una lectura veïna per tenir oberta al costat d'aquesta: <a href="/ca/blog/fiscalitat-internacional-per-a-emprenedors-digitals-guia">Fiscalitat internacional per a emprenedors digitals: guia completa</a>, que afina precisament els marges del que explica aquesta guia.
...
A Exentax dissenyem estructures cas per cas per a freelances catalans. Reserva la teva assessoria gratuïta i et diem quina combinació (LLC, residència, convenis) aguanta per al teu perfil real.
...
## L'estructura "òptima": tres preguntes honestes abans de triar-la
...
### Tres patrons que veiem repetidament funcionar

- **Freelance digital, residència Espanya, clients globals B2B/B2C, 100-300k EUR.** LLC US single-member + autònom en residència amb dividends imputats; OSS si hi ha B2C UE; calendari IRPF/IVA + 5472 + 720 coordinat. Cost anual all-in 2.500-4.500 EUR, estalvi fiscal típic 25-40% vs autònom pur.
- **Seller ecommerce, residència LatAm, clients US/global, 200-800k USD.** LLC US Wyoming o New Mexico + Mercury + Stripe + A2X; sense IVA UE si no es creua llindar; declaració fiscal en residència segons país. Cost 3.000-5.000 USD anuals, estalvi fortament dependent de la legislació local.
- **Consultor B2B, residència mòbil, clients UE/UK, 80-200k EUR.** UK Ltd amb OSS via representant o EOOD búlgara amb substància mínima; banca Wise + Tide o DSK; residència personal optimitzada (Portugal NHR mentre duri, Andorra, Xipre). Estructura més complexa però rendible sobre 150k+.

### Què ens pregunten més

**I l'estructura "ideal" de l'influencer fiscal X?** Sol estar dissenyada per al seu cas (residència, volum, mix), no per al teu. Replicar sense diagnòstic previ és la font nº 1 dels retreballs que veiem en consulta.

**Quan té sentit canviar d'estructura?** Quan l'estalvi net anual supera per almenys 3x el cost anual de manteniment de la nova estructura, i la transició es pot fer sense trencar continuïtat operativa amb clients i banca.

A Exentax fem el diagnòstic amb els teus números reals, descartem les estructures que no encaixen i et donem un pla d'implementació amb calendari i costos - no una recomanació genèrica.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Parlar%20d'%E2%80%9Eestructura%20fiscal%20%C3%B2ptima%E2%80%9D%20des%20de%20Catalunya%20sense%20esmentar%20la%20quota%20%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ternacionales, clientes en múltiples países y una actividad 100% digital. En este artículo…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ión máxima**: en España, por ejemplo, puedes pagar entre el 30% y el 47% sobre tus ingreso…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…a**: en España, por ejemplo, puedes pagar entre el 30% y el 47% sobre tus ingresos - **Cuo…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…mericana empieza a tener sentido cuando: - Facturas más de 15.000€/año a clientes internac…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…do neto**: muchos de nuestros clientes pasan de pagar el 35-45% a pagar el 10-20% de forma…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…de nuestros clientes pasan de pagar el 35-45% a pagar el 10-20% de forma completamente leg…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">9%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…jetas para equipo | | **Stripe US** | Cobrar a clientes | 2.9% + $0.30 por transacción | |…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ndario IRPF/IVA + 5472 + 720 coordinado. Coste anual all-in 2.500-4.500 EUR, ahorro fiscal…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">4.500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…IRPF/IVA + 5472 + 720 coordinado. Coste anual all-in 2.500-4.500 EUR, ahorro fiscal típico…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">40%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…Coste anual all-in 2.500-4.500 EUR, ahorro fiscal típico 25-40% vs autónomo puro. - **Sell…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…gún país (atribución directa típica en pass-through). Coste 3.000-5.000 USD anuales, ahorr…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ís (atribución directa típica en pass-through). Coste 3.000-5.000 USD anuales, ahorro depe…»</span> <strong>[NO VERIFICAT]</strong></li>
