...
**Davant l'<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>:** L'IRS sap qui és el propietari de la teva LLC. Quan sol·licites l'EIN, declares qui és el responsible party. Quan presentes el Form 5472, reportes les transaccions entre tu i la LLC. La privacitat estatal no té efecte davant el servei d'impostos federal.

**Davant <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>:** El BOI Report (Beneficial Ownership Information Report) requereix que declaris qui són els propietaris beneficiaris de la LLC, incloent-hi nom, data de naixement, adreça i número d'identificació. Aquesta informació no és pública, però està en mans del govern federal.
...
Per continuar aquest fil, <a href="/ca/blog/propietaris-ficticis-per-a-llcs-per-que-es-illegal-i-els">Propietaris ficticis per a LLCs: per què és il·legal i els riscos que es corren</a> completa un matís que aquí només hem tocat de passada.
...
A Exentax configurem LLCs per maximitzar la confidencialitat mantenint-te 100 % transparent davant d'Hisenda. Reserva la teva assessoria gratuïta i et diem què pots mantenir realment privat.
...
## Privadesa de la LLC americana: on és avantatge real i on és mite venut per gurus

"Wyoming amaga el teu nom del públic" és cert. "Wyoming t'amaga de l'IRS, FinCEN, Hisenda i bancs" és absolutament fals.

- **El que SÍ és privat: el registre estatal públic.** Wyoming, New Mexico i Delaware (amb nominee) NO publiquen el nom del beneficial owner. Cerca pública del Secretary of State només mostra el registered agent.
- **El que NO és privat: FinCEN BOI Report.** Des de l'entrada en vigor del Corporate Transparency Act, tota LLC amb <20 empleats i <5M$ ha de reportar al FinCEN el nom, data de naixement, adreça i document d'identitat de cada beneficial owner. No públic però existeix. Sanció $591/dia.
- **El que NO és privat: la teva residència fiscal.** Espanya, França, Itàlia reben informació via CRS, FATCA-IGA, sol·licitud directa a l'IRS. Pretendre "amagar" la LLC a Hisenda és il·lusió.
- **Privadesa estructurada i legal.** Wyoming + nominee + PO Box virtual és privadesa legítima vs competidors. Però declarada en residència i reportada al FinCEN.

### El que més ens pregunten

**Amb nominee desaparec totalment?** Només del registre estatal. BOI exigeix identitat real.

**New Mexico és més privat que Wyoming?** Marginalment més opac a nivell estatal. En la resta, idèntic.

A Exentax estructurem LLC amb privadesa real vs tercers i compliment total.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…&lt;a href=&quot;/es/blog/extension-irs-form-1120-como-solicitarla&quot;&gt;Form 5472&lt;/a&gt;, reportas las tr…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 8938</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…uales. Pero declarada en residencia (Modelo 720/721 España, Form 8938 si residente US) y r…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
