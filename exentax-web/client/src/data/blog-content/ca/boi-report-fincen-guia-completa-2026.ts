...
El BOI Report al FinCEN sembla senzill i ho és, però els errors que veiem cada setmana es repeteixen: identitats de beneficiari mal capturades, terminis oblidats després de canvis societaris i còpies del FinCEN ID que ningú guarda. Aquí entra el mètode Exentax.

- **Identitat i document** del beneficiari efectiu verificats abans de qualsevol càrrega: passaport llegible, adreça residencial actual i FinCEN ID assignat per persona.
- **Trigger d'actualització a 30 dies**: qualsevol canvi d'adreça, passaport o estructura obre la finestra curta de re-presentació que la majoria salta.
- **Comprovant de presentació**: PDF i número de transmissió arxivats al repositori del client, no al correu de l'operador.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Si%20has%20constitu%C3%AFt%20una%20LLC%20als%20Estats%20Units%20els%20darrers%20anys%2C%20segur%20que%20has%20se%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
