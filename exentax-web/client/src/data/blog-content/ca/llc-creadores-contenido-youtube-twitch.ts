...
Aquí és on la LLC brilla especialment. A Exentax revisem el teu cas amb dades reals: <a href="/ca/agendar">agenda una consulta gratuïta</a> de 30 minuts.- Factures des de la teva LLC. "CreatorName LLC" sona infinitament més professional que "Joan García, autònom"
...
A Exentax estructurem ingressos multi-plataforma de creadors catalans. Reserva la teva assessoria gratuïta: mapem AdSense, Twitch i patrocinis i et diem on ha d'aterrar cada euro.
...
## LLC per a creadors de contingut (YouTube, Twitch, TikTok): com cobrar net en USD

Si vius de YouTube, Twitch, TikTok o Patreon i resideixes fora dels EUA, una LLC ben muntada canvia la teva operativa: cobres directament en USD des de Google AdSense, Twitch, sponsors i plataformes, sense comptes personals saturats, sense canvi de divisa car i amb factura neta per a sponsors corporatius.

- **El coll d'ampolla sense LLC.** Adsense paga a l'IBAN espanyol, Twitch reté 30% sense W-8BEN, sponsors USA demanen W-9 (que tu no pots donar com a persona física no-US), i el teu compte personal rep transferències internacionals amb comissions de 25-50 USD cadascuna. Plus: Hisenda rep el report CRS complet.
- **El stack amb LLC.** Single-member LLC a Wyoming o Delaware, EIN, Mercury Business com a compte principal en USD. Configures AdSense per pagar a la LLC (amb el seu EIN), apliques W-8BEN-E a Twitch/TikTok per reduir retenció al 0% sota tractat, i signes sponsorships des de la LLC amb factura pròpia.
- **El tema fiscal en residència.** Si resideixes a Catalunya, els ingressos de la LLC tributen en IRPF com a rendiment d'activitat. LLC desestimada = atribució directa. Si resideixes en LATAM, generalment la LLC és opaca i només tributa el distribuït.
- **Targetes i despeses.** Mercury emet targetes USD per gastar en programari (Adobe, Notion), equip (càmera, mic), promoció (Meta, Google) i subscripcions. 100% deduïble. Sense recàrrec de canvi a cada compra USD.

### Què ens pregunten més

**La meva audiència canvia amb la LLC?** No per als subscriptors. Sí en sponsorships: la teva marca es professionalitza i molts sponsors corporatius només treballen amb entitats. Obertura de mercat real.

**Què passa amb els meus cobraments AdSense actuals al compte personal?** Canvies el mètode de pagament a EIN + Mercury de la LLC. Històric previ es queda facturat a tu; nou a la LLC.

A Exentax muntem el setup complet per a creadors (LLC + EIN + Mercury + W-8BEN-E + AdSense/Twitch/TikTok migration + comptabilitat mensual) en 4-6 setmanes, llest per cobrar el primer payout.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22Per%20a%20un%20creador%20catal%C3%A0%20que%20viu%20d'AdSense%2C%20Twitch%2C%20Patreon%20i%20patrocinis%2C%20l'eq%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ntido? No hay una regla universal, pero si facturas más de 2.500-3.000€ al mes con tu cont…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…No hay una regla universal, pero si facturas más de 2.500-3.000€ al mes con tu contenido, …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…scriptores Supongamos que generas esto al mes: - AdSense: $2,000 - 2 sponsorships: $3,000 …»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">3,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…e generas esto al mes: - AdSense: $2,000 - 2 sponsorships: $3,000 - Merch: $500 - Patreon:…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6,300</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…nsorships: $3,000 - Merch: $500 - Patreon: $800 - **Total: $6,300/mes ($75,600/año)** **Si…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">75,600</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…3,000 - Merch: $500 - Patreon: $800 - **Total: $6,300/mes ($75,600/año)** **Sin LLC (autón…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">35%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…($75,600/año)** **Sin LLC (autónomo en España):** - IRPF ~35% + cuota autónomos = una carg…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…l en EE.UU. (Disregarded Entity) - Impuesto federal EE.UU.: 0% (Single-Member LLC no resid…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">9,500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ber LLC no residente) - Costes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">11,500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…C no residente) - Costes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">16,500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…tes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18,500/año** Ese ahorro…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">18,500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18,500/año** Ese ahorro son do…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…lla sin LLC.** Adsense paga al IBAN español, Twitch retiene 30% sin W-8BEN, sponsors USA p…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…ámara, mic, OBS), promoción (Meta, Google) y subscriptions. 100% deducible para la LLC. Si…»</span> <strong>[NO VERIFICAT]</strong></li>
<li><span class="font-mono">3%</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…para la LLC. Sin recargo de cambio en cada compra (típico 2-3% en tarjetas EUR sobre cargo…»</span> <strong>[NO VERIFICAT]</strong></li>
