...
## Actualització Exentax avui: EIN sense SSN, el camí avui

Obtenir l’EIN sent no resident és tràmit resolt però amb terminis i matisos a fixar:

- **Via oficial avui.** **SS-4 per fax al +1-855-215-1627** (IRS Internacional). Temps típic **4-6 setmanes**, pics fins a 8 al febrer-abril. Online no està disponible sense SSN/ITIN.
- **Document retornat.** L’IRS emet la **CP 575** una sola vegada per correu postal. Si es perd, demana una **147C** trucant a l’IRS Business Line **+1-267-941-1099** (dl-dv 6:00-23:00 ET). Sense CP 575/147C, els bancs rebutgen l'obertura.
- **Casella 10 del SS-4.** "Reason for applying" → marca "Started new business" o "Banking purpose only". El motiu afecta com l’IRS classifica l'entitat i les expectatives de futures declaracions.

### Preguntes freqüents avui

**Necessito ITIN a més de l’EIN?** No per operar la LLC ni per a banca. ITIN només si presentes una declaració personal als EUA (1040-NR) o has de signar un W-8BEN específic.

**Una agència pot tramitar-lo més ràpid?** Les que prometen 24-48 h fan servir SS-4 per telèfon amb tercer autoritzat (Form 8821 o POA). Possible, cost habitual 200-400 USD.

**L’EIN caduca?** No. L’EIN és permanent. El que es perd és el document; el número segueix actiu i es recupera via 147C en qualsevol moment.
<!-- exentax:overhaul-avui-v1 end -->

<!-- exentax:execution-v2 -->
## Com obtenim l'EIN sense SSN a Exentax

La sol·licitud d'EIN sense SSN es fa per fax amb el SS-4, no pel web de l'IRS, i la majoria de rebuigs que veiem cada setmana vénen de tres errors idèntics. El mètode Exentax els neutralitza abans de qualsevol enviament.

- **Responsible Party correcta**: la persona física beneficiària amb adreça residencial (no la de la LLC) i descripció d'activitat coherent amb la resta de l'expedient.
- **SS-4 sense buits** i poder signat perquè tramitem en el teu nom amb fax dedicat i seguiment d'acús.
- **CP-575 arxivat** tan aviat com arriba: aquest document obre comptes bancaris i ningú l'hauria de perdre.

Si vols que tramitem el teu o auditar un ja emès, obre la <strong>calculadora Exentax</strong> o reserva trenta minuts.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22L'EIN%20(Employer%20Identification%20Number)%20%C3%A9s%2C%20per%20a%20la%20teva%20LLC%2C%20l'equivalent%20al%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…cuenta sin tu EIN. - **Declarar impuestos ante el IRS.** El Form 1120 y el Form 5472 requi…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…IN. - **Declarar impuestos ante el IRS.** El Form 1120 y el Form 5472 requieren tu EIN com…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 8821</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…n 24-48 h usan el SS-4 por teléfono con tercero autorizado (Form 8821 o Power of Attorney)…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
