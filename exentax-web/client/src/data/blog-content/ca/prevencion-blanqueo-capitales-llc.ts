...
Depenent del volum i tipus de transaccions, el teu banc pot estar obligat a presentar informes davant <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> (Financial Crimes Enforcement Network). Això no significa que estiguis sota investigació. és un procediment rutinari.
...
A Exentax alineem BOI + registre de titulars reals + Model 720 per a clients catalans. Reserva la teva assessoria gratuïta i posem la teva LLC en compliance als dos costats de l'Atlàntic.
...
Mercury, Wise, Relay, Brex i pràcticament tots els bancs US que obren a no residents operen sota normativa AML/KYC del FinCEN. Entendre quins senyals activen els sistemes AML és la diferència entre tres anys sense incidències i perdre el compte en dues setmanes.

- **El triangle KYC que s'exigeix en obrir.** Identitat del beneficial owner (passaport + utility bill), origen dels fons (contracte/factura/extracte d'activitat real prèvia), i consistència de l'activitat declarada amb la web i els moviments.
- **Cinc red flags que disparen revisió immediata.** Moviments circulars, transferències cap a/des de jurisdiccions d'alt risc (Iran, Corea del Nord, RDC), fragmentació sota llindars (diversos pagaments de 9.500$ per evitar CTR de 10k$), pic d'activitat sense justificació, discrepància declarada vs real.
- **El SAR i per què mai t'avisen.** El banc presenta un Suspicious Activity Report al FinCEN i, per llei, NO POT informar-te (tipping-off és delicte penal). El que veus: compte tancat amb 30 dies per retirar, sense explicació.
- **Com protegir la teva LLC.** Documentació exhaustiva de cada client, bookkeeping mensual real amb conciliació, evitar moure a personal sense concepte clar, mai operar des d'IP de país sancionat.

### El que més ens pregunten

**Rebre cripto a la LLC és problemàtic?** Depèn. Cripto d'exchanges regulades (Coinbase, Kraken) amb KYC documentat és acceptable; de wallets anònimes o mixers és senyal AML immediat.

**Si Mercury em tanca puc obrir Wise?** Normalment sí. Però si van tancar per activitat real, altres també tancaran. Cal corregir la causa.

A Exentax estructurem AML compliance per a LLCs de no residents i mediem quan un banc demana informació.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Vols parlar-ne ara? Truca'ns al <a href="tel:+34614916910">+34 614 916 910</a> o escriu-nos per <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20estic%20llegint%20%22La%20normativa%20antiblanqueig%20espanyola%20(SEPBLAC%2C%20AEAT%2C%20Banc%20d'Espanya)%20s'ha%20end%E2%80%A6%22%20i%20vull%20parlar%20amb%20un%20assessor%20sobre%20el%20meu%20cas.">WhatsApp</a> i et responem avui mateix.</p>
...
<li><span class="font-mono">10,000</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…cuando se realizan transacciones en efectivo superiores a $10,000 en un mismo día. Para la…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">9.500</span> <span class="opacity-70">(xifra)</span> <span class="text-xs italic">— «…t), fragmentación bajo umbrales de reporte (varios pagos de 9.500$ para evitar el CTR de 1…»</span> <strong>[NO VERIFICAT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referència legal)</span> <span class="text-xs italic">— «…bre el &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt; para entender la…»</span> <strong>[REVISIÓN MANUAL — font suggerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
