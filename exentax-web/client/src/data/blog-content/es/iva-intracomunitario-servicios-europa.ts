...
Si eres autónomo o pyme española y tienes clientes empresa en otros países de la UE, el IVA intracomunitario es una de las áreas que más confusión genera. La regla general en servicios B2B es sencilla: facturas sin repercutir IVA y el cliente lo autoliquida en su país. Pero hay matices importantes que distinguen una factura limpia de una rechazada por inspección. Esta guía explica cuándo se aplica realmente la regla, cómo registrarte en el ROI, qué declarar en los modelos 303 y 349 y los errores que cuestan paralelas.

## Servicios B2B: regla general y excepciones

El artículo 69 de la Ley del IVA establece que en servicios B2B intracomunitarios la operación se localiza en sede del destinatario. Es decir: si vendes consultoría a una empresa francesa, la operación tributa en Francia y tú emites la factura sin IVA español. Excepciones relevantes: servicios relacionados con bienes inmuebles (tributan donde está el inmueble), transporte de pasajeros (donde se realiza), restauración y catering (lugar de consumo) y servicios culturales o educativos presenciales (lugar del evento). Conviene revisar cada operación porque la calificación errónea es de los errores más comunes.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22Si%20eres%20aut%C3%B3nomo%20o%20pyme%20espa%C3%B1ola%20y%20tienes%20clientes%20empresa%20en%20otros%20pa%C3%ADses%20de%E2%80%A6%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
