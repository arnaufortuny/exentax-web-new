...
- **Tarjetas y gastos.** Mercury emite tarjetas USD para gastar en software (Adobe, Notion, Final Cut), equipo (cámara, mic, OBS), promoción (Meta, Google) y subscriptions. 100% deducible para la LLC. Sin recargo de cambio en cada compra (típico 2-3% en tarjetas EUR sobre cargos USD). Por eso, en Exentax te llevamos el calendario al día: tú dejas de pensar en plazos y nosotros los cerramos antes de que aprieten.
