...
## Testaferros y prestanombres en una LLC: por qué es ilegal y qué riesgos asumes realmente

Usar a un familiar, amigo o "servicio profesional" como titular formal de tu LLC para que no aparezcas tú es la idea más cara y peligrosa que circula en foros de optimización fiscal. No es estrategia: es delito de blanqueo de capitales en US, en la UE y en LATAM, y la cooperación internacional en este punto es tan profunda que pretender ocultar al beneficial owner real ya no funciona técnicamente. Estos son los riesgos reales que asumes y por qué nunca compensan.

- **Es delito penal, no infracción tributaria.** El Corporate Transparency Act US tipifica falsedad documental en el BOI report con hasta $10.000 de multa civil + 2 años de cárcel federal. La UE (5ª y 6ª Directiva AML) tipifica el ocultamiento del UBO como blanqueo agravado. España: art. 301 CP, hasta 6 años. Diferencia capital: la sanción tributaria es dinero, la penal es cárcel y antecedentes que cierran cuentas bancarias el resto de tu vida.
- **El testaferro tiene incentivos contradictorios contigo.** Hoy es tu primo de confianza, mañana se enfada o se divorcia y la LLC es legalmente suya. Tienes un acuerdo privado que vale cero ante un tribunal US (los registros formales prevalecen). Casos reales: testaferro retira fondos y se va, testaferro hereda y los hijos no devuelven, testaferro cae en problemas legales propios y la LLC se embarga.
- **El sistema te encuentra de tres maneras.** (1) BOI report exige UBO real bajo amenaza penal - si quien firma como UBO es testaferro y se descubre, ambos van a juicio. (2) KYC bancario (Mercury, Wise) pregunta source of funds y patrón de operaciones; si quien firma "no sabe" del negocio, suspenden cuenta y reportan SAR. (3) CRS y FATCA cruzan a tu residencia el dato de la cuenta - si tú operas pero el UBO declarado es otro, salta la inconsistencia.
- **El coste real de "regularizar a posteriori".** Cuando se descubre, no hay regularización amistosa: hay procedimiento penal contra ti y contra el testaferro, congelación de cuentas, embargo de la LLC, denuncia cruzada a tu residencia (España: blanqueo + delito fiscal) y, si hubo flujo significativo, procedimiento penal firme. Recuperar fondos congelados puede llevar años y costar más que el ahorro inicial pretendido.

### Lo que más nos preguntan

**¿Y si pongo a mi pareja como única member y yo opero por su cuenta?** Si tu pareja no aporta capital, no toma decisiones y no recibe distribuciones reales, la estructura es simulación: el UBO real eres tú y debes constar como tal en el BOI. Hacerlo de otra forma es exactamente lo que el CTA prohíbe.

**¿Las "agencias de privacidad" que ofrecen nominee real son legales?** Nominee como manager público (estatal) sí es legal y útil para privacidad frente a competidores. Nominee como UBO en BOI report es delito. La distinción es crítica: lo primero es cosmético público, lo segundo es ocultar al sistema federal y a tu Hacienda.

En Exentax estructuramos privacidad legítima (nominee manager + Wyoming + PO Box virtual) y BOI report con UBO real - porque la privacidad legal funciona, pero la ilegal te destruye.
<!-- /exentax:execution-v2 -->
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Llámanos al <a href="tel:+34614916910">+34 614 916 910</a> o escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22testaferros%20prestanombres%20llc%20ilegal%20riesgos%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
...
<li><span class="font-mono">10.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…US tipifica falsedad documental en el BOI report con hasta $10.000 de multa civil + 2 años…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…o presentas el &lt;a href=&quot;/es/blog/como-operar-llc-dia-a-dia&quot;&gt;Form 5472&lt;/a&gt;, reportas transa…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
