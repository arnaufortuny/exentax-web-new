...
4. **Configura tu infraestructura**: <a href="/es/blog/iban-swift-routing-number-que-son">cuenta bancaria</a>, <a href="/es/blog/pasarelas-pago-llc-stripe-paypal-dodo">pasarela de pagos</a>, contabilidad
...
## La estructura "óptima": tres preguntas honestas antes de elegirla

No hay estructura óptima universal. Lo que es óptimo para un freelance digital con clientes EU residiendo en España es desastroso para un seller Amazon residiendo en LatAm. Antes de proponer LLC, EOOD, UK Ltd o autónomo, hacemos siempre estas tres preguntas - y la respuesta determina la decisión.

- **¿Dónde está tu residencia fiscal real, no la administrativa?** Tu residencia fiscal real se determina por días, centro de intereses vitales y, en caso de doble residencia, por convenio. Si vives en Madrid con tu familia y trabajas remoto, eres residente fiscal español aunque tengas residencia legal en otro país. Esto fija la fiscalidad personal y, frecuentemente, la imputación de TFI/CFC.
- **¿Quiénes son tus clientes y dónde están?** B2B en EU exige IVA inverso o registros locales según servicio; B2C en EU dispara OSS/IOSS; B2B y B2C globales sin concentración EU pueden simplificarse con LLC US sin IVA. La estructura debe alinear con la realidad comercial, no al revés.
- **¿Cuál es tu volumen y previsión a 24 meses?** Bajo 50k EUR anuales, autónomo + tarifa plana suele ser óptimo en España; entre 50-150k, depende del mix de clientes; sobre 150k, las opciones internacionales empiezan a competir con coste-beneficio claro. Cambiar de estructura cada año destruye más valor que el ahorro nominal.

### Tres patrones que vemos repetidamente funcionar
...
**¿Y la estructura "ideal" del influencer fiscal X?** Suele estar diseñada para su caso (residencia, volumen, mix), no para el tuyo. Replicar sin diagnóstico previo es la fuente nº 1 de los retrabajos que vemos en consulta.

**¿Cuándo tiene sentido cambiar de estructura?** Cuando el ahorro neto anual supera por al menos 3x el coste anual de mantenimiento de la nueva estructura, y la transición se puede hacer sin romper continuidad operativa con clientes y banca.

En Exentax hacemos el diagnóstico con tus números reales, descartamos las estructuras que no encajan y te damos un plan de implementación con calendario y costes - no una recomendación genérica.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…ternacionales, clientes en múltiples países y una actividad 100% digital. En este artículo…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…ión máxima**: en España, por ejemplo, puedes pagar entre el 30% y el 47% sobre tus ingreso…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…a**: en España, por ejemplo, puedes pagar entre el 30% y el 47% sobre tus ingresos - **Cuo…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…mericana empieza a tener sentido cuando: - Facturas más de 15.000€/año a clientes internac…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…do neto**: muchos de nuestros clientes pasan de pagar el 35-45% a pagar el 10-20% de forma…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…de nuestros clientes pasan de pagar el 35-45% a pagar el 10-20% de forma completamente leg…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">9%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…jetas para equipo | | **Stripe US** | Cobrar a clientes | 2.9% + $0.30 por transacción | |…»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…ndario IRPF/IVA + 5472 + 720 coordinado. Coste anual all-in 2.500-4.500 EUR, ahorro fiscal…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">4.500</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…IRPF/IVA + 5472 + 720 coordinado. Coste anual all-in 2.500-4.500 EUR, ahorro fiscal típico…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">40%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…Coste anual all-in 2.500-4.500 EUR, ahorro fiscal típico 25-40% vs autónomo puro. - **Sell…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…gún país (atribución directa típica en pass-through). Coste 3.000-5.000 USD anuales, ahorr…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…ís (atribución directa típica en pass-through). Coste 3.000-5.000 USD anuales, ahorro depe…»</span> <strong>[NO VERIFICADO]</strong></li>
