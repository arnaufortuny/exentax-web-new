export default `Vamos a ser directos: si eres autónomo en España y la mayoría de tus ingresos vienen de fuera, clientes en EE.UU., UK, Alemania o cualquier otro país, probablemente estás pagando mucho más de lo necesario. Y no poco.
