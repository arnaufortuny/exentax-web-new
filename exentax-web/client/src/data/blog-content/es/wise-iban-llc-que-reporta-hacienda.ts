...
- **Cruce con tu declaración en residencia.** España: Modelo 720 obliga a declarar cuentas en el extranjero si suma >50.000€ a 31/12 o saldo medio del último trimestre. Tu IBAN BE de Wise cuenta como cuenta extranjera de la LLC y, por atribución (LLC disregarded), es de tu titularidad indirecta. Si Hacienda recibe via CRS que tienes 80k€ ahí y no presentaste 720, salta el procedimiento de imputación. Sanción típica: 50% del saldo no declarado. Y si te llega un requerimiento, en Exentax mantenemos el dossier preparado para que respondas en horas, no en semanas.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22wise%20iban%20llc%20que%20reporta%20hacienda%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
