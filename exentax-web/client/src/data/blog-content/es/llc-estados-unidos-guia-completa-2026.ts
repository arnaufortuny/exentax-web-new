...
- **Form 5472 + 1120 pro forma.** Sigue siendo obligatorio para SMLLC de no residente con cualquier *reportable transaction*. Sanción base **25.000 USD por formulario y año** (IRC §6038A). Ejercicio 2025 → vencimiento **15 de abril actualmente**, extensión vía **Form 7004** hasta el **15 de octubre actualmente**. Aquí entra Exentax: te presentamos el formulario, archivamos el acuse y, si la administración pregunta, ya tienes la respuesta lista.
