...
- **Stack recomendado por modelo.** SaaS B2B global: Stripe + Paddle. Infoproductos B2C UE: Lemon Squeezy o Dodo (MoR cubre IVA digital). Servicios de asesoría: Stripe + Wise/transferencia + PayPal opcional. E-commerce físico US: Stripe + Shop Pay. NUNCA dependas de una sola pasarela: un freeze sin alternativa es el riesgo operativo nº1.
