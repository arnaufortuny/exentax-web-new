...
Si tienes una LLC en Estados Unidos, cada año debes presentar el Form 1120 (junto con el <a href="/es/blog/como-operar-llc-dia-a-dia">Form 5472</a>) antes del 15 de abril. Pero aquí va una noticia que te va a encantar: puedes extender ese plazo 6 meses completos, hasta el 15 de octubre, sin dar explicaciones. Así de fácil.
...
Antes del 15 de abril, nos aseguramos de que tu extensión esté presentada. Después, con calma y sin prisas, preparamos tu Form 1120 y Form 5472 con toda la documentación en orden. Así trabajamos, sin sorpresas ni urgencias de última hora.
...
## Form 7004: cómo se pide la extensión IRS y por qué casi siempre conviene

Form 7004 es la prórroga automática de seis meses para presentar Form 1120 + 5472 (entre otros). Es automática, gratuita y, salvo casos muy excepcionales, parte estándar del calendario fiscal de cualquier LLC unipersonal extranjera. Esto es lo que hace, cómo se pide y por qué la usamos sistemáticamente.

- **Qué cubre y qué no.** Form 7004 prorroga el plazo de presentación seis meses (de 15 abril a 15 octubre típicamente) pero NO prorroga el plazo de pago de cualquier impuesto debido. Para LLC unipersonal extranjera con 5472 + 1120 pro-forma sin actividad gravada en US, no hay impuesto que pagar - la extensión cubre el 100% de la obligación.
- **Cuándo presentarla.** Antes de la fecha original (15 de abril para LLC con ejercicio fiscal natural). Se presenta electrónicamente a través de modernized e-File o por correo certificado a la dirección IRS correspondiente al estado. Sin acuse del e-file o sello postal anterior al 15 de abril, la prórroga no aplica y entras en penalty zone.
- **Penalidades sin prórroga.** Form 5472 no presentado o tarde sin extensión: 25.000 USD por formulario por año. Si te das cuenta el 16 de abril sin haber presentado 7004, el daño ya está hecho - no hay forma de "regularizar hacia atrás" sin disclosure voluntario. La 7004 es la red de seguridad sistemática.
- **Por qué la usamos siempre.** Aunque tengas todo listo en marzo, presentar la 7004 da margen para auditoría interna del 5472, ajuste de cifras tras cierre contable definitivo, y revisión de coherencia con tu 720/IRS Spain Treaty Position si aplica. Cero coste, cero riesgo, máximo margen.

### Lo que más nos preguntan

**¿La extensión despierta atención del IRS?** No. Es absolutamente rutinaria - el IRS recibe millones cada año. Lo que sí dispara atención es presentar 1120 con datos manifiestamente inconsistentes o no presentar 5472 en absoluto.

**¿Y si me olvido también del plazo extendido del 15 de octubre?** Penalty 25.000 USD por 5472 por año, intereses sobre cualquier impuesto debido (raramente aplicable a LLC pass-through sin ECI), y reapertura potencial. La regularización vía Streamlined o disclosure voluntario es posible pero costosa. Mejor no llegar.

En Exentax presentamos la 7004 sistemáticamente cada abril dentro del retainer y aseguramos la 5472 + 1120 pro-forma antes del 15 de octubre con tiempo para revisión cruzada con tu declaración en residencia.
<!-- /exentax:execution-v2 -->
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Llámanos al <a href="tel:+34614916910">+34 614 916 910</a> o escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22extension%20irs%20form%201120%20como%20solicitarla%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
...
<li><span class="font-mono">50%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…estándar en el mundo empresarial estadounidense. **Más del 50% de las declaraciones de imp…»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…da en US, no hay impuesto que pagar - la extensión cubre el 100% de la obligación. - **Cuá…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…enes una LLC en Estados Unidos, cada año debes presentar el Form 1120 (junto con el &lt;a hre…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…(junto con el &lt;a href=&quot;/es/blog/como-operar-llc-dia-a-dia&quot;&gt;Form 5472&lt;/a&gt;) antes del 15 de …»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 7004</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…ctubre, sin dar explicaciones. Así de fácil. ¿Cómo? Con el Form 7004. Y en Exentax lo pres…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
