...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Llámanos al <a href="tel:+34614916910">+34 614 916 910</a> o escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22que%20pasa%20si%20no%20presentas%205472%20multas%20irs%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
...
<li><span class="font-mono">25.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…&gt;IRS&lt;/a&gt; rara vez perdona ese olvido: la sanción base son **25.000 USD** por formulario no…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…sustancialmente incompleta**. Hasta 2018 la sanción era de 10.000 USD; desde entonces la c…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">75.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…resentar el 5472, son tres formularios. Tres por 25.000 = **75.000 USD** antes incluso de …»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.603</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…tructura formal y referencias a IRM 20.1.9 y al regulation §1.6038A-4, marca la diferencia…»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">500.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…a LLC: una LLC con $0 de revenue paga lo mismo que una con $500.000. - **Cómo se entera el…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">80%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…Probabilidad de éxito en first-time + reasonable cause: 60-80%. ### Lo que más nos pregunt…»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…uien está caminando hacia un problema de cinco cifras: el **Form 5472**. No es un impuesto…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…* antes incluso de entrar en intereses. 3. **Cascada con el Form 1120.** Recuerda que tu L…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1099</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…y el tipo de cliente, pueden generar reporting de terceros (Form 1099, retenciones, FATCA …»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
