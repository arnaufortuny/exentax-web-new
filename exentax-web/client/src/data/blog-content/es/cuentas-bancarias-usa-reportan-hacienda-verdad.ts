...
- **EE. UU. no participa en CRS.** Es el único G20 que no firmó el Common Reporting Standard. La consecuencia práctica: Mercury, Relay, Choice Financial, Evolve y Column N.A. no tienen obligación de enviar saldos automáticamente al país de residencia del titular. No es un truco, es la arquitectura del sistema desde 2014.
...
<li><span class="font-mono">100 %</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…rta CRS. No recibe CRS.** Cualquier institución financiera 100 % estadounidense, abriendo …»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…ligación declarativa propia (Modelo 720 si saldo combinado &gt;50.000 €). La asimetría CRS no…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">25 %</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…ovimientos diarios, beneficiarios indirectos por debajo del 25 % de control, contraparte d…»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…, tu vida personal es tu vida personal. - El compliance US (Form 5472, BOI, mantenimiento …»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…un cliente Exentax que tiene su LLC bien estructurada. ### DAC7 y DAC8: directivas europea…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…ente Exentax que tiene su LLC bien estructurada. ### DAC7 y DAC8: directivas europeas, no …»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
