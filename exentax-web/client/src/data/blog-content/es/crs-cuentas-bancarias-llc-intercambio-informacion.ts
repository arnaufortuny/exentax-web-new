...
Cierro con una lectura relacionada que encaja con el hilo de este artículo: <a href="/es/blog/estructura-fiscal-optima-freelancer-internacional">La estructura fiscal óptima para freelancers internacionales actualmente</a> es una pieza útil para terminar de contextualizar el escenario.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Llámanos al <a href="tel:+34614916910">+34 614 916 910</a> o escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22crs%20cuentas%20bancarias%20llc%20intercambio%20informacion%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…odelo 720 requiere reportar cuentas con saldos superiores a 50.000€. **4. Información de t…»</span> <strong>[NO VERIFICADO]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…que trabaja como autónomo en España puede estar pagando un 45% efectivo entre IRPF y cuota…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…reportar cuentas financieras en el extranjero que superen $10,000 en cualquier momento del…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 114</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…//www.fincen.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;FinCEN&lt;/a&gt; Form 114) te obliga a reportar…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
