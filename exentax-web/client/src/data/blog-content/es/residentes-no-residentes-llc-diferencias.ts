export default `No es lo mismo tener una LLC siendo residente de Estados Unidos que siendo no residente. La estructura legal es la misma, pero la **fiscalidad y las obligaciones** cambian radicalmente.
