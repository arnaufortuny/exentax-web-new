export default `Constituir una LLC es solo el primer paso. Para que tu empresa siga activa, en regla y con el Good Standing intacto, hay obligaciones anuales que debes cumplir. La buena noticia: en Exentax nos encargamos de absolutamente todo como parte del plan de mantenimiento anual. Tú te dedicas a tu negocio y nosotros al compliance.
