...
- **Revolut Technologies Inc.** (Estados Unidos): entidad estadounidense del grupo bajo la cual se ofrece **Revolut Business a clientes con LLC estadounidense**, con **Lead Bank** como banco partner. Lead Bank es un banco con licencia federal de EE. UU. y, como tal, queda **fuera del CRS** (EE. UU. no es jurisdicción participante); el reporting que aplica es FATCA, no CRS.
- Filiales en Singapur, Australia y otros mercados con sus propios reguladores.
