...
Constituir un holding solo por moda añade contabilidad, declaraciones, costes y exposición a inspección, sin contrapartida.
...
- Las filiales tributan por sociedades al 25%<!-- [REVISIÓN MANUAL: cifra "25%" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> sobre sus beneficios.
- Cuando las filiales reparten dividendos al holding, opera la **exención por doble imposición interna del 95%<!-- [REVISIÓN MANUAL: cifra "5%" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --><!-- [REVISIÓN MANUAL: cifra "95%" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] -->** (artículo 21 LIS), siempre que el holding posea ≥5% de la filial y ≥1 año de antigüedad.
- El holding puede reinvertir esos dividendos sin tributar nuevamente.
- Si finalmente el holding distribuye dividendos a los socios personas físicas, esos dividendos tributan en el IRPF del ahorro (19-28%<!-- [REVISIÓN MANUAL: cifra "28%" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> según tramo).
...
- Constitución: 500-3.000<!-- [REVISIÓN MANUAL: cifra "3.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR según jurisdicción.
- Domicilio social y secretaría: 500-2.000<!-- [REVISIÓN MANUAL: cifra "2.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR/año.
- Contabilidad y cuentas anuales: 1.500<!-- [REVISIÓN MANUAL: cifra "1.500" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] -->-5.000<!-- [REVISIÓN MANUAL: cifra "5.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR/año.
- Auditoría si supera umbrales: 3.000-10.000<!-- [REVISIÓN MANUAL: cifra "10.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR/año.
- Asesoría fiscal especializada: 2.000-8.000<!-- [REVISIÓN MANUAL: cifra "8.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR/año.

Suelo realista anual: 4.000<!-- [REVISIÓN MANUAL: cifra "4.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] -->-12.000<!-- [REVISIÓN MANUAL: cifra "12.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR para un holding internacional bien gestionado. El holding solo se justifica si el ahorro fiscal o el control adicional supera con margen ese coste.
...
- **Mezclar patrimonio personal y holding**: rompe el blindaje y complica auditorías.
...
**Caso 1: empresa familiar con beneficios anuales de 300.000<!-- [REVISIÓN MANUAL: cifra "300.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR.**
Holding clásica protege patrimonio acumulado, permite reinvertir en bienes raíces o filiales sin pagar IRPF intermedio y profesionaliza la sucesión. Ahorro real estimado: 25-40%<!-- [REVISIÓN MANUAL: cifra "40%" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> del impacto fiscal sin holding a largo plazo.

**Caso 2: emprendedor con SaaS en crecimiento de 100.000<!-- [REVISIÓN MANUAL: cifra "100.000" — verificar contra https://sede.agenciatributaria.gob.es — fecha: 2026-04-21] --> EUR/año.**
Holding aún no compensa. Los costes adicionales (asesoría, contabilidad doble, registros mercantiles) superan al beneficio fiscal. Mejor consolidar la operativa primero y replantear cuando supere 200.000<!-- [REVISIÓN MANUAL: cifra "200.000" — verificar contra fuente oficial vigente (revisión editorial) — fecha: 2026-04-21] --> EUR.
...
- **Modelos informativos.** Cuentas bancarias en EE. UU. con saldo medio o final >50.000<!-- [REVISIÓN MANUAL: cifra "50.000" — verificar contra https://sede.agenciatributaria.gob.es — fecha: 2026-04-21] --> € en el ejercicio: **Modelo 720** (Ley 5/2022 tras STJUE C-788/19, 27/01/2022; sanciones ahora dentro del régimen general LGT). Operaciones vinculadas con la LLC y dividendos repatriados: **Modelo 232**. Criptoactivos custodiados en EE. UU.: **Modelo 721**.
...
- **Estados Unidos.** Delaware General Corporation Law y Limited Liability Company Act, Wyoming Limited Liability Company Act (Title 17, Chapter 29), instrucciones <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> del Form 5472 e IRC §7701<!-- [REVISIÓN MANUAL: ref legal "IRC §7701" — verificar contra https://www.irs.gov — fecha: 2026-04-21] --> (clasificación de entidades).
- **Andorra.** Llei 95/2010 de l'Impost sobre Societats (IS al 10 %<!-- [REVISIÓN MANUAL: cifra "10 %" — verificar contra https://sede.agenciatributaria.gob.es — fecha: 2026-04-21] -->), Llei 5/2014 del IRPF y régimen de residencias activa/pasiva del Govern d'Andorra; informes anuales del Departament de Tributs i de Fronteres.
- **Estonia.** Income Tax Act estonio (sistema de impuesto diferido sobre beneficios distribuidos al 20/22 %<!-- [REVISIÓN MANUAL: cifra "22 %" — verificar contra https://sede.agenciatributaria.gob.es — fecha: 2026-04-21] -->) y documentación oficial del programa e-Residency.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22holding%20empresarial%20como%20funciona%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>

Si tu plan es montar la LLC en Wyoming, repasa nuestra página de servicio <a href="/es/servicios/llc-wyoming">LLC en Wyoming</a> con costes, plazos y siguientes pasos concretos.
