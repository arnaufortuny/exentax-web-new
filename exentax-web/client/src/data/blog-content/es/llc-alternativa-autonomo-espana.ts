...
Esto **no significa** que sean cuentas opacas ni que puedas dejar de declararlas. Si superas los umbrales del **modelo 720/721** (50.000 € en cuentas en el extranjero, criptos, etc.), debes declararlas igual. Y si recibes ingresos a través de tu LLC, debes incluirlos en tu IRPF. Lo que sí significa es que no hay un cruce automático de datos: la información llega a Hacienda **a través de ti**, vía tu propia declaración, no vía un fichero del banco. Esto te obliga a llevarlo todo limpio y bien documentado: cualquier intento de "olvidarse" termina mal en una inspección. Es el momento de pedir ayuda. En Exentax abrimos el caso, presentamos lo pendiente y respondemos por ti al organismo correspondiente.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22Si%20eres%20aut%C3%B3nomo%20en%20Espa%C3%B1a%20y%20tu%20trabajo%20se%20puede%20hacer%20desde%20un%20port%C3%A1til%2C%20lo%20%E2%80%A6%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
