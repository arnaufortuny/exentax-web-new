...
- **Conservación de la contabilidad** (facturas emitidas y recibidas, extractos bancarios, comprobantes) durante al menos **siete años**. Es el plazo razonable para cubrir auditorías, intereses y posibles requerimientos. Tranquilo: en Exentax esto es trabajo de cada semana, lo gestionamos antes de que la carta llegue a tu buzón.
...
- **Paso 5 - BOI Final Report.** FinCEN exige reporte final de BOI al cesar la entidad, dentro de los 30 días tras la disolución estatal. Sin esto, sanciones civiles posibles. Es el momento de pedir ayuda. En Exentax abrimos el caso, presentamos lo pendiente y respondemos por ti al organismo correspondiente.
