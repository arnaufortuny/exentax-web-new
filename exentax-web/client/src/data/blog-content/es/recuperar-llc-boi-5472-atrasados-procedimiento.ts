...
El primer paso, antes de mover nada, es saber exactamente qué falta. La pregunta tiene tres dimensiones:

1. **Forms 5472 + 1120 pro-forma**: ¿qué ejercicios no se presentaron? ¿Hubo en cada uno de esos ejercicios al menos una reportable transaction? Si la respuesta a la segunda es "no", técnicamente no hay obligación.
2. **BOI Report**: ¿se presentó alguna vez ante FinCEN? ¿Hay actualizaciones pendientes (cambios de dirección, documento de identidad, beneficiarios)?
3. **Annual Report estatal y Registered Agent**: ¿está la LLC al corriente con el estado, o también hay deuda ahí?

Sin este diagnóstico claro, cualquier acción posterior es ruido.
## Procedimientos disponibles para regularizar

### Para el Form 5472 atrasado
...
La elección entre uno y otro depende del perfil concreto. Para la mayoría de SMLLCs de no residentes, la vía Delinquent es la habitual.
...
Cada estado tiene su procedimiento de **reinstatement**: pago de los Annual Reports atrasados, sus penalty fees y, en algunos casos, una cuota de reinstatement. Coste típico: 200-1.500 USD según estado y antigüedad del impago.
### Orden de presentación correcto

El orden importa porque algunos pasos dependen de otros:

1. **Reinstatement estatal primero**, si la LLC está en estado disuelto o delinquent. Sin LLC activa, el resto carece de sentido legal.
2. **BOI Report segundo**, si está pendiente. Es rápido, gratuito y cierra esa puerta.
3. **Forms 5472 + 1120 pro-forma**: presentar todos los ejercicios atrasados de golpe, en un mismo paquete, con la reasonable cause statement adjunta.
4. **Coordinación con tu Hacienda local**, si los ejercicios atrasados también afectaban a la imputación de ingresos en tu país de residencia. Casi siempre conviene regularizar también allí, en paralelo o inmediatamente después.
### Qué incluir en una reasonable cause statement seria

Una reasonable cause que el IRS toma en serio incluye:

- Hechos concretos y cronológicos: cuándo se constituyó la LLC, cuándo se descubrió la obligación, qué se hizo al descubrirlo.
- Causa específica del incumplimiento: ausencia de información del proveedor original, asesoramiento equivocado, circunstancia personal verificable.
- Acción correctiva inmediata: el propio acto de presentar voluntariamente forma parte de la cause.
- Compromiso de cumplimiento futuro: contratación de proveedor profesional, calendario anual establecido.

Las cause statements genéricas, sin hechos verificables, fallan. Las que cuentan una historia específica y plausible suelen prosperar.
### Qué esperar después de presentar

El IRS responde a estos paquetes en plazos variables: típicamente 4-9 meses. Las posibles respuestas son:
...
- **Presentar los formularios sin reasonable cause statement**. Activa el cálculo automático de sanciones sin contexto que las justifique.
- **Presentar parcialmente**: solo el último año, dejando los anteriores. Llama la atención precisamente sobre lo que falta.
- **Cerrar la LLC para "borrar el rastro"**. La obligación se mantiene; cerrar antes de regularizar es la peor de las combinaciones.
- **Esperar "a ver qué pasa"**. Cada mes que pasa, la posición negociadora empeora.
### Cómo lo gestionamos en Exentax

Recibimos cada mes a clientes con BOI o 5472 atrasados, desde un único ejercicio hasta cinco o seis. El procedimiento es siempre el mismo: diagnóstico ordenado, paquete de regularización con reasonable cause sólida, coordinación con tu asesor local si procede, y cierre del expediente sin sobresaltos.

Si llevas tiempo con esta deuda en la cabeza, agenda una sesión inicial gratuita en nuestra página de agendamiento. En 30 minutos te decimos qué procede en tu caso y qué coste real cabe esperar.
...
- [Qué pasa si no presentas el Form 5472: multas del IRS y cómo regularizar](/es/blog/que-pasa-si-no-presentas-5472-multas-irs)
...
## Actualización Exentax hoy: recuperación al día

El procedimiento de regularización de 5472 y BOI atrasados ha cambiado en aspectos pequeños pero importantes durante recent years:

- **5472 fuera de plazo.** La sanción inicial sigue en **25.000 USD por formulario y año** (IRC §6038A) con incremento de 25.000 USD por cada periodo de 30 días tras notificación del IRS. La vía habitual es presentar el 5472 + 1120 pro forma con **carta de** *reasonable cause* anexa, citando hechos concretos: pandemia, cambio de asesor, cambio de residencia, error administrativo documentado. La práctica IRS de 2024-hoy ha aceptado *reasonable cause* en porcentajes razonables cuando la cronología es coherente y la regularización es voluntaria, no forzada.
- **BOI atrasado.** Tras la *interim final rule* de marzo 2025, sólo las **foreign reporting companies** quedan en ámbito. Si tu LLC está obligada y presentas tarde, multa civil de **591 USD/día** (importe ajustado por inflación, fuente FinCEN). La presentación voluntaria antes de notificación reduce significativamente el riesgo penal.
- **Forma de presentación hoy.** El IRS sigue exigiendo el 5472 en **papel** o vía e-file específico (no se admite por TurboTax/asesor general). Conviene enviarlo por correo certificado a Ogden, Utah con acuse de recibo y conservar el tracking 7 años.

### Orden recomendado para regularizar

1. Reúne extractos bancarios de los años pendientes y reconstruye las *reportable transactions* (capital aportado, retiros, pagos a relacionados).
2. Prepara 1120 pro forma + 5472 por cada año en orden cronológico ascendente.
3. Adjunta carta de *reasonable cause* única y firmada por el dueño.
4. Si aplica, presenta BOI atrasado en [el portal oficial de FinCEN para el BOI](https://boiefiling.fincen.gov) el mismo mes.

### Preguntas frecuentes hoy

**¿Cuánto tarda el IRS en responder?** Entre 4 y 10 meses. Hasta entonces no asumas que la *reasonable cause* fue aceptada.

**¿Conviene regularizar antes de cerrar la LLC?** Sí. Cerrar con 5472 pendientes deja la deuda viva contra el dueño persona física.

**¿Necesito ITIN para regularizar?** No. La 1120 pro forma admite "Foreign US" como TIN del dueño cuando no hay ITIN/SSN.
<!-- exentax:overhaul-hoy-v1 end -->

<!-- exentax:execution-v2 -->
## Cómo recuperamos una LLC con BOI y 5472 atrasados en Exentax

Cuando llegan BOI o 5472 con uno o varios años atrasados, la prioridad no es presentar deprisa: es elegir la vía correcta para minimizar penalty. El método Exentax descarta la regularización ciega y aplica la pista que mejor proteja al cliente.

- **Voluntary disclosure** cuando aún no hay notificación del IRS o FinCEN: minimiza penalties al máximo si se hace antes de que abran procedimiento.
- **Streamlined-equivalent** para el non-filer no doloso: documentar la causa, regularizar todo en bloque y abrir la ventana de reasonable cause.
- **Defensa documental**: reconstruir transacciones reportables, conciliar banking y archivar trazabilidad antes de mover ficha.

Si tu LLC tiene años pendientes y quieres saber qué vía corresponde, lanza la <strong>calculadora Exentax</strong> o reserva treinta minutos.
<!-- /exentax:execution-v2 -->
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Llámanos al <a href="tel:+34614916910">+34 614 916 910</a> o escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22recuperar%20llc%20boi%205472%20atrasados%20procedimiento%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
...
<li><span class="font-mono">25.000</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…Las sanciones nominales asustan. Form 5472 no presentado: 25.000 USD por formulario y año.…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(cifra)</span> <span class="text-xs italic">— «…lgunos casos, una cuota de reinstatement. Coste típico: 200-1.500 USD según estado y antig…»</span> <strong>[NO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…en tu país de residencia. Las sanciones nominales asustan. Form 5472 no presentado: 25.000…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
