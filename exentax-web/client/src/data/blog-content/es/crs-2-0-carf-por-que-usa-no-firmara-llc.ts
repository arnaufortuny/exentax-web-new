...
- **Ya tiene FATCA y no necesita el CRS.** El **Foreign Account Tax Compliance Act** se aprobó como parte del HIRE Act y obliga a las instituciones financieras extranjeras a identificar y reportar al IRS cuentas de **US persons** (ciudadanos, residentes fiscales y entidades estadounidenses). Es un régimen **bilateral** articulado mediante **Intergovernmental Agreements (IGAs)** Modelo 1 (intercambio recíproco a través del fisco local) y Modelo 2 (reporte directo de la institución financiera al IRS). La reciprocidad real, sin embargo, es muy limitada: en la práctica, el IRS recibe de los bancos extranjeros muchísima más información de la que devuelve a las autoridades extranjeras sobre cuentas de no residentes en EE. UU. Adoptar CRS supondría aceptar reciprocidad multilateral plena, que es justo lo que el Congreso ha bloqueado durante toda la última década, sin distinción de mayoría política.
...
<!-- exentax:cta-v1 -->
Reserva una consulta gratuita sin compromiso: revisamos tu caso real, identificamos la exposición a CRS 2.0 y CARF y te decimos qué tiene sentido. <a href="/es/agendar">Agendar consulta gratuita</a>.
<!-- /exentax:cta-v1 -->
