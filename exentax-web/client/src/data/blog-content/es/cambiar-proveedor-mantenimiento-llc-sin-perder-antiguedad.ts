...
Si tu LLC sigue en el ámbito vigente del BOI Report (tras la interim final rule de FinCEN de marzo de 2025, el BOI sólo aplica a "foreign reporting companies": entidades constituidas fuera de EE. UU. y registradas en un estado; verifica en FinCEN.gov) y el cambio de proveedor implica cambio de dirección de notificaciones o de algún beneficiario reportado, hay 30 días para actualizar el reporte ante FinCEN. El trámite es online y gratuito. Si tu LLC se constituyó en EE. UU. queda hoy fuera de la obligación.
...
<li><span class="font-mono">Form 8822</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…figura como dirección de la LLC ante el IRS, presenta un **Form 8822-B** para actualizarla…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
