...
Antes de explicar cómo se hace, conviene fijar lo que se queda intacto. Cambiar de proveedor de servicios de mantenimiento **no toca**:

- **La LLC en sí.** Sigue siendo la misma persona jurídica registrada en el mismo estado, con el mismo nombre y la misma fecha de constitución. Tu antigüedad sigue ahí.
- **El EIN.** El número fiscal asignado por el IRS no se cambia salvo en transformaciones muy concretas (cambio de tipo de entidad, fusión, etc.).
- **Los Articles of Organization.** El documento fundacional permanece tal cual.
- **El historial bancario.** Mercury, Wise, Relay y similares no requieren ninguna acción salvo si tu Registered Agent o dirección figuran en el perfil.
- **El historial fiscal.** Las declaraciones presentadas ante el IRS y FinCEN siguen siendo válidas y constan a tu nombre.
### Lo que SÍ cambia

Lo que efectivamente se modifica son tres cosas, todas operativas:

1. **El Registered Agent**, si tu nuevo proveedor te ofrece RA distinto del actual.
2. **La dirección de notificaciones**, si la del proveedor anterior figuraba como mailing address en el estado o en el IRS.
3. **El responsable de presentar formularios** del próximo ciclo: 5472, BOI, Annual Report, etc.

Nada de esto afecta a la entidad: son cambios de proveedor de servicios, no cambios de naturaleza jurídica.
## Procedimiento real, paso a paso

### Paso 1. Diagnóstico de qué está atado al proveedor actual

Antes de tocar nada, identifica qué partes están en manos del proveedor actual:

- ¿Es él quien figura como Registered Agent ante el estado?
- ¿Su dirección figura como mailing address en la EIN Confirmation Letter o en el perfil del IRS?
- ¿Tiene acceso a tus credenciales del Secretary of State, FinCEN o IRS?
- ¿Tiene copia de tu Operating Agreement, Articles, EIN letter y BOI confirmation?

Documentar esto en una hoja antes de iniciar el cambio evita sorpresas.

### Paso 2. Recuperar tus documentos

Antes de comunicar el cambio, asegúrate de tener en tu poder:

- Articles of Organization
- EIN Confirmation Letter (CP 575) o 147C
- Operating Agreement firmado
- BOI Report confirmation
- Última Annual Report o Franchise Tax presentada
- Copia de los últimos Forms 5472 + 1120 pro-forma presentados

Si el proveedor actual no quiere entregártelos, tienes derecho legal a obtenerlos. Insiste. Si bloquea, hay vías administrativas (solicitudes directas al IRS para 147C, al estado para certificate of good standing, a FinCEN para la confirmación BOI).

### Paso 3. Designar el nuevo Registered Agent

El cambio de RA se hace presentando un **Statement of Change of Registered Agent** (o equivalente según el estado) ante el Secretary of State. Es un trámite estándar, suele costar entre 10 y 50 USD, y se procesa en días.

El nuevo RA debe haberte aceptado formalmente como cliente antes de presentar el cambio. La fecha efectiva es la de presentación; desde ese momento, el correo legal va al nuevo RA.

### Paso 4. Actualizar la mailing address del IRS si procede

Si la dirección del proveedor anterior figura como dirección de la LLC ante el IRS, presenta un **Form 8822-B** para actualizarla a la nueva (la del nuevo proveedor o, si prefieres, la tuya). Es un formulario sencillo de una hoja.

### Paso 5. Actualizar el BOI Report si cambia algo

Tras la **interim final rule de FinCEN de marzo de 2025**, el **BOI Report NO aplica a las LLC formadas en EE. UU. propiedad de no residentes** ante FinCEN: solo presentan las **foreign reporting companies** (entidades constituidas fuera de EE. UU. y registradas para operar en un estado). Si tu entidad encaja en ese supuesto y el cambio de proveedor implica cambio de dirección de notificaciones, de documento de identidad o de cualquier dato de algún beneficiario reportado (titulares con ≥ 25 % o control sustancial), tienes **30 días** desde el cambio para actualizar el BOIR en **boiefiling.fincen.gov**. El trámite es online, gratuito y se completa en **10-15 minutos**. Mantén el **BOIR Confirmation Number** de cada presentación en tu archivo legal. La sanción civil por no actualizar llega a **591 USD/día** y la penal hasta **10.000 USD y 2 años de prisión** (31 U.S.C. §5336). Si no estás en ámbito, monitorizamos FinCEN.gov por ti. En Exentax hemos cerrado a sanción cero clientes que llegaron justo así. Hablar pronto vale oro y te ahorra cinco cifras.

### Paso 6. Comunicar a banca y plataformas (sólo si procede)

Mercury, Wise, Relay y similares no necesitan saber nada del cambio de RA salvo que tu dirección registrada de la LLC haya cambiado. En ese caso, actualízala en cada plataforma para evitar incoherencias en sus revisiones de KYC.

### Paso 7. Cierre limpio con el proveedor anterior

Confirma por escrito la fecha de fin de servicio, solicita la devolución proporcional si procede, y guarda el correo. Esto cierra el ciclo y evita que aparezcan "cargos automáticos" del año siguiente.
### Cuánto tarda y cuánto cuesta

Un cambio de proveedor bien ejecutado se completa en **2-4 semanas** y cuesta:

- Statement of Change of RA: 10-50 USD según estado
- Form 8822-B: gratis
- Actualización BOI: gratis
- Honorarios del nuevo proveedor: según paquete contratado

No hay sanción, no hay reinicio, no hay nada que se "pierda". Lo único que se pierde es la inercia con el proveedor que ya no te servía. Aquí entra Exentax: te presentamos el formulario, archivamos el acuse y, si la administración pregunta, ya tienes la respuesta lista.
### Cuándo NO cambiar (todavía)

Hay dos momentos en los que conviene esperar:

- **A pocas semanas del cierre fiscal**, si el proveedor actual ya está preparando tu 5472 del ejercicio. Termina ese ciclo y cambia después.
- **Con BOI o 5472 atrasados pendientes**, si el proveedor actual está gestionando la regularización. Acaba ese expediente antes de mover nada.

En cualquier otro escenario, esperar "por si acaso" cuesta dinero y no aporta seguridad.
### Cómo lo hacemos en Exentax

En Exentax recibimos cada mes a clientes que cambian desde otros proveedores. El proceso es exactamente el descrito arriba. Nos hacemos cargo del cambio de RA, del 8822-B, de la actualización del BOI si procede, y empezamos a operar el ciclo siguiente sin que pierdas un día de cobertura.

Si llevas tiempo pensando que tu proveedor actual no responde a la altura y quieres ver si encajamos, agenda una sesión inicial gratuita en nuestra página de agendamiento. Te decimos con honestidad si conviene cambiar ahora, esperar al cierre o no cambiar.
...
## La verdad operativa sobre cambiar de proveedor de mantenimiento

La antigüedad de una LLC vive en el estado de constitución y en los registros del IRS, no en el panel de tu proveedor actual. Cambiar de proveedor es un trámite administrativo, no una refundación. La confusión nace porque algunos proveedores presentan el cambio como traumático para retener al cliente. Estas son las cinco piezas que importan, en orden.

- **Registered agent.** Es el único elemento legalmente vinculante en el estado. Se cambia con un formulario corto al Secretary of State (en Wyoming, New Mexico o Delaware: alrededor de 10-25 USD). El cambio surte efecto inmediato y no afecta a la fecha de constitución.
- **Annual report y franchise tax.** Los plazos los marca el estado, no el proveedor. Si tu proveedor anterior dejaba pasar la fecha, el problema era operativo, no estructural. Tras el cambio, el nuevo proveedor (o tú directamente) se encarga del próximo annual report con la misma fecha de vencimiento.
- **EIN y registros del IRS.** El EIN es permanente y va asociado a la LLC, no al proveedor. Lo único que cambia es el "responsible party" si tú asumes ese rol; se notifica con Form 8822-B, sin coste y sin reinicio de nada.
- **Cuenta bancaria y dirección comercial.** Si la dirección del proveedor figuraba en Mercury, hay que actualizarla con la nueva dirección comercial (o domicilio personal si así lo decides). Mercury aplica esta actualización en 24-48 horas con un comprobante simple.
- **5472 y BOI.** El cambio de proveedor no genera obligación adicional de Form 5472, pero conviene incluir el cambio de dirección/responsible party en el próximo BOI report a FinCEN dentro del plazo de 30 días previsto por la regla.

### Lo que más nos preguntan

**¿Pierdo historial bancario o de credit profile si cambio?** No. Mercury no se entera del cambio salvo en lo relativo a dirección. El historial transaccional sigue intacto y la antigüedad de la cuenta se mantiene.

**¿El IRS marca la LLC como sospechosa por cambio de agent?** No. Los cambios de registered agent son rutinarios y se procesan miles cada semana en cada estado. Lo que sí marca como sospechosa una LLC es no presentar el 5472 o tener años de annual report sin pagar - ambas cosas independientes del cambio de proveedor.

En Exentax recibimos LLCs cada semana con cambio de proveedor y dejamos en marcha agent, dirección, calendario y notificación BOI sin que el cliente tenga que escribir un solo correo.
<!-- /exentax:execution-v2 -->
