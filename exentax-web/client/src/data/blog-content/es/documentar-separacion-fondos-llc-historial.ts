...
1. **Distribución al miembro** (owner draw): dinero que sale de la LLC al miembro.
2. **Aportación de capital** (capital contribution): dinero que entra a la LLC desde el miembro.
3. **Reembolso de gasto pagado por el miembro en nombre de la LLC**: gastos que el miembro adelantó y que la LLC reembolsa.
4. **Pago a un proveedor real con error operativo**: pago que se hizo desde la cuenta equivocada y se documenta como tal.
...
Imagina un auditor del <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>, un abogado defendiendo a la LLC en un litigio o un compliance officer de Mercury revisando la cuenta. ¿Qué ve?
...
- **Documentación viva, no archivo muerto.** Carpeta compartida con Operating Agreement firmado, actas anuales, expense reports, contratos de servicios intra-grupo. Es lo primero que pide un banco en KYC reforzado y lo primero que solicita una inspección.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">¿Necesitas hablarlo ya? Llámanos al <a href="tel:+34614916910">+34 614 916 910</a> o escríbenos por <a href="https://wa.me/34614916910?text=Hola%20Exentax%2C%20vengo%20del%20art%C3%ADculo%20%22documentar%20separacion%20fondos%20llc%20historial%22%20y%20quiero%20hablar%20con%20un%20asesor%20sobre%20mi%20caso.">WhatsApp</a> y te respondemos hoy mismo.</p>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referencia legal)</span> <span class="text-xs italic">— «…nte, una mezcla histórica complica: - La preparación del **Form 5472**, que requiere docum…»</span> <strong>[REVISIÓN MANUAL — fuente sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
