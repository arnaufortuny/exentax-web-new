...
> Se o seu stack actual é Wise Business + Relay + Slash com Mercury de apoio, é exactamente a ordem inversa de encerramento: primeiro gateways, depois fintechs secundárias, e por fim a conta principal por onde passa o último cash. Wallester com IBAN europeu costuma ser dos últimos a fechar e deve rever-se à luz das suas obrigações CRS em Espanha.
...
Se quer encerrar a sua LLC com segurança, peça uma consulta gratuita: revemos a sua situação, dizemos honestamente se faz mais sentido encerrar ou pausar, e se avançarmos entregamos plano com datas e preço fechado. Se ao contrário pensa que a LLC continua a fazer sentido mas quer baixar custos e obrigações, experimente antes a nossa <strong>calculadora fiscal</strong> e compare a situação actual com o cenário de a manter activa com o stack adequado: <a href="/pt/blog/wise-bancos-e-llc-a-stack-bancaria-completa-que-ninguem">Wise Business, Relay e Slash como contas operacionais, Mercury como apoio, e Wallester apenas quando aplicar IBAN europeu</a> com a respectiva análise CRS.
...
<li><span class="font-mono">25.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…si la LLC tiene dueño extranjero único, con la **sanción de 25.000 USD por formulario no p…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…. - **Registered Agent fees** anuales (50-150 USD/año). - **Form 5472 + 1120 pro forma** a…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…pago. 4. Presentación de declaraciones finales ante el IRS (Form 1120 + 5472 marcados *Fin…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1065</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…incluir la **distribución final** del cash al miembro. - **Form 1065 (Final)** si tu LLC e…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 966</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…-S (Final)** si elegiste tributar como C-corp o S-corp. - **Form 966 (Corporate Dissolutio…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 941</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…ón de disolución, si la LLC tributaba como corporación. - **Form 941 / 940 final** si tení…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 568</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…anchise tax mínimo del año del cierre** además de presentar Form 568 final. - **Otros esta…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
