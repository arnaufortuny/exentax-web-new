...
## Porquê fazer esta auditoria agora

Uma LLC bem gerida no primeiro ano tende a continuar bem gerida. Uma LLC que arrasta erros acumula-os com juros: sanções que crescem mês a mês, formulários que ficam mais caros de regularizar, banca que se torna mais difícil de manter quando começam as revisões de KYC.

A auditoria rápida tem um objectivo concreto: converter o difuso ("acho que está tudo bem") em algo verificável. Se depois detectas dois ou três pontos vermelhos, o plano de acção é muito mais barato do que descobri-los numa inspecção.
## Os 12 pontos

### 1. Estado legal da LLC

Entra no site do Secretary of State do estado de constituição e procura a tua LLC pelo nome. Deve aparecer como **Active**, **In Good Standing** ou equivalente. Se aparece **Delinquent**, **Forfeited** ou **Dissolved**, tens um problema crítico que se resolve com reinstatement antes de qualquer outra coisa.

### 2. Registered Agent vigente

Pagaste a renovação do Registered Agent este ano? A morada que figura no estado é a actual? Um RA caducado deriva em correio perdido do <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> ou do FinCEN, e isso deriva em sanções que chegam sem aviso.

### 3. Annual Report ou Franchise Tax apresentado

Wyoming pede Annual Report no mês de aniversário. Delaware pede Franchise Tax a 1 de Junho. New Mexico não pede nada anual. Seja qual for o estado, garante que sabes o que te corresponde e verifica que o último ciclo foi apresentado.

### 4. EIN intacto e em teu nome

Confirma que ainda tens a **EIN Confirmation Letter (CP 575)** ou, em substituição, a **147C**. Se a perdeste, liga ao IRS e pede-a: serve para abrir contas, contratar gateways e demonstrar a existência fiscal da LLC.

### 5. Form 5472 + 1120 pro-forma do último ano

Se és não residente com SMLLC e tiveste qualquer movimento entre ti e a LLC, o 5472 com 1120 pro-forma é obrigatório. Pergunta-te: foi apresentado o do exercício anterior? Tens cópia? Se a resposta é "não" ou "não tenho a certeza", é ponto vermelho.

### 6. BOI Report apresentado e actualizado

Apresentaste o BOI Report no FinCEN quando se constituiu a LLC ou na primeira janela de conformidade? Actualizaste morada, documento de identidade ou beneficiários se mudaram? O BOI não é um trâmite único: qualquer alteração relevante exige actualização em 30 dias.

### 7. Operating Agreement assinado e guardado

Abre o ficheiro e confirma que tem assinatura, data e percentagens claras. Se nunca o assinaste, assina-o agora com data real (não retroactiva). Bancos, processadores e compliance pedem-no com frequência crescente.

### 8. Conta bancária da LLC sem mistura

Revê os últimos seis meses de extractos. Há pagamentos pessoais teus com o cartão da LLC? Recebimentos da LLC na tua conta pessoal? Qualquer mistura é ponto vermelho, não porque vá saltar algo hoje, mas porque rompe o corporate veil e complica o 5472.

### 9. Residência fiscal correcta em cada plataforma

Mercury, Wise, Relay, Stripe, PayPal, Interactive Brokers, exchanges de cripto: em todas deves ter declarada a residência fiscal real do beneficiário. Uma única plataforma com a residência errada gera incoerência automática quando há cruzamento CRS.

### 10. Declaração no teu país do último exercício

Imputaste os rendimentos da LLC na tua declaração local? Isto não é opcional na maioria das jurisdições europeias e latino-americanas. Se tens dois ou mais exercícios sem declarar, convém regularização voluntária antes do cruzamento CRS ou DAC.

### 11. Modelo 720/721 se resides em Espanha

Se resides em Espanha e a soma de contas, valores ou cripto fora de Espanha ultrapassa 50 000 €, tens obrigação declarativa. A sentença do TJUE limitou a sanção desproporcional, mas a obrigação informativa continua em vigor e cruza-se automaticamente.

### 12. Calendário e fornecedor para o próximo ano

Por último: tens claro quem apresenta o teu 5472 no próximo Abril? Quem renova o RA? Quem supervisa o BOI se algo muda? Se a resposta é "eu, quando me lembrar", a probabilidade de algo cair nos próximos 18 meses é alta.
### Como interpretar o resultado

- **0-2 pontos vermelhos:** a tua LLC está bem gerida. Continua assim e formaliza o calendário anual.
- **3-5 pontos vermelhos:** há dívida técnica. Convém um plano de remediação ordenado nos próximos 60-90 dias.
- **6 ou mais pontos vermelhos:** estás em zona de risco. O barato é regularizar voluntariamente; o caro é esperar por uma carta do IRS, do FinCEN ou da AT.
## O que fazer com o resultado

Se a auditoria sai limpa, guarda o exercício na tua pasta da LLC com data. Repete-a a cada seis meses; demora vinte minutos.
...
### 6. BOI Report apresentado e atualizado
...
### 10. Declaração no seu país do último exercício

Este é um dos pontos que auditamos primeiro quando assumimos um processo. Se não estiver limpo aqui, qualquer hipótese a jusante torna-se negociável perante a autoridade.

### 11. Modelo 720/721 se reside em Espanha

Apontamento concreto dos nossos casos: é assim que acontece de facto, não como uma página comercial descreve. Os números e o calendário pesam - falhar num deles desfaz o resto.

### 12. Calendário e prestador para o próximo ano
...
## Atualização Exentax hoje: chaves verificadas

Três mudanças concretas do último ano alteram como pontuar esta auditoria atualmente:

- **BOI Report (FinCEN).** Após a *interim final rule* de 21 de março de 2025, as LLC constituídas nos EUA com beneficial owners norte-americanos saem do âmbito. As **foreign reporting companies** (entidades constituídas fora dos EUA e registadas num estado) continuam obrigadas. Verifica o estado atual em [fincen.gov/boi](https://www.fincen.gov/boi) antes de marcar o ponto 6 a verde.
- **Form 5472 + 1120 pro forma.** A sanção por não apresentação mantém-se em **25.000 USD por formulário e ano** (IRC §6038A). Para o exercício fiscal em curso o prazo é **15 de abril** e a prorrogação via **Form 7004** leva-o a **15 de outubro de hoje**.
- **Annual Report estadual.** Wyoming mantém a taxa mínima de 60 USD; Delaware fica em 300 USD de Franchise Tax com vencimento a 1 de junho; New Mexico continua sem Annual Report. Para outros estados, confirma datas no portal do Secretary of State.

### Como priorizar se falhares três ou mais pontos

1. **Crítico (7 dias):** estado *Delinquent/Forfeited*, EIN perdido sem 147C, 5472 do ano em curso por apresentar.
2. **Alto (30 dias):** Operating Agreement por assinar, Registered Agent caducado, separação de fundos quebrada.
3. **Médio (90 dias):** sem rasto contabilístico, sem cópias de segurança, BOI não verificado na jurisdição afetada.

### FAQ hoje

**Esta auditoria substitui uma revisão profissional?** Não. Cobre 90 % dos problemas operacionais visíveis mas não deteta exposições fiscais subtis (PE, ECI, residência económica) que exigem análise caso a caso.

**Com que frequência repetir?** Uma vez por ano, idealmente em janeiro e antes de 15 de março (prazo 1042-S se o emitires). Se mudares de banco, morada ou sócios, repete no mesmo mês.

**Aplica-se a uma LLC dormente?** Sim. Uma LLC sem atividade continua obrigada a Annual Report, Registered Agent e, se houve qualquer movimento entre ti e a entidade, ao 5472 também.
<!-- exentax:overhaul-hoje-v1 end -->

<!-- exentax:execution-v2 -->
## Como fazemos a auditoria rápida na Exentax

Uma auditoria útil não procura culpados: arruma a LLC em menos de trinta minutos e deixa claro o que urge antes do próximo fecho. Processamos centenas destas checklists por semana e os doze pontos que importam repetem-se sempre.
...
- **Calendário fiscal fechado** com prazos federais, estaduais e do seu país de residência numa única folha.
...
<li><span class="font-mono">90 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…uedes verificar tú mismo en treinta minutos y que cubren el 90 % de los problemas que vemo…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…la suma de cuentas, valores o cripto fuera del país supera 50.000 €, tienes obligación de …»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">301.770</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…, vigentes actualmente: - **Estados Unidos.** Treas. Reg. §301.7701-3 (clasificación check…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">IRC §6038</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…. Reg. §301.7701-3 (clasificación check-the-box de la LLC), IRC §6038A y Treas. Reg. §1.60…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…sarelas y demostrar la existencia fiscal de la LLC. ### 5. Form 5472 + 1120 pro-forma del …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">RD 1065/2007</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…ia fiscal internacional), Ley 27/2014 LIS, Ley 58/2003 LGT, RD 1065/2007 (Modelo 232 sobre…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
