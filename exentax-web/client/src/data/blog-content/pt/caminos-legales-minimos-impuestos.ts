...
- 0 % federal nos EUA por <a href="/pt/blog/tributacao-pass-through-para-llc-como-funciona-e-por-que">pass-through</a>.
...
Estas combinações requerem assessoria especializada e desenho honesto. Não são receitas, são construções à medida.
...
1. **Calcule a sua fatura atual real**: IRS + Segurança Social + IVA líquido suportado, tudo junto. Sem esse número, qualquer comparação é teórica.
2. **Defina o que está disposto a mudar**: só estrutura, residência, ou ambas.
3. **Estime a poupança líquida** de cada caminho após descontar custos operacionais (sociedade, assessoria, vida noutro país).
4. **Verifique o risco fiscal**: controlo efetivo, transparência internacional, exit tax, substância.
5. **Consulte assessoria especializada antes de atuar**: uma decisão mal tomada custa mais a recuperar do que a tomar bem.
...
Combinação de holding patrimonial + planeamento sucessório + possível expatriação parcial. Estrutura complexa mas claramente legal, com poupança acumulada em décadas que justifica plenamente o investimento inicial em assessoria.
...
- **Tributação zero**: nenhuma estrutura LLC consegue "zero impostos" se vives num país com regras CFC/transparência fiscal ou atribuição de rendimentos. O que se consegue é **não duplicar tributação** e **declarar corretamente na residência**, não eliminá-la.<!-- exentax:execution-v2 -->
...
> **Quanto pode poupar combinando bem estas alavancas?** Estime a fatura anual com a <strong>calculadora fiscal da Exentax</strong>.
...
<li><span class="font-mono">47%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…levamos años trabajando con personas que vienen huyendo del 47% de IRPF más &lt;a href=&quot;https…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…stino. Algunas opciones reales actualmente: - **Andorra**: 10% IRPF, 10% IS, 4,5% IGI. Tas…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…nes reales actualmente: - **Andorra**: 10% IRPF, 10% IS, 4,5% IGI. Tasas mínimas, calidad …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…fue. - **Italia**: régimen del impatriado y régimen flat de 200.000 EUR para grandes patri…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ficos para nuevos residentes. - **EAU (Dubái, Abu Dhabi)**: 0% IRPF personal real, con vis…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…nte? Depende del país. Para un autónomo español que factura 80.000 EUR al año, sustituir e…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">37%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…or una LLC bien gestionada puede mover la carga fiscal del ~37% combinado al ~20-25% efect…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…onada puede mover la carga fiscal del ~37% combinado al ~20-25% efectivo, dependiendo de g…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">1.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…y reduces carga sin cambiar tu vida. Coste anual: menos de 1.000 EUR. **Caso 2: emprendedo…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">47 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…atos, Paraguay, Uruguay) puede reducir el tipo efectivo del 47 % al 10-25 %. Exige mudanza…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">25 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…uay, Uruguay) puede reducir el tipo efectivo del 47 % al 10-25 %. Exige mudanza real con p…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">0 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ía, SaaS, ecommerce, royalties), las cifras se mueven entre 0 % y 15 % efectivo según juri…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">15 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…aS, ecommerce, royalties), las cifras se mueven entre 0 % y 15 % efectivo según jurisdicci…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**¿Cuánto cuesta una estructura legal optimizada?** Entre 1.500 € y 8.000 € de coste anual…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">8.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…o cuesta una estructura legal optimizada?** Entre 1.500 € y 8.000 € de coste anual para pe…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">500.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…0 € y 8.000 € de coste anual para perfiles entre 80.000 € y 500.000 € de facturación. El c…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">8.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…l empleador, que permiten aportaciones adicionales de hasta 8.500 EUR anuales sin penaliza…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">50 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…an declarar. - **Inversión en empresas de nueva creación**: 50 % de deducción estatal sobr…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…presas de nueva creación**: 50 % de deducción estatal sobre 100.000 EUR anuales si cumples…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">80 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…RPF. - **Donativos** a entidades acogidas a la Ley 49/2002: 80 % los primeros 250 EUR y 40…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">40 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ades acogidas a la Ley 49/2002: 80 % los primeros 250 EUR y 40 % en lo restante, además de…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">24 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…trabajador y cubre seis ejercicios completos. Tributas al **24 %** hasta 600.000 EUR de re…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">600.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…cubre seis ejercicios completos. Tributas al **24 %** hasta 600.000 EUR de rendimientos de…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…o**: ordena gastos deducibles, evalúa pasar a SL si superas 60.000-80.000 EUR de beneficio…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…pa para &quot;no declarar&quot; desde España: con FATCA y los avances DAC8 todo aflora. Su valor es …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
