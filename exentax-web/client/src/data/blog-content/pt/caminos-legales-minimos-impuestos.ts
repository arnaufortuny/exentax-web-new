...
3. **Estime a poupança líquida** de cada caminho após descontar custos operacionais (sociedade, consultoria, vida noutro país).
4. **Verifique o risco fiscal**: controlo efetivo, transparência internacional, exit tax, substância.
5. **Consulte consultoria especializada antes de atuar**: uma decisão mal tomada custa mais a recuperar do que a tomar bem.
