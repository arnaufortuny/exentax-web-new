export default `Se tens uma LLC e o BOI Report não está apresentado, ou os Forms 5472 + 1120 pro-forma dos últimos anos não estão apresentados, não estás numa situação irrecuperável. Estás numa situação recuperável, mas só se actuas agora e na ordem correcta.

Este artigo é o procedimento que aplicamos na Exentax para casos de dívida reguladora acumulada.

## Enquadrar a situação com honestidade

Três perguntas rápidas:

1. **Quantos anos de 5472 faltam?** Um, dois, três ou mais.
2. **BOI apresentado?** Sim, não, ou "acho que sim, mas não tenho a confirmação".
3. **LLC activa no estado?** Active ou já em delinquent/forfeited?

A combinação destas respostas define prioridade e urgência.
### Ordem de regularização que sempre funciona

Em 9 de cada 10 casos:

1. **Estado** (Active/Good Standing).
2. **BOI Report**.
3. **5472 + 1120 pro-forma** (mais recente primeiro, depois o resto).
4. **Declaração pessoal no teu país** se necessário.
...
### Passo 1. Estado e Registered Agent

Procura a tua LLC no site do Secretary of State:

- **Active**: passa ao passo 2.
- **Delinquent / Not in Good Standing**: paga o Annual Report ou Franchise Tax em falta. 50-300 USD mais penalização.
- **Forfeited / Dissolved Administratively**: apresenta **Reinstatement**. 100-500 USD por estado, processado em 2-6 semanas.

Até isto estar resolvido, não apresentes BOI nem 5472.
### Passo 2. BOI Report

Três cenários:

- **Nunca apresentado**: apresenta agora. 100 % online no FinCEN, gratuito, 30-60 min.
...
Mesma abordagem mas avaliar adicionalmente vias de voluntary disclosure adequadas.

### Caso C. JÁ recebeste notificação do IRS

Situação crítica. Não apresentes nada sem profissional com experiência em respostas ao IRS. Ordem, linguagem e argumentos mudam materialmente o resultado.
### Passo 4. Declaração pessoal no teu país

Se resides num país de tributação mundial e não declaraste rendimentos da LLC nos anos afectados, a regularização local é o passo seguinte.
### O que NÃO fazer

- **Movimentar dinheiro para/da conta da LLC** durante a regularização.
- **Abrir nova banca** com a LLC em delinquent.
- **Apresentar 5472 com números inventados** para "ganhar tempo".
- **Ignorar notificação do IRS ou FinCEN**.
### Calendário realista

Caso típico (3 anos 5472 em falta, BOI nunca apresentado, LLC delinquent, sem notificação): **8-14 semanas** bem organizadas.
### Como o abordamos na Exentax

Na Exentax acompanhamos casos de regularização todos os meses. Diagnóstico sério antes de tocar em nada. Dizemos-te à partida que perfil de sanção enfrentas, o que é recuperável sem sanção e o que carrega risco residual.

Se estás nesta situação, agenda uma sessão inicial gratuita na nossa página de agendamento.
...
## Atualização Exentax hoje: recuperação em dia
...
1. Reúne extratos bancários dos anos pendentes e reconstrói as *reportable transactions* (capital aportado, levantamentos, pagamentos a relacionados).
2. 1120 pro forma + 5472 por cada ano em ordem cronológica ascendente.
3. Carta única de *reasonable cause* assinada pelo proprietário.
4. Se aplicável, apresentar BOI atrasado em [o portal oficial da FinCEN para o BOI](https://boiefiling.fincen.gov) no mesmo mês.

### FAQ hoje

**Quanto tempo demora o IRS a responder?** Entre 4 e 10 meses. Não assumir aceitação até lá.

**Convém regularizar antes de fechar a LLC?** Sim. Fechar com 5472 pendentes deixa a dívida viva contra o proprietário pessoa singular.

**Preciso de ITIN para regularizar?** Não. O 1120 pro forma aceita "Foreign US" como TIN do proprietário quando não há ITIN/SSN.
<!-- exentax:overhaul-hoje-v1 end -->

<!-- exentax:execution-v2 -->
## Como recuperamos uma LLC com BOI e 5472 em atraso na Exentax

Quando BOI ou 5472 chegam com um ou vários anos em atraso, a prioridade não é submeter depressa: é escolher a via certa para minimizar a multa. O método Exentax descarta a regularização cega e aplica a pista que melhor proteja o cliente.

- **Voluntary disclosure** quando ainda não há notificação IRS ou FinCEN: minimiza multas ao máximo se feito antes de abrir procedimento.
- **Streamlined-equivalente** para o non-filer não doloso: documentar a causa, regularizar em bloco e abrir a janela de reasonable cause.
- **Defesa documental**: reconstruir reportable transactions, reconciliar banca e arquivar rastreabilidade antes de mover qualquer peça.

Se a sua LLC tem anos pendentes e quer saber a via que se aplica, abra a <strong>calculadora Exentax</strong> ou marque trinta minutos.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">25.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…Las sanciones nominales asustan. Form 5472 no presentado: 25.000 USD por formulario y año.…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…lgunos casos, una cuota de reinstatement. Coste típico: 200-1.500 USD según estado y antig…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…en tu país de residencia. Las sanciones nominales asustan. Form 5472 no presentado: 25.000…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
