...
<!-- /exentax:execution-v2 -->
  ...
  Para sócios portugueses de LLC americana em atraso com declarações US (**FBAR FinCEN 114** para contas > USD 10.000, **Form 5472 IRC §6038A(d)** com sanção USD 25.000/formulário/ano, FinCEN BOI sob **CTA §6403** com sanção USD 591/dia), a regularização efetua-se via **Streamlined Foreign Offshore Procedures (SFOP)** ou **Voluntary Disclosure Practice (VDP)** do IRS. Em Portugal, as obrigações paralelas são o **Anexo J do Modelo 3 IRS** retroativo, **Modelo 38** para transferências internacionais > €12.500 (Lei 5/2002), e a **Comunicação à AT** ao abrigo do **acordo FATCA Portugal-EUA de 06/08/2015 (Lei 82-B/2014)**. Conservação 10 anos (art. 130.º CIRS). Fechamos isto contigo a partir da Exentax: uma chamada, submissão feita, ficheiro pronto, o risco fica no papel.
