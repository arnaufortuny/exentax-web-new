...
| Imóveis (arrendamento) | Morada do imóvel, número de cadastro ou equivalente, número de dias arrendados por imóvel, tipo de imóvel |
...
- **CRS / DAC2**: reporte bancário de saldos e rendimentos. Veja <a href="/pt/blog/crs-para-residentes-em-espanha-e-latam-implicacoes-reais">CRS para residentes UE e LATAM</a>.
...
- **DAC8**: reporte de cripto-activos, recentemente em plena aplicação. Veja <a href="/pt/blog/dac8-e-criptomoedas-o-novo-reporting-fiscal-automatico-em">DAC8 e criptomoedas</a>.
...
- **Revolut Business**: quando associado a uma **LLC norte-americana**, o habitual é operar sob Revolut Payments USA; os IBAN europeus (lituanos, BE) **não são emitidos por defeito** a uma LLC: são emitidos a clientes europeus do banco europeu do grupo. Se lhe oferecerem um IBAN europeu, certifique-se a que entidade jurídica essa conta está associada e sob que regime reporta.
...
- **Doutrina administrativa.** Resoluções do <a href="https://serviciostelematicosext.hacienda.gob.es/TEAC/DYCTEA" target="_blank" rel="noopener">TEAC</a> e consultas vinculativas da DGT relativas a LLC unipessoais (entre outras V0443-08, V1631-17, V1147-22), interpretadas à luz do BOE de fevereiro de 2020 sobre classificação de entidades estrangeiras transparentes.
- **Convénios e regulamentação internacional.** Convénio de Dupla Tributação entre a Espanha e os EUA assinado em 1990 com Protocolo de 2013 em vigor desde 2019, Directiva 2011/16/UE alterada pela DAC6, DAC7 e DAC8, e Modelo de Convénio <a href="https://www.oecd.org" target="_blank" rel="noopener">OCDE</a> com seus Comentários.
