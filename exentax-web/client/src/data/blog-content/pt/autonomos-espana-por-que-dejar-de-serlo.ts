...
Na Exentax analisamos o seu caso concreto numa consulta gratuita de 30 minutos. Colocamos os números à sua frente: quanto paga hoje, quanto pagaria com LLC, e quanto economiza por ano. Sem compromisso, sem pressão, sem "resultados orientativos". Números reais com o seu faturamento real.

Se te revês no trabalhador independente que não consegue crescer ou no MEI que já não cabe, a LLC é muitas vezes a saída mais limpa, desde que esteja bem desenhada. Na Exentax fazemos o diagnóstico em 30 minutos: marca a tua consulta gratuita e dizemos-te claramente se faz sentido para ti.
...
- **Espanha.** Lei 35/2006 (LIRPF), arts. 8, 9 (residência), 87 (atribuição de rendimentos), 91 (CFC pessoas singulares); Lei 27/2014 (LIS), art. 100 (CFC sociedades); Lei 58/2003 (LGT), arts. 15 e 16; Lei 5/2022 (regime sancionatório do Modelo 720 após TJUE C-788/19 de 27/01/2022); RD 1065/2007 (Modelos 232 e 720); <a href="https://www.boe.es/buscar/act.php?id=BOE-A-2023-19036" target="_blank" rel="noopener">Ordem HFP/887/2023</a> (Modelo 721 cripto).
...
- **BOI / Corporate Transparency Act: a tua LLC NÃO está obrigada (uma vantagem competitiva).** Após a <a href="https://www.fincen.gov/boi" target="_blank" rel="noopener">interim final rule da FinCEN de março de 2025</a>, a obrigação do BOI Report foi **restringida às "foreign reporting companies"** (entidades constituídas FORA dos EUA e registadas para operar num estado). Uma **LLC formada nos EUA detida por um não residente NÃO submete o BOI Report**: uma formalidade a menos no calendário, menos burocracia e uma estrutura mais limpa do que nunca. Se a tua LLC foi constituída antes da entrada em vigor dessa regra provisória e já submeteste o BOI, guarda o comprovativo. O estado regulatório pode mudar: **monitorizamos a FinCEN.gov em cada submissão** e, se a obrigação voltar, gerimos sem custo adicional. Estado atual verificável em [fincen.gov/boi](https://www.fincen.gov/boi).
...
- **EIN e notificações.** Sem EIN não se submete 5472 nem BOI. O IRS não avisa antes de sancionar; descobre-se quando o EIN é bloqueado ou uma submissão posterior é rejeitada. Agora é o momento certo para pedir ajuda. Na Exentax abrimos o caso, submetemos o que estiver em falta e respondemos pela tua conta perante a autoridade competente.
