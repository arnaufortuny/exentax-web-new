export default `Este artigo foi pensado para os autónomos de Espanha, mas a lógica cola no trabalhador independente português ou no MEI/autónomo brasileiro: Segurança Social a subir, <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> progressivo que morde o segundo escalão, e um tecto de receitas que bloqueia qualquer tentativa de escalar a sério.

O sistema de trabalhadores autónomos na Espanha foi desenhado para um padeiro de bairro, não para um designer UX que trabalha com startups de São Francisco. E, no entanto, milhares de freelancers digitais continuam a pagar tudo como se vendessem pão.
...
4. **recebe os benefícios líquidos**: mediante Owner's Draws para sua conta pessoal
...
**Total pago:** 12.000€ + 1.400€ (manutenção LLC) = **13.400€ → 18,6% efetivo**
...
Algumas leituras adjacentes a manter à mão: <a href="/pt/blog/impostos-com-clientes-internacionais-em-espanha-o-que">Impostos com clientes internacionais em Espanha: o que ninguém conta</a> e <a href="/pt/blog/criptomoedas-e-trading-com-llc-guia-fiscal-completo-para">Criptomoedas e trading com LLC: guia fiscal completo para traders</a>, que afinam precisamente os contornos do que este guia explica.
## A quota de autónomo: o imposto mais absurdo da Espanha
...
## A conta honesta de quando o regime espanhol de autónomos deixa de fazer sentido

Sair do regime espanhol de autónomos não é uma decisão ideológica, é uma decisão de números. E esses números mudam de forma significativa a partir de certo limiar de facturação, certa proporção de clientes estrangeiros e certo horizonte de continuidade. Estes são os critérios que aplicamos na Exentax antes de propor qualquer movimento.

- **Limiar de facturação.** Abaixo de 30.000-40.000 € líquidos por ano, o RETA com a quota reduzida do primeiro escalão e as despesas dedutíveis habituais costuma continuar a ser razoável. A partir de 60.000-80.000 € líquidos com clientes no estrangeiro, uma LLC americana correctamente declarada na residência começa a mostrar uma vantagem líquida real após custo de manutenção.
- **Composição de clientes.** Se 70 % ou mais dos seus clientes estão fora de Espanha e pagam em USD/EUR/GBP, uma LLC elimina retenções, simplifica facturação internacional e abre contas multi-divisa. Se 70 % são espanhóis, a LLC acrescenta complexidade sem vantagem real.
- **Horizonte temporal.** Uma estrutura LLC faz sentido quando pensa manter actividade internacional pelo menos 3-5 anos. Se está a testar o mercado seis meses, mantenha-se autónomo.
- **Exposição patrimonial.** O RETA não separa património pessoal e profissional; uma LLC sim, o que conta em perfis expostos a litígios, devoluções massivas ou responsabilidade cruzada.

### O que mais nos perguntam

**Posso ser autónomo e ter uma LLC ao mesmo tempo?** Sim, são figuras compatíveis se a LLC não concorrer com a actividade declarada como autónomo e se a imputação de rendimentos for correctamente reflectida no seu IRPF. Recomendamo-lo em transições progressivas, não como estado permanente.

**E se sair do RETA e depois precisar de voltar?** Voltar é administrativamente trivial; o que convém vigiar é a lacuna de cobertura nas contingências comuns e o cálculo de carência para reforma. Modelamos antes da saída em cada caso.

Na Exentax não propomos saída do RETA por defeito: fazemos a conta com os seus números reais, dizemos-lhe se compensa e, se sim, acompanhamos também no calendário para que não haja lacunas.
...
<li><span class="font-mono">5.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…un minuto. Hagamos números reales. Supongamos que facturas 5.000€ al mes (60.000€ al año):…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…amos números reales. Supongamos que facturas 5.000€ al mes (60.000€ al año): - **Cuota de …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.600</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…es (60.000€ al año): - **Cuota de autónomos:** ~300€/mes (~3.600€/año con la base mínima n…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">24%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…(~3.600€/año con la base mínima nueva) - **IRPF:** Entre el 24% y el 37% sobre tu benefici…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">37%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…año con la base mínima nueva) - **IRPF:** Entre el 24% y el 37% sobre tu beneficio neto - …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…** Entre el 24% y el 37% sobre tu beneficio neto - **IVA:** 21% que cobras y luego ingresa…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">32.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…l) El resultado: de esos 60.000€, te pueden quedar entre **32.000€ y 38.000€** después de …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">38.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ultado: de esos 60.000€, te pueden quedar entre **32.000€ y 38.000€** después de impuestos…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">35.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ridad - **El IRPF es progresivo y despiadado**: a partir de 35.000€ ya estás en el tramo d…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a estás en el tramo del 37%. A partir de 60.000€, llegas al 45% - **Pagos fraccionados**: …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…as al 45% - **Pagos fraccionados**: cada trimestre pagas un 20% de tu beneficio estimado. …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ales con clientes internacionales es la más eficiente: - **0% de impuesto federal en EE.UU…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">8.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…mo sin optimizar tu estructura, dejas sobre la mesa entre **8.000€ y 20.000€** que podrías…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">20.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…timizar tu estructura, dejas sobre la mesa entre **8.000€ y 20.000€** que podrías estar ah…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…podrías estar ahorrando legalmente. En cinco años, eso son 40.000-100.000€. ## ¿Cómo funci…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…s estar ahorrando legalmente. En cinco años, eso son 40.000-100.000€. ## ¿Cómo funciona ex…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">72.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…r ahí ### Ejemplo con números reales **Ingresos brutos:** 72.000€/año **Gastos deducibles …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">18.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**Ingresos brutos:** 72.000€/año **Gastos deducibles LLC:** 18.000€/año (software, hardwar…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">54.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ción, viajes, servicios) **Beneficio neto (pass-through):** 54.000€/año **Carga fiscal en …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">12.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…/año **Carga fiscal en país de residencia sobre 54.000€:** ~12.000€ (tipo efectivo ~22%) *…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">22%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…aís de residencia sobre 54.000€:** ~12.000€ (tipo efectivo ~22%) **Total pagado:** 12.000€…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">1.400</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…~12.000€ (tipo efectivo ~22%) **Total pagado:** 12.000€ + 1.400€ (mantenimiento LLC) = **1…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">13.400</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**Total pagado:** 12.000€ + 1.400€ (mantenimiento LLC) = **13.400€ → 18,6% efectivo** **Co…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…do:** 12.000€ + 1.400€ (mantenimiento LLC) = **13.400€ → 18,6% efectivo** **Como autónomo:…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">62.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…vo** **Como autónomo:** 72.000€ - gastos limitados = base ~62.000€ **IRPF ~35%:** ~21.700€…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">35%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ónomo:** 72.000€ - gastos limitados = base ~62.000€ **IRPF ~35%:** ~21.700€ + cuota autóno…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21.700</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…72.000€ - gastos limitados = base ~62.000€ **IRPF ~35%:** ~21.700€ + cuota autónomos 3.600…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">25.300</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…2.000€ **IRPF ~35%:** ~21.700€ + cuota autónomos 3.600€ = **25.300€ → 35.1% efectivo** **D…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">1%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…~35%:** ~21.700€ + cuota autónomos 3.600€ = **25.300€ → 35.1% efectivo** **Diferencia:** 1…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">11.800</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…omos 3.600€ = **25.300€ → 35.1% efectivo** **Diferencia:** 11.800€/año más en tu bolsillo.…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">30.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ier movimiento. - **Umbral de facturación.** Por debajo de 30.000-40.000 € netos al año, e…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…abituales suele seguir siendo razonable. A partir de 60.000-80.000 € netos con clientes en…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">70 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…oste de mantenimiento. - **Composición de clientes.** Si el 70 % o más de tus clientes est…»</span> <strong>[NÃO VERIFICADO]</strong></li>
