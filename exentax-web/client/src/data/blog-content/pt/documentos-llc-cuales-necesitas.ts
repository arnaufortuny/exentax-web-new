...
O EIN (Employer Identification Number) é o número de identificação fiscal da tua LLC perante o <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>. Equivale ao NIF/NIPC português ou ao CNPJ brasileiro, mas para entidades americanas. A carta CP 575 do IRS confirma oficialmente a atribuição do teu EIN.
...
O BOI Report (Beneficial Ownership Information) é uma declaração perante o <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> que identifica os proprietários reais da LLC. Desde 1 de janeiro de 2024, todas as LLCs devem apresentá-lo (embora o FinCEN tenha suspendido temporariamente a enforcement de sanções).
...
Algumas leituras adjacentes a manter à mão: <a href="/pt/blog/por-que-abrir-uma-llc-americana-em-2026-os-5-pilares-da">Por que abrir uma LLC americana atualmente: os 5 pilares da vantagem americana</a> e <a href="/pt/blog/ein-vs-itin-vs-ssn-os-numeros-de-identificacao-fiscal">EIN vs ITIN vs SSN: os números de identificação fiscal americanos explicados</a>, que afinam precisamente os contornos do que este guia explica.
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…autorizado a trabajar en EE.UU. para tener una LLC. Todo es 100% remoto - **Dirección físi…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…strarte en Stripe/PayPal, presentar declaraciones fiscales (Form 5472 + 1120) y operar con…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
