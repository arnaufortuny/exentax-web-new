export default `Quando constituis uma LLC nos Estados Unidos, recebes um "kit legal" completo. vários documentos, cada um com uma função concreta. Na Exentax preparamo-los e entregamo-los todos como parte do serviço de constituição. Mas é bom que saibas o que é cada um e para que o vais precisar.
