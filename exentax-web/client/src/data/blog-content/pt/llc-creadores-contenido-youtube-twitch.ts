export default `Para um creator em Portugal ou no Brasil a viver de AdSense, Twitch, Patreon e patrocínios, a equação fiscal sai rapidamente dos eixos: <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> progressivo, Segurança Social, IVA sobre subs, withholding tax que a Google retém e um Regime Simplificado que salta dos eixos acima dos 14 500 €. Uma LLC muda o cenário por completo.

O YouTube paga-lhe desde a Irlanda. O Twitch desde San Francisco. Os patrocinadores podem estar em qualquer parte do mundo. E está a tentar encaixar tudo isso num regime fiscal local que não foi desenhado para a sua realidade.

## Por que uma LLC encaixa com os criadores

A maioria das plataformas de conteúdo está nos Estados Unidos. Quando tem uma LLC americana:
...
- **Separa o seu património pessoal** do negócio. Se alguém processa a sua marca, os seus bens pessoais estão protegidos.
...
Não há uma regra universal, mas se fatura mais de 2.500-3.000€ por mês com o seu conteúdo, é provável que a estrutura comece a compensar. O ponto exato depende do seu país de residência, do seu tipo de conteúdo e de como gere os seus rendimentos atualmente.
...
- Fatura desde a sua LLC. "CreatorName LLC" soa infinitamente mais profissional do que "João Silva, trabalhador independente/autónomo"
...
Suponhamos que gera isto por mês:
- AdSense: $2.000
- 2 patrocínios: $3.000
- Merch: $500
- Patreon: $800
...
**Sem LLC (trabalhador independente/autónomo na Espanha):**
- IRPF ~35% + quota de autónomo = ~$28.000 em impostos
...
Para continuar neste fio, <a href="/pt/blog/llc-americana-para-agencias-de-marketing-digital-estrutura">LLC americana para agências de marketing digital: estrutura, faturamento e escalabilidade</a> e <a href="/pt/blog/o-que-e-o-irs-e-como-afeta-a-sua-llc-americana">O que é o IRS e como afeta a sua LLC americana?</a> completam nuances que aqui apenas tocámos.
### O que inclui o serviço da Exentax

Na Exentax cuidamos de tudo: constituição da LLC, obtenção do EIN, abertura de conta bancária americana, configuração de gateways de pagamento e compliance anual. dedica-se a criar conteúdo, nós ocupamo-nos do chato mas necessário papelório.
...
## LLC para criadores de conteúdo (YouTube, Twitch, TikTok): como cobrar limpo em USD

Se vive de YouTube, Twitch, TikTok ou Patreon e reside fora dos EUA, uma LLC bem montada muda a sua operativa: cobra directamente em USD desde Google AdSense, Twitch, patrocinadores e plataformas, sem contas pessoais saturadas, sem câmbio caro e com factura limpa para patrocinadores corporativos.

- **O gargalo sem LLC.** AdSense paga ao seu IBAN local, Twitch retém 30% sem W-8BEN, patrocinadores US pedem W-9 (que não pode dar como pessoa não-US), e a sua conta pessoal recebe transferências internacionais com taxas de 25-50 USD. Mais: a AT recebe o reporte CRS completo.
- **O stack com LLC.** Single-member LLC em Wyoming ou Delaware, EIN, Mercury Business como conta principal USD. Configura AdSense para pagar à LLC (EIN), aplica W-8BEN-E em Twitch/TikTok para reduzir retenção a 0% sob convenção, assina patrocínios desde a LLC com factura própria.
- **No lado fiscal em residência.** Se reside em Portugal, os rendimentos da LLC tributam em IRS como rendimento de actividade ou capital. LLC transparente = atribuição directa. Se reside em LATAM, geralmente a LLC é opaca e só distribuições tributam.
- **Cartões e despesas.** Mercury emite cartões USD para gastar em software, equipamento, promoção e subscrições. 100% dedutível. Sem majoração de câmbio em cada compra USD.

### O que mais nos perguntam

**O meu público muda com a LLC?** Não para subscritores. Sim em patrocínios: a sua marca profissionaliza-se e muitos patrocinadores corporativos só trabalham com entidades. Abertura de mercado real.

**O que acontece com os meus pagamentos AdSense actuais na conta pessoal?** Muda o método de pagamento para EIN + Mercury da LLC. Histórico fica facturado a si; novo à LLC.

Na Exentax montamos o setup criador completo (LLC + EIN + Mercury + W-8BEN-E + migração AdSense/Twitch/TikTok + contabilidade mensal) em 4-6 semanas, pronto para o primeiro payout.
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ntido? No hay una regla universal, pero si facturas más de 2.500-3.000€ al mes con tu cont…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…No hay una regla universal, pero si facturas más de 2.500-3.000€ al mes con tu contenido, …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…scriptores Supongamos que generas esto al mes: - AdSense: $2,000 - 2 sponsorships: $3,000 …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">3,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…e generas esto al mes: - AdSense: $2,000 - 2 sponsorships: $3,000 - Merch: $500 - Patreon:…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6,300</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…nsorships: $3,000 - Merch: $500 - Patreon: $800 - **Total: $6,300/mes ($75,600/año)** **Si…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">75,600</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…3,000 - Merch: $500 - Patreon: $800 - **Total: $6,300/mes ($75,600/año)** **Sin LLC (autón…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">35%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…($75,600/año)** **Sin LLC (autónomo en España):** - IRPF ~35% + cuota autónomos = una carg…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…l en EE.UU. (Disregarded Entity) - Impuesto federal EE.UU.: 0% (Single-Member LLC no resid…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">9,500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ber LLC no residente) - Costes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">11,500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…C no residente) - Costes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">16,500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…tes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18,500/año** Ese ahorro…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">18,500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18,500/año** Ese ahorro son do…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…lla sin LLC.** Adsense paga al IBAN español, Twitch retiene 30% sin W-8BEN, sponsors USA p…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ámara, mic, OBS), promoción (Meta, Google) y subscriptions. 100% deducible para la LLC. Si…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">3%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…para la LLC. Sin recargo de cambio en cada compra (típico 2-3% en tarjetas EUR sobre cargo…»</span> <strong>[NÃO VERIFICADO]</strong></li>
