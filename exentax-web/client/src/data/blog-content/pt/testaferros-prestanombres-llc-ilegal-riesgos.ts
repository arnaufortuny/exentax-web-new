...
O BOI Report perante o <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> exige que declare os "beneficial owners", os proprietários reais, não os nominais. Se coloca o seu primo como owner mas é quem controla o negócio, está a fornecer informação falsa a uma agência federal encarregada de combater crimes financeiros.
...
Na Exentax recusamos este tipo de montagem e explicamos porquê. Marca a tua consultoria gratuita: construímos uma estrutura no teu próprio nome, completamente legal, sem arranjos que caem na primeira fiscalização.
### Próximos passos
...
<li><span class="font-mono">10.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…US tipifica falsedad documental en el BOI report con hasta $10.000 de multa civil + 2 años…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…o presentas el &lt;a href=&quot;/es/blog/como-operar-llc-dia-a-dia&quot;&gt;Form 5472&lt;/a&gt;, reportas transa…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
