export default `Usar testas-de-ferro para ocultar a titularidade de uma LLC é crime de simulação contratual e fiscal em Espanha (art. 305 CP), com penas de 1 a 5 anos de prisão e multas até 6 vezes o valor defraudado. Na Exentax fechámos sem sanção clientes exatamente nesta situação. Falar cedo compensa — e poupa-te cinco dígitos.
