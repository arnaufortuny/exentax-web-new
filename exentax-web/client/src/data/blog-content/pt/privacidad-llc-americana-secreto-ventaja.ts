...
**Proteção contra pesquisas online:** Se alguém procurar o seu nome na internet, não encontrará a sua LLC associada a si (pelo menos não pelos registos estatais). Isto é útil para trabalhadores independentes/autónomos e empreendedores que preferem separar a sua identidade pessoal da sua atividade empresarial.
...
**Perante o <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>:** O IRS sabe quem é o proprietário da sua LLC. Quando solicita o EIN, declara quem é o responsible party. Quando apresenta o Form 5472, reporta as transações entre si e a LLC. A privacidade estatal não tem efeito perante o serviço de impostos federal.

**Perante o <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>:** O BOI Report (Beneficial Ownership Information Report) exige que declare quem são os proprietários beneficiários da LLC, incluindo nome, data de nascimento, morada e número de identificação. Esta informação não é pública, mas está nas mãos do governo federal.
...
Para a maioria dos trabalhadores independentes/autónomos e empreendedores digitais que procuram privacidade + custo baixo, Novo México é a opção mais eficiente.
...
Para continuar neste fio, <a href="/pt/blog/proprietarios-ficticios-para-llcs-por-que-e-ilegal-e-os">Proprietários fictícios para LLCs: por que é ilegal e os riscos que corre</a> completa uma nuance que aqui apenas tocámos.
...
## Privacidade da LLC americana: onde é vantagem real e onde é mito vendido por gurus
...
**Com nominee desapareço totalmente?** Só do registo estatal. BOI exige identidade real.

**New Mexico é mais privado que Wyoming?** Marginalmente mais opaco a nível estatal. No resto, idêntico.

Na Exentax estruturamos LLCs com privacidade real vs terceiros e compliance total.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…&lt;a href=&quot;/es/blog/extension-irs-form-1120-como-solicitarla&quot;&gt;Form 5472&lt;/a&gt;, reportas las tr…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 8938</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…uales. Pero declarada en residencia (Modelo 720/721 España, Form 8938 si residente US) y r…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
