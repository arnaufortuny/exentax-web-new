...
1. **Separar contas**: uma conta para a LLC, outra para si. Nunca misturar
...
|---|---|---|---|
| Trabalhador independente (Portugal) / MEI ou autónomo (Brasil) | Nenhuma | Baixa | Baixo |
| Lda. (Portugal) / Ltda. (Brasil) | Sim | Alta | Alto (capital social e contabilidade obrigatória) |
...
Na Exentax desenhamos a estrutura LLC adequada ao seu perfil de risco e operamo-la formalmente.
...
<li><span class="font-mono">50,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…o Imagina que tu LLC tiene un contrato con un cliente por $50,000. El cliente dice que no …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…anda es contra la LLC, no contra ti. Si la LLC solo tiene $10,000 en su cuenta, eso es lo …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">200,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…máximo que el cliente puede reclamar de la LLC. Tu casa de $200,000 y tus ahorros de $30,0…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">30,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…e reclamar de la LLC. Tu casa de $200,000 y tus ahorros de $30,000 están protegidos. ### ¿…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ciedad Limitada (España) | Sí | Alta | Alto (capital mínimo 3.000€) | | LLC (EE.UU.) | Sí …»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…* 4. **Cumplir con todas las obligaciones**: Annual Report, Form 5472, BOI Report 5. **No …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
