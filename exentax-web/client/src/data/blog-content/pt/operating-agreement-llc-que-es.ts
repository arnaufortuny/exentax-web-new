export default `Quando constituis uma LLC, recebes os Articles of Organization, o documento público que regista a tua empresa no estado. Mas há outro documento igualmente importante (e que muitos ignoram): o **Operating Agreement**.
