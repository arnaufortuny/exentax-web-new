export default `Se fazes trading de cripto a partir de Portugal, já sabes como o jogo ficou depois de janeiro de 2023: ganhos a menos de 365 dias tributados a 28 %, staking e yield tratados como rendimentos de capitais, e a AT a cruzar dados com a CryptoAsset Reporting Framework. Montar uma LLC não apaga nada disto, mas muda a fotografia se estiver bem estruturada.
...
## O Modelo 721: declaração de criptoativos no estrangeiro Desde a última reforma, se tem criptomoedas em exchanges fora de Espanha por valor superior a **50.000€ a 31 de dezembro**, deve apresentar o Modelo 721 antes de 31 de março do ano seguinte. A não apresentação pode acarretar sanções importantes.
...
**Importante:** O <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> considera as criptomoedas como "property" (propriedade), não como divisa. Isto significa que cada operação com cripto (incluindo swaps) é um evento fiscal nos EUA. No entanto, como a sua LLC é uma Disregarded Entity de não residente, não há obrigação de tributação federal sobre esses ganhos.
...
Para fechar, uma leitura relacionada que encaixa naturalmente ao lado deste artigo: <a href="/pt/blog/impostos-com-clientes-internacionais-em-espanha-o-que">Impostos com clientes internacionais em Espanha: o que ninguém conta</a> ajuda a arredondar o contexto.
...
Na Exentax vemos todas as semanas traders portugueses e brasileiros a estudar passar a cripto para dentro de uma LLC. Marca a tua consultoria gratuita: analisamos o teu caso e dizemos-te claramente o que aguenta perante as Finanças e o que não.
...
- **Qualificação do rendimento.** Em Espanha, a AEAT distingue ganho patrimonial (compra-venda de cripto) tributado em base do aforro (19-28%) e rendimento de actividade económica (trading habitual com organização mínima) tributado em base geral (até 47 %). Operar via SMLLC não muda a qualificação: organizado e profissional = actividade económica; esporádico = ganho patrimonial.
- **Trading vs. investimento de longo prazo.** Perfil "buy & hold" com 5-15 operações/ano encaixa como ganho patrimonial — aproveita taxas de aforro, a SMLLC pass-through acrescenta pouco além de ordem operacional. Perfil daytrading com 200+ operações/ano em SMLLC exige argumentação de actividade económica e abre deduções de despesa mas força o marginal.
- **DAC8 e reporting.** A partir de hoje os CASP europeus reportam à AEAT posições e movimentos dos clientes. Exchanges não-UE (Coinbase US, Kraken US, Binance US) não entram directamente em DAC8, mas entram via CARF (<a href="https://www.oecd.org" target="_blank" rel="noopener">OECD</a> Crypto Reporting Framework) e CRS quando saldos passam pela banca.
- **On-chain como prova.** Os movimentos em wallets próprias são rastreáveis e públicos. A AEAT pode solicitar prova de custo de aquisição e titularidade. Manter registo detalhado (Koinly, Cointracking) desde o primeiro movimento; reconstruir 3 anos de DEX trading depois é desproporcionado.

### O que mais nos perguntam

**Se opero cripto na minha LLC, evito o Modelo 721?** Não: o Modelo 721 obriga o residente fiscal espanhol a declarar cripto-activos no estrangeiro acima de 50.000 €. A titularidade nominal pela LLC não isenta — a AEAT olha à substância, não à forma.

**Convém mover cripto para Portugal ou Emirados?** Só com mudança real e estadia maioritária. Portugal mantém isenção para holding >365 dias mas o imposto a daytrading recentemente introduzido limita o atractivo para profissionais. Emirados continua sem tributação sobre cripto, mas exige residência efectiva.

Na Exentax modelamos a imputação cripto em residência, deixamos o reporting Modelo 721 e a rastreabilidade Koinly preparada e, se convier, propomos mudança de jurisdição com números a 5 anos.
...
<li><span class="font-mono">6.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…cias patrimoniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.0…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…moniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…se del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 20…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 200.000€: **2…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">27%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…1%** - 50.000€ – 200.000€: **23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%** Esto aplica a cada opera…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a LLC para un trader? Depende de tu volumen: - **Menos de 10.000€/año en ganancias:** Prob…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">47 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…l con organización mínima) tributado en base general (hasta 47 %). Operar a través de SMLL…»</span> <strong>[NÃO VERIFICADO]</strong></li>
