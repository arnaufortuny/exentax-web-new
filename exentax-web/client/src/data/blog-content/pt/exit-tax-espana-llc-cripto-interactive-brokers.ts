...
| Limiar | Condição |
|--------|----------|
| **Limiar 1** | Valor de mercado das ações/participações **≥ 4.000.000 €** |
| **Limiar 2** | Percentagem de participação **≥ 25%** numa entidade **E** valor de mercado **≥ 1.000.000 €** |
...
### Diferimento por transferência para um Estado da UE ou do EEE
...
<li><span class="font-mono">4.000.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…1** | Valor de mercado de las acciones/participaciones **≥ 4.000.000 €** | | **Umbral 2** …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «….000 €** | | **Umbral 2** | Porcentaje de participación **≥ 25%** en una entidad **Y** val…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">1.000.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ipación **≥ 25%** en una entidad **Y** valor de mercado **≥ 1.000.000 €** | Si no se super…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">6.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a los tipos del ahorro: | Tramo | Tipo | |---|---| | Hasta 6.000 € | 19% | | 6.000 € – 50.…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…s del ahorro: | Tramo | Tipo | |---|---| | Hasta 6.000 € | 19% | | 6.000 € – 50.000 € | 21…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ramo | Tipo | |---|---| | Hasta 6.000 € | 19% | | 6.000 € – 50.000 € | 21% | | 50.000 € – …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…| |---|---| | Hasta 6.000 € | 19% | | 6.000 € – 50.000 € | 21% | | 50.000 € – 200.000 € | …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a 6.000 € | 19% | | 6.000 € – 50.000 € | 21% | | 50.000 € – 200.000 € | 23% | | 200.000 € …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">23%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…19% | | 6.000 € – 50.000 € | 21% | | 50.000 € – 200.000 € | 23% | | 200.000 € – 300.000 € …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">300.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «….000 € | 21% | | 50.000 € – 200.000 € | 23% | | 200.000 € – 300.000 € | 27% | | Más de 300…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">27%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…| | 50.000 € – 200.000 € | 23% | | 200.000 € – 300.000 € | 27% | | Más de 300.000 € | 28% …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…23% | | 200.000 € – 300.000 € | 27% | | Más de 300.000 € | 28% | **Ejemplo práctico:** Un …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">1.200.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…con coste de adquisición de 300.000 € y valor de mercado de 1.200.000 € al abandonar Españ…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">900.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…cipación en alguna entidad, tendría una ganancia latente de 900.000 €. Al tipo marginal de…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…nes ≥25% de participación (que en una SMLLC siempre tienes: 100%) **y** el valor de la LLC…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">800.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ón en la LLC**, no los criptoactivos en sí. Si la LLC vale 800.000 € (todo en cripto) y ti…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">2.000.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…tán sujetas al exit tax en la normativa actual**. Si tienes 2.000.000 € en BTC en tu walle…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">500.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…iempre aplica Muchos inversores con patrimonios de 200.000-500.000 € asumen que el exit ta…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ibutaria con las sanciones del art. 191 LGT (sanción del 50-150% de la cuota) además de in…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">120.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…e la vía penal del art. 305 CP (cuota defraudada superior a 120.000 €). ### ¿Cómo se valor…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">301.770</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…2/12/1990, Protocolo en vigor 27/11/2019). - **Treas. Reg. §301.7701-3** (clasificación de…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
<li><span class="font-mono">90%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…donaciones intervivos previas) es donde se gana o pierde el 90% del impacto. ### Lo que má…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…as realizadas son computables fiscalmente). ### ¿Afecta el DAC8 a la situación cripto en e…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
