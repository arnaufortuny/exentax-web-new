export default `Vamos contar-te algo que a maioria das empresas de formação de LLCs não te conta: uma LLC **não é para toda a gente**. Tem vantagens enormes se o teu perfil encaixa, mas também tem custos, obrigações e situações onde não faz sentido.
