...
Uma Single-Member LLC com proprietário não residente paga **0% de imposto federal** nos EUA sobre rendimentos de fonte estrangeira. Combinado com a estrutura fiscal correta, pode-se chegar a otimizar a carga fiscal **até 0%**, face aos **40-47%** que pagas como trabalhador independente/autónomo.

Isto não é evasão. é otimização fiscal internacional, completamente legal.

### 2. Proteção patrimonial
A tua LLC é uma entidade separada. Se o teu negócio tiver uma dívida ou um problema legal, os teus bens pessoais (casa, poupanças, carro) estão protegidos. Como trabalhador independente em Portugal ou autónomo/MEI no Brasil, essa proteção não existe, respondes com todo o teu património pessoal.
...
Ao contrário da TSU portuguesa (21,4% sobre rendimento relevante) ou do DAS/INSS brasileiro, a LLC não tem contribuição mensal obrigatória. Pagas manutenção anual, mas não há um custo mensal que não para se não faturas.
...
- Trabalhadores independentes/autónomos com **clientes 100% nacionais**: se todos os teus clientes estão no teu país, a LLC não traz vantagem fiscal
...
## Vantagens e desvantagens da LLC para não residentes: quadro honesto antes de decidir

### Vantagens reais

- **Acesso ao sistema financeiro US.** Stripe, PayPal US, Mercury/Wise USD, Brex, contratos B2B com corporates americanas.
- **Tributação 0% federal sem ETBUS e sem US-source income.** Desenho legal US para não residentes.
- **Profissionalização e credibilidade.**
- **Flexibilidade de planeamento.**
...
### Quando convém uma LLC

Cobranças US recorrentes, expansão a mercado norte-americano, marketplace que exige entidade US, restruturação patrimonial planeada.
...
**A LLC protege-me numa acção?** Limita responsabilidade a activos da LLC com separação rigorosa.

**Posso fechar facilmente?** Sim, com dissolução formal.

Na Exentax modelamos prós/contras com o seu caso real.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…) Una Single-Member LLC con propietario no residente paga **0% de impuesto federal** en EE…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a optimizar la carga fiscal **hasta un 0%**, frente al **40-47%** que pagas como autónomo.…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…tido? - Freelancers digitales con ingresos superiores a **$2,000/mes** - Emprendedores con…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…# ¿Para quién NO tiene sentido? - Autónomos con **clientes 100% nacionales**: si todos tus…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">1.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…$100/año), banco con fees variables. Total realista año 1: $1.500-$3.000. Si tu margen no …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…o), banco con fees variables. Total realista año 1: $1.500-$3.000. Si tu margen no soporta…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ar BOI = $591/día. Olvidar declarar en residencia = sanción 50%-150% del impuesto eludido.…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…OI = $591/día. Olvidar declarar en residencia = sanción 50%-150% del impuesto eludido. Una…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…uales: &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472 + 1120&lt;/a&gt;, FBAR (si…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
