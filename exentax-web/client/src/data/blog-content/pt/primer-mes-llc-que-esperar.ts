...
- recebe acesso ao seu dashboard com seu número de conta, routing number e cartão de débito virtual.

Com sua conta ativa, já pode receber pagamentos em dólares de qualquer parte do mundo.
## Semana 2: Configuração de cobranças

Uma vez que tem a conta bancária, configuramos seus canais de cobrança:
...
Sua LLC está operacional. começa a emitir faturas profissionais da sua empresa americana. Os dados de faturamento são:

- Nome da sua LLC
- Endereço do agente registado
...
No final do primeiro mês, já tem uma rotina estabelecida:
...
### O que acontece nos bastidores (e nem percebe)

Enquanto se dedica a trabalhar no seu negócio durante esse primeiro mês, na Exentax estamos a fazer isso por si:

- **Verificando** que Mercury tenha aprovado corretamente sua conta e que todos os dados estejam corretos
- **Configurando** seu ecossistema de cobranças (Stripe, PayPal, o que precisar)
- **Respondendo** a qualquer solicitação de documentação adicional que o banco possa pedir
- **Garantindo** que seu BOI Report esteja apresentado corretamente perante o <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>
...
|---|---|---|
| **Semana 1** | Conta Mercury aprovada. recebe acesso ao dashboard, routing number e cartão virtual. | Exentax coordena, Mercury aprova |
| **Semana 2** | Configuração de Stripe/PayPal. Primeiro teste de cobrança se quiser. | Exentax orienta, verifica |
| **Semana 3** | Primeiras faturas a clientes. Primeira cobrança real na sua conta Mercury. Champanhe! | fatura, Mercury recebe |
| **Semana 4** | Rotina estabelecida. Separação de contas clara. Dashboard financeiro organizado. | opera, nós supervisionamos |
### E o compliance?

Durante o primeiro mês não tem nenhuma obrigação fiscal. Zero. Nada. As declarações perante o <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> (Form 5472 e Form 1120) são apresentadas uma vez por ano, e nós cuidamos de tudo isso como parte do serviço de manutenção anual.
...
Sim. Chama-se Owner's Draws. transfere do Mercury para sua conta pessoal. Documente como distribuição de lucros. Nós registramos para o Form 5472.

**"Preciso faturar em inglês?"**
Não é obrigatório, mas é recomendável se seus clientes são internacionais. A fatura vai com o nome da sua LLC, o endereço do agente registado, seu EIN e os dados bancários.

**"Quando começo a economizar em impostos?"**
Desde a primeira fatura que emitir através da LLC. A economia fiscal se materializa quando declarar no seu país de residência com a base tributável otimizada.

**"E se eu me arrepender?"**
Pode dissolver a LLC a qualquer momento. Mas ninguém se arrependeu até agora. Uma vez que vê a diferença nos números, não há volta atrás.
...
Na Exentax acompanhamos o mês 1 de cada cliente lusófono, semana a semana. Marca a tua consultoria gratuita: vemos onde estás e damos-te o mapa.
...
## Primeiro mês com a sua LLC: o que esperar (e NÃO esperar) nos 30 dias iniciais

O primeiro mês é uma mistura de espera burocrática e decisões operativas. Eis o que se passa de verdade, semana a semana.

- **Semana 1: formação e EIN.** Articles of Organization apresentados com aprovação em 24-72h. EIN via SS-4 fax ou online - online só para residentes com SSN, para não residentes 2-4 semanas por fax (ou 24h com serviço express EA). Sem EIN não há banco, sem banco não há Stripe.
- **Semana 2-3: conta bancária e onboarding fintech.** Mercury aprova em 3-7 dias com documentação limpa. Wise USD em paralelo como backup. É o gargalo real: rejeições são frequentes.
- **Semana 3-4: Stripe, contabilidade e operating agreement.** Stripe aprovado em 2-5 dias se o site está operacional. Operating agreement assinado. Bookkeeping desde dia 1.
- **O que NÃO acontece no primeiro mês.** Não factura volume significativo, não tem histórico bancário para crédito, não está ainda em "plena segurança jurídica" (falta primeiro 1120/5472 e BOI). É construção, não produção.

### O que mais nos perguntam

**Posso facturar antes de ter conta?** Tecnicamente sim, com conta ponte. Operativamente desaconselhado.

**Em quanto tempo recupero?** Se a LLC abre Stripe USD ou contrato corporate US, normalmente 1-3 meses.

Na Exentax acompanhamos os 30 dias iniciais com calendário semanal e mediação bancária.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…ttps://www.irs.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; (Form 5472 y Form 1120) se pres…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…rs.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; (Form 5472 y Form 1120) se presentan una ve…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
