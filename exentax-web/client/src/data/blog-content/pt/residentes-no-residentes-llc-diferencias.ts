export default `Não é a mesma coisa ter uma LLC sendo residente dos Estados Unidos ou sendo não residente. A estrutura legal é a mesma, mas a **fiscalidade e as obrigações** mudam radicalmente.
