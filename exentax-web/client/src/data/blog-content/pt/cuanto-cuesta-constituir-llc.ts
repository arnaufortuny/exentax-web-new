...
Constituir uma LLC custa de 0 $ a 50 $ de taxa estatal no Novo México, 100 $ no Wyoming e 90 $ no Delaware; com serviço profissional, o custo total do primeiro ano fica entre 400 $ e 1.500 $.

Comecemos por esclarecer uma coisa que faz ranger os ouvidos a quem trabalha nisto: uma LLC não se "cria". **Constitui-se**.

Cria-se um perfil no Instagram ou uma conta da Netflix. Constitui-se uma entidade legal reconhecida por um estado soberano dos Estados Unidos, com obrigações fiscais, um número de identificação federal e deveres de comunicação ao <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>. Diferença subtil — até a **Autoridade Tributária e Aduaneira (AT)** em Portugal, ou a **Receita Federal** no Brasil, puxarem o fio à meada.

Agora que isto ficou dito, a pergunta que importa: quanto custa?

## Custos de constituição (uma vez)

A factura de abertura depende do estado escolhido:

### Novo México
| Rubrica | Detalhe |
|---|---|
| Filing fee estadual | Taxa estadual aplicável |
| Registered Agent (1.º ano) | Serviço incluído |
| Obtenção do EIN | Incluída no serviço |
| Operating Agreement | Personalizado, incluído |
| BOI Report | Apenas se a LLC entrar no âmbito atual (foreign reporting companies após a IFR da FinCEN de março de 2025); se aplicável, incluída |
| **Constituição completa** | Honorário único integral |
...
Constituída a LLC, há obrigações recorrentes que merecem a mesma seriedade que a constituição:

### Novo México: sem Annual Report estadual
| Rubrica | Detalhe |
|---|---|
| Annual Report | Não exigido |
| Taxa estadual anual | Não aplicável |
| Registered Agent | Serviço incluído |
| Form 5472 + 1120 | Preparação profissional incluída |
| **Manutenção integral** | Quota anual única |

### Wyoming
| Rubrica | Detalhe |
|---|---|
| Annual Report obrigatório | Taxa anual estadual |
| Registered Agent | Serviço incluído |
| Form 5472 + 1120 | Preparação profissional incluída |
| **Manutenção integral** | Quota anual única |
...
## Que estado encaixa no seu perfil? Comparativo honesto por caso real

Os preços de tabela não escolhem o estado por si. O estado certo depende daquilo que vende, do volume que factura e de querer ou não procurar investidor, vender a empresa ou simplesmente operar com tranquilidade. É a leitura honesta que damos em cada chamada da Exentax quando um cliente hesita entre Novo México, Wyoming e Delaware:
...
## O custo real da sua LLC a 24 meses

A pergunta que quase ninguém responde por inteiro é: **quanto vai ter pago daqui a dois anos?** Uma LLC tem um pico de despesa no mês 0 (constituição, EIN, Operating Agreement, banca), um pagamento anual fixo no mês 12 e outro no mês 24. Olhar só para 12 meses esconde a parte recorrente; a 24 meses, a fotografia é honesta.

### Cenário A — Freelancer no Novo México (perfil austero)
...
Total real a 24 meses: **uma quota inicial de constituição + duas quotas anuais de manutenção + zero taxas estaduais adicionais.** É a estrutura mais previsível do mercado.

### Cenário B — Agência no Wyoming (perfil equilibrado)

- **Mês 0**: idêntico ao NM em alcance, com a diferença de que o filing fee e o Annual Report futuro estão orçamentados.
- **Mês 12**: além da manutenção Exentax (5472 + 1120 + Registered Agent), paga o Annual Report estadual do Wyoming (taxa anual aplicável segundo a fórmula em vigor).
- **Mês 24**: igual ao mês 12, segundo Annual Report.

Total real a 24 meses: **constituição + duas quotas Exentax + dois Annual Reports estaduais.** Continua acessível e compra a charging-order law forte do Wyoming, é o que se paga a mais face ao NM.

### Cenário C — SaaS no Delaware (perfil corporate)

- **Mês 0**: filing no Delaware (mais caro à entrada), com Operating Agreement preparado para acolher cláusulas de futura ronda seed.
- **Mês 12**: além da quota Exentax, **taxa anual de LLC** do Delaware (o Delaware não cobra Franchise Tax às LLCs no sentido corporate, mas a taxa anual de LLC é fixa e relevante) mais o Registered Agent.
- **Mês 24**: igual ao mês 12.

Total real a 24 meses: **constituição mais cara + dois ciclos de Annual Report + duas quotas Exentax.** O cenário mais caro, justificado quando se vai captar capital ou vender a empresa: recupera-se o prémio no dia em que um VC abre a sua cap table sem o obrigar a redomiciliar.

### O que NÃO muda entre os três cenários

- O Form 5472 + 1120 pro-forma submete-se igual nos três estados; a sanção pela omissão também é a mesma: 25.000 USD por formulário e ano. E se chegar uma notificação, na Exentax mantemos o dossiê pronto para responderes em horas, não em semanas.
- O BOI Report está harmonizado a nível federal; o estado é indiferente.
- A banca (Mercury, Relay, Wise Business) funciona igual nos três estados.
- A sua obrigação de declarar a LLC em residência (AT em Portugal, Receita Federal no Brasil, AEAT em Espanha) não muda com a escolha do estado: a tributação efectiva do proprietário depende da residência, não de Delaware vs NM.

## O custo de NÃO constituir LLC

Eis o número que a maioria ignora: o custo de **não ter LLC** quando devia.

Se factura 60.000 €/ano como independente em Portugal com clientes internacionais e a sua carga efectiva (IRS + contribuições) ronda 35-45 %, são **21.000-27.000 €** de imposto. Com uma LLC bem estruturada e um planeamento de residência limpo, o lado federal dos EUA fica em **0 % de imposto federal** sobre esses fluxos; só sobra a tributação de residência, que pode optimizar-se via atribuição ou dividendo conforme a regra local.

A diferença é real e o custo da LLC amortiza-se no primeiro mês. Leia a nossa <a href="/pt/blog/autonomo-em-espanha-vs-llc-nos-eua-comparacao-fiscal">comparação independente em Espanha vs LLC dos EUA</a> para números trabalhados (o esquema aplica-se da mesma forma a Portugal e ao Brasil com as taxas locais).

## "Mas não há serviços que fazem isto por 49 dólares?"

Sim, há. E fazem exactamente um trabalho mecânico: preenchem um formulário e enviam. Sem aconselhamento fiscal, sem Operating Agreement adaptado ao seu caso, sem suporte pós-constituição, sem preparação de declarações, sem ninguém que lhe explique o que fazer a seguir.

Constituir a LLC é o passo fácil. Difícil — e o que faz a diferença — é operá-la correctamente para que a estrutura fiscal funcione mesmo.

Para aprofundar, <a href="/pt/blog/llc-americana-para-agencias-de-marketing-digital-estrutura">LLC americana para agências de marketing digital: estrutura, facturação e escala</a> e <a href="/pt/blog/seguranca-juridica-da-llc-e-protecao-patrimonial-a-vantagem">Segurança jurídica da LLC e protecção patrimonial: a vantagem</a> completam aquilo que aqui apenas tocamos.

## O que inclui a Exentax (sem letras pequenas nem custos ocultos)

É aqui que fechamos o círculo e juntamos num único bloco aquilo que noutros sites aparece disperso em cinco bullets de marketing: o que fazemos exactamente, o que cobre a quota anual, o que poupa e o que não lhe vamos cobrar à parte mais tarde. Tudo num só lugar, orçamento fechado por escrito antes de começar.

**Na constituição (mês 0):**
- Filing legal no estado óptimo para o seu perfil (Novo México, Wyoming, Delaware ou Florida) com Articles of Organization apresentados ao Secretary of State e filing fee estadual pago por nós.
- Obtenção do EIN federal via SS-4 junto do IRS — sem filas, sem ter de explicar a Washington o que é um não residente.
- Operating Agreement personalizado para o seu caso real, não um modelo descarregado de um blogue.
- BOI Report junto da FinCEN quando aplicável segundo a regra em vigor (após a IFR de Março de 2025, a maioria das LLCs detidas por não residentes já não está no âmbito; monitorizamos por si).
- Registered Agent do 1.º ano incluído.
- Onboarding bancário com Mercury, Relay, Wise Business ou Slash, conforme a actividade e o perfil de pagamentos recebidos.
- Aconselhamento fiscal inicial para perceber toda a estrutura antes de operar.
- ITIN tratado via W-7 sempre que o seu banco ou o gateway o exija.

**Na manutenção anual (todos os anos a partir do ano 1):**
- Preparação e submissão do Form 5472 + Form 1120 pro-forma ao IRS Service Center de Ogden, Utah, com Form 7004 de prorrogação quando convém.
...
Este artigo apoia-se em normas em vigor. Citamos as fontes principais para que possa verificar:

- **EUA.** Treas. Reg. §301.7701-3 (classificação de entidades / *check-the-box*); IRC §882 (imposto sobre rendimentos de estrangeiros conectados com US trade or business); IRC §871 (FDAP e retenções a não residentes); IRC §6038A e Treas. Reg. §1.6038A-2 (<a href="https://www.irs.gov/forms-pubs/about-form-5472" target="_blank" rel="noopener">Form 5472</a> para *25 % foreign-owned* e *foreign-owned disregarded entities*); IRC §7701(b) (residência fiscal, *substantial presence test*); 31 U.S.C. §5336 (Corporate Transparency Act, BOI Report junto da FinCEN).
- **Portugal.** Código do IRS, art. 16.º (residência fiscal); **Código do IRC, art. 66.º e 66.º-A** (regime de imputação de lucros de entidades não residentes sujeitas a regime fiscal claramente mais favorável — CFC); art. 91.º CIRC (eliminação da dupla tributação); Lei Geral Tributária, art. 38.º (cláusula geral antiabuso); Decreto-Lei n.º 64/2016 e Portaria n.º 302-D/2016 (Modelo 53 e troca automática); **Modelo 3 do IRS — Anexo J** (rendimentos obtidos no estrangeiro por residentes em Portugal, incluindo rendas atribuídas a sócios de LLC); **Modelo 58 do Banco de Portugal (BdP)** — comunicação de operações com o exterior e contas detidas fora de Portugal para efeitos de balança de pagamentos.
- **Brasil.** IN RFB 1.520/2014 e seguintes (regime de tributação em bases universais — TBU para pessoas físicas com participação em offshore); **Lei 14.754/2023** (regime aplicável a rendimentos de investimentos no exterior por pessoa física residente no Brasil); Convenção Brasil-EUA para evitar dupla tributação (em negociação, não em vigor); IN RFB 2.060/2021 sobre obrigações acessórias; **DIRPF (Declaração de Ajuste Anual / DAA)** com Bens e Direitos no exterior e ficha de Rendimentos Recebidos do Exterior; **Carnê-Leão Web** para tributação mensal das rendas atribuídas pela LLC; **DCBE — Declaração de Capitais Brasileiros no Exterior** ao Banco Central do Brasil (Bacen) quando o conjunto de ativos no exterior atinge o limite anual ou trimestral; **e-Financeira** (IN RFB 1.571/2015) como canal de troca de informação financeira automática (FATCA / CRS-equivalente bilateral Brasil-EUA).
...
A aplicação concreta destas normas ao seu caso depende da residência fiscal, da actividade da LLC e da documentação que mantenha. Este conteúdo é informativo e não substitui aconselhamento profissional personalizado.
...
- **Tributação zero**: nenhuma estrutura LLC consegue "zero impostos" se vives num país com regras CFC/transparência fiscal ou atribuição de rendimentos. O que se consegue é **não duplicar tributação** e **declarar correctamente na residência**, não eliminá-la.
...
- [Documentos da LLC: quais precisa e como organizá-los](/pt/blog/documentos-da-llc-quais-precisa-e-como-organiza-los)
- [Registered Agent: o que é e por que é obrigatório para a sua LLC](/pt/blog/registered-agent-o-que-e-e-por-que-e-obrigatorio-para-sua)
<!-- /exentax:cross-refs-v1 -->

<!-- exentax:legal-facts-v1 -->
## Factos legais e de procedimento

As obrigações junto da FinCEN e do IRS mudaram recentemente; eis o estado atual:
...
Cada situação fiscal depende da sua residência, da actividade exercida e dos contratos em vigor. As informações aqui apresentadas são gerais e não substituem aconselhamento personalizado; analise o seu caso específico antes de tomar decisões estruturais.
...
**Preciso de ITIN para constituir a LLC ou só para certas coisas?** Para constituir, não. Para o EIN, não obrigatoriamente (pede-se por fax com passaporte se a casa do responsible party for preenchida correctamente). Para abrir Mercury ou Wise Business, normalmente não. Para Stripe, Slash ou qualquer gateway que peça W-9 do responsible party, sim. Tratamos do ITIN quando um gateway o bloquear, não "por precaução".
...
**Leituras associadas:** para aprofundar, veja o nosso artigo sobre <a href="/pt/blog/diferenca-llc-vs-corporation-s-corp-c-corp-guia">diferenças entre LLC, Corporation, S-Corp e C-Corp</a>.
