export default `Uma das perguntas mais frequentes quando você começa a operar sua LLC é: "Enviei dinheiro para um cliente, quando chega?" Ou ao contrário: "Vão me pagar, quando vejo na minha conta?"
