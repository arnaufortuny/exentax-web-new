...
- **EIN Confirmation Letter**: a carta do <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> confirmando o teu número fiscal
...
Na Exentax preparamos o dossier bancário para passar Mercury, Relay ou Chase à primeira para clientes em Portugal e no Brasil. Marca a tua consultoria gratuita: identificamos os buracos e tapamo-los antes de clicares em „Open account”.
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…tu LLC y tus datos personales. En Mercury, este proceso es 100% online. ### 2. Verificació…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">250,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…regulado por la FDIC. Tus depósitos están asegurados hasta $250,000, con cobertura extendi…»</span> <strong>[NÃO VERIFICADO]</strong></li>
