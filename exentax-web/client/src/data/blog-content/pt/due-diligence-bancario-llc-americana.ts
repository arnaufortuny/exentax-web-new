export default `Quando solicitas uma conta bancária empresarial para a tua LLC nos Estados Unidos, o banco não te abre simplesmente uma conta. Realiza um processo de due diligence (devida diligência) para verificar que a tua empresa é legítima e que tu és quem dizes ser.
