export default `A Estónia tornou-se popular graças à e-Residency, à sua digitalização e à promessa de "0 % sobre lucros reinvestidos". É provavelmente a jurisdição europeia com melhor marketing institucional e, ao mesmo tempo, uma das pior compreendidas. Este guia explica como funciona realmente o sistema fiscal estónio atualmente, sem ainda avaliar se encaixa no seu caso. Para essa segunda discussão, já escrevemos um artigo dedicado: <a href="/pt/blog/por-que-nao-abrir-uma-empresa-na-estonia-a-llc-americana">por que não abrir empresa na Estónia para a maioria dos não residentes</a>.
...
- Os dividendos recebidos tributam à taxa autónoma de 28 % de <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> (ou englobamento opcional).
...
**E se vivo em Portugal com NHR activo?** NHR isenta dividendos de fonte estrangeira sob certas condições. NHR + OÜ funcionou em muitos casos, mas o regime NHR está limitado em altas posteriores a 2024 - verificar elegibilidade antes de planear.

Na Exentax modelamos Estónia OÜ com a sua residência e plano de extracção real - se o diferimento acrescenta ou se LLC US ou estatuto independente cobrem melhor o caso sem a complexidade estónia.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…racias a la e-Residency, su digitalización y la promesa de &quot;0% sobre beneficios reinvertid…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">2.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ial mínimo: 0,01 EUR desde la última reforma (anteriormente 2.500 EUR exigibles a la prime…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «….500 EUR exigibles a la primera distribución). Constitución 100% online en 1-3 días con e-…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">22%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ciedad reparte dividendos a los socios, Estonia aplica el **22% nominal**, calculado como …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">7.800</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…sobre el importe neto distribuido. Es decir, para entregar 7.800 EUR netos al socio, la so…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…egar 7.800 EUR netos al socio, la sociedad debe disponer de 10.000 EUR (7.800 al socio + 2…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">2.200</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…, la sociedad debe disponer de 10.000 EUR (7.800 al socio + 2.200 de impuesto). Sobre el b…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">14%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…carga efectiva es del 22%. - Existe un tipo reducido del **14% (calculado como 14/86)** pa…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…- Los dividendos recibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…idendos recibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EU…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hast…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…butan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">23%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% has…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…horro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">28%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000 EUR, 28% por encima. - El convenio …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…nio España-Estonia limita la retención en origen estonia al 5% sobre dividendos para parti…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a al 5% sobre dividendos para participaciones inferiores al 25%, y existe deducción por do…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…doble imposición. - Carga combinada típica: en torno al 25-30% según renta total. Si eres …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**Declaración mensual de IVA** si está registada (umbral: 40.000 EUR/año en EEE). - **Dec…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…do contabilidad, domicilio, contact person y annual report: 1.500-3.500 EUR. ## Banca: el …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">3.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…tabilidad, domicilio, contact person y annual report: 1.500-3.500 EUR. ## Banca: el cuello…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…fica el valor del régimen. **Caso 2: consultor europeo con 80.000 EUR/año que necesita el …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…cios queden en la sociedad, 0% de impuestos. Al distribuir, 20% (22% efectivo según el eje…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…España: TFI/CFC aplica si tributación efectiva estonia es &lt;50% de la española y la socieda…»</span> <strong>[NÃO VERIFICADO]</strong></li>
