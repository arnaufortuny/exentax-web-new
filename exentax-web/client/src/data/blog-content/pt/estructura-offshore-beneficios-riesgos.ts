export default `A palavra "offshore" arrasta um peso enorme: para alguns significa liberdade financeira e planeamento inteligente, para outros evasão e opacidade. A realidade é mais prosaica. Uma estrutura offshore não é ilegal por definição nem mágica por si só: é simplesmente uma sociedade ou conjunto de sociedades constituídas numa jurisdição diferente daquela onde o proprietário reside. O que a torna boa ou má ideia é como se usa, o que se declara e que riscos se assumem.
...
- Banca operacional remota (Mercury, Wise, Wallester, Slash).
...
Na Exentax podemos analisar a sua situação e propor a estrutura mínima viável que cubra os seus objetivos sem assumir riscos desnecessários. Na Exentax analisamos o teu caso com dados reais: <a href="/pt/agendar">agenda uma consulta gratuita</a> de 30 minutos.
...
> **Quer saber se o seu setup atual o expõe a alguma destas listas?** Passe o caso pela <strong>calculadora fiscal da Exentax</strong>.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…0; equivalentes en LatAm). No hacerlo es delito. - **&quot;Pagar 0% a nivel personal&quot;**: tu paí…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…cionado**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domici…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…o**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domicilios, …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ncia, SaaS, ecommerce y creadores. - **Reino Unido (Ltd)**: 25% impuesto de sociedades per…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…en Estonia o necesitas IBAN europeo. - **Bulgaria (OOD)**: 10% de impuesto de sociedades, …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…de tu país. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, int…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">200%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ís. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, intereses y…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">RD 1080/1991</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…febrero de 2023)**, modificada posteriormente. Sustituyó al RD 1080/1991 e introdujo crite…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
