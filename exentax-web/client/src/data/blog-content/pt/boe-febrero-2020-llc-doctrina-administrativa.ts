...
Se és residente fiscal em Portugal, no Brasil ou em Angola e tens uma <a href="/pt/blog/llc-estados-unidos-guia-completo-nao-residentes-2026">LLC americana</a>, a pergunta-chave não é o que diz a IRS norte-americana mas sim o que dizem as autoridades fiscais de cada país sobre a tua LLC. E para entender o tema com profundidade vale a pena começar pela jurisdição que mais tinta gastou nesta matéria: Espanha, com o seu corpus de consultas vinculativas da Direcção-Geral dos Tributos (DGT) e resoluções do Tribunal Económico-Administrativo Central (TEAC) consolidado a partir de fevereiro de 2020. Esse referencial influencia a forma como a Autoridade Tributária e Aduaneira (AT) portuguesa, a Receita Federal do Brasil (RFB) e a Administração Geral Tributária (AGT) angolana abordam casos análogos. Vamos analisá-lo com precisão.
...
- **Não se aplicam as exenções por dupla tributação de dividendos.** Aplica-se o **crédito por dupla tributação jurídica internacional** (art. 81.º do CIRS em Portugal, art. 80 LIRPF em Espanha) apenas pelo imposto efectivamente pago nos EUA, que para uma Disregarded Entity é tipicamente **0 USD** federal (ver <a href="/pt/blog/tributacao-pass-through-para-llc-como-funciona-e-por-que">tributação pass-through</a>).
...
Mais detalhe em <a href="/pt/blog/deducoes-fiscais-para-sua-llc-o-que-pode-deduzir-e-como">despesas dedutíveis na tua LLC</a>.

### Implicações operacionais

1. **Precisas de contabilidade real da LLC.** Não podes "estimar" o rendimento líquido: precisas de livros, justificativos, conciliações bancárias. Em Portugal, contabilidade organizada certificada por contabilista certificado (CC) acima do limiar dos 200.000 €.
2. **O teu IRS deve declarar o rendimento líquido imputado**, não a "remessa" recebida na tua conta pessoal. O Anexo J e, quando aplicável, o Anexo B do Modelo 3 são as peças centrais.
...
4. **Pagamentos por conta.** Se qualificares como Categoria B em Portugal, entras no calendário de pagamentos por conta e retenções na fonte aplicáveis aos titulares de rendimentos profissionais.
...
3. **Considerar a tua actividade concreta.** Regime prático distinto para serviços, e-commerce, royalties, trading. Desenvolvido em <a href="/pt/blog/tributacao-da-llc-segundo-a-atividade-economica-servicos">tributação da LLC consoante a tua actividade económica</a>.
4. **Manter documentação robusta.** É o que distingue uma estrutura defensável de uma estrutura vulnerável: contratos com clientes, facturas, comprovativos de despesa, actas de decisão.
...
Queres rever o teu caso à luz da doutrina vigente e desenhar a estrutura mais eficiente para a tua situação? Marca a tua assessoria gratuita.

Para fechar com uma leitura relacionada que encaixa naturalmente neste fio: <a href="/pt/blog/tributacao-internacional-para-empreendedores-digitais-guia">Tributação internacional para empreendedores digitais: tudo o que precisas de saber</a> ajuda a contextualizar o cenário.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Precisas de falar já? Escreve-nos por <a href="https://wa.me/34614916910?text=Ol%C3%A1%20Exentax%2C%20venho%20do%20artigo%20%22BOE%20fevereiro%202020%20LLC%20doutrina%20administrativa%22%20e%20quero%20falar%20com%20um%20assessor%20sobre%20o%20meu%20caso.">WhatsApp</a> e respondemos hoje mesmo.</p>
