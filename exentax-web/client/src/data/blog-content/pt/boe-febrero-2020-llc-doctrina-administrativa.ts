...
Queres rever o teu caso à luz da doutrina vigente e desenhar a estrutura mais eficiente para a tua situação? Marca a tua consultoria gratuita.
...
- **Revolut Business**: quando se associa a uma **LLC norte-americana**, o normal é operar sob Revolut Payments USA; os IBAN europeus (lituanos, BE) **não são emitidos por defeito** a uma LLC: são emitidos a clientes europeus do banco europeu do grupo. Se te oferecerem um IBAN europeu, certifica-te de a que entidade jurídica a conta está associada e sob que regime reporta.
