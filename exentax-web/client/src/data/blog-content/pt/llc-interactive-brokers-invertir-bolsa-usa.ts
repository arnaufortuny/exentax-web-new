export default `Uma das perguntas mais frequentes que os clientes da Exentax fecham connosco: "posso abrir Interactive Brokers em nome da minha LLC para investir a partir dos Estados Unidos?". A resposta é **sim, faz-se, e bem estruturado faz sentido**. Neste artigo explicamos como funciona realmente, que brokers estão disponíveis para uma LLC de não residentes, o que muda fiscalmente e como se desenha uma operação de investimento limpa a partir da tua LLC.

## O ponto de partida

Uma **Single-Member LLC** US, propriedade de um não residente, tem plena capacidade jurídica nos Estados Unidos. Tem EIN, tem conta bancária operacional, tem domicílio legal via registered agent. Para abrir conta de broker é exatamente igual a qualquer outra entidade US: apresenta os seus documentos corporativos, identifica o beneficial owner com W-8BEN-E, e opera com normalidade.

Que um não residente abra conta de broker para a sua LLC é prática habitual. O importante é saber qual broker, com que documentação e para que objetivo.
## Brokers que abrem conta a uma LLC de não residente

Existem opções reais. A ideia de que "nenhum broker top-tier aceita LLC foreign-owned" é falsa. Estes são os caminhos efetivos:

### Interactive Brokers (ações, ETFs, opções, obrigações)

A IB aceita contas em nome de LLC US com beneficial owner não residente. A abertura faz-se como conta business e os documentos-chave são:

- Articles of Organization da LLC.
- EIN Letter (CP575 ou 147C).
- Operating Agreement.
- W-8BEN-E assinado pela LLC declarando o beneficial owner real.
- Documento de identidade do proprietário.
- Comprovativo de morada do proprietário.

O processo costuma resolver-se em 2–4 semanas se a documentação chegar completa e coerente. O que vemos na Exentax: quando a LLC está bem constituída e os documentos são consistentes (mesmo nome legal, mesmo EIN, mesmo beneficial owner declarado no BOI e no W-8BEN-E), a abertura é direta.

Acesso: 150+ mercados, comissões competitivas, ferramentas profissionais (TWS, IBKR Pro), margem, opções, futuros via a própria plataforma.

### Tradovate (futuros)

A Tradovate permite abrir contas em nome de LLC para operar futuros (ES, NQ, CL, GC, etc.). Documentação semelhante (Articles, EIN, Operating Agreement, W-8BEN-E). É a opção de referência quando a atividade da LLC é trading de futuros com horizonte intradiário ou swing.

### Kraken (cripto institucional)

A Kraken aceita contas corporativas para LLCs e opera com não residentes. A conta institucional/Pro permite operar com criptoativos com custódia regulada e ferramentas de trading sérias. Para uma LLC com atividade cripto (trading, tesouraria em stablecoins, exposição a BTC/ETH), a Kraken é um dos caminhos limpos.

### Outras disponíveis consoante perfil

- **Charles Schwab International**: contas para não residentes, tradicionalmente mais focado em pessoas singulares.
- **TastyTrade / Tradier**: aceitam LLCs US, especialmente úteis para opções.
- **Webull**: opera com LLC com documentação standard.

O critério real não é "que broker me deixa", é "que broker encaixa com a tua atividade e com a forma como a tua LLC está desenhada".
## O que muda fiscalmente quando investes via LLC

Aqui vai o enquadramento real, sem marketing e sem alarme.

### Nos EUA (federal)

Uma SMLLC disregarded foreign-owned que invista em mercados financeiros US:

- **Mais-valias sobre ações US**: para não residentes, as mais-valias da venda de ações US **não são rendimento de fonte US** (IRC §865(a)(2)) salvo presença física superior a 183 dias. **Não há tributação nos EUA** sobre as mais-valias da carteira. Isto mantém-se quando a operação vai via SMLLC disregarded.
- **Dividendos US**: withholding de 30 % por defeito, redutível via treaty (15 % Portugal, 15 % Espanha, 15 % México, 15 % Colômbia, 10 % Chile, 15 % Argentina). O broker aplica a treaty rate se o W-8BEN-E estiver apresentado.
- **Juros portfolio (obrigações US)**: 0 % ao abrigo da portfolio interest exemption (§871(h)) cumprindo os requisitos.
- **Juros bancários US**: tipicamente isentos para não residentes (§871(i)).

A LLC não acrescenta tributação federal nova. O que acrescenta é **uma entidade operacional limpa** com conta de broker própria, reporting próprio, rastreabilidade própria.

### No teu país de residência

A distribuição de dividendos e mais-valias que a LLC recebe, quando se atribui ou se distribui ao sócio residente, tributa segundo as regras do teu país (<a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> em Portugal, IRPF em Espanha, ISR no México, etc.). Aqui a LLC não é um escudo fiscal perante a tua autoridade fiscal local: o planeamento vem do **desenho do fluxo** (quando distribuis, o que reinvestes, que veículos escolhes), não do envólucro.
## Quando faz sentido investir via LLC (os casos reais)

### 1. Tens uma LLC operativa com tesouraria excedente

A tua LLC fatura, opera, e acumula caixa entre distribuições. Investir essa caixa em T-Bills (via Slash ou IB), money market ou ETFs conservadores **dentro da própria LLC** mantém o capital produtivo sem o tirares para a tua vida pessoal antes de tempo. Operação habitual e limpa.

### 2. Queres operar derivados (opções, futuros) com veículo dedicado

Uma conta de broker dentro da LLC separa-te a atividade de derivados do teu património pessoal. Se a operação é séria, a LLC traz ordem contabilística, separação patrimonial e um perímetro fiscal definido. IB para opções, Tradovate para futuros.

### 3. Trading cripto com escala

Operar cripto a partir de uma LLC abre acesso a produtos institucionais (Kraken Pro, custódia, tarifas), separa o risco do património pessoal e permite rastreabilidade limpa para a tua declaração. Para volumes sérios é o caminho standard.

### 4. Estrutura familiar / patrimonial coordenada

Famílias que coordenam a sua exposição ao mercado dentro de uma LLC para manter um único centro de gestão, controlo de distribuições aos membros e planeamento coerente com outras estruturas (sociedade no país de residência, fideicomisso, etc.).

### 5. Investimento ativo com custos dedutíveis

A LLC permite deduzir despesas operacionais associadas à atividade investidora séria: data feeds, software de análise, formação, infraestrutura. Quando há atividade real, esses custos reduzem a base.
### O único detalhe a planear: estate tax US sobre ativos US diretos

É o ponto que sim convém saber, sem alarmismo:

Um não residente que faleça com ativos US-situs acima de 60.000 USD (ações US diretas, por exemplo) está sujeito a US estate tax federal. Uma SMLLC disregarded não isola esse risco por si só, porque também se transparenta para efeitos de estate tax.

Significa isto que não deves investir via LLC? Não. Significa que, se a tua carteira US direta ultrapassa esse limite, convém **planear** com um destes caminhos:

- **ETFs UCITS irlandeses/luxemburgueses** dentro da LLC: não são US-situs, eliminam o risco de estate tax sobre essa parte.
- **Estrutura interposta** (sociedade não US por cima da LLC) quando os montantes o justificam.
- **Cobertura específica** (term life US insurance) em perfis concretos.

É planeamento patrimonial standard, não um problema da LLC. Desenhamo-lo contigo quando o património investido o pede.
### O que vemos cada semana na Exentax

**O cliente que vai abrir IB sem EIN coerente**: a LLC foi constituída há meses, o EIN está, mas o operating agreement não menciona o beneficial owner corretamente e o W-8BEN-E que o cliente prepara tem erros. A IB pede esclarecimentos e o processo trava. Resolvemos numa passagem: documentos consistentes, W-8BEN-E correto, abertura limpa.
...
2. **W-8BEN-E correto**: identificação do beneficial owner, declaração de treaty se aplicável, datas e assinaturas em ordem.
3. **Capitalização documentada**: a LLC tem fundos próprios para investir; as entradas do sócio estão registadas.
...
E, sobretudo, montamos-te o ecossistema completo: banca operacional, tesouraria com rendimento, cartões corporativos, brokers consoante o teu objetivo, distribuições planeadas. Uma estrutura que investe com ordem, não uma LLC com um broker improvisado por cima.
...
## LLC + Interactive Brokers: como investir na bolsa US como entidade e porque às vezes compensa

Investir na bolsa US através da sua LLC em vez de a título pessoal muda o regime fiscal, a rastreabilidade e o planeamento sucessório. Não é para todos, mas para perfis específicos (capital >250k, plano de reinvestimento sustentado, residência com CFC favorável) é tecnicamente correcto.

- **Como funciona o setup.** Single-member LLC (Wyoming preferido por privacidade), EIN, conta IBKR Pro aberta em nome da LLC com W-8BEN-E (benefícios convencionais se PT, ES, FR, etc.). IBKR é o broker que melhor aceita entidades estrangeiras e LLCs transparentes.
- **Tributação de mais-valias e dividendos.** Mais-valias bolsa US para LLC propriedade de não residente: 0% federal. Dividendos US: retenção 30% por defeito, reduzida a 15% (ou 0% em casos específicos) sob convenção com W-8BEN-E. Tributação em residência: atribuição se LLC transparente (PT IRS), ou dividendo se opaca.
- **Porque investir desde LLC vs pessoal.** Centralização para gestão profissional, sucessão simplificada, separação operativa da actividade principal, possível holding intermediária com reinvestimento sem distribuição. NÃO é escudo fiscal automático.
- **Quando não convém.** Capital <250k EUR, residência com CFC agressivo, ou plano de retirar tudo em 1-2 anos.

### O que mais nos perguntam

**A IBKR deixa-me abrir conta como LLC sem ITIN?** Sim, com EIN da LLC e W-8BEN-E correctamente preenchido. ITIN é do owner; raro a IBKR exigir para entidade transparente.

**Diferença fiscal LLC vs pessoal para bolsa US?** Na tributação US: praticamente nenhuma. Em residência (PT): a LLC é atribuída, tributa igual. A vantagem LLC é planeamento, não fiscalidade directa.

Na Exentax montamos o setup LLC + IBKR + W-8BEN-E + bookkeeping específico para portfolios de investimento e modelamos antes se compensa.
...
<li><span class="font-mono">30 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…vía SMLLC disregarded. - **Dividendos US**: withholding del 30 % por defecto, reducible ví…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">15 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**: withholding del 30 % por defecto, reducible vía treaty (15 % España, 15 % México, 15 %…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">10 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ucible vía treaty (15 % España, 15 % México, 15 % Colombia, 10 % Chile, 15 % Argentina). E…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">0 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…EN-E está presentada. - **Intereses portfolio (bonos US)**: 0 % bajo portfolio interest ex…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…sidente que fallece teniendo activos US-situs por encima de 60.000 USD (acciones US direct…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…pital gains de bolsa US para LLC propiedad de no residente: 0% federal (no efectivamente c…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ectivamente conectado, sin ETBUS). Dividendos US: retención 30% por defecto, reducida a 15…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">15%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…TBUS). Dividendos US: retención 30% por defecto, reducida a 15% (o 0% en casos específicos…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">IRC §865</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…lías de venta de acciones US **no son renta de fuente US** (IRC §865(a)(2)) salvo presenci…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
