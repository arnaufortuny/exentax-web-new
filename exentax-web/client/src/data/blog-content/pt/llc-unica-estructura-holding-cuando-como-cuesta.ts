export default `Quando uma LLC funciona, a pergunta muda. Já não é "devo abrir uma LLC?", é "devo ter mais do que uma?". E quase sempre: "devo passar a uma estrutura holding?". Este artigo responde com dados reais: quando o salto se justifica, como se monta sem partir nada, e quanto custa de facto manter.
...
|---|---|
| Annual Reports estatais (4 entidades × 50-60 USD) | 200-240 |
| Registered Agent (4 × 100-150) | 400-600 |
| Contabilidade e compliance <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> (5472+1120 × 4) | 1.800-3.200 |
| Actualizações BOI se houver | 0 (grátis) |
| Honorários estruturais (fornecedor pro) | 1.500-3.500 |
| **Total estimado** | **4.000-7.500 USD/ano** |
...
1. **Constituição das novas entidades**. 2-4 semanas.
2. **Abertura bancária** para holding e novas operativas. 4-8 semanas em Mercury/Wise/Relay.
3. **Migração progressiva** de contratos e cobranças desde a LLC original, sem cortar facturação. 2-3 meses.
4. **Encerramento ou reorganização** da LLC original.
...
<!-- exentax:cta-v1 -->
Constituição desde 2.000 € e manutenção desde 1.400 €/ano. A consulta inicial é gratuita. <a href="/pt/servicos/llc-wyoming">Marcar consulta gratuita</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">1.800</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…v&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; (5472+1120 × 4) | 1.800-3.200 | | BOI updates si…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">3.200</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…get=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; (5472+1120 × 4) | 1.800-3.200 | | BOI updates si hay c…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…tis) | | Honorarios estructurales (proveedor profesional) | 1.500-3.500 | | **Total estima…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">3.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…| Honorarios estructurales (proveedor profesional) | 1.500-3.500 | | **Total estimado** | …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
<li><span class="font-mono">4.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…eedor profesional) | 1.500-3.500 | | **Total estimado** | **4.000-7.500 USD/año** | A esto…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">7.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…profesional) | 1.500-3.500 | | **Total estimado** | **4.000-7.500 USD/año** | A esto hay q…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…, sin plan de venta parcial del negocio. Coste anual: 1.500-2.500 USD (registered agent + …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">80%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…contabilidad básica + 1120/5472). Es la opción óptima para 80% de casos en los primeros 1-…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…- **Cómo se construye técnicamente.** La holding LLC posee 100% del membership interest de…»</span> <strong>[NÃO VERIFICADO]</strong></li>
