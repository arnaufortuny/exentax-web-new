...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Queres falar agora? Liga-nos para <a href="tel:+34614916910">+34 614 916 910</a> ou escreve-nos por <a href="https://wa.me/34614916910?text=Ol%C3%A1%20Exentax%2C%20estou%20a%20ler%20%22O%20regime%20de%20tributa%C3%A7%C3%A3o%20que%20escolhe%20como%20aut%C3%B3nomo%20determina%20como%20calcula%20o%20IRP%E2%80%A6%22%20e%20quero%20falar%20com%20um%20consultor%20sobre%20o%20meu%20caso.">WhatsApp</a> e respondemos hoje.</p>
...
<li><span class="font-mono">600.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ón directa, en su variante simplificada (rendimientos hasta 600.000 euros) o normal (por e…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…siones. La simplificada permite una deducción adicional del 5% del rendimiento neto positi…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">2.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…de gastos de difícil justificación, con un máximo anual de 2.000 euros. Es lo que usan más…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">90%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…con un máximo anual de 2.000 euros. Es lo que usan más del 90% de los autónomos profesiona…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">250.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…excluido si tu volumen de rendimientos íntegros supera los 250.000 euros anuales (150.000 …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">150.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…de rendimientos íntegros supera los 250.000 euros anuales (150.000 en agricultura, ganader…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…guno de los dos te encaja: alternativas Si tu actividad es 100% digital, internacional y c…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ETA, modelos trimestrales y un IRPF progresivo que llega al 47%. Una &lt;a href=&quot;/es/blog/llc…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ñol puro para perfiles digitales con facturación superior a 40.000 euros anuales. La regul…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">RD 439/2007</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…s. La regulación detallada está en el Reglamento del IRPF (RD 439/2007) y en la Orden anua…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
