...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Queres falar agora? Escreve-nos por <a href="https://wa.me/34614916910?text=Ol%C3%A1%20Exentax%2C%20estou%20a%20ler%20%22O%20regime%20de%20tributa%C3%A7%C3%A3o%20que%20escolhe%20como%20aut%C3%B3nomo%20determina%20como%20calcula%20o%20IRP%E2%80%A6%22%20e%20quero%20falar%20com%20um%20assessor%20sobre%20o%20meu%20caso.">WhatsApp</a> e respondemos hoje.</p>
...
Raramente recomendamos módulos versus estimativa directa no abstracto: a resposta depende do perfil de actividade e da previsibilidade do rendimento. A tabela de decisão que partilhamos com clientes tem quatro colunas. Primeira coluna: sector de actividade (a disponibilidade de módulos é fixada pelo código de actividade; alguns perfis digitais e de assessoria estão excluídos por definição). Segunda coluna: previsibilidade do rendimento (os módulos dão a mesma factura trimestral fixa independentemente do rendimento real, o que protege o lado positivo mas penaliza os anos fracos). Terceira coluna: intensidade de despesas dedutíveis (a estimativa directa recompensa perfis com despesas elevadas porque a base de IRPF é líquida; os módulos ignoram despesas, o que favorece actividades com poucas despesas). Quarta coluna: a disciplina plurianual (mudar de regime tranca a nova escolha por pelo menos três anos, pelo que a decisão deve ser projectada contra um horizonte de três anos, não um único ano). A recomendação limpa vem de preencher a tabela com números reais e ler o resultado, não de uma regra de uma linha.
