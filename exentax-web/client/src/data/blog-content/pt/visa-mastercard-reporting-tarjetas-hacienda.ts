...
A regra geral é que **a conta e a titularidade estão bem cobertas**, enquanto o **detalhe transação a transação** não é enviado de ofício: é reconstruído apenas numa inspeção concreta.
...
5. **"Melhor pagar sempre com o cartão estrangeiro para não deixar rasto."** O rasto existe e, sobretudo, operar de forma claramente desenhada para não deixar rasto é exatamente o padrão que mais depressa dispara alertas numa inspeção.
...
<li><span class="font-mono">3.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…terminados umbrales (clásicamente, operaciones superiores a 3.000 € en efectivo y, para co…»</span> <strong>[NÃO VERIFICADO]</strong></li>
