export default `O IBAN belga que a Wise atribui a uma LLC entra na troca CRS de mais de 120 jurisdições, e para um residente fiscal em Espanha a AEAT recebe o saldo a 31 de dezembro todo setembro.
