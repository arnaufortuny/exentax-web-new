...
<li><span class="font-mono">25%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ssive NFE, los datos de los controlling persons (umbral del 25% directo o indirecto, o con…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…servicios cumplen los requisitos de **Active NFE** (más del 50% de los ingresos son operat…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…(declaración de bienes en el extranjero, umbral agregado de 50.000 €) y, en su caso, Model…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">DAC2</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…n la UE se transpuso a través de la **Directiva 2011/16/UE (DAC2)** y, en Bélgica, mediant…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
