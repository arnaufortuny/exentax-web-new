export default `Em Portugal não há bem um equivalente ao Registered Agent: é uma mistura de sede social, mandatário fiscal e oficial de diligências. Cada estado dos EUA exige que a LLC nomeie um, fisicamente presente no estado, disponível em horário comercial. E não, o Registered Agent não é a tua morada bancária.
...
Na Exentax integramos um Registered Agent sólido logo na constituição para clientes lusófonos. Marca a tua consultoria gratuita: validamos a tua cobertura e, se for frágil, trocamo-la.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…ntienden que tu LLC es de un extranjero, no saben qué es el Form 5472, y no pueden orienta…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
