export default `Se está a constituir uma LLC nos Estados Unidos, um dos requisitos obrigatórios é designar um Registered Agent (agente registado). Não é opcional, sem ele, não pode constituir nem manter a sua LLC em nenhum estado. Mas fique tranquilo: na Exentax o Registered Agent está incluído em todos os nossos planos. Não tem de o procurar, contratar nem renovar. Tratamos de tudo.
