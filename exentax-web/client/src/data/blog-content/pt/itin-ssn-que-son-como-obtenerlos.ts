...
O SSN não é apenas um número fiscal. é a sua identidade no sistema norte-americano. o usa para trabalhar, pagar impostos, acessar benefícios da Seguridade Social, solicitar crédito e praticamente tudo que envolva interagir com o governo federal.

**Se não é cidadão nem residente dos EUA, não pode obter um SSN.** Simples assim. Não há exceções, não há atalhos, não há truques. Se alguém disser o contrário, desconfie.
...
**Se tem uma LLC e é não residente, o ITIN é o seu número.** não precisa de SSN, não pode obtê-lo, e não precisa dele. O ITIN cumpre perfeitamente a sua função para tudo o que se relaciona com a sua LLC.
...
### Para que precisa do ITIN se tem uma LLC?
...
O processo tem vários passos, mas é completamente gerenciável, especialmente se tiver alguém que o gerencie por si (spoiler: na Exentax cuidamos de tudo).

### Passo 1: Preparar o Form W-7

O Form W-7 é a solicitação oficial do ITIN perante o IRS. Inclui os seus dados pessoais, o seu endereço, o seu país de cidadania e o motivo pelo qual precisa do ITIN.

### Passo 2: Reunir a documentação de suporte

Precisa de documentos que comprovem a sua identidade e o seu status de estrangeiro. Os mais comuns:
...
O passaporte vigente é, de longe, a opção mais simples. Se tem passaporte, basicamente é a única coisa que precisa como documento de suporte.

### Passo 3: Incluir uma declaração de impostos

O IRS exige que o Form W-7 seja apresentado junto com uma declaração de impostos federal (como o Form 1040-NR ou anexo ao Form 1120 da sua LLC). Isso demonstra que precisa do ITIN para um propósito fiscal real.
...
Envia o Form W-7 + declaração de impostos + documentos originais (ou cópias autenticadas) ao IRS ITIN Operation Center em Austin, Texas. O IRS devolve os documentos originais em 60-90 dias.

**Opção B: Através de um CAA (Certified Acceptance Agent)**
Um CAA é uma pessoa ou entidade autorizada pelo IRS para verificar os seus documentos de identidade. A vantagem é que o CAA autentica os seus documentos, então **não precisa enviar os originais** ao IRS. Muito mais seguro e cômodo.

**Opção C: Pessoalmente em um escritório do IRS**
Só viável se estiver nos Estados Unidos. se apresenta com os documentos, verificam a sua identidade na hora e processam a solicitação.
...
Uma vez aprovado, recebe uma carta do IRS com o seu ITIN atribuído. Esse número não expira enquanto o usar pelo menos uma vez a cada 3 anos em uma declaração fiscal.
## Erros comuns ao solicitar o ITIN

Depois de gerir dezenas de solicitações de ITIN, estes são os erros que mais vemos:

- **Enviar documentos incompletos.** Se faltar algo, o IRS rejeita a solicitação e tem que recomeçar do zero.
...
- **Não renovar um ITIN expirado.** Se não usou o seu ITIN em 3 anos, deve renová-lo antes de apresentar declarações.
...
- Envio de documentos por correio registado internacional
- Preparação da declaração de impostos que deve acompanhar a solicitação
### Na Exentax ajudamos a obter o seu ITIN
...
**Na Exentax cuidamos de todo o processo por si:**

- Preparamos o Form W-7 com todas as informações corretas
- Orientamos sobre quais documentos precisa e como prepará-los
...
- Fazemos acompanhamento até que receba o seu ITIN
...
Para continuar neste fio, <a href="/pt/blog/problemas-comuns-da-llc-e-como-evita-los-licoes-de-clientes">Problemas comuns da LLC e como evitá-los: lições de clientes reais</a> completa uma nuance que aqui apenas tocámos.
### Precisa do seu ITIN agora?

Se acabou de constituir a sua LLC ou está prestes a fazê-lo, o momento de solicitar o seu ITIN é agora. Quanto antes o tiver, antes poderá cumprir com todas as suas obrigações fiscais sem complicações.

Na Exentax montamos o pedido de ITIN via Certifying Acceptance Agent para clientes lusófonos. Marca a tua consultoria gratuita: vemos se realmente precisas e, se sim, levamo-lo até ao fim.
...
## ITIN e SSN: o que são, em que diferem e qual lhe convém tratar

Confundir ITIN e SSN é um dos erros mais comuns ao montar uma LLC sem passaporte americano. São dois números fiscais emitidos por administrações distintas, com casos de uso muito diferentes.

- **SSN (Social Security Number).** Emitido pela Social Security Administration e reservado a cidadãos US e residentes com autorização de trabalho. Se não for nenhum, não pode obter SSN - não é um trâmite, é um requisito de status migratório. Sem SSN não se fecha: há alternativa.
- **ITIN (Individual Taxpayer Identification Number).** Emitido pelo IRS para individuos não residentes com obrigações fiscais nos EUA (1040-NR, certas contas, 1099 com retenção). Pedido com formulário W-7 + passaporte certificado ou notarial + documento que justifique a necessidade fiscal.
- **Quando não precisa de nenhum para a LLC.** Single-member LLC sem ETBUS, EIN obtido via SS-4 (que admite "Foreign" em vez de SSN/ITIN), Mercury onboardada sem ITIN: caminho padrão para não residente em B2B internacional.
- **Quando precisa de ITIN.** Vende na Amazon US ou plataformas que retêm 30% sem TIN, é beneficiário de royalty com 1042-S, apresenta 1040-NR pessoal (raro para não residente sem ETBUS), contas bancárias específicas.

### O que mais nos perguntam

**A minha LLC precisa de SSN ou ITIN para abrir Mercury?** Nenhum. A Mercury usa o EIN da LLC e o passaporte do owner. Se um prestador lhe pede, está a usar um fluxo doméstico US - peça versão internacional ou mude.

**Quanto demora obter um ITIN?** 6-12 semanas directamente com o IRS por correio + passaporte certificado. Com um Certified Acceptance Agent (CAA) o passaporte fica consigo, prazos similares.

Na Exentax avaliamos primeiro se precisa mesmo de ITIN - e se sim, tratamos de tudo (W-7 + documentação + acompanhamento) sem que tenha de enviar o passaporte.
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…s ITIN.** Vendes en Amazon US o plataformas que retienen al 30% sin TIN, eres beneficiario…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…e: - **Presentar declaraciones de impuestos** ante el IRS (Form 1120, &lt;a href=&quot;/es/blog/fo…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…1120, &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt;) - **Cumplir con …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1040</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…nte junto con una declaración de impuestos federal (como el Form 1040-NR o adjunto al Form…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">form 1042</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…tariada + documento que justifique la necesidad fiscal (ej: form 1042-S, 1099, declaración…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
