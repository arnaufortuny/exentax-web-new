export default `Há uma frase que se repete em cada vídeo do YouTube e em cada anúncio de "abre a tua LLC em 5 minutos": **"a tua LLC não paga impostos nos EUA"**. A frase é tecnicamente correcta para muitos perfis. O problema é o que as pessoas entendem ao ouvi-la: "então não pago impostos em lado nenhum". Isto já não é verdade.

Este artigo não repete o mecanismo do pass-through nem a lista por país. Para isso já tens o nosso <a href="/pt/blog/tributacao-pass-through-para-llc-como-funciona-e-por-que">guia pass-through</a> e a <a href="/pt/blog/tributacao-da-llc-por-pais-de-residencia-o-que-se-paga-onde">fiscalidade da LLC por país de residência</a>. Aqui explicamos **o que se passa de verdade no teu país**, por que ordem, e por que 80 % dos problemas que vemos na Exentax vêm precisamente daqui.

## Erro de partida: "não tributa nos EUA" NÃO significa "não tributa"

A tua LLC americana, na grande maioria dos casos, é uma **disregarded entity** ou uma **partnership** para o <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>. Isto significa que o IRS não a vê como contribuinte separado: o rendimento é imputado directamente ao sócio. Se tu, como sócio, és não residente nos EUA e não realizas lá actividade efectiva (sem escritório físico, empregados ou presença comercial), esse rendimento **não gera imposto federal nos EUA**.
...
| Perfil | LLC paga nos EUA | Tu pagas em casa | Como é tipicamente declarado |
|---|---|---|---|
| Freelance serviços online | Não | Sim | Categoria B (rendimentos empresariais) |
| E-commerce fora dos EUA | Não | Sim | Categoria B |
| SaaS internacional | Não | Sim | Categoria B + possível IVA UE |
| Investimento broker via LLC | Possível withholding | Sim | Categoria E (capital) |
| Trading activo cripto/forex via LLC | Não (geralmente) | Sim | Capital ou empresarial conforme frequência |
| Royalties via LLC | Withholding 30 % salvo W-8BEN | Sim | Capital |
...
1. **"Não retiro dinheiro, não tributo."** Em transparência tributas pelo lucro apurado, não pelos retiros. Erro mais caro e mais comum.
2. **"Declaro quando passar para a minha conta pessoal."** Mesmo erro. Leva a omitir 1, 2, 3 anos e regularizar com sanções.
3. **"O da LLC disse que não havia nada para declarar em casa."** O fornecedor que montou a LLC não é o teu fiscalista local. Sem visibilidade, sem responsabilidade.
4. **"É no Wyoming, ninguém sabe."** Sabe-se. CRS, DAC, FATCA totalmente operacionais.
5. **"Mudo a residência para Andorra/Dubai/Paraguai e está resolvido."** Só se a mudança for **real, completa e bem executada**. No papel não chega.
6. **A assimetria temporal.** "Enquanto não vierem, está tudo bem." Quando vêm, vêm vários anos atrás com sanções acumuladas.
...
1. Quantos anos estão abertos.
2. Montantes em jogo.
3. **Regularização voluntária** (declarações de substituição antes de notificação), que reduz drasticamente as sanções.
4. Se também é preciso rectificar declarações de bens no estrangeiro em atraso.
5. Se a estrutura ainda faz sentido ou precisa de redesenho.
...
<li><span class="font-mono">0 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…herente, documentado y a tu favor. ## El punto de partida: 0 % federal en EE. UU. (cuando …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">47 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…alidad, es la diferencia entre tributar como autónomo al 35–47 % cada euro generado, o tri…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">30.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…euer / IRPP del año correspondiente. El año que distribuyes 30.000 €, tributas por 30.000 …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…mplicado, es ordenado: - **España**: Modelo 720 si superas 50.000 € en cuentas/valores en …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a, no en EE.UU. Esto es lo que casi nadie explica. - **El &quot;0% en EE.UU.&quot; es real, con cond…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a LLC son tu renta personal y tributan al marginal IRPF (24-47% España; hasta 45% Francia;…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…personal y tributan al marginal IRPF (24-47% España; hasta 45% Francia; hasta 45% Alemania…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…n de residencia determina la tributación. Si vas a Andorra (10% IS, sin CFC para entidades…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…as con tu declaración local. 5. **Compliance US continuo**: Form 5472, 1120 pro forma, BOI…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
