...
Há simulação quando os atos ou negócios celebrados são apenas aparentes e não correspondem à realidade da operação. Aplicado a estruturas internacionais: se interpõe uma <a href="/pt/blog/llc-nos-estados-unidos-guia-completo-para-nao-residentes-em">LLC norte-americana</a> entre si e os seus clientes mas continua a prestar materialmente a atividade a partir de Portugal ou de Espanha (mesma equipa, mesma morada, mesmas decisões), a Autoridade Tributária pode declarar a simulação e imputar-lhe diretamente os rendimentos como pessoa singular.
...
**Como evitar**: se mudar de residência, faça-o a sério (mais de 183 dias fora, sem centro de interesses no país de origem, com certificado de residência fiscal do novo país). Desenvolvemos a marcha a seguir em <a href="/pt/blog/nomade-digital-onde-pagar-impostos-e-como-escolher-a">residência fiscal do nómada digital</a>.
...
**Como evitar**: se a atividade se desenrola essencialmente em Portugal ou em Espanha, ponderar honestamente se a LLC é a estrutura adequada ou se uma sociedade portuguesa (Lda. ou S.A.) ou uma S.L. espanhola como entidade operacional faria mais sentido. Análise completa em <a href="/pt/blog/desenho-de-uma-estrutura-fiscal-internacional-solida-quadro">desenho de estrutura internacional sólida</a>.
...
1. **Começar pela qualificação correta** da LLC na sua jurisdição (ver <a href="/pt/blog/doutrina-administrativa-espanhola-sobre-a-llc-americana">doutrina DGT/TEAC sobre a LLC</a> e a consulta em <a href="https://petete.tributos.hacienda.gob.es" target="_blank" rel="noopener">PETETE</a>).
2. **Desenhar conforme a atividade real** (ver <a href="/pt/blog/tributacao-da-llc-segundo-a-atividade-economica-servicos">tributação da LLC segundo a atividade</a>).
...
Quer uma revisão profissional da sua estrutura para detetar e corrigir riscos antes que seja a Autoridade Tributária a fazê-lo? Marque a sua consultoria gratuita.
...
<!-- exentax:cta-mid -->
**Antes de mexer na sua estrutura, veja como trabalhamos.** Em <a href="/pt/como-trabalhamos">a nossa metodologia</a> verá o que revisamos e em que ordem, do diagnóstico dos seis riscos até à regularização voluntária se for necessária.

<!-- exentax:cta-final -->
**Vamos colocar números reais no seu caso.** Reserve 30 minutos e olhamos juntos para qual dos seis riscos pesa mais no seu dossiê e como neutralizá-lo sem deitar tudo abaixo.
...
- **Doutrina administrativa.** Decisões do <a href="https://serviciostelematicosext.hacienda.gob.es/TEAC/DYCTEA" target="_blank" rel="noopener">TEAC</a> e consultas vinculativas da DGT relativas a LLC unipessoais (entre outras V0443-08, V1631-17, V1147-22), interpretadas à luz do BOE de fevereiro de 2020 sobre classificação de entidades estrangeiras transparentes.
...
- **Convenções e normativa internacional.** Convenção de Dupla Tributação entre Espanha e EUA assinada em 1990, com Protocolo de 2013 em vigor desde 2019, Diretiva 2011/16/UE alterada por DAC6, DAC7 e DAC8, e Modelo de Convenção <a href="https://www.oecd.org" target="_blank" rel="noopener">OCDE</a> com os respetivos Comentários e Instrumento Multilateral BEPS.
