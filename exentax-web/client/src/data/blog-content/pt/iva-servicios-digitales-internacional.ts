export default `O IVA em operações internacionais é um dos temas mais confusos da fiscalidade para freelancers. Cobra IVA a um cliente na Alemanha? E a um nos Estados Unidos? E se o cliente for um particular, não uma empresa? As regras mudam conforme cada cenário.
