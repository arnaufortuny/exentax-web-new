...
| **CRS 2.0** (OCDE, junho de 2023) | O anterior + moeda eletrónica (EMI e *Specified Electronic Money Products*), due diligence reforçada sobre controlling persons, produtos digitais equiparáveis a depósito | Mesmas RFI mais EMI e prestadores equiparados | A partir de janeiro de 2027 sobre dados do exercício de 2026, conforme transposição de cada país |
| **CARF** (OCDE, junho de 2023) | Criptoativos: exchanges, custodiantes, plataformas de derivados cripto, certos prestadores DeFi com elemento centralizado | Reporting Crypto-Asset Service Providers (RCASP) | Janeiro de 2027 sobre dados do exercício de 2026 na UE, via DAC8 |
