...
Vale a pena ter as datas oficiais à vista para não confundir títulos de imprensa com calendário regulatório real. A OCDE aprovou **em 2023 o pacote CRS 2.0 + CARF** e publicou o documento de referência *International Standards for Automatic Exchange of Information in Tax Matters — Crypto-Asset Reporting Framework and 2023 update to the Common Reporting Standard*. A União Europeia transpõe-no através da **Diretiva (UE) 2023/2226 (DAC8)**, adotada em 17 de outubro de 2023, que altera a Diretiva 2011/16/UE para integrar a revisão do CRS e o âmbito do CARF. A data de aplicação material é **1 de janeiro de 2026**, com **primeira troca efetiva em 2027 sobre dados do exercício de 2026**. A peça específica dos criptoativos é completada por um **Multilateral Competent Authority Agreement on CARF** aberto à assinatura das jurisdições com compromisso de implementação, já assinado por mais de meia centena de países.

As três camadas que coexistem hoje cabem numa única tabela:

| Peça | O que cobre | Quem reporta | Primeira troca |
| --- | --- | --- | --- |
| **CRS 1.0** (OCDE 2014) | Contas financeiras tradicionais: depósito, custódia, certos contratos de seguro, veículos de investimento | Reporting Financial Institutions de jurisdições aderentes | Setembro de 2017 |
| **CRS 2.0** (OCDE 2023) | O anterior + moeda eletrónica (EMI e *Specified Electronic Money Products*), due diligence reforçada sobre controlling persons, produtos digitais equiparáveis a depósito | Mesmas RFI mais EMI e prestadores equiparados | A partir de 2027 sobre dados de 2026, conforme transposição de cada país |
| **CARF** (OCDE 2023) | Criptoativos: exchanges, custodiantes, plataformas de derivados cripto, certos prestadores DeFi com elemento centralizado | Reporting Crypto-Asset Service Providers (RCASP) | Janeiro de 2027 sobre dados de 2026 na UE, via DAC8 |

Uma nota prática para evitar uma confusão recorrente: **a OCDE não publica nenhum padrão oficialmente designado "CRS 3.0"**. A etiqueta circula informalmente em peças de imprensa, vídeos e conteúdos de divulgação como abreviatura para o pacote OCDE de 2023 (CRS 2.0 mais CARF). Quando ler ou ouvir "CRS 3.0", a leitura regulatória correta é "revisão CRS de 2023 + CARF", aplicada na UE através da DAC8. Não existe um texto OCDE intitulado "CRS 3.0" para onde remeter: existe o documento integrado de 2023 e a Diretiva (UE) 2023/2226 que o transpõe.
