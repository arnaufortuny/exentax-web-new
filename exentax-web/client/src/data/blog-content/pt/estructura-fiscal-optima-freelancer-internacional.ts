...
- **Tributação máxima**: em Portugal podes pagar até 48% de IRS (mais adicional de solidariedade) acrescido de Segurança Social; no Brasil o Carnê-Leão pode levar a 27,5% de IR mais INSS
...
- **Zero proteção patrimonial**: como trabalhador independente/autónomo, respondes com todo o teu património pessoal
## As opções de estrutura fiscal

### Opção 1: Trabalhador independente/autónomo no teu país (situação atual)
...
Uma leitura adjacente a manter à mão: <a href="/pt/blog/tributacao-internacional-para-empreendedores-digitais-guia">Tributação internacional para empreendedores digitais: guia completo</a>, que afina precisamente os contornos do que este guia explica.
...
Na Exentax desenhamos estruturas caso a caso para freelancers em Portugal e no Brasil. Marca a tua consultoria gratuita e dizemos-te que combinação (LLC, residência, tratados) faz sentido para o teu perfil real.
...
## A estrutura "óptima": três perguntas honestas antes de a escolher
...
### Três padrões que vemos repetidamente funcionar
...
**E a estrutura "ideal" do influencer fiscal X?** Costuma ser desenhada para o caso dele (residência, volume, mix), não para o seu. Replicar sem diagnóstico prévio é a fonte nº 1 dos retrabalhos que vemos em consulta.

**Quando faz sentido mudar de estrutura?** Quando a poupança líquida anual excede em pelo menos 3x o custo anual de manutenção da nova estrutura, e a transição se pode fazer sem quebrar continuidade operativa com clientes e banca.

Na Exentax fazemos o diagnóstico com os seus números reais, descartamos as estruturas que não encaixam e damos-lhe um plano de implementação com calendário e custos - não uma recomendação genérica.
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ternacionales, clientes en múltiples países y una actividad 100% digital. En este artículo…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ión máxima**: en España, por ejemplo, puedes pagar entre el 30% y el 47% sobre tus ingreso…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…a**: en España, por ejemplo, puedes pagar entre el 30% y el 47% sobre tus ingresos - **Cuo…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.seg-social.es" rel="nofollow noopener" target="_blank">www.seg-social.es</a>]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…mericana empieza a tener sentido cuando: - Facturas más de 15.000€/año a clientes internac…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…do neto**: muchos de nuestros clientes pasan de pagar el 35-45% a pagar el 10-20% de forma…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…de nuestros clientes pasan de pagar el 35-45% a pagar el 10-20% de forma completamente leg…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">9%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…jetas para equipo | | **Stripe US** | Cobrar a clientes | 2.9% + $0.30 por transacción | |…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ndario IRPF/IVA + 5472 + 720 coordinado. Coste anual all-in 2.500-4.500 EUR, ahorro fiscal…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">4.500</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…IRPF/IVA + 5472 + 720 coordinado. Coste anual all-in 2.500-4.500 EUR, ahorro fiscal típico…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">40%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…Coste anual all-in 2.500-4.500 EUR, ahorro fiscal típico 25-40% vs autónomo puro. - **Sell…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…gún país (atribución directa típica en pass-through). Coste 3.000-5.000 USD anuales, ahorr…»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ís (atribución directa típica en pass-through). Coste 3.000-5.000 USD anuales, ahorro depe…»</span> <strong>[NÃO VERIFICADO]</strong></li>
