export default `Depois de gerir várias centenas de LLCs para clientes lusófonos, os mesmos erros voltam em loop: mistura de contas pessoais com a LLC, 5472 esquecido, BOI por entregar, morada do Registered Agent usada como morada bancária, e o clássico „vejo isto no próximo ano” que acaba em multa <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> de cinco dígitos.
...
**O problema:** Desde a entrada em vigor do CTA, a <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> exige que todas as LLCs reportem os seus proprietários beneficiários (Beneficial Ownership Information). Os prazos e requisitos mudam com frequência, e não cumprir pode trazer consequências que convém evitar.
...
Na Exentax corrigimos estes desvios todas as semanas. Marca a tua consultoria gratuita: auditamos a tua LLC, listamos os riscos ativos e damos-te um plano concreto de limpeza.
...
## Os problemas mais comuns com uma LLC e como evitá-los antes que aconteçam

Após anos a gerir LLCs de não residentes, os problemas são sempre os mesmos quatro ou cinco. Todos evitáveis com planeamento.

- **Esquecer o 5472 + 1120 anual.** Multa mais cara e mais fácil de evitar. $25.000 mínimo por não apresentar o 5472. Prazo 15 de Abril, prorrogável a 15 de Outubro. Solução: contabilidade desde dia 1.
- **Não apresentar BOI Report ao FinCEN.** Sanção $591/dia. Aplica a quase toda LLC nova: 30 dias desde formação. Solução: incluir BOI inicial no setup.
- **Misturar dinheiro pessoal e da LLC.** Quebrar a separação patrimonial (piercing the corporate veil) permite processá-lo pessoalmente. Solução: conta separada estrita, draws documentados.
- **Não declarar a LLC em residência.** PT (IRS), ES (720 + IRPF), FR (IR + 3916), DE (ESt + AStG se CFC). Sanção típica 50%-150% do imposto evadido. Solução: planear desde a abertura.

### O que mais nos perguntam

**Se não facturei nada, devo apresentar 5472?** Sim, salvo excepção muito limitada. Qualquer movimento owner/LLC é reportable transaction.

**Posso regularizar anos passados sem apresentar?** Sim, por apresentação tardia. Multa igual mas reduz probabilidade de auditoria agressiva.

Na Exentax tratamos compliance integral e regularizamos LLCs com histórico quebrado.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">90%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…entre hacer las cosas bien y hacer las cosas &quot;a medias&quot; El 90% de los problemas que vemos …»</span> <strong>[NÃO VERIFICADO]</strong></li>
<li><span class="font-mono">25,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…ado:** La multa por no presentación según IRS §6038A es de $25,000 por formulario, por año…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">50,000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…formulario, por año. Si llevas dos años sin presentar, son $50,000. Y el IRS no necesita d…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…LLC estaba en &quot;not in good standing&quot; La constitución es el 10% del trabajo. El 90% restant…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">50%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…CFC), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido +…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido + in…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; por no presentar el Form 5472. Cuentas de Mercury c…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(referência legal)</span> <span class="text-xs italic">— «…eportables entre tú y la LLC, y lo presentamos junto con el Form 1120 (return informativa)…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
