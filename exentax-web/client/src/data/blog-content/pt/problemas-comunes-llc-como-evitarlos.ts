...
Um Operating Agreement genérico pode não refletir a sua situação real (single-member vs multi-member, como gere distribuições, regras de dissolução). E se algum dia tiver uma disputa legal ou uma auditoria, é o primeiro documento que vão pedir. Fechamos isto contigo a partir da Exentax: uma chamada, submissão feita, arquivo pronto, o risco fica no papel.
...
- **Não declarar a LLC em residência.** PT (IRS), ES (720 + IRPF), FR (IR + 3916), DE (ESt + AStG se CFC). Sanção típica 50%-150% do imposto evadido. Solução: planear desde a abertura. É o momento de pedir ajuda. Na Exentax abrimos o caso, submetemos o que falta e respondemos à administração por ti.
