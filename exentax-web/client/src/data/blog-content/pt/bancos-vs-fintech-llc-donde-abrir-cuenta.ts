export default `Quando você abre sua LLC, uma das primeiras decisões é onde abrir a conta bancária. E é aqui que começa a confusão: Mercury não é um banco. Wise também não. Relay também não. Mas todos oferecem uma conta, um cartão e um routing number.
