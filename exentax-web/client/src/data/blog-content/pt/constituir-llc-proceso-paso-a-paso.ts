export default `Decidiste abrir uma LLC a partir de Portugal ou do Brasil e queres ver o processo todo antes de assinar fosse o que fosse? Boa ideia. Constituir uma LLC sendo não residente é hoje um processo 100 % online, sem visto, sem viajar e sem advogado americano, mas nem por isso é só preencher um formulário.

Neste guia detalhamos passo a passo o que fazemos na prática na Exentax para os nossos clientes: escolha do estado, submissão dos Articles of Organization, EIN, Operating Agreement, BOI Report, abertura da conta Mercury e arranque da manutenção anual. Sem passos escondidos e sem prazos otimistas a mais.

Aqui explicamos o processo passo a passo, para que entenda exatamente o que está envolvido.
...
- **Delaware**: Melhor estrutura legal. Recomendado se busca investidores
...
Sua LLC precisa de um nome único que não esteja registado no estado. O nome deve incluir "LLC" ou "Limited Liability Company".

Exemplo: **"MinhaEmpresa Digital LLC"**

Pode verificar a disponibilidade do nome no site do Secretary of State do estado escolhido.
...
Como não residente, contrata um serviço de Registered Agent profissional. Este serviço está incluído nos planos de constituição da Exentax.
...
Uma vez constituída a LLC, precisa do **EIN** (Employer Identification Number), o número fiscal da sua empresa perante o <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>.
...
Desde 1 de janeiro de 2024, todas as LLCs devem reportar seus proprietários reais perante o <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>. tem **90 dias** desde a constituição para apresentar este relatório.
### Passo 8: Abrir a conta bancária

Com os documentos em mãos (Articles of Organization, EIN, Operating Agreement), pode abrir sua conta bancária nos EUA. As opções mais populares:
...
Com sua LLC e conta bancária ativas, pode se registar no Stripe, PayPal e outros gateways para começar a receber pagamentos.
### Passo 10: Começar a operar

Sua LLC está pronta. Agora pode faturar clientes, receber pagamentos e operar seu negócio de qualquer parte do mundo.
...
Tecnicamente sim. Mas sejamos sinceros: quer dedicar semanas a navegar formulários em inglês, ligar para o IRS (com seu horário americano e seus 45 minutos de espera), rezar para que o Mercury não rejeite sua conta por um dado mal preenchido, e descobrir depois que seu Operating Agreement genérico não serve?
...
5. **Apresentamos o BOI Report** perante o FinCEN, nem percebe
6. **Abrimos sua conta bancária** no Mercury, com toda a documentação perfeita
7. **Deixamos operacional**: pronto para faturar, receber e começar a trabalhar
...
Queres começar o processo com acompanhamento de ponta a ponta a partir de Portugal ou do Brasil? Agenda a tua consultoria gratuita. Validamos o teu projeto, escolhemos juntos o melhor estado e arrancamos com a constituição assim que disseres "vamos".
...
- **Operating Agreement assinado no dia 1.** Os bancos (Mercury, Relay) pedem-no no KYC inicial desde janeiro de 2024. Sem OA, a abertura de conta fica bloqueada. Modelo SMLLC de não residente, assinado e arquivado digitalmente.

### Perguntas frequentes hoje

**Qual é a ordem ótima?** Articles → EIN (fax SS-4) → OA assinado → Mercury/Relay → contabilidade. Saltar passos atrasa a primeira fatura cobrada em USD.

**Preciso de BOI após a rule de março de 2025?** Se a LLC for 100 % formada nos EUA e os beneficial owners não forem americanos, não. Se for foreign, sim. Verifique no dia da submissão.

**Que custos anuais devo orçamentar?** Wyoming ~225 USD/ano (RA + 60 USD Annual Report), Delaware ~450 USD (RA + 300 USD), New Mexico ~125 USD (só RA, sem Annual Report).
<!-- exentax:overhaul-hoje-v1 end -->

<!-- exentax:execution-v2 -->
## Como constituímos uma LLC na Exentax sem que parta no primeiro mês

Constituir é a parte fácil; o difícil é não a partir nos primeiros trinta dias por descuidos que viram multas ou fecho de contas. O método Exentax monta os cinco blocos por ordem e deixa registo de cada passo.

- **Estado correcto antes dos Articles of Organization**: Wyoming, New Mexico ou Delaware segundo uso real (banca, holding, ecommerce), não segundo moda do YouTube.
- **EIN, BOI e Operating Agreement** assinados e arquivados antes de abrir banca; sem OA, Mercury e Relay recusam a conta.
- **Stack bancário coerente** com o mesmo titular e morada em todos os KYC para evitar bloqueios na primeira transferência recebida.

Para ver o custo exacto e o calendário antes de decidir, abra a <strong>calculadora Exentax</strong> ou marque trinta minutos: enviamos a proposta e o plano de constituição por escrito.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…una LLC en Estados Unidos siendo no residente es un proceso 100% online que se puede compl…»</span> <strong>[NÃO VERIFICADO]</strong></li>
...
<li><span class="font-mono">1.000</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…e **5-10 días hábiles** (filing 110 USD, *expedited* +50 a +1.000 USD según urgencia). - *…»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">100 %</span> <span class="opacity-70">(valor)</span> <span class="text-xs italic">— «…**¿Necesito BOI tras la rule de marzo 2025?** Si la LLC es 100 % formada en EE. UU. y tus …»</span> <strong>[REVISIÓN MANUAL — fonte sugerida: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
