...
Every couple of years a "definitive" version of automatic exchange of tax information shows up, and with it the question we hear most often at Exentax: if the OECD tightens the screws again with CRS 2.0 and CARF, what exactly happens to a <a href="/en/blog/llc-in-the-united-states-complete-guide-for-non-residents-in">US LLC</a> owned by a European or Latin American non-resident? The short answer is that the perimeter tightens outside the United States, not inside. The long answer, which is the one that matters, requires understanding why Washington never signed CRS 1.0, why it will not sign CRS 2.0 either, and how that affects your structure today and your planning for the years ahead.
