...
It is worth keeping the official dates in plain sight so you do not confuse press headlines with the regulatory calendar. The OECD approved **the CRS 2.0 + CARF package in June 2023** and published the reference document *International Standards for Automatic Exchange of Information in Tax Matters — Crypto-Asset Reporting Framework and (2023) update to the Common Reporting Standard*. The European Union has transposed it through **Directive (EU) 2023/2226 (DAC8)**, adopted on 17 October 2023, which amends Directive 2011/16/EU to bring in the revised CRS and the scope of CARF. The material application date is **1 January 2026**, with the **first effective exchange in January 2027 over fiscal year 2026 data**. The crypto leg is complemented by a **Multilateral Competent Authority Agreement on CARF** open to signature by jurisdictions committed to implementation, already signed by more than fifty countries.
...
| **CRS 2.0** (OECD 2023) | Everything above + e-money (EMIs and *Specified Electronic Money Products*), reinforced due diligence on controlling persons, digital deposit-like products | Same RFIs plus EMIs and assimilated providers | From January 2027 over fiscal year 2026 data, depending on each country's transposition |
| **CARF** (OECD 2023) | Crypto-assets: exchanges, custodians, crypto-derivatives platforms, certain DeFi providers with a centralised element | Reporting Crypto-Asset Service Providers (RCASP) | January 2027 over fiscal year 2026 data in the EU through DAC8 |
