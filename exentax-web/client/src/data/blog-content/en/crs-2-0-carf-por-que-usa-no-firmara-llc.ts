...
It is worth keeping the official dates in plain sight so you do not confuse press headlines with the regulatory calendar. The OECD approved **the CRS 2.0 + CARF package in 2023** and published the reference document *International Standards for Automatic Exchange of Information in Tax Matters — Crypto-Asset Reporting Framework and 2023 update to the Common Reporting Standard*. The European Union has transposed it through **Directive (EU) 2023/2226 (DAC8)**, adopted on 17 October 2023, which amends Directive 2011/16/EU to bring in the revised CRS and the scope of CARF. The material application date is **1 January 2026**, with the **first effective exchange in 2027 over fiscal-year 2026 data**. The crypto leg is complemented by a **Multilateral Competent Authority Agreement on CARF** open to signature by jurisdictions committed to implementation, already signed by more than fifty countries.

The three layers that coexist today fit on a single table:

| Layer | What it covers | Who reports | First exchange |
| --- | --- | --- | --- |
| **CRS 1.0** (OECD 2014) | Traditional financial accounts: depository, custodial, certain insurance products, investment vehicles | Reporting Financial Institutions in participating jurisdictions | September 2017 |
| **CRS 2.0** (OECD 2023) | Everything above + e-money (EMIs and *Specified Electronic Money Products*), reinforced due diligence on controlling persons, digital deposit-like products | Same RFIs plus EMIs and assimilated providers | From 2027 over 2026 data, depending on each country's transposition |
| **CARF** (OECD 2023) | Crypto-assets: exchanges, custodians, crypto-derivatives platforms, certain DeFi providers with a centralised element | Reporting Crypto-Asset Service Providers (RCASP) | January 2027 over 2026 data in the EU through DAC8 |

A practical note to avoid a recurring confusion: **the OECD does not publish any standard officially called "CRS 3.0"**. The label circulates informally in news pieces, videos and explainer content as a shorthand for the OECD's 2023 package (CRS 2.0 plus CARF). When you read or hear "CRS 3.0", the correct regulatory reading is "CRS 2023 revision + CARF", applied in the EU through DAC8. There is no OECD text titled "CRS 3.0" to point to: there is the integrated 2023 document and Directive (EU) 2023/2226 that brings it into EU law.
