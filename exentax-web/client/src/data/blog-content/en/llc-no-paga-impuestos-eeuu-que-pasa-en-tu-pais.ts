...
3. **Voluntary regularisation** (amended returns before any notice), which sharply reduces penalties.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22There's%20a%20phrase%20that%20gets%20repeated%20in%20every%20YouTube%20video%20and%20every%20open%20you%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">0 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…herente, documentado y a tu favor. ## El punto de partida: 0 % federal en EE. UU. (cuando …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">47 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…alidad, es la diferencia entre tributar como autónomo al 35–47 % cada euro generado, o tri…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">30.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…euer / IRPP del año correspondiente. El año que distribuyes 30.000 €, tributas por 30.000 …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…mplicado, es ordenado: - **España**: Modelo 720 si superas 50.000 € en cuentas/valores en …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…a, no en EE.UU. Esto es lo que casi nadie explica. - **El &quot;0% en EE.UU.&quot; es real, con cond…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…a LLC son tu renta personal y tributan al marginal IRPF (24-47% España; hasta 45% Francia;…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">45%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…personal y tributan al marginal IRPF (24-47% España; hasta 45% Francia; hasta 45% Alemania…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…n de residencia determina la tributación. Si vas a Andorra (10% IS, sin CFC para entidades…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…as con tu declaración local. 5. **Compliance US continuo**: Form 5472, 1120 pro forma, BOI…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
