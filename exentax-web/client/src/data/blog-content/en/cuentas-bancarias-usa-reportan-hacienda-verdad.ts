...
If your combined US financial accounts (Mercury + Relay + any others) exceed $10,000 at any point during the calendar year, you must file the **FBAR (<a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> Form 114)**. This is YOUR filing obligation, separate from what the bank reports.
...
- **<a href="https://www.oecd.org" target="_blank" rel="noopener">OECD</a> CAEAA**: expanding crypto asset reporting globally
...
One adjacent read worth having open alongside this one: <a href="/en/blog/optimal-tax-structure-for-international-freelancers-the">Optimal tax structure for international freelancers: the complete framework</a>, which sharpens exactly the edges we skimmed above.
...
Keep your W-8BEN-E aligned with the real structure, invoice and collect always from the LLC account, store monthly PDF statements, and if a 720 information notice arrives you will have five business days to respond. Run your case through the <strong>Exentax tax calculator</strong> to see the net cost of filing clean versus staying in a grey zone.

To see how this data crosses with Modelo 720 filing, continue with <a href="/en/blog/modelo-720-and-modelo-721-guide-for-spanish-residents-with">the step-by-step guide to Modelo 720 and 721</a>, and if you want a full setup audit, <strong>book a call with the Exentax team</strong> and we review it with you.

<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Does%20Mercury%20tell%20my%20tax%20authority%20how%20much%20money%20I%20have%3F%20This%20is%20the%20questio%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">100 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…rta CRS. No recibe CRS.** Cualquier institución financiera 100 % estadounidense, abriendo …»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ligación declarativa propia (Modelo 720 si saldo combinado &gt;50.000 €). La asimetría CRS no…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ovimientos diarios, beneficiarios indirectos por debajo del 25 % de control, contraparte d…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…, tu vida personal es tu vida personal. - El compliance US (Form 5472, BOI, mantenimiento …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…un cliente Exentax que tiene su LLC bien estructurada. ### DAC7 y DAC8: directivas europea…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…ente Exentax que tiene su LLC bien estructurada. ### DAC7 y DAC8: directivas europeas, no …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
