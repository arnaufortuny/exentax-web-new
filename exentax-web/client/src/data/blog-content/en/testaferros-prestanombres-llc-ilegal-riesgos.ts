...
The BOI Report filed with <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> requires you to declare the **beneficial owners**: the real owners, not the nominal ones. Filing a BOI Report showing a nominee owner while hiding the actual owner is:
- A **federal crime**
...
- **Criminal offence, not tax infringement.** The Corporate Transparency Act criminalises BOI false statements with up to $10,000 civil fine + 2 years federal prison. EU (5th and 6th AML directives) classifies UBO hiding as aggravated money laundering. Spain: art. 301 CP, up to 6 years. Key difference: tax sanction is money, criminal is jail and criminal record that closes bank accounts for the rest of your life.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Using%20a%20nominee%20owner%20for%20your%20LLC%20is%20tempting%20for%20some%2C%20but%20it's%20illegal%2C%20ri%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">10.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…US tipifica falsedad documental en el BOI report con hasta $10.000 de multa civil + 2 años…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…o presentas el &lt;a href=&quot;/es/blog/como-operar-llc-dia-a-dia&quot;&gt;Form 5472&lt;/a&gt;, reportas transa…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
