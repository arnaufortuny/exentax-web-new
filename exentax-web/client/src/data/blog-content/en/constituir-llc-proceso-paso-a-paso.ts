export default `Forming a US LLC as a non-resident is a 100% online process that can be completed in a few weeks. You don't need to travel, you don't need a visa, and you don't need a US lawyer.
...
Once the LLC is formed, you need the **EIN** (Employer Identification Number), your company's tax ID with the <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>.
...
Since 1 January 2024, all LLCs must report their beneficial owners to <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>. You have **90 days** from formation to file this report. Penalty for non-compliance: $591/day.
...
To see the exact cost and timeline before deciding, run the <strong>Exentax calculator</strong> or book thirty minutes: we send the proposal and the formation plan in writing.
<!-- /exentax:execution-v2 -->
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…una LLC en Estados Unidos siendo no residente es un proceso 100% online que se puede compl…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">1.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…e **5-10 días hábiles** (filing 110 USD, *expedited* +50 a +1.000 USD según urgencia). - *…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">100 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…**¿Necesito BOI tras la rule de marzo 2025?** Si la LLC es 100 % formada en EE. UU. y tus …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.fincen.gov/boi" rel="nofollow noopener" target="_blank">www.fincen.gov</a>]</strong></li>
