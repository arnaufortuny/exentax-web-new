...
This is where most structures collapse. The fact that the LLC pays no federal income tax in the US **does not mean you owe nothing back home**. If you're a tax resident of Spain, the LLC's income is attributed to your IRPF as business income (see administrative doctrine, including the line reinforced in <a href="/en/blog/the-spanish-administrative-doctrine-on-the-us-llc-feb-2020">February 2020</a>). The same kind of attribution rules exist in most EU countries.
...
Wise, Mercury, Relay, Interactive Brokers and crypto exchanges **report automatically** to tax authorities under CRS, DAC7 and, from today, DAC8. It's not "what people say online", it's in their public policy. More detail in our <a href="/en/blog/wise-business-and-crs-what-it-reports-to-your-tax-authority">Wise Business and CRS analysis</a>.
...
At Exentax we work with people coming from generic accountants or "low cost" formation services that didn't include real ongoing management. We don't judge, we organise. More on the <a href="/en/blog/annual-llc-maintenance-obligations-you-cannot-ignore">real annual maintenance of an LLC</a> and on the difference between <a href="/en/blog/us-resident-vs-non-resident-llc-the-key-tax-differences">US residents and non-residents</a> for LLC purposes.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22You%20have%20a%20US%20LLC%20and%20everything%20seems%20to%20work%3A%20you%20invoice%20clients%2C%20move%20mon%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">Form 8832</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…- ¿Algún momento se ha hecho una elección S-Corp o C-Corp (Form 8832 / 2553) sin que lo se…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…enes claro, no asumas: revísalo. ### 2. ¿Estás presentando Form 5472 + Form 1120 cada año?…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…no asumas: revísalo. ### 2. ¿Estás presentando Form 5472 + Form 1120 cada año? Si eres no …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…rada de tu patrimonio personal - Reportes automáticos (CRS, DAC7, DAC8) que ya están en ma…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…e tu patrimonio personal - Reportes automáticos (CRS, DAC7, DAC8) que ya están en marcha S…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
