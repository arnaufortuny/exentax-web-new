export default `Amazon is the world's largest marketplace. A US LLC gives you access to the full Amazon Seller ecosystem without geographic restrictions. Here's everything you need to know.
...
| 2. Obtain EIN | <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> Form SS-4 | 4-8 weeks |
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Amazon%20is%20the%20world's%20largest%20marketplace%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">9%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…s) | | Stripe/Shopify Payments | Procesamiento de pagos | 2.9% + $0.30 | | Amazon Seller C…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…(Merchant of Record), DoDo Payments y PayPal Business. - **DAC7.** Directiva (UE) 2021/514…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
