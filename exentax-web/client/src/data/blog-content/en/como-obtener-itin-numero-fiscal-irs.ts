...
> If you want to understand the role of the W-8BEN and why it works so well alongside a properly issued ITIN, see the <a href="/en/blog/w8-ben-and-w8-ben-e-the-complete-guide">complete W-8BEN and W-8BEN-E guide</a>.
...
If you are starting and have not yet set up the LLC, the natural path is to work both pieces in parallel: <a href="/en/blog/us-llc-as-an-alternative-to-being-self-employed-in-spain">the LLC as an alternative to self-employment</a>, the <a href="/en/blog/ein-tax-number-for-your-llc-how-to-get-it">EIN</a> and, where it applies to your personal situation, the ITIN. And if you already have an LLC but you are receiving US withholding you do not understand, the missing piece to clean up the situation is almost always this one.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22como%20obtener%20itin%20numero%20fiscal%20irs%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…amar reembolsos** de retenciones excesivas (por ejemplo, el 30% retenido en dividendos, ro…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">15%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…e retiene 30%. Con un ITIN y el W-8BEN, normalmente bajas a 15% por convenio. Si ya te ret…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…N válido con TIN. Un ITIN bien emitido baja la retención al 0%, 5% o 10% según el tipo de …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…lido con TIN. Un ITIN bien emitido baja la retención al 0%, 5% o 10% según el tipo de rent…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…con TIN. Un ITIN bien emitido baja la retención al 0%, 5% o 10% según el tipo de renta y e…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 1040</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…derales que declarar, dividendos americanos, una LLC con un Form 1040-NR pendiente; una ve…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…es un permiso de residencia ni un visado. - No te exime del Form 5472 si tienes una LLC un…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 8804</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…rticipación en los beneficios, y la entidad debe retenerte (Form 8804/8805). Para reportar…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
