export default `Modelo 991 forces Visa, Mastercard and American Express to report to Spain's AEAT every card charge or payment above 25,000 euros per holder per year, plus any associated foreign accounts.
...
## How to read the Visa and Mastercard reporting question as a stable mapping rather than as a recurring rumour
...
<!-- exentax:lote15-native-v1:visa-mastercard-reporting-tarjetas-hacienda-en -->
