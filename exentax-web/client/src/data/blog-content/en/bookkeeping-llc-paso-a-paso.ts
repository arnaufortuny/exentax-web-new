...
Before touching any software, the first rule is to <a href="/en/blog/separating-personal-and-llc-finances-why-it-matters">absolutely separate personal money from LLC money</a>. That means no personal purchases on the Mercury or Wallester card, no LLC invoices paid from your personal account, and every withdrawal marked as an "owner draw" from the LLC account to your personal account.
...
For more detail on what is deductible and what is not, see our guide on <a href="/en/blog/tax-deductions-for-your-llc-complete-guide">deductible LLC expenses</a>.
...
Yes. Even at low volume, manual spreadsheet bookkeeping increases the risk of Form 5472 errors and makes it harder to justify expenses to the IRS in an audit. Wave (free) or Xero at 15 USD/month solve the case.
...
- **Layer 1 - Single operating account.** Every LLC inflow and outflow runs through Mercury, Relay or Wise Business. Zero personal cards on the LLC account and zero personal withdrawals without a bookkeeping entry. This single rule prevents 80 % of later audit issues.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22bookkeeping%20llc%20paso%20a%20paso%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">90%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ensual es el paso que la mayoría se salta y el que evita el 90% de los problemas. Si tu ho…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">12.450</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…e evita el 90% de los problemas. Si tu hoja dice que tienes 12.450 USD y Mercury dice 12.3…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">12.380</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…lemas. Si tu hoja dice que tienes 12.450 USD y Mercury dice 12.380 USD, hay 70 USD que no …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">1.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ías. - **Olvidar las comisiones FX.** Cuando Wise convierte 1.000 EUR a USD, hay una peque…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…Casos típicos donde aplica **Caso 1: freelance que factura 60.000 USD/año a 4 clientes eur…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">80 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…s personales sin asiento contable. Esta sola regla evita el 80 % de los problemas de audit…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…cuenta de la LLC. La conciliación automática deja menos del 5 % de transacciones que requi…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…Una contabilidad ordenada te da tres cosas: cumplimiento (Form 5472, 1120 pro-forma y, en …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…Ese resumen es lo que entregas a tu asesor para preparar el Form 1120 pro-forma y el &lt;a hr…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
