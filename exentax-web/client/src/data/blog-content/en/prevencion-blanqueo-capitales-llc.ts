...
Depending on the volume and type of transactions, your bank may be required to file reports with <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> (Financial Crimes Enforcement Network). This doesn't mean you're under investigation. it's a routine procedure.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Anti-Money%20Laundering%20(AML)%20regulations%20are%20increasingly%20strict%20worldwide%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">10,000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…cuando se realizan transacciones en efectivo superiores a $10,000 en un mismo día. Para la…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">9.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…t), fragmentación bajo umbrales de reporte (varios pagos de 9.500$ para evitar el CTR de 1…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…bre el &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt; para entender la…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
