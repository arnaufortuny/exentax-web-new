...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22holding%20empresarial%20como%20funciona%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<!-- exentax:cta-v1 -->
Formation, EIN, BOI, banking and ongoing maintenance — one team that understands your case end to end. <a href="/en/services/llc-wyoming">Explore all services</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…vidades en España: - **Holding (S.L. patrimonial)**: posee 100% de las filiales. - **Filia…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…iscal aplicable: - Las filiales tributan por sociedades al 25% sobre sus beneficios. - Cua…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">95%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…lding, opera la **exención por doble imposición interna del 95%** (artículo 21 LIS), siemp…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…del 95%** (artículo 21 LIS), siempre que el holding posea ≥5% de la filial y ≥1 año de ant…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…físicas, esos dividendos tributan en el IRPF del ahorro (19-28% según tramo). El ahorro fi…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…recurrente que conviene presupuestar: - Constitución: 500-3.000 EUR según jurisdicción. - …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">2.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…UR según jurisdicción. - Domicilio social y secretaría: 500-2.000 EUR/año. - Contabilidad …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…taría: 500-2.000 EUR/año. - Contabilidad y cuentas anuales: 1.500-5.000 EUR/año. - Auditor…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…500-2.000 EUR/año. - Contabilidad y cuentas anuales: 1.500-5.000 EUR/año. - Auditoría si s…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…1.500-5.000 EUR/año. - Auditoría si supera umbrales: 3.000-10.000 EUR/año. - Asesoría fisc…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">8.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «….000-10.000 EUR/año. - Asesoría fiscal especializada: 2.000-8.000 EUR/año. Suelo realista …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">4.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…especializada: 2.000-8.000 EUR/año. Suelo realista anual: 4.000-12.000 EUR para un holding…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">12.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ializada: 2.000-8.000 EUR/año. Suelo realista anual: 4.000-12.000 EUR para un holding inte…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">300.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…plica **Caso 1: empresa familiar con beneficios anuales de 300.000 EUR.** Holding clásica …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">40%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…edio y profesionaliza la sucesión. Ahorro real estimado: 25-40% del impacto fiscal sin hol…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…go plazo. **Caso 2: emprendedor con SaaS en crecimiento de 100.000 EUR/año.** Holding aún …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…consolidar la operativa primero y replantear cuando supere 200.000 EUR. **Caso 3: profesio…»</span> <strong>[NOT VERIFIED]</strong></li>
