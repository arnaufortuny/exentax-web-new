...
### How the <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> views cryptocurrency
...
- Regulated in the US, compliant with <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>
...
Closing out, here's a related piece that sits naturally next to this article: <a href="/en/blog/taxes-with-international-clients-in-spain-what-nobody-tells">Taxes with international clients in Spain: what nobody tells you</a> helps round off the context.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Cryptocurrency%20trading%20through%20a%20US%20LLC%20is%20one%20of%20the%20more%20complex%20areas%20of%20L%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">6.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…cias patrimoniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.0…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…moniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">21%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 200.000€: **2…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">27%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…1%** - 50.000€ – 200.000€: **23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…**23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%** Esto aplica a cada opera…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…a LLC para un trader? Depende de tu volumen: - **Menos de 10.000€/año en ganancias:** Prob…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">47 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…l con organización mínima) tributado en base general (hasta 47 %). Operar a través de SMLL…»</span> <strong>[NOT VERIFIED]</strong></li>
