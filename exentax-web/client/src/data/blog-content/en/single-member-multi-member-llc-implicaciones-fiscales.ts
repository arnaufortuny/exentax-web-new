...
- **Specific penalties for unfiled 1065**: currently around 245 USD per month per member. We close it with you from Exentax: one call, the filing goes out, the archive is set, and the risk stays on paper.
