export default `If you are planning to leave Spain, or have already done so, and hold significant assets in cryptocurrency, an Interactive Brokers account, or a stake in a US LLC, you need to understand the **Exit Tax** before the Spanish Tax Agency (AEAT) reminds you of it. Article 95 bis of the Spanish Personal Income Tax Act (LIRPF, Ley 35/2006) imposes a tax on unrealised capital gains at the moment a tax resident ceases to be one. This is not a theoretical rule: it carries real deadlines, specific calculations, and significant financial consequences.
...
| Threshold | Condition |
|-----------|-----------|
| **Threshold 1** | Market value of shares/interests **≥ €4,000,000** |
| **Threshold 2** | Ownership stake **≥ 25%** in an entity **AND** market value **≥ €1,000,000** |
...
See our guides on the <a href="/en/blog/llc-interactive-brokers-investing-us-stocks">LLC and Interactive Brokers</a>, <a href="/en/blog/cryptocurrency-and-trading-with-llc-complete-tax-guide-for">crypto trading with LLC</a>, and the <a href="/en/blog/us-spain-tax-treaty-applied-to-llcs">Spain–US double tax treaty and the LLC</a> for deeper coverage.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22If%20you%20are%20planning%20to%20leave%20Spain%2C%20or%20have%20already%20done%20so%2C%20and%20hold%20signifi%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
