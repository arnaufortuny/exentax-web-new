...
- **DAC8**: crypto-asset reporting, fully applicable from today. See <a href="/en/blog/dac8-and-cryptocurrencies-the-automatic-tax-reporting-of">DAC8 and crypto</a>.
...
3. **LLC taxation.** The DAC7 report evidences income; your LLC, as Disregarded Entity, passes those revenues to you, and you declare them where you reside. Spanish doctrine on LLCs (see <a href="/en/blog/the-spanish-administrative-doctrine-on-the-us-llc-feb-2020">BOE Feb-2020 and <a href="https://petete.tributos.hacienda.gob.es" target="_blank" rel="noopener">DGT</a>/TEAC doctrine on LLC</a>) treats this income as imputable to the partner.
...
2. **Optimize within the law.** There is LLC expense deductibility (see <a href="/en/blog/how-to-run-your-llc-day-to-day-practical-guide-for-non">LLC tax deductions</a>) and remittance planning to the partner.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22**DAC7**%20is%20one%20of%20the%20most%20important%20regulations%20of%20the%20last%20few%20years%20for%20a%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">2.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…con menos de 30 transacciones de venta de bienes y menos de 2.000 € de contraprestación al…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…VA deben coincidir con el reporte DAC7.** Si Amazon reporta 60.000 € de ingresos brutos en…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…export default &#96;La **DAC7** es una de las normativas más importantes de los últimos a…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…DAC7 + CRS deja muy poca opacidad. ### Combinación con CRS, DAC8 y FATCA DAC7 no opera de …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC2</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…aislada. Es parte de un ecosistema regulatorio: - **CRS / DAC2**: reporting bancario de sa…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC6</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…atam-implicaciones&quot;&gt;CRS para residentes ES y LATAM&lt;/a&gt;. - **DAC6**: reporting obligatorio …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
