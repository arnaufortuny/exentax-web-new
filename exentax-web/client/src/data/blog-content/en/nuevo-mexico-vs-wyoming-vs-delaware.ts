export default `When forming a US LLC as a non-resident, one of the first decisions you'll face is which state to choose. New Mexico, Wyoming, and Delaware are the three most popular options. Here's an honest comparison with real numbers.
...
| BOI Report (<a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>) | Required | Required | Required |
...
To keep going on this thread, <a href="/en/blog/advantages-and-disadvantages-of-a-us-llc-for-non-residents">Advantages and disadvantages of a US LLC for non-residents: honest analysis</a> and <a href="/en/blog/self-employed-in-spain-vs-llc-in-the-us-complete-tax">Self-employed in Spain vs LLC in the US: complete tax comparison</a> fill in nuances this guide only touched on.
...
For the cost and plan in each state for your case, run the <strong>Exentax calculator</strong> or book thirty minutes.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22When%20forming%20a%20US%20LLC%20as%20a%20non-resident%2C%20one%20of%20the%20first%20decisions%20you'll%20fa%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>

If you want to see the full process in detail, check our <a href="/en/services">services page</a> with everything we cover.
<!-- /exentax:cta-conv-v1 -->

<!-- exentax:cta-v1 -->
We compare New Mexico, Wyoming, Delaware and Florida against your real case — no trendy-state pitch. <a href="/en/services">Compare my case with an advisor</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">80%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…na | ### ¿Cuál elegir? Nuestra recomendación clara Para el 80% de los freelancers y empren…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…ticas**: &lt;a href=&quot;/es/blog/documentos-llc-cuales-necesitas&quot;&gt;Form 5472&lt;/a&gt;, Form 1120, &lt;a h…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…f=&quot;/es/blog/documentos-llc-cuales-necesitas&quot;&gt;Form 5472&lt;/a&gt;, Form 1120, &lt;a href=&quot;/es/blog/c…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
