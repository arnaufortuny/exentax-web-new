...
1. **Formally close the LLC** (dissolution), liquidating assets to yourself.
2. **Sell the business assets** (asset sale) keeping the LLC standing and optionally closing it after.
3. **Sell the LLC entirely** (equity sale): the buyer takes the entity, the EIN, and everything inside.
...
| Documentation | Articles of Dissolution + final 5472/1120 + EIN cancel + final BOI | Bill of sale + assignments + asset list | Membership Interest Purchase Agreement + due diligence |
...
The standard closing procedure: internal decision, banking liquidation, final <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> filings (5472 + 1120 marked final), state Articles of Dissolution, EIN cancellation, final BOI.
...
|---|---|
| Identified buyer, valuation > 1× ARR | Consider selling |
| No buyer, low operations | Dissolve |
...
If you want to know which path fits your real case, run the <strong>Exentax calculator</strong> or book thirty minutes.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22There%20comes%20a%20moment%20in%20many%20LLCs%20when%20the%20question%20is%20the%20same%3A%20do%20I%20close%20i%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">28%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…rticipación social y tributar como ganancia patrimonial (19-28%). Consulta caso a caso. &lt;!…»</span> <strong>[NOT VERIFIED]</strong></li>
