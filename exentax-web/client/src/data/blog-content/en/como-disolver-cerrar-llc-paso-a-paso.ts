...
If you have been carrying the LLC for years and have accumulated 5472 backlogs, **the right move is to clean up before closing**, not close to bury the issue. The detail of the specific risk is in the <a href="/en/blog/what-happens-if-you-dont-file-form-5472-irs-penalties-and">Form 5472 penalty guide</a>. Closing an LLC with pending 5472s does not extinguish accrued penalties; it only freezes them and the IRS keeps them against you as the individual associated with the EIN. We close it with you from Exentax: one call, the filing goes out, the archive is set, and the risk stays on paper.
### 5. State dissolution: Articles of Dissolution or Certificate of Cancellation
...
- **Step 5 - BOI Final Report.** FinCEN requires a final BOI report on entity cease, within 30 days of state dissolution. Without it, possible civil penalties. This is where Exentax steps in: we file the form, archive the receipt and, if the authority asks, your answer is already on the desk.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22como%20disolver%20cerrar%20llc%20paso%20a%20paso%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
