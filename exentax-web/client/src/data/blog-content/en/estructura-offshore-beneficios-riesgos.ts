...
> **Want to check if your current setup exposes you to one of these lists?** Run your case through the <strong>Exentax tax calculator</strong> and we will assess risk and legal alternative.
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…0; equivalentes en LatAm). No hacerlo es delito. - **&quot;Pagar 0% a nivel personal&quot;**: tu paí…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…cionado**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domici…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…o**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domicilios, …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ncia, SaaS, ecommerce y creadores. - **Reino Unido (Ltd)**: 25% impuesto de sociedades per…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…en Estonia o necesitas IBAN europeo. - **Bulgaria (OOD)**: 10% de impuesto de sociedades, …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…de tu país. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, int…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">200%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ís. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, intereses y…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">RD 1080/1991</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…febrero de 2023)**, modificada posteriormente. Sustituyó al RD 1080/1991 e introdujo crite…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
