...
For freelancers whose clients are mostly US-based or outside the EU, a <a href="/en/blog/us-llc-as-an-alternative-to-being-self-employed-in-spain">US LLC</a> dramatically simplifies the workflow: invoices to US clients go out without VAT by default (no federal VAT in the US) and Form 349 disappears. For EU B2B clients, the LLC invoices from the US under the general rule for services provided by a foreign supplier, usually subject to the reverse charge mechanism at the client's location. VAT management is drastically reduced.
...
<li><span class="font-mono">BOE-A-1992-28740</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…vo está en la &lt;a href=&quot;https://www.boe.es/buscar/act.php?id=BOE-A-1992-28740&quot;&gt;Ley 37/1992 …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
