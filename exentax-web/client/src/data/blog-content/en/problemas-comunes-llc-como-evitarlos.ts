...
**What happens:** LLC owner doesn't know about Form 5472, doesn't file it, receives <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> penalty notice for **$25,000** (IRC §6038A).
...
Closing out, here's a related piece that sits naturally next to this article: <a href="/en/blog/how-much-does-it-cost-to-form-a-us-llc-complete-cost">How much does it cost to form a US LLC? Complete cost breakdown</a> helps round off the context.
...
- **Not filing FinCEN BOI Report.** Penalty $591/day (capped over $10k). Applies to nearly every new LLC: 30 days from formation to report. Subsequent changes (address change, membership transfer, new manager) have 30 days from change. Solution: include initial BOI in setup and annual change review.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Based%20on%20our%20experience%20helping%20hundreds%20of%20LLC%20owners%2C%20these%20are%20the%20most%20co%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">90%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…entre hacer las cosas bien y hacer las cosas &quot;a medias&quot; El 90% de los problemas que vemos …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25,000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ado:** La multa por no presentación según IRS §6038A es de $25,000 por formulario, por año…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">50,000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…formulario, por año. Si llevas dos años sin presentar, son $50,000. Y el IRS no necesita d…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…LLC estaba en &quot;not in good standing&quot; La constitución es el 10% del trabajo. El 90% restant…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">50%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…CFC), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido +…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…), Portugal (IRS), Italia (IRPEF + RW). Sanción típica: 50%-150% del impuesto eludido + in…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; por no presentar el Form 5472. Cuentas de Mercury c…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…eportables entre tú y la LLC, y lo presentamos junto con el Form 1120 (return informativa)…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
