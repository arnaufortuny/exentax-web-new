...
**BOI Report:** Beneficial ownership information is filed with <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>. The database is not public, but law enforcement, financial institutions (with consent), and authorized agencies can access it. You must provide your real name, date of birth, address, and government-issued ID.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…&lt;a href=&quot;/es/blog/extension-irs-form-1120-como-solicitarla&quot;&gt;Form 5472&lt;/a&gt;, reportas las tr…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 8938</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…uales. Pero declarada en residencia (Modelo 720/721 España, Form 8938 si residente US) y r…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
