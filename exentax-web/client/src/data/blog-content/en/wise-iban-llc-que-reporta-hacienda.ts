export default `The Belgian IBAN that Wise assigns to an LLC enters the CRS exchange covering more than 120 jurisdictions, and for a Spanish tax resident the AEAT receives the December 31 balance every September.
...
- If the closing balances do not match the income you declare, the tax authority has a natural lever to open an inspection. Relax: at Exentax this is what we do every week, we close it before the letter ever lands in your inbox.
