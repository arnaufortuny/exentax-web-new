...
1. **Before opening a broker**: check that the LLC has coherent corporate documentation (Articles, EIN, Operating Agreement, BOI filed).
2. **Correct W-8BEN-E**: identification of the beneficial owner, treaty claim if applicable, dates and signatures in order.
3. **Documented capitalization**: the LLC has its own funds to invest; the member's contributions are recorded.
4. **Segregated account**: the brokerage account is operated from the LLC's bank account, not from the member's personal account.
5. **Coherent Operating Agreement**: reflects the investing activity if applicable, defines how movements are approved, how the result is distributed.
6. **Internal reporting**: at every fiscal close, the broker P&L is incorporated into the LLC's accounting and into the 5472 / 1120 pro forma.
7. **Coordination with your local advisor**: so the attribution / distribution of investing income is properly declared in your country.
### Why Exentax
...
<a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> and <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> reporting requirements moved recently; the current state is:
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22One%20of%20the%20most%20frequent%20questions%20Exentax%20clients%20close%20on%3A%20Can%20I%20open%20Inter%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">30 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…vía SMLLC disregarded. - **Dividendos US**: withholding del 30 % por defecto, reducible ví…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">15 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…**: withholding del 30 % por defecto, reducible vía treaty (15 % España, 15 % México, 15 %…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">10 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ucible vía treaty (15 % España, 15 % México, 15 % Colombia, 10 % Chile, 15 % Argentina). E…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">0 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…EN-E está presentada. - **Intereses portfolio (bonos US)**: 0 % bajo portfolio interest ex…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…sidente que fallece teniendo activos US-situs por encima de 60.000 USD (acciones US direct…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…pital gains de bolsa US para LLC propiedad de no residente: 0% federal (no efectivamente c…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ectivamente conectado, sin ETBUS). Dividendos US: retención 30% por defecto, reducida a 15…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">15%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…TBUS). Dividendos US: retención 30% por defecto, reducida a 15% (o 0% en casos específicos…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">IRC §865</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…lías de venta de acciones US **no son renta de fuente US** (IRC §865(a)(2)) salvo presenci…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
