...
- 0% federal in the US through <a href="/en/blog/pass-through-taxation-for-llcs-how-it-works-and-why-it">pass-through</a>.
...
- **Nominees and front owners**: in addition to being illegal, it does not deceive the tax authority and breaks any real asset shield (<a href="/en/blog/nominee-owners-for-llcs-why-it-is-illegal-and-the-risks-you">complete guide</a>).
...
You need to move residency to a low/no-tax jurisdiction (Andorra, UAE, Panama, Monaco) and completely break your prior residency. Paying zero without relocating is illegal in any <a href="https://www.oecd.org" target="_blank" rel="noopener">OECD</a> country.
...
- **United States.** Delaware General Corporation Law and Limited Liability Company Act, Wyoming Limited Liability Company Act (Title 17, Chapter 29), <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> Form 5472 instructions and IRC §7701 (entity classification).
...
> **How much can you save by combining these levers properly?** Estimate your annual bill with the <strong>Exentax tax calculator</strong> and compare "as today" vs "with planning".

To see how the LLC fits your life in Spain continue with <a href="/en/blog/us-llc-as-an-alternative-to-being-self-employed-in-spain">the LLC versus autónomo in Spain guide</a>, and if you are tempted to move look at <a href="/en/blog/digital-nomad-where-to-pay-taxes-and-how-to-choose-your-tax">the digital nomad and tax residency strategy</a>. To design your map, <strong>book a session with Exentax</strong>.

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22caminos%20legales%20minimos%20impuestos%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">47%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…levamos años trabajando con personas que vienen huyendo del 47% de IRPF más &lt;a href=&quot;https…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…stino. Algunas opciones reales actualmente: - **Andorra**: 10% IRPF, 10% IS, 4,5% IGI. Tas…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…nes reales actualmente: - **Andorra**: 10% IRPF, 10% IS, 4,5% IGI. Tasas mínimas, calidad …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…fue. - **Italia**: régimen del impatriado y régimen flat de 200.000 EUR para grandes patri…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ficos para nuevos residentes. - **EAU (Dubái, Abu Dhabi)**: 0% IRPF personal real, con vis…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…nte? Depende del país. Para un autónomo español que factura 80.000 EUR al año, sustituir e…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">37%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…or una LLC bien gestionada puede mover la carga fiscal del ~37% combinado al ~20-25% efect…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…onada puede mover la carga fiscal del ~37% combinado al ~20-25% efectivo, dependiendo de g…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">1.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…y reduces carga sin cambiar tu vida. Coste anual: menos de 1.000 EUR. **Caso 2: emprendedo…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">47 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…atos, Paraguay, Uruguay) puede reducir el tipo efectivo del 47 % al 10-25 %. Exige mudanza…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…uay, Uruguay) puede reducir el tipo efectivo del 47 % al 10-25 %. Exige mudanza real con p…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">0 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ía, SaaS, ecommerce, royalties), las cifras se mueven entre 0 % y 15 % efectivo según juri…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">15 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…aS, ecommerce, royalties), las cifras se mueven entre 0 % y 15 % efectivo según jurisdicci…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…**¿Cuánto cuesta una estructura legal optimizada?** Entre 1.500 € y 8.000 € de coste anual…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">8.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…o cuesta una estructura legal optimizada?** Entre 1.500 € y 8.000 € de coste anual para pe…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">500.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…0 € y 8.000 € de coste anual para perfiles entre 80.000 € y 500.000 € de facturación. El c…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">8.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…l empleador, que permiten aportaciones adicionales de hasta 8.500 EUR anuales sin penaliza…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">50 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…an declarar. - **Inversión en empresas de nueva creación**: 50 % de deducción estatal sobr…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…presas de nueva creación**: 50 % de deducción estatal sobre 100.000 EUR anuales si cumples…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">80 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…RPF. - **Donativos** a entidades acogidas a la Ley 49/2002: 80 % los primeros 250 EUR y 40…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">40 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ades acogidas a la Ley 49/2002: 80 % los primeros 250 EUR y 40 % en lo restante, además de…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">24 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…trabajador y cubre seis ejercicios completos. Tributas al **24 %** hasta 600.000 EUR de re…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">600.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…cubre seis ejercicios completos. Tributas al **24 %** hasta 600.000 EUR de rendimientos de…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…o**: ordena gastos deducibles, evalúa pasar a SL si superas 60.000-80.000 EUR de beneficio…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">IRC §7701</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; del Form 5472 e IRC §7701 (clasificación de en…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…s://www.irs.gov&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;IRS&lt;/a&gt; del Form 5472 e IRC §7701 (clasifi…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…pa para &quot;no declarar&quot; desde España: con FATCA y los avances DAC8 todo aflora. Su valor es …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
