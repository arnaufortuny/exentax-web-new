...
<li><span class="font-mono">28%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ario** (dividendos), tributando en la base del ahorro al 19-28%. - Aplicaba el Convenio Es…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…vorable al contribuyente: 19-28% en IRPF base ahorro vs. 24-47% en base general por rendim…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ibutaría como entidad opaca en EE.UU. (impuesto federal del 21%) y la doctrina española sí…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…or el periodo no prescrito + intereses + sanción mínima del 50% (puede subir). ### Cómo pl…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">21 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…Corp election. Si quieres opacidad real (con tributación al 21 % federal), debes presentar…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 8832</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…(atribución de rentas). - Hace **check-the-box election** (Form 8832) para tributar como *…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
