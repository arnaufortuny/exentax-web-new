export default `If you have an LLC and the BOI Report is not filed, or the Forms 5472 + 1120 pro-forma of the past few years are not filed, you are not in an unrecoverable situation. You are in a recoverable situation, but only if you act now and in the right order.
...
- **Never filed**: file it now. 100% online with <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>, free, takes 30-60 minutes.
...
Critical situation. Do not file anything before consulting with a professional who has handled IRS responses before. The order, language, and arguments of the response materially change the outcome.
...
- **Late BOI.** After the March 2025 interim final rule, only **foreign reporting companies** remain in scope. If your LLC is in scope and files late, civil fine of **USD 591/day** (inflation-adjusted; FinCEN source). Voluntary filing before notice materially reduces criminal exposure.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22If%20you%20have%20an%20LLC%20and%20the%20BOI%20Report%20is%20not%20filed%2C%20or%20the%20Forms%205472%20%2B%201120%20%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">25.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…Las sanciones nominales asustan. Form 5472 no presentado: 25.000 USD por formulario y año.…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…lgunos casos, una cuota de reinstatement. Coste típico: 200-1.500 USD según estado y antig…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…en tu país de residencia. Las sanciones nominales asustan. Form 5472 no presentado: 25.000…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
