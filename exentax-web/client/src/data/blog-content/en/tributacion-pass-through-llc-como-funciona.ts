...
The $25,000 penalty for not filing Form 5472 (IRC §6038A) exists precisely because pass-through entities with foreign owners need this transparency mechanism. The IRS wants to know what transactions occurred, even though no tax is owed. This is where Exentax steps in: we file the form, archive the receipt and, if the authority asks, your answer is already on the desk.
...
- **Mandatory reporting even when disregarded.** A non-resident SMLLC must file **Form 5472 + pro forma 1120** annually for any *reportable transaction* (base penalty USD 25,000/yr, IRC §6038A). Reporting is informational; it does not mean paying federal tax. This is where Exentax steps in: we file the form, archive the receipt and, if the authority asks, your answer is already on the desk.
