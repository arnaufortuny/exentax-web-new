...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Pass-through%20taxation%20is%20the%20core%20of%20why%20US%20LLCs%20are%20so%20efficient%20for%20non-res%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">6,000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…Imagina que eres diseñador web, vives en Madrid y facturas $6,000 al mes a clientes intern…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.600</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…nomo en España, pagas: - Cuota de autónomos (entre 200 € y 1.600 €/mes según ingresos) - I…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">21%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…hasta el 47% en tramos altos) - IVA en facturas nacionales (21%) - Gastos deducibles limit…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…n 40-47% de carga fiscal total a poder optimizar **hasta un 0%**, dependiendo de tu estruc…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…generoso con lo que considera gasto deducible: ### Gastos 100% deducibles para tu LLC: - *…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…de nuestros clientes reducen su carga fiscal total entre un 50% y un 70% respecto a operar…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">70%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…os clientes reducen su carga fiscal total entre un 50% y un 70% respecto a operar como aut…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">3,000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ecto a operar como autónomo en su país. Si facturas más de $3,000 al mes, los números empi…»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…vés de tu LLC. **En Estados Unidos:** - Tu LLC presenta el Form 1120 + &lt;a href=&quot;/es/blog/q…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…l Form 1120 + &lt;a href=&quot;/es/blog/que-es-irs-guia-duenos-llc&quot;&gt;Form 5472&lt;/a&gt; (informativo) - …»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 7004</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…&lt;a href=&quot;/es/blog/extension-irs-form-1120-como-solicitarla&quot;&gt;Form 7004&lt;/a&gt;) - **Te orientam…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 1065</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…ja de ser disregarded y pasa a partnership por defecto, con Form 1065 + K-1 anual, manteni…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
