...
- **If you want to optimize taxation without relocating**, a US LLC offers 0% federal in the US (<a href="/en/blog/pass-through-taxation-for-llcs-how-it-works-and-why-it">pass-through</a>) and lets you remain a resident of your current country, declaring the net income after expenses.
...
At Exentax we can help you analyze your case, calculate real numbers before and after the move, and design the corporate structure that best fits your life in Andorra. At Exentax we review your case with real data: <a href="/en/book">book a free consultation</a> for 30 minutes.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22crear%20empresa%20andorra%20ventajas%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">3.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…a proyectos de mayor tamaño. Capital social mínimo: - SL: 3.000 EUR. - SA: 60.000 EUR. Con…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…yor tamaño. Capital social mínimo: - SL: 3.000 EUR. - SA: 60.000 EUR. Constitución: 4-8 se…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">2.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…te habitual entre escritura, registro, asesoría y trámites: 2.500-6.000 EUR. La constituci…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">6.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…itual entre escritura, registro, asesoría y trámites: 2.500-6.000 EUR. La constitución exi…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…de sociedades andorrano (IS)** tiene un tipo general del **10%**. Existen tipos reducidos …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…eral del **10%**. Existen tipos reducidos para los primeros 50.000 EUR de base imponible y…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…Indirecte)**, equivalente al IVA, con tipo general del **4,5%** (uno de los más bajos del …»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">1%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…* (uno de los más bajos del mundo). Hay tipos reducidos del 1% (alimentación, medicamentos…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…dos del 1% (alimentación, medicamentos) y superreducido del 0%. ### Fiscalidad personal: e…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">24.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…tiene una estructura muy sencilla: - 0% sobre los primeros 24.000 EUR de renta. - 5% entre…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">24.001</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…a: - 0% sobre los primeros 24.000 EUR de renta. - 5% entre 24.001 y 40.000 EUR. - 10% sobr…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">22%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…&quot;noopener&quot;&gt;Seguridad Social&lt;/a&gt; andorrana): aproximadamente 22% sobre la base de cotizació…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">600.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…r en Andorra al menos 90 días al año. - Inversión mínima de 600.000 EUR en activos andorra…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">47.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…paciones en sociedades andorranas). - Depósito adicional de 47.500 EUR ante el AFA (más 9.…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">9.500</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ranas). - Depósito adicional de 47.500 EUR ante el AFA (más 9.500 EUR por familiar). - Dem…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">1.200</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…y LatAm: - **Vivienda**: alquiler de 2 habitaciones desde 1.200-2.500 EUR/mes en zonas hab…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">4.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ales (Escaldes, Andorra la Vella, La Massana). Compra desde 4.000 EUR/m² hacia arriba. - *…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…rativamente, mantener una SL andorrana cuesta entre 2.500 y 5.000 EUR/año en gestoría, ase…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…# Riesgos reales y honestos - **Vida en un país pequeño**: 80.000 habitantes, opciones lim…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…sos típicos donde aplica **Caso 1: profesional digital con 200.000 EUR/año dispuesto a viv…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…gualable en Europa. **Caso 2: jubilado con renta pasiva de 100.000 EUR/año.** Residencia p…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">0 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…dorra ofrece tipos efectivos del 10 % en sociedades y entre 0 % y 10 % en IRPF, con CASS (…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">550.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…nversión mínima de 600.000 € (depósito 50.000 € + inversión 550.000 € en activos andorrano…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">2 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…ocietats es 10 %; la holding andorrana puede acceder a tipo 2 % cumpliendo requisitos de p…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">25 %</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…n cartera de valores cualificada (&gt;4 M€ valor de mercado o &gt;25 % participación en sociedad…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">300.000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…irme?** No automáticamente, pero un perfil con facturación &gt;300.000 €/año y residencia pre…»</span> <strong>[NOT VERIFIED]</strong></li>
