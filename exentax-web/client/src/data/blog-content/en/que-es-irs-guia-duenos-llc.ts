export default `If you have a US LLC, or you're thinking about having one, you're going to hear a lot about the **IRS**. It's the entity you'll have the most relationship with from a tax perspective. Better to understand it well from the start.
