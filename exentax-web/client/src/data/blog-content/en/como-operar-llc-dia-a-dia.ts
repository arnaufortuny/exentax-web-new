...
| EIN Letter (CP575) | Bank account, tax filings | <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> (Exentax obtains) |
| Operating Agreement | Banking, contracts, everything | Exentax (customized) |
| BOI Report confirmation | Compliance proof | <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a> (Exentax files) |
...
If something in this structure left you wanting more detail, <a href="/en/blog/your-first-month-with-a-us-llc-what-to-expect-week-by-week">Your first month with a US LLC: what to expect week by week</a> dives into a neighbouring piece of the puzzle we usually keep for a separate write-up.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Want to discuss it now? Call us at <a href="tel:+34614916910">+34 614 916 910</a> or message us on <a href="https://wa.me/34614916910?text=Hi%20Exentax%2C%20I'm%20reading%20%22Once%20your%20LLC%20is%20formed%20and%20your%20bank%20account%20is%20open%2C%20what%20does%20daily%20operat%E2%80%A6%22%20and%20want%20to%20talk%20to%20an%20advisor%20about%20my%20case.">WhatsApp</a> and we'll get back to you today.</p>
...
<li><span class="font-mono">250,000</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…heredadas) (banco con licencia federal y seguro FDIC hasta $250,000). Lo que lo hace espec…»</span> <strong>[NOT VERIFIED]</strong></li>
<li><span class="font-mono">9%</span> <span class="opacity-70">(figure)</span> <span class="text-xs italic">— «…*: para cobros con tarjeta, suscripciones o pagos online (2.9% + $0.30 por transacción) - …»</span> <strong>[NOT VERIFIED]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(legal reference)</span> <span class="text-xs italic">— «…s registros son esenciales para tus declaraciones fiscales (Form 5472 + 1120) y para demos…»</span> <strong>[REVISIÓN MANUAL — suggested source: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
