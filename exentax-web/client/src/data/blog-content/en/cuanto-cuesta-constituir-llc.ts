...
| Item | Detail |
|---|---|
| State filing fee | Applicable state fee |
| Registered Agent (year 1) | Service included |
...
| **Full formation** | Single bundled fee |
...
The delta is real, and the cost of the LLC is recovered in the first month. Read our <a href="/en/blog/self-employed-in-spain-vs-llc-in-the-us-complete-tax">self-employed Spain vs US LLC tax comparison</a> for fully worked-out numbers (the framework is the same for the UK and Ireland; only the local rate differs).
...
- [LLC documents: which ones you need and how to keep them](/en/blog/llc-documents-which-ones-you-need-and-how-to-keep-them)
