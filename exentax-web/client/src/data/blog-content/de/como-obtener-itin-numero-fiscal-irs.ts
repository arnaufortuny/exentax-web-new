...
3. **Identitätsprüfung durch CAA.** Wir koordinieren die Passprüfung über das CAA-Netzwerk. Sie schicken Ihren Originalpass nicht nach Texas. Die Prüfung erfolgt sicher. Atme durch: bei Exentax ist das Routine, wir bringen dich auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
...
Die ITIN wirkt wie ein kleiner Vorgang, bis man ihn allein versucht und merkt, dass der IRS keine Anrufe zurückgibt, das Formular Feinheiten hat, die man nur nach Dutzenden Fällen kennt, und eine Ablehnung Sie ein weiteres Jahr ohne Rückerstattung kosten kann. Was unser Team mitbringt ist genau das Gegenteil: ein bekannter Prozess, eine sichere CAA-Prüfung, eine von US-Buchhaltern vorbereitete Stützerklärung und die Gewissheit, dass jede Notice fristgerecht beantwortet wird. Bei Exentax haben wir Mandanten in genau dieser Lage ohne Strafe geschlossen. Früh sprechen lohnt sich — und spart dir fünf Stellen.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22como%20obtener%20itin%20numero%20fiscal%20irs%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<!-- /exentax:cta-conv-v1 -->
  ...
  ### ITIN-Antrag aus Deutschland: praktische Hinweise

  Über **Certifying Acceptance Agents (CAAs)** in Berlin, München und Frankfurt entfällt das Versenden des Originalpasses an Austin, TX. Der CAA prüft das Identitätsdokument vor Ort und stellt eine **Form W-7 (COA — Certificate of Accuracy)** aus. Bearbeitungszeit nach **IR-2024-25**: 7–11 Wochen. Alternativ akzeptiert der IRS eine **certified copy by the issuing agency** (Bundesdruckerei) — keine notariell beglaubigten Kopien laut **IRS Publication 1915 (rev. 11/2023)**.
