export default `Fangen wir damit an, etwas klarzustellen, das uns in den Ohren wehtut, die wir in dieser Branche arbeiten: Eine LLC wird nicht „erstellt". Sie wird **gegründet**.
