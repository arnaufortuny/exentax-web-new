...
| Position | Detail |
|---|---|
| State Filing Fee | Anwendbare staatliche Gebühr |
| Registered Agent (Jahr 1) | Im Service enthalten |
| EIN-Beantragung | Im Service enthalten |
| Operating Agreement | Auf Ihren Fall zugeschnitten, enthalten |
| BOI Report | Nur, wenn die LLC unter den aktuellen Geltungsbereich fällt (Foreign Reporting Companies nach FinCEN-IFR März 2025); falls anwendbar, enthalten |
| **Komplette Gründung** | Einmaliges Festhonorar |
...
| Staatliche Jahresgebühr | Nicht anwendbar |
| Registered Agent | Im Service enthalten |
| Form 5472 + 1120 | Professionelle Erstellung enthalten |
| **Komplette Wartung** | Einheitliche Jahresgebühr |

### Wyoming
| Position | Detail |
|---|---|
| Annual Report (verpflichtend) | Staatliche Jahresgebühr |
| Registered Agent | Im Service enthalten |
| Form 5472 + 1120 | Professionelle Erstellung enthalten |
| **Komplette Wartung** | Einheitliche Jahresgebühr |
...
| Position | Detail |
|---|---|
| Franchise Tax + Annual Report | Staatliche Jahresgebühr + Franchise Tax |
| Registered Agent | Im Service enthalten |
| Form 5472 + 1120 | Professionelle Erstellung enthalten |
| **Komplette Wartung** | Einheitliche Jahresgebühr |
...
| Mandantenprofil | Empfohlener Bundesstaat | Warum |
|---|---|---|
| **Freelancer / B2B-Berater** mit Rechnungen an DACH-, EU- oder US-Kunden, ohne Angestellte | New Mexico | Kein Annual Report, keine staatliche Jahresgebühr und angemessene Privatsphäre. Die günstigste Struktur über 2-3 Jahre. |
| **Digitalagentur oder Kreativstudio** mit 1-3 Partnern, ohne Pläne für externes Kapital | Wyoming | Starke Charging-Order-Law (besserer Schutz vor persönlichen Gläubigern), moderate Annual-Report-Gebühr und neutrale Reputation bei Banken. |
| **SaaS oder Tech-Startup**, das einen US-VC, einen Accelerator oder eine Series A vorsieht | Delaware | De-facto-Standard für Series A; kein Sand-Hill-Road-VC akzeptiert eine New-Mexico-LLC ohne kostspielige Redomiziliation. Die Franchise Tax tut weh, erspart Ihnen aber spätere Reincorporation. |
| **E-Commerce oder Dropshipping** auf Shopify, Stripe und Amazon FBA mit mittlerem Volumen | Wyoming oder New Mexico | Ohne Investorenperspektive funktionieren beide. Wyoming wiegt schwerer, wenn das Geschäft Vermögen anhäuft (Lager, Marken); New Mexico, wenn es reiner Cashflow ist. |
| **Content-Creator** (YouTube, Twitch, Substack, Online-Kurse), monetarisiert über AdSense, Sponsoren und Plattformen | New Mexico | Die niedrigsten Fixkosten und null Annual Report gewinnen klar; die meisten Creator brauchen die Delaware-Sophistikation nicht. |
| **Berater mit US-Kunden**, der eine stabile Corporate Card braucht | Wyoming | Mercury und Relay verarbeiten Wyoming-LLCs sauber, und die Corporate Card wird reibungslos akzeptiert, weil der Staat als „Old Money" reputabel gilt. |
| **Holding-Struktur** oder IP-Verwahrung zwischen Mitgründern | Delaware | Der Delaware Court of Chancery ist die vorhersehbarste Gesellschaftsrechts-Jurisprudenz der Welt; der Aufschlag rechnet sich bei Streitigkeiten. |
...
- Form 5472 + 1120 pro-forma wird in allen drei Staaten identisch eingereicht; die Sanktion bei Versäumnis ist ebenfalls identisch: 25.000 USD pro Formular und Jahr.
...
Der Delta-Effekt ist real, und die LLC-Kosten amortisieren sich im ersten Monat. Lesen Sie unseren <a href="/de/blog/selbststandig-in-spanien-vs-llc-in-den-usa-vollstandiger">Vergleich Selbstständig in Spanien vs US-LLC</a> für vollständig durchgerechnete Zahlen (das Schema gilt analog für DACH mit den jeweiligen lokalen Sätzen).
...
- **Österreich.** EStG §4 und §27 (Kapitalvermögen, ausschüttende Erträge); KStG §10a (Hinzurechnungsbesteuerung); BAO §49 (Anzeige ausländischer Beteiligungen).
...
Wie diese Regeln auf Ihren Fall anzuwenden sind, hängt von Ihrer Steuerresidenz, der Tätigkeit der LLC und der von Ihnen geführten Dokumentation ab. Dieser Inhalt ist informativ und ersetzt keine personalisierte Beratung.
