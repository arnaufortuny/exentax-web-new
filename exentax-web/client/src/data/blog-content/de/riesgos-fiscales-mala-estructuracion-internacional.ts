...
**Folge**: Stellt das Finanzamt fest, dass Sie weiterhin im Inland steuerlich ansässig sind, kommt **Ihr gesamtes Welteinkommen** zur erneuten Besteuerung am Ursprungsort, mit vollständiger Nachveranlagung, Zinsen, Sanktionen und möglichem Strafverfahren.

**Wie Sie das vermeiden**: Wenn Sie umziehen, dann richtig (mehr als 183 Tage außerhalb, ohne wirtschaftlichen Mittelpunkt im Ursprungsland, mit Ansässigkeitsbescheinigung des neuen Landes). Wir entwickeln das in <a href="/de/blog/digitaler-nomade-wo-steuern-zahlen-und-steuerlichen-wohnsitz">Steueransässigkeit des digitalen Nomaden</a>.
...
- Zusätzliche Sanktionen wegen unterlassener Anmeldung der Betriebsstätte zum richtigen Zeitpunkt (Säumniszuschläge, Verspätungszuschläge, Hinterziehungszinsen).

**Wie Sie das vermeiden**: Wenn die Tätigkeit im Wesentlichen aus Deutschland oder Spanien erbracht wird, prüfen Sie ehrlich, ob die LLC die richtige Struktur ist oder ob eine deutsche GmbH oder eine spanische S.L. als operative Einheit besser passt. Vollständige Analyse in <a href="/de/blog/gestaltung-einer-soliden-internationalen-steuerstruktur">Gestaltung einer soliden internationalen Struktur</a>.
...
4. Jahr 5: vorläufige Veranlagung, Vorschlag zur Nachveranlagung + Zinsen + Sanktion.
...
1. **Beginnen Sie mit der korrekten Klassifikation** der LLC in Ihrer Jurisdiktion (siehe <a href="/de/blog/spanische-verwaltungsdoktrin-zur-us-llc-feb-2020">Doktrin DGT/TEAC zur LLC</a> sowie die Konsultation in <a href="https://petete.tributos.hacienda.gob.es" target="_blank" rel="noopener">PETETE</a>).
2. **Gestalten Sie nach der tatsächlichen Aktivität** (siehe <a href="/de/blog/llc-besteuerung-nach-wirtschaftlicher-aktivitat">LLC-Besteuerung nach Aktivität</a>).
...
Möchten Sie eine professionelle Überprüfung Ihrer Struktur, um Risiken zu erkennen und zu korrigieren, bevor das Finanzamt sie erkennt? Buchen Sie Ihre kostenlose Beratung.

Wenn ein bestimmter Punkt dieser Struktur noch mehr Tiefe verdient, finden Sie in <a href="/de/blog/internationale-besteuerung-fur-digitale-unternehmer">Internationale Besteuerung für digitale Unternehmer: vollständiger Leitfaden</a> genau den angrenzenden Aspekt, den wir normalerweise in einen eigenen Text auslagern.
...
<!-- exentax:cta-final -->
**Setzen wir echte Zahlen an Ihren Fall.** Buchen Sie 30 Minuten und wir prüfen gemeinsam, welches der sechs Risiken in Ihrem Dossier am stärksten wiegt und wie es sich neutralisieren lässt, ohne alles abzureißen.
...
- **Verwaltungsdoktrin.** Beschlüsse des <a href="https://serviciostelematicosext.hacienda.gob.es/TEAC/DYCTEA" target="_blank" rel="noopener">TEAC</a> und verbindliche Auskünfte der DGT zu Ein-Personen-LLC (u. a. V0443-08, V1631-17, V1147-22), ausgelegt im Lichte des BOE vom Februar 2020 zur Klassifikation transparenter ausländischer Einheiten.
...
- **Konventionen und internationale Normen.** Doppelbesteuerungsabkommen Spanien-USA, unterzeichnet 1990, mit Protokoll von 2013 in Kraft seit 2019, Richtlinie 2011/16/EU geändert durch DAC6, DAC7 und DAC8, Modell-Konvention der <a href="https://www.oecd.org" target="_blank" rel="noopener">OECD</a> mit Kommentaren und Multilaterales Instrument BEPS.
...
- **Vermischung von privatem und betrieblichem Geld ohne Nachvollziehbarkeit.** LLC-Karte für private Ausgaben, Überweisungen an die Familie ohne Verwendungszweck, Draws ohne Beleg. Das bricht die Haftungsbeschränkung, erschwert die Buchführung und wird in einer Prüfung als Simulation der unternehmerischen Tätigkeit ausgelegt.
