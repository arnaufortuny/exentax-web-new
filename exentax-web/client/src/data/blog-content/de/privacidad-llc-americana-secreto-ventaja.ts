...
**Vor dem <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>:** Der IRS weiß, wer der Eigentümer Ihrer LLC ist. Bei der Beantragung der EIN geben Sie an, wer die verantwortliche Person ist. Wenn Sie das Form 5472 einreichen, melden Sie die Transaktionen zwischen Ihnen und der LLC. Der staatliche Datenschutz hat keine Wirkung gegenüber der Bundessteuerbehörde.

**Vor <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>:** Der BOI Report (Beneficial Ownership Information Report) verlangt, dass Sie die wirtschaftlich Berechtigten der LLC offenlegen, einschließlich Name, Geburtsdatum, Adresse und Identifikationsnummer. Diese Informationen sind nicht öffentlich, befinden sich aber in den Händen der Bundesregierung.
...
- **Was NICHT privat ist: FinCEN BOI Report.** Seit Corporate Transparency Act muss jede LLC <20 Mitarbeiter und <5M$ Umsatz Name, Geburtsdatum, Adresse und Ausweis jedes Beneficial Owner an FinCEN melden. Nicht öffentlich, aber existiert. Strafe $591/Tag.
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…&lt;a href=&quot;/es/blog/extension-irs-form-1120-como-solicitarla&quot;&gt;Form 5472&lt;/a&gt;, reportas las tr…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 8938</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…uales. Pero declarada en residencia (Modelo 720/721 España, Form 8938 si residente US) y r…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
