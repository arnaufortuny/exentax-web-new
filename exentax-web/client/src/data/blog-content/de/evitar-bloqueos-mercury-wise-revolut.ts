export default `Die Kontosperrung ist der Albtraum jedes LLC-Eigentümers. Eines Tages loggen Sie sich bei Mercury oder Wise ein und sehen: „Ihr Konto wurde eingeschränkt." Ohne Vorwarnung, ohne klare Erklärung, und mit Ihrem Geld gesperrt.
