...
Mit LLC: Die abzugsfähigen Ausgaben sind wesentlich umfangreicher (alles, was für das Geschäft laut <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> „gewöhnlich und notwendig" ist), und Sie erklären nur die Nettogewinne. Die Bemessungsgrundlage wird erheblich reduziert.

Um diesen Faden weiterzuziehen, vertieft <a href="/de/blog/kann-man-legal-0-steuern-zahlen-die-wahrheit-uber">Kann man legal 0% Steuern zahlen? Die Wahrheit über Steueroptimierung</a> eine Nuance, die wir hier nur gestreift haben.
### Was sollten Sie tun?
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Der%20Ursprungsartikel%20ist%20auf%20Spanien%20zugeschnitten%2C%20doch%20das%20Muster%20passt%201%3A1%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">10.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…n la UE:** Aplica el sistema OSS (One-Stop Shop) si superas 10.000€/año en ventas a consum…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">72.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…un ejemplo real: **Perfil:** Desarrollador web en España, 72.000€/año de facturación, todo…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">23.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…es. ### Sin optimización (autónomo estándar): - **IRPF:** ~23.000€ (tipo efectivo ~32%) - …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">32%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…n (autónomo estándar): - **IRPF:** ~23.000€ (tipo efectivo ~32%) - **Cuota de autónomos:**…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">4.800</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…** ~23.000€ (tipo efectivo ~32%) - **Cuota de autónomos:** ~4.800€/año - **IVA:** 0€ (serv…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">27.800</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…- **IVA:** 0€ (servicios B2B internacionales) - **Total:** ~27.800€ → **38.6% de carga fis…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">6%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…servicios B2B internacionales) - **Total:** ~27.800€ → **38.6% de carga fiscal** ### Con e…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.200</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…gle-Member LLC no residente) - **Coste LLC + compliance:** ~1.200€/año - **Base imponible …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…tos deducibles de la LLC - **Total impuesto federal EE.UU.: 0%** La diferencia: entre **18…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">18.600</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…Total impuesto federal EE.UU.: 0%** La diferencia: entre **18.600€ y 21.600€ de ahorro anu…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">21.600</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…esto federal EE.UU.: 0%** La diferencia: entre **18.600€ y 21.600€ de ahorro anual** con l…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">47%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…eguir como autónomo en España Pagas IRPF progresivo (hasta 47%), cuota de autónomos (200-1…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">1.600</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…Pagas IRPF progresivo (hasta 47%), cuota de autónomos (200-1.600 €/mes según tramo y base)…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">60%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…tónomos (200-1.600 €/mes según tramo y base) y te queda un ~60% de lo que facturas. Es la …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…es con regímenes fiscales especiales: - **Portugal (NHR):** 20% tipo fijo sobre rendimient…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…rendimientos profesionales durante 10 años - **Andorra:** ~10% IRPF máximo - **Dubai/EAU:*…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">30.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ropio artículo. ### ¿Qué debería hacer? Si facturas más de 30.000€/año a clientes internac…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
