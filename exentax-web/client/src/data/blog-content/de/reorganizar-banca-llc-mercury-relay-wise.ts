export default `Eine saubere Bankarchitektur für eine LLC kombiniert in der Regel 3 Konten: Mercury für das USD-Operativ-Geschäft, Wise für den EUR-Umtausch mit 0,41 % Spread und Relay als Backup mit physischen Karten.
