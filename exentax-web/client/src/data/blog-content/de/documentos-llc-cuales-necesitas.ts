...
Der BOI Report (Beneficial Ownership Information) ist eine Meldung an <a href="https://www.fincen.gov" target="_blank" rel="noopener">FinCEN</a>, die die tatsächlichen Eigentümer der LLC identifiziert. Seit 1. Januar 2024 müssen alle LLCs ihn einreichen (obwohl FinCEN vorübergehend die Durchsetzung von Sanktionen ausgesetzt hat).
...
Ein paar angrenzende Beiträge, die man neben diesem geöffnet lassen sollte: <a href="/de/blog/warum-2026-eine-us-llc-eroffnen-die-5-saulen-des">Warum aktuell eine US LLC eröffnen: die 5 Säulen des amerikanischen Vorteils</a> und <a href="/de/blog/ein-vs-itin-vs-ssn-us-steueridentifikationsnummern-erklart">EIN vs ITIN vs SSN: US-Steueridentifikationsnummern erklärt</a> schärfen genau die Kanten, die wir oben nur angerissen haben.
...
- **Fiskal- und Bankenblock.** Forms 5472 + 1120 pro forma der letzten drei Jahre, Steueransässigkeitserklärung des Owners, Mercury/Relay/Wise-Auszüge der letzten sechs Monate und Abstimmung mit der Buchhaltung. Das verlangt Stripe Risk in einer erweiterten KYC-Prüfung.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Um%20aus%20Deutschland%2C%20%C3%96sterreich%20oder%20der%20Schweiz%20eine%20LLC%20aufzusetzen%2C%20brauche%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">100%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…autorizado a trabajar en EE.UU. para tener una LLC. Todo es 100% remoto - **Dirección físi…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…strarte en Stripe/PayPal, presentar declaraciones fiscales (Form 5472 + 1120) y operar con…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
