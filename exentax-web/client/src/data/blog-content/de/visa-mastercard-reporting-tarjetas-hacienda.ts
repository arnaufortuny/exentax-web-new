export default `Das Modelo 991 verpflichtet Visa, Mastercard und American Express, jede Karten­buchung über 25.000 € pro Karteninhaber und Jahr sowie die zugehörigen ausländischen Konten an die spanische AEAT zu melden.
...
Die allgemeine Regel: **Konto und Inhaberschaft sind gut erfasst**, während das **Detail auf Transaktionsebene** nicht standardmäßig fließt; es wird nur in einer konkreten Prüfung rekonstruiert. Atme durch: bei Exentax ist das Routine, wir bringen dich auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
