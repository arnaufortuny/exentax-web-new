...
| **CRS 2.0** (OECD 2023) | Wie oben + E-Geld (EMIs und *Specified Electronic Money Products*), verstärkte Sorgfaltspflichten gegenüber controlling persons, einlagenähnliche Digitalprodukte | Dieselben RFI sowie EMIs und gleichgestellte Anbieter | Ab Januar 2027 über Daten zum Geschäftsjahr 2026, je nach Umsetzung im Mitgliedstaat |
| **CARF** (OECD 2023) | Kryptoassets: Börsen, Verwahrer, Krypto-Derivate-Plattformen, bestimmte DeFi-Anbieter mit zentralisiertem Element | Reporting Crypto-Asset Service Providers (RCASP) | Januar 2027 über Daten zum Geschäftsjahr 2026 in der EU, via DAC8 |
