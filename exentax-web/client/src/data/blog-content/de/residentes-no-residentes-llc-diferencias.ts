...
- **Außensteuergesetz (AStG)**: Bei Klassifizierung der LLC als ausländische Kapitalgesellschaft (selten bei SMLLC) kann die **Hinzurechnungsbesteuerung nach §§ 7-14 AStG** greifen, wenn die LLC niedrig besteuert ist (< 25 %, ab Steuerreform 2024 < 15 %) und überwiegend passive Einkünfte erzielt. Für eine operativ tätige Service-LLC ist das in der Regel nicht der Fall.
...
Für in Österreich Ansässige ist die SMLLC ebenfalls grundsätzlich als transparente Mitunternehmerschaft zu qualifizieren (vgl. EAS 3401, 3413 des österreichischen BMF zur Behandlung ausländischer LLCs). Die Gewinne werden im Rahmen der österreichischen Einkommensteuer (Tarif 0-55 % gemäß § 33 EStG, Spitzensteuersatz 55 % über 1 Mio. € befristet bis 2025) erfasst. Das **DBA Österreich-USA (BGBl. III Nr. 6/1998, Protokoll 2006)** regelt die Doppelbesteuerung. **CFC-Regelung**: § 10a KStG (umgesetzt aus ATAD I Art. 7-8) greift nur bei Kapitalgesellschaften, nicht bei transparenten LLCs ohne Optierung.
