...
- **Mitteilung von Auslandsbeziehungen nach §138 AO**: Pflicht zur Mitteilung der Gründung oder des Erwerbs einer Beteiligung an einer ausländischen Gesellschaft (auch transparente LLC) an das zuständige Finanzamt **innerhalb von 5 Monaten nach Ablauf des Kalenderjahres**, in dem das mitteilungspflichtige Ereignis eingetreten ist. Verstöße werden mit Bußgeld bis 25.000 € geahndet. Atme durch: bei Exentax ist das Routine, wir bringen dich auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
...
3. **Dokumentation pflegen**: Verträge, Rechnungen, Belege, Buchhaltung der LLC, kohärente CRS-Selbstauskünfte. Ohne Dokumentation kehrt eine Prüfung de facto die Beweislast auf den Steuerpflichtigen um. Bei Exentax haben wir Mandanten in genau dieser Lage ohne Strafe geschlossen. Früh sprechen lohnt sich — und spart dir fünf Stellen.
