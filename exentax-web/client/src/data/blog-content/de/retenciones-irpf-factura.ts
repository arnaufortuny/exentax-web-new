...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22IRPF-Quellensteuern%20auf%20Rechnungen%20sind%20die%20Art%20und%20Weise%2C%20wie%20die%20spanische%20%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">15%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…donde la AEAT cruza datos automáticamente. ## Porcentajes: 15% general y 7% para nuevos au…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">7%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…cruza datos automáticamente. ## Porcentajes: 15% general y 7% para nuevos autónomos El por…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…esta circunstancia al pagador. Hay porcentajes especiales: 1% para módulos en algunas acti…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…entajes especiales: 1% para módulos en algunas actividades, 19% para arrendamientos urbano…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…bre la base sin IVA y total a percibir. Ejemplo: factura de 1.000 euros + 21% IVA - 15% re…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…n IVA y total a percibir. Ejemplo: factura de 1.000 euros + 21% IVA - 15% retención = 1.00…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.060</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…1.000 euros + 21% IVA - 15% retención = 1.000 + 210 - 150 = 1.060 euros que tu cliente te …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…rofesional o empresarial que no esté en módulos. Calcula el 20% sobre el rendimiento neto …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">70%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…n facturas. Si tus clientes ya retuvieron el equivalente al 70% o más de tus ingresos, no …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…bligación de presentar el 130. Por eso muchos profesionales 100% B2B (que retienen al 15% …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">RD 439/2007</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…detalladas de retenciones están en el Reglamento del IRPF (RD 439/2007, accesible en el &lt;a…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
<li><span class="font-mono">BOE-A-2007-6820</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…cesible en el &lt;a href=&quot;https://www.boe.es/buscar/act.php?id=BOE-A-2007-6820&quot;&gt;BOE&lt;/a&gt;). La …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
</ul>
</aside>
<!-- /exentax:review-anchor-v1 -->
`;
