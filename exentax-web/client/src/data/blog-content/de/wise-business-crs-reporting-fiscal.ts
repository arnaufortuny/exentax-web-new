...
- **Meldepflichten in Deutschland.** US-Bankkonten und alle europäischen IBAN-Konten auf Ihren Namen (Wise, Revolut, N26, Wallester): **Anlage AUS** und **Anlage KAP** zur ESt-Erklärung, ohne Bagatellgrenze. Mitteilung der Beteiligung an einer ausländischen Gesellschaft nach **§ 138 AO** innerhalb von 5 Monaten nach Ablauf des Kalenderjahres, in dem die Beteiligung erworben wurde; bei Verstoß Bußgeld bis 25.000 €. Bei Anwendung der Hinzurechnungsbesteuerung zusätzlich **Anlage AStG** mit dem Hinzurechnungsbetrag. Atme durch: bei Exentax ist das Routine, wir bringen dich auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
