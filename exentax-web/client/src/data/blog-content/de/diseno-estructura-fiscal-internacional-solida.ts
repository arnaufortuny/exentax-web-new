...
**Wirtschaftliche Aktivität** verstehen, siehe <a href="/de/blog/llc-besteuerung-nach-wirtschaftlicher-aktivitat">Besteuerung nach Aktivität</a>. **Reale Steuerresidenz** (Tage, Interessenzentrum, Familie), siehe <a href="/de/blog/digitaler-nomade-wo-steuern-zahlen-und-steuerlichen-wohnsitz">Nomade-Residenz</a>. Vermögensdiagnose. 5-Jahres-Ziel.
...
- **Single-Member LLC US Disregarded Entity**: B2B-Services. Siehe <a href="/de/blog/new-mexico-vs-wyoming-vs-delaware-welchen-bundesstaat-fur">NM vs WY vs DE</a>.
- **Multi-Member LLC Partnership**.
- **LLC Check-the-Box C-Corp**: Corporate-Opazität.
- **Spanische SL**: ES-Aktivität.
- **ES-Holding + Auslandsfilial**: Vermögensprofile.
- **OÜ Estland, HK Limited, Singapur, BVI**: Spezial. OÜ überbewertet, siehe <a href="/de/blog/warum-kein-estnisches-unternehmen-eroffnen-die-us-llc">warum nicht Estland</a>.
...
Schritt 1 überspringen; Residenz nur auf Papier; Vehikel nach Trend; ohne Substanz; Vermischung; keine Überprüfung. Siehe <a href="/de/blog/steuerrisiken-bei-mangelhafter-internationaler">Risiken</a>.
### Zusammenfassung
...
Wer hier mehr Tiefe vermisst, findet in <a href="/de/blog/melden-us-bankkonten-an-ihre-heimische-steuerbehorde-die">Melden US-Bankkonten an Ihre heimische Steuerbehörde? Die ehrliche Antwort</a> genau den Nachbaraspekt, den wir normalerweise in einen eigenen Text auslagern.
...
## Das Exentax-Framework zum Entwurf einer internationalen Steuerstruktur

Eine solide internationale Steuerstruktur kauft man nicht; man entwirft sie aus fünf Schichten in der richtigen Reihenfolge. Die Reihenfolge zu überspringen ist die häufigste Ursache für Strukturen, die bei der ersten Anfrage scheitern. Das ist das Framework, mit dem wir bei Exentax jeden Fall bearbeiten.

- **Schicht 1 - Ehrliche persönliche Diagnose.** Inventur der aktuellen Steuerresidenz, Staatsbürgerschaft, Vermögen nach Jurisdiktion, Einkommensquellen und Angehörigen. Die Struktur eines Singles mit digitalem Einkommen ähnelt nicht der eines verheirateten Elternteils mit schulpflichtigen Kindern oder eines konzentrierten Immobilienvermögens. Entwurf ohne dies ist blindes Engineering.
- **Schicht 2 - Wahl der Wohnsitzjurisdiktion.** Der wirkungsstärkste Hebel der fünf. Andorra, Portugal mit NHR-IFICI, Italien mit Impatriate-Regime, VAE, Paraguay, Uruguay, Zypern, Malta. Jeweils mit Regime, geforderter Substanz, DBA mit Ihrem Herkunftsland und realem Betrieb. Ohne abgeschlossene Schicht ist die Gesellschaftsstruktur sekundär.
- **Schicht 3 - Gesellschaftsstruktur.** US-LLC für internationalen operativen Fluss, andorranische oder VAE-Holding zur Akkumulation, lokale Betriebsgesellschaft bei physischer Substanz, spanische ETVE in qualifizierten Fällen. Kriterium: Die Gesellschaft dient dem Residenten, nicht umgekehrt. Hübsche Gesellschaft mit fehlpositioniertem Residenten ist eine fehlerhafte Struktur.
- **Schicht 4 - Bank und Zahlungsschienen.** Mercury + Wise Business als USD-EUR-Betriebspaar, lokale Bank in Wohnsitzjurisdiktion für Alltagsausgaben, FX-Broker bei rechtfertigendem Volumen, Stripe/Paddle/DoDo-Gateways nach Kundenmix. Jede Geldbewegung zwischen Schichten muss gegen eine DBA-Klausel erklärbar sein.
- **Schicht 5 - Wiederkehrender Compliance.** 5472 + 1120 pro forma, BOI-Report, staatlicher Annual Report, Residenz-Erklärungen (IRPF/lokale KSt), implizite CRS/DAC7/DAC8, spanische Modelo 720/721 bei Bedarf. Ohne integrierten Kalender bricht die eleganteste Struktur in 3 Jahren zusammen.

### Was wir am häufigsten gefragt werden

**Wie lange dauert der Entwurf einer Gesamtstruktur?** Zwischen 6 und 16 Wochen je nach Komplexität. Schicht 1 (Diagnose) 1-2 Wochen; Schicht 2 (Residenz) 3-9 Monate bei effektivem Umzug; Schichten 3-4 (Gründung und Bank) parallel 4-8 Wochen; Schicht 5 (Compliance) als geschlossenes Handbuch an Klient.

**Und wenn sich meine Lage in 3 Jahren ändert?** Die Struktur wird mit Ausstiegsklauseln und Umzugs-Scharnieren entworfen, damit eine Änderung (Heirat, Kinder, Firmenverkauf, Teil-Ruhestand) nicht bedeutet, alles neu zu machen. Modularität sitzt im Entwurf ab Schicht 1, nicht nachträglich.

Bei Exentax wenden wir dieses Framework seit Jahren mit Klienten aus Europa und Lateinamerika an. Wir verkaufen keine Konfektionsstrukturen; wir führen fünf Schichten in der richtigen Reihenfolge aus und übergeben dem Klienten einen dokumentarisch verteidigungsfähigen Entwurf, der ab Tag eins operativ ist.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Eine%20internationale%20Steuerstruktur%20zu%20gestalten%20ist%20nicht%20das%20exotischste%20Lan%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">80.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…fil 1: Consultor freelance B2B residente en España, factura 80.000-150.000 €/año, sin equi…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">150.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…Consultor freelance B2B residente en España, factura 80.000-150.000 €/año, sin equipo.** E…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…Perfil 2: E-commerce en Amazon Europa, residente en España, 200.000-500.000 €/año.** Estru…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">500.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…: E-commerce en Amazon Europa, residente en España, 200.000-500.000 €/año.** Estructura re…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">100.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…7. **Perfil 3: SaaS B2B internacional, residente en LATAM, 100.000 € arr.** LLC + Mercury …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…- **EE.UU.**: &lt;a href=&quot;/es/blog/que-es-irs-guia-duenos-llc&quot;&gt;Form 5472&lt;/a&gt; + Form 1120 pro-…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…href=&quot;/es/blog/que-es-irs-guia-duenos-llc&quot;&gt;Form 5472&lt;/a&gt; + Form 1120 pro-forma anual, BOI …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">DAC7</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…Modelo 721 para cripto, Modelo 100/130, posible Modelo 238 (DAC7) si vendes en plataformas…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…a fiscal, sustancia, stack bancario, normativa nueva (DAC7, DAC8, MiCA, cambios CDI), umbr…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
