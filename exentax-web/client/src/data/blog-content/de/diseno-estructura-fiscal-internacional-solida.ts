...
## Der spezifische Fall des in Deutschland und Österreich Steuerpflichtigen
  ...
  Eine **belastbare internationale Steuerstruktur** für deutsche und österreichische Mandanten beruht auf vier Säulen, die in jeder Phase überprüfbar sein müssen.

  Die erste Säule ist die **wirtschaftliche Substanz** im Sinne der **§§ 7-14 AStG** und der OECD-BEPS-Aktion 5. Eine US-LLC ohne eigenes Personal, ohne Geschäftsräume und ohne unternehmerische Risikotragung wird vom deutschen Finanzamt regelmäßig als Briefkastenstruktur eingestuft, was die **Hinzurechnungsbesteuerung** auslöst. Seit dem ATAD-Umsetzungsgesetz 2021 reicht ein "ausreichend ausgestatteter Geschäftsbetrieb" (Substance Test, § 8 Abs. 2 AStG) als Verteidigung; das BMF-Schreiben vom 22. Dezember 2023 (BStBl. I 2023, 2179) konkretisiert die Anforderungen.

  Die zweite Säule ist die **Verrechnungspreisdokumentation** nach **§ 90 Abs. 3 AO** in Verbindung mit der **Gewinnabgrenzungsaufzeichnungsverordnung (GAufzV)** und dem **OECD-Verrechnungspreisleitfaden 2022**. Bei Geschäftsbeziehungen zwischen einer in Deutschland steuerpflichtigen Person und ihrer US-LLC sind Local File und Master File zu führen, wenn die jeweiligen Schwellenwerte erreicht sind.

  Die dritte Säule ist die **DBA-Konformität**: Das DBA Deutschland-USA vom 29. August 1989 (Änderungsprotokoll 2006) enthält in Artikel 28 eine umfassende **Limitation-on-Benefits-Klausel (LoB)**, die Treaty Shopping verhindert. Eine LLC ohne wirtschaftliche Substanz oder ohne qualifizierende US-Anteilseigner verliert den DBA-Schutz.

  Die vierte Säule ist die **fortlaufende Compliance-Dokumentation** nach §§ 140 ff. AO mit Aufbewahrung über zehn Jahre. In Österreich greifen die parallelen Vorschriften der §§ 124 ff. BAO und § 10a KStG.

  ### Praktische Implikationen der DBA-Konformität

  Eine US-LLC-Struktur, die das DBA Deutschland-USA in Anspruch nehmen will, muss zusätzlich die seit 2017 geltenden BEPS-Aktion-6-Anforderungen (Treaty Shopping Prevention) erfüllen, insbesondere den **Principal Purpose Test (PPT)**. Bei Strukturen, deren wesentlicher Zweck die Erlangung eines DBA-Vorteils ist, kann das US-Treasury die DBA-Anwendung verweigern, was eine deutsche Quellensteuer von 25 % nach § 50a EStG zur Folge haben kann.
...
Prüfungen. Hier kommt Exentax ins Spiel: wir reichen das Formular ein, archivieren den Beleg und, wenn die Behörde fragt, liegt deine Antwort bereits fertig.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Eine%20internationale%20Steuerstruktur%20zu%20gestalten%20ist%20nicht%20das%20exotischste%20Lan%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
