export default `Das Wort "offshore" trägt eine schwere Last: Für die einen bedeutet es finanzielle Freiheit und kluge Planung, für die anderen Hinterziehung und Opazität. Die Realität ist nüchterner. Eine Offshore-Struktur ist weder per Definition illegal noch an sich magisch: Sie ist schlicht eine Gesellschaft oder eine Reihe von Gesellschaften, die in einer anderen Jurisdiktion gegründet wurden als der Wohnsitzstaat des Eigentümers. Was sie zu einer guten oder schlechten Idee macht, ist die Nutzung, die Erklärung und die übernommenen Risiken.
...
1. **Angemessene Substanz**: Die Gesellschaft existiert dort, wo behauptet, mit Sitz, Entscheidungen und ggf. echten Personen.
2. **Kohärenz mit Ihrem realen Leben**: Nicht etwas auf Papier konstruieren, das nicht zu Wohnort, Entscheidungen und Operationen passt.
3. **Vollständige Erklärung im Wohnsitzland**: Eigentum, Kontrolle, Konten und Erträge.
4. **Gerechtfertigte laufende Kosten**: Wenn die Steuerersparnis kleiner ist als die Strukturkosten, lohnt es sich nicht.
5. **Zukunftssicherheit**: Widerstandsfähig gegenüber absehbaren Änderungen (BEPS, CRS, Register).
### Die Option, die wir in den meisten Fällen empfehlen

Für Freelancer, Berater, digitale Agenturen, SaaS, E-Commerce und Creator mit Wohnsitz in Spanien, LatAm oder Europa und internationalen Einkünften löst eine <a href="/de/blog/llc-in-den-usa-vollstandiger-leitfaden-fur-nicht-residenten">US-LLC</a> den Durchschnittsfall besser als jede traditionelle Offshore-Alternative:
...
Bei Exentax können wir Ihre Situation analysieren und die minimal tragfähige Struktur vorschlagen, die Ihre Ziele ohne unnötige Risiken erreicht. Bei Exentax prüfen wir Ihren Fall mit echten Daten: <a href="/de/buchen">buchen Sie eine kostenlose Beratung</a> von 30 Minuten.
...
1. **Spanische Liste nicht kooperativer Jurisdiktionen (Orden HFP/115/2023, BOE 10. Februar 2023)**, später verfeinert. Sie ersetzte das RD 1080/1991 und führte die qualitativen Kriterien des Artikels 16 Ley 11/2021 ein. umfasst sie unter anderem Anguilla, Bahrain, Barbados, Bermudas, Dominica, Fidschi, Gibraltar (teilweise), Guam, Marianen, Salomonen, Turks und Caicos, BVI, US Virgin Islands, Jersey und Guernsey (teilweise), Libanon, Macau, Mauritius, Palau, Amerikanisch-Samoa, Samoa, Seychellen, Trinidad und Tobago, Vanuatu. Die geltende Liste stets auf der AEAT-Seite prüfen.
...
> **Setzt Sie Ihr aktuelles Setup einer dieser Listen aus?** Lassen Sie Ihren Fall durch den <strong>Exentax-Steuerrechner</strong> laufen.

Für das ganze Ökosystem und die Rolle der LLC lesen Sie weiter in <a href="/de/blog/legale-wege-um-ihre-steuern-zu-minimieren">den legalen Wegen zur Steuerminimierung</a>, und wenn Ihr Hauptvermögen ausländische Konten oder Krypto sind, prüfen Sie <a href="/de/blog/modelo-720-und-modelo-721-leitfaden-fur-in-spanien-ansassige">den Modelo-720-und-721-Leitfaden</a>. Für das Strukturdesign <strong>vereinbaren Sie ein Gespräch mit Exentax</strong>.

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Das%20Wort%20offshore%20tr%C3%A4gt%20eine%20schwere%20Last%3A%20F%C3%BCr%20die%20einen%20bedeutet%20es%20finanzie%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…0; equivalentes en LatAm). No hacerlo es delito. - **&quot;Pagar 0% a nivel personal&quot;**: tu paí…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…cionado**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domici…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…o**: una sociedad offshore mal elegida puede consumir 5.000-15.000 USD/año en domicilios, …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ncia, SaaS, ecommerce y creadores. - **Reino Unido (Ltd)**: 25% impuesto de sociedades per…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">10%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…en Estonia o necesitas IBAN europeo. - **Bulgaria (OOD)**: 10% de impuesto de sociedades, …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…de tu país. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, int…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">200%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ís. Si no la has declarado, sanciones por entre el 50% y el 200% más recargos, intereses y…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">RD 1080/1991</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…febrero de 2023)**, modificada posteriormente. Sustituyó al RD 1080/1991 e introdujo crite…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
