...
## Florida: Der vierte Bundesstaat zur Auswahl

Florida ist beliebt wegen der nicht vorhandenen State Income Tax und seines wirtschaftsfreundlichen Rufs. Für Nichtansässige sollten jedoch einige Punkte klar sein.
...
- **Die EIN ist die gleiche Art von Nummer**: Sie wird vom <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a> ausgestellt, nicht vom Bundesstaat
...
Um diesen Faden weiterzuziehen, vertiefen <a href="/de/blog/vor-und-nachteile-einer-us-llc-fur-nicht-residenten-ehrliche">Vor- und Nachteile einer US LLC für Nicht-Residenten: ehrliche Analyse</a> und <a href="/de/blog/selbststandig-in-spanien-vs-llc-in-den-usa-vollstandiger">Selbstständig in Spanien vs LLC in den USA: vollständiger Steuervergleich</a> Nuancen, die wir hier nur gestreift haben.
...
## Exentax-Update aktuell: Bundesstaaten-Vergleich Ende aktuell

Die drei Staaten bleiben die sinnvolle Wahl für eine LLC eines Nicht-Residenten; Nuancen aktuell:

- **Wyoming:** Filing 100 USD, **Annual Report 60 USD** (am Vortag des Jubiläums), **keine state income tax**, hohe Privatsphäre. Ideal für Standardbetrieb und kleine Holdings.
- **Delaware:** Filing 110 USD, **Franchise Tax 300 USD/Jahr** (Fälligkeit 1. Juni), Court of Chancery mit gefestigter Rechtsprechung. Höhere Kosten, aber bevorzugte Lesart von VC-Investoren und Corporate-Käufern.
- **New Mexico:** Filing 50 USD, **kein Annual Report**, **keine state income tax**, maximale öffentliche Privatsphäre. Minimale Jahreskosten (nur RA, ~125 USD). Ideal für Side-Projects, minimalistische Profile und Tests.

### FAQ aktuell

**Welcher bei internationalem SaaS?** Wyoming als Standard. Delaware nur, wenn Sie in 24 Monaten VC in den USA aufnehmen wollen.

**Sperrt New Mexico Mercury oder Stripe?** Nein. Mercury, Relay, Wise und Stripe akzeptieren alle drei. Unterschied sind Kosten und Reputation, nicht Zugang.

**Kann ich von einem Staat in einen anderen umsiedeln?** Ja, über *conversion* oder *domestication*: Die LLC behält EIN, Gründungsdatum und Bankkonten. Kosten 200-600 USD je Staat.
<!-- exentax:overhaul-aktuell-v1 end -->

<!-- exentax:execution-v2 -->
## Wie wir bei Exentax den Bundesstaat wählen: Anwendungsfall, kein Trend

Die Wahl des Bundesstaats gewinnt man nicht mit Gebührenvergleich: sie hängt vom Verwendungszweck ab. Was wir bei Exentax wöchentlich anwenden, ist eine Ausschlussfrage nach realer Nutzung, nicht Registered-Agent-Werbung.

- **Wyoming** für Standard-Operationen nichtansässiger Freelancer mit Digitaleinkünften: angemessene Privatsphäre, stabiles Annual Report und Banking-Akzeptanz bei Mercury, Wise und Relay.
- **New Mexico** bei maximaler Privatsphäre im öffentlichen Register ohne Annual Report - manche Banken sind im KYC strenger.
- **Delaware** nur bei Investitionen, mehrstufiger Holding oder Series LLC; Franchise Tax und Kosten höher, lohnen sich für Freelancer nicht.

Für Kosten und Plan pro Bundesstaat in Ihrem Fall starten Sie den <strong>Exentax-Rechner</strong> oder buchen dreißig Minuten.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Wenn%20Sie%20aus%20Deutschland%2C%20%C3%96sterreich%20oder%20der%20Schweiz%20eine%20LLC%20gr%C3%BCnden%20wollen%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<!-- exentax:cta-v1 -->
Wir vergleichen New Mexico, Wyoming, Delaware und Florida anhand Ihres konkreten Falls — ohne den gerade angesagten Bundesstaat zu pushen. <a href="/de/leistungen">Meinen Fall mit einem Berater vergleichen</a>.
<!-- /exentax:cta-v1 -->
...
<li><span class="font-mono">80%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…na | ### ¿Cuál elegir? Nuestra recomendación clara Para el 80% de los freelancers y empren…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…ticas**: &lt;a href=&quot;/es/blog/documentos-llc-cuales-necesitas&quot;&gt;Form 5472&lt;/a&gt;, Form 1120, &lt;a h…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…f=&quot;/es/blog/documentos-llc-cuales-necesitas&quot;&gt;Form 5472&lt;/a&gt;, Form 1120, &lt;a href=&quot;/es/blog/c…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
