...
1. Formale Auflösungsentscheidung (intern).
2. Operativer Abbau (Kunden, Verträge, Schulden, Vermögen).
3. Schließung von Bankkonten und Zahlungs-Gateways.
4. Einreichung der Schlusserklärungen beim IRS (Form 1120 + 5472 als *Final return*).
5. Staatliche Auflösung (Articles of Dissolution oder Certificate of Cancellation).
6. EIN-Schließung beim IRS und BOI-Report-Abwicklung bei FinCEN, soweit zutreffend.
7. Kündigung des Registered Agent und persönliches Dokumentenarchiv.
...
- **Buchhaltung aufbewahren** (ein- und ausgegangene Rechnungen, Kontoauszüge, Belege) mindestens **sieben Jahre**. Sinnvoller Horizont für Prüfungen, Zinsen und mögliche Anfragen.
...
Wer 5472-Rückstände aufgebaut hat, sollte **vor der Schließung regularisieren**, nicht durch Schließung verstecken. Details im <a href="/de/blog/was-passiert-wenn-sie-form-5472-nicht-einreichen-irs-strafen">Form 5472-Strafen-Leitfaden</a>. Eine Schließung mit offenen 5472 löscht aufgelaufene Strafen nicht; sie friert sie ein, und der IRS verfolgt sie gegen Sie als der mit der EIN verknüpften natürlichen Person.
### 5. Staatliche Auflösung: Articles of Dissolution oder Certificate of Cancellation
...
Eigene ITINs oder mit der LLC verknüpfte Partner-ITINs „schließen" nicht mit der LLC: sie bleiben für Ihre persönliche US-Aktivität gültig, solange sie regelmäßig genutzt werden (siehe <a href="/de/blog/itin-beantragen-individuelle-steuernummer-irs">ITIN-Leitfaden</a>).
...
1. **Bank vor dem finalen 5472 schließen.** Die letzte Distribution lässt sich danach kaum dokumentieren.
2. **Staatliche Auflösung ohne Bezahlung der ausstehenden Franchise Tax** beantragen (Delaware und Kalifornien sind am strengsten).
3. **Foreign Qualifications in anderen Staaten vergessen** zu kündigen.
4. **Final return auf 1120 / 1065 nicht markieren.** Der IRS erwartet im Folgejahr weiter eine Erklärung.
5. **BOI Report nicht aktualisieren**, wenn die Vorschriften es verlangen.
6. **Kontoauszüge nicht** vor der Schließung sichern.
...
Wenn Sie Ihre LLC sicher schließen wollen, vereinbaren Sie eine kostenlose Beratung: wir prüfen Ihre Lage, sagen ehrlich, ob Schließen oder Pausieren mehr Sinn ergibt, und liefern bei Beauftragung einen Schließplan mit Daten und Festangebot. Geht es Ihnen umgekehrt darum, dass die LLC weiter Sinn ergibt, aber Kosten und Pflichten sinken sollen, testen Sie zuerst unseren <strong>Steuerrechner</strong> und vergleichen Sie die heutige Situation mit dem Szenario aktiv mit dem richtigen Stack: <a href="/de/blog/wise-banken-und-llc-der-komplette-banking-stack-den-niemand">Wise Business, Relay und Slash als operative Konten, Mercury als Backup und Wallester nur bei europäischer IBAN</a> mit zugehöriger CRS-Analyse.
...
- **Schritt 4 - Final Form 5472 + 1120 pro forma.** "Final Return" auf beiden Formularen ankreuzen. Ohne dies erwartet die IRS weiter jährlich 5472 mit 25.000 USD Strafe pro Versäumnis. Der teuerste und häufigste Fehler.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22como%20disolver%20cerrar%20llc%20paso%20a%20paso%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…. - **Registered Agent fees** anuales (50-150 USD/año). - **Form 5472 + 1120 pro forma** a…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1120</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…pago. 4. Presentación de declaraciones finales ante el IRS (Form 1120 + 5472 marcados *Fin…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 1065</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…incluir la **distribución final** del cash al miembro. - **Form 1065 (Final)** si tu LLC e…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 966</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…-S (Final)** si elegiste tributar como C-corp o S-corp. - **Form 966 (Corporate Dissolutio…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 941</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…ón de disolución, si la LLC tributaba como corporación. - **Form 941 / 940 final** si tení…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">Form 568</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…anchise tax mínimo del año del cierre** además de presentar Form 568 final. - **Otros esta…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
