export default `Estland ist dank der e-Residency, seiner Digitalisierung und dem Versprechen "0 % auf reinvestierte Gewinne" populär geworden. Es ist wahrscheinlich die europäische Jurisdiktion mit dem besten institutionellen Marketing und gleichzeitig eine der am schlechtesten verstandenen. Dieser Leitfaden erklärt, wie das estnische Steuersystem aktuell wirklich funktioniert, ohne bereits zu bewerten, ob es zu Ihrem Fall passt. Für diese zweite Diskussion haben wir bereits einen eigenen Artikel: <a href="/de/blog/warum-kein-estnisches-unternehmen-eroffnen-die-us-llc">warum für die meisten Nicht-Residenten kein estnisches Unternehmen sinnvoll ist</a>.
...
Für die meisten Profile, die wir betreuen, bietet eine <a href="/de/blog/durchlaufbesteuerung-fur-llcs-wie-sie-funktioniert-und-warum">US-LLC im Pass-through</a> bessere effektive Besteuerung, operativere Banken und niedrigere Unterhaltskosten. Wenn Sie konkrete Zahlen für Ihren Fall vergleichen möchten, können wir das bei Exentax unverbindlich tun. Bei Exentax prüfen wir Ihren Fall mit echten Daten: <a href="/de/buchen">buchen Sie eine kostenlose Beratung</a> von 30 Minuten.
...
<!-- exentax:zero-tax-nuance-v1 --><!-- exentax:execution-v2 -->
...
- **e-Residency: digitale Identität, keine Steueransässigkeit.** e-Residency erlaubt OÜ-Verwaltung remote via digitalem Portal, elektronische Vertrags- und Erklärungsunterzeichnung. Verleiht KEINE estnische Steueransässigkeit, gibt KEIN Wohnrecht in Estland, reduziert NICHT Ihre Steuerpflicht im Wohnsitzland. Operatives Werkzeug, keine Steuerstruktur.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Estland%20ist%20dank%20der%20e-Residency%2C%20seiner%20Digitalisierung%20und%20dem%20Versprechen%20%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…racias a la e-Residency, su digitalización y la promesa de &quot;0% sobre beneficios reinvertid…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">2.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ial mínimo: 0,01 EUR desde la última reforma (anteriormente 2.500 EUR exigibles a la prime…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «….500 EUR exigibles a la primera distribución). Constitución 100% online en 1-3 días con e-…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">22%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ciedad reparte dividendos a los socios, Estonia aplica el **22% nominal**, calculado como …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">7.800</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…sobre el importe neto distribuido. Es decir, para entregar 7.800 EUR netos al socio, la so…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…egar 7.800 EUR netos al socio, la sociedad debe disponer de 10.000 EUR (7.800 al socio + 2…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">2.200</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…, la sociedad debe disponer de 10.000 EUR (7.800 al socio + 2.200 de impuesto). Sobre el b…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">14%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…carga efectiva es del 22%. - Existe un tipo reducido del **14% (calculado como 14/86)** pa…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…- Los dividendos recibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…idendos recibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EU…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ibidos tributan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hast…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…butan en el IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">23%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…IRPF del ahorro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% has…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">200.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…horro: 19% hasta 6.000 EUR, 21% hasta 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">28%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…a 50.000 EUR, 23% hasta 200.000 EUR, 27% hasta 300.000 EUR, 28% por encima. - El convenio …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">5%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…nio España-Estonia limita la retención en origen estonia al 5% sobre dividendos para parti…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">25%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…a al 5% sobre dividendos para participaciones inferiores al 25%, y existe deducción por do…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…doble imposición. - Carga combinada típica: en torno al 25-30% según renta total. Si eres …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…**Declaración mensual de IVA** si está registrada (umbral: 40.000 EUR/año en EEE). - **Dec…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…do contabilidad, domicilio, contact person y annual report: 1.500-3.500 EUR. ## Banca: el …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">3.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…tabilidad, domicilio, contact person y annual report: 1.500-3.500 EUR. ## Banca: el cuello…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">80.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…fica el valor del régimen. **Caso 2: consultor europeo con 80.000 EUR/año que necesita el …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…cios queden en la sociedad, 0% de impuestos. Al distribuir, 20% (22% efectivo según el eje…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">50%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…España: TFI/CFC aplica si tributación efectiva estonia es &lt;50% de la española y la socieda…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
