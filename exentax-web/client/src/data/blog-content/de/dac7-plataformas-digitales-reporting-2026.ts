...
- **heute (jetzt)**: viertes Geschäftsjahr in vollem Anwendungsumfang. Die Finanzämter verfügen über drei Jahre kreuzbarer Daten. Die daraus folgenden Prüfungen materialisieren sich gerade. Hier kommt Exentax ins Spiel: wir reichen das Formular ein, archivieren den Beleg und, wenn die Behörde fragt, liegt Ihre Antwort bereits fertig.
...
- **Meldepflichten in Deutschland.** US-Bankkonten und alle europäischen IBAN-Konten auf Ihren Namen (Wise, Revolut, N26, Wallester): **Anlage AUS** und **Anlage KAP** zur ESt-Erklärung, ohne Bagatellgrenze. Mitteilung der Beteiligung an einer ausländischen Gesellschaft nach **§ 138 AO** innerhalb von 5 Monaten nach Ablauf des Kalenderjahres, in dem die Beteiligung erworben wurde; bei Verstoß Bußgeld bis 25.000 €. Bei Anwendung der Hinzurechnungsbesteuerung zusätzlich **Anlage AStG** mit dem Hinzurechnungsbetrag. Bleiben Sie ruhig: bei Exentax ist das unser Wochengeschäft, wir schließen es ab, bevor der Brief in Ihrem Postfach landet.
