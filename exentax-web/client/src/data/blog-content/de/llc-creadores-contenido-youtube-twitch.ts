export default `Für einen DACH-Creator, der von AdSense, Twitch, Patreon und Sponsoring lebt, wird das steuerliche Bild schnell unhaltbar: KSK oder Freiberufler-Status, Umsatzsteuer auf Subs, US-Withholding durch Google und ein persönlicher Grenzsteuersatz, der schon im sechsstelligen Bereich bei 42 % liegt. Eine LLC verändert dieses Bild vollständig.
...
Bei Exentax strukturieren wir Multi-Plattform-Einnahmen von DACH-Creators. Buchen Sie Ihre kostenlose Beratung: wir mappen AdSense, Twitch und Sponsorings und sagen Ihnen, wo jeder Euro landen soll.
...
## LLC für Content-Creator (YouTube, Twitch, TikTok): wie Sie sauber in USD kassieren
...
**Ändert sich mein Publikum mit der LLC?** Nicht für Abonnenten. Ja bei Sponsorships: Marke professionalisiert sich und viele Corporate-Sponsoren arbeiten nur mit Entitäten. Echte Marktöffnung.

**Was passiert mit meinen aktuellen AdSense-Auszahlungen aufs Privatkonto?** Zahlungsmethode in AdSense auf EIN + Mercury der LLC ändern. Historie bleibt Ihnen zugeordnet; neu der LLC.

Bei Exentax bauen wir das vollständige Creator-Setup in 4-6 Wochen (LLC + EIN + Mercury + W-8BEN-E + AdSense/Twitch/TikTok-Migration + monatliche Buchhaltung), bereit für den ersten Payout.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22F%C3%BCr%20einen%20DACH-Creator%2C%20der%20von%20AdSense%2C%20Twitch%2C%20Patreon%20und%20Sponsoring%20lebt%2C%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ntido? No hay una regla universal, pero si facturas más de 2.500-3.000€ al mes con tu cont…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…No hay una regla universal, pero si facturas más de 2.500-3.000€ al mes con tu contenido, …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">2,000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…scriptores Supongamos que generas esto al mes: - AdSense: $2,000 - 2 sponsorships: $3,000 …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">3,000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…e generas esto al mes: - AdSense: $2,000 - 2 sponsorships: $3,000 - Merch: $500 - Patreon:…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">6,300</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…nsorships: $3,000 - Merch: $500 - Patreon: $800 - **Total: $6,300/mes ($75,600/año)** **Si…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">75,600</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…3,000 - Merch: $500 - Patreon: $800 - **Total: $6,300/mes ($75,600/año)** **Sin LLC (autón…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">35%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…($75,600/año)** **Sin LLC (autónomo en España):** - IRPF ~35% + cuota autónomos = una carg…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…l en EE.UU. (Disregarded Entity) - Impuesto federal EE.UU.: 0% (Single-Member LLC no resid…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">9,500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ber LLC no residente) - Costes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">11,500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…C no residente) - Costes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">16,500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…tes LLC: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18,500/año** Ese ahorro…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">18,500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…: razonables - **Total: ~$9,500-11,500 → ahorro de ~$16,500-18,500/año** Ese ahorro son do…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…lla sin LLC.** Adsense paga al IBAN español, Twitch retiene 30% sin W-8BEN, sponsors USA p…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ámara, mic, OBS), promoción (Meta, Google) y subscriptions. 100% deducible para la LLC. Si…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">3%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…para la LLC. Sin recargo de cambio en cada compra (típico 2-3% en tarjetas EUR sobre cargo…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
