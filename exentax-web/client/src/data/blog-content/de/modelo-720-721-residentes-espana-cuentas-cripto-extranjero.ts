...
Es deckt drei separate Blöcke ab, jeder mit eigener Schwelle von kumuliert 50.000 €:

| Block | Inhalt | Schwelle |
| --- | --- | --- |
| Block I: Konten | Giro-, Spar-, Einlagen-, Kredit- und sonstige Konten bei ausländischen Finanzinstituten | 50.000 € (Stand 31.12. oder Q4-Durchschnitt) |
| Block II: Wertpapiere, Rechte, Versicherungen und Renten | Aktien, Fondsanteile, Anleihen, Repräsentationsrechte, Lebens- oder Invaliditätsversicherungen, Leibrenten | 50.000 € (Wert 31.12.) |
| Block III: Immobilien und Immobilienrechte | Im Ausland gelegene Immobilien und dingliche Rechte daran | 50.000 € (Anschaffungswert) |

Jeder Block wird separat bewertet. Die Pflicht entsteht, sobald die Schwelle in **mindestens einem** Block überschritten wird.
### Was das Modelo 721 ist

Das **Modelo 721** ist das Krypto-Pendant zum 720. Es wird durch die **Verordnung HFP/886/2023 vom 26. Juli** geregelt, in Umsetzung des Real Decreto 249/2023, und verlangt die Meldung **virtueller Währungen im Ausland**, deren kumulierter Saldo am 31. Dezember **50.000 €** überschreitet. Die erste Kampagne fand im Steuerjahr 2024 statt (für das Steuerjahr 2023).

Krypto gilt als „im Ausland gelegen", wenn es von einer nicht in Spanien ansässigen Stelle oder Person verwahrt wird (Coinbase US, Kraken, Binance außerhalb der spanischen Einheit, Ledger in Self-Custody mit ausländischem Anbieter usw.). Liegt Ihr Krypto bei einer **bei der Banco de España registrierten** Einheit oder in **reiner Self-Custody** ohne ausländischen Anbieter, gilt das 721 nicht (es kann jedoch die **dreizehnte Zusatzbestimmung des LIRPF** greifen: interne Meldung durch spanische Anbieter).
### Wer ist verpflichtet

Zur Abgabe des 720 und/oder 721 verpflichtet:

- **Natürliche Personen** mit steuerlichem Wohnsitz in Spanien (Art. 9 LIRPF: 183 Tage, Mittelpunkt der wirtschaftlichen Interessen, Kern der Lebensinteressen).
- **Juristische Personen** mit Sitz in Spanien.
- **Betriebsstätten** ausländischer Einheiten in Spanien.
- **Erbengemeinschaften und ruhende Nachlässe** nach Art. 35.4 LGT.
- **Wirtschaftlich Berechtigte** (controlling persons), auch wenn der formale Eigentümer eine andere Person oder Einheit ist. Hier wird die US-LLC relevant: Wenn Sie wirtschaftlich Berechtigter einer <a href="/de/blog/llc-in-den-usa-vollstandiger-leitfaden-fur-nicht-residenten">US-LLC</a> sind und die LLC ein Wise- oder Mercury-Konto hält, sind Sie persönlich verpflichtet, dieses Konto als Auslandsvermögen zu melden.
### Fristen und Form

- **Modelo 720**: vom 1. Januar bis **31. März** des Folgejahres. Nur online (Sede Electrónica AEAT, Zertifikat oder Cl@ve).
- **Modelo 721**: vom 1. Januar bis **31. März** des Folgejahres. Nur online.
...
## Wie Wise, Mercury, Revolut und Ihre LLC einzuordnen sind

Hier sehen wir die meisten Fehler. Schritt für Schritt.

### Wise / Revolut / N26 / Wallester (europäische Einheiten)

Konten bei im Ausland ansässigen Finanzinstituten (Belgien, Litauen, Deutschland, Estland). Ist die Inhaberin Ihre US-LLC und Sie der wirtschaftlich Berechtigte, gehören sie in **Block I des 720**, sobald die kumulierte Schwelle von 50.000 € erreicht ist. Vertieft in <a href="/de/blog/wise-iban-und-llc-was-wirklich-an-die-steuerbehoerde">was Wise tatsächlich an die Steuerbehörde meldet</a> und <a href="/de/blog/revolut-business-und-crs-was-ihrer-steuerbehorde-gemeldet">Revolut Business und CRS</a>. Diese Konten erreichen die AEAT zudem über CRS – der Abgleich ist automatisch.

### Mercury, Relay, US-Banking

Die USA sind nicht im CRS, aber das **befreit nicht vom 720**. Die spanische Meldepflicht ist unabhängig vom internationalen Austausch: Wenn Ihr Mercury-Konto den Saldo oder Q4-Durchschnitt von 50.000 € kumuliert mit anderen Auslandskonten überschreitet, müssen Sie es melden. Vgl. <a href="/de/blog/melden-us-bankkonten-an-ihre-heimische-steuerbehorde-die">melden US-Bankkonten an Ihre Heimat-Steuerbehörde</a>.

### Ausländische Broker (Interactive Brokers, Tastytrade usw.)

Wertpapierpositionen gehen in **Block II** (Schwelle 50.000 € am 31.12. zum Marktwert). Erträge wie Dividenden und Zinsen erreichen die Steuerbehörde über CRS aus der Broker-Jurisdiktion.

### Krypto auf ausländischen Börsen

Coinbase, Kraken, Binance international, KuCoin, Bybit usw.: nicht in Spanien ansässige Anbieter. Kumulierter Saldo am 31.12. über 50.000 € → **Modelo 721**. Mit DAC8 aktuell wird der Abgleich noch schneller (<a href="/de/blog/dac8-und-kryptowahrungen-die-automatische-steuerliche">DAC8 und Krypto-Reporting</a>).

### Reine Self-Custody

Eine Hardware-Wallet ohne ausländischen Anbieter ist technisch außerhalb des 721. Generieren die Mittel jedoch Erträge (Staking, DeFi) über ausländische Plattformen, kann dies die Pflicht auslösen.
### Was genau zu melden ist

Für jedes Konto, jeden Wert, jede Krypto:

- ID des Inhabers und ggf. des wirtschaftlich Berechtigten.
- Identifikation der Einheit: Name, Steuer-ID oder Äquivalent, Adresse.
- Identifikation des Kontos oder Vermögenswerts: IBAN, Nummer, ISIN, Krypto-Ticker.
- Eröffnungs- bzw. Erwerbsdatum und ggf. Schließungs- oder Veräußerungsdatum.
- Salden: Stand 31.12. und Q4-Durchschnitt (Konten) bzw. Wert 31.12. (Wertpapiere und Krypto).
- Vermögenstyp gemäß offizieller Klassifikation.

Die Abgabe erfolgt blockweise, mit spezifischen Schlüsseln je Situation (Alleininhaber, Mitinhaber, Bevollmächtigter, Begünstigter usw.).
## Typische Fehler, die wir wöchentlich sehen

1. **„Mein Wise ist in den USA (Wise US Inc.), ich melde nicht."** Das gälte nur, wenn Ihr Konto wirklich bei Wise US Inc. liegt – aus Europa eine Ausnahme. Die meisten europäischen Wise-Konten liegen bei Wise Europe SA (Belgien) und gehen ins 720.
2. **„Meine LLC ist Inhaberin, nicht ich."** Sie sind wirtschaftlich Berechtigter und damit als Steueransässiger in Spanien zur Meldung verpflichtet.
3. **„30.000 € bei Wise und 25.000 € bei Mercury, ich liege unter der Schwelle."** Die Schwelle ist **kumuliert** je Block. 30.000 + 25.000 = 55.000 € → beide Konten meldepflichtig.
4. **„Ich habe einmal abgegeben, das reicht."** Erneut zu melden, wenn die Erhöhung über 20.000 € liegt oder ein Element gekündigt wird.
5. **„Krypto bei Binance, ich gebe Binance Spanien an."** Ist Ihr Konto bei Binance International (nicht der bei der Banco de España registrierten Einheit), müssen Sie es als ausländische Börse abbilden.
6. **„Da der EuGH die Sanktionen kippte, melde ich nicht mehr."** Der EuGH kippte das spezifische unverhältnismäßige Regime, nicht die Pflicht. Art. 198 LGT und Art. 191 bleiben.
7. **„Wenn ich 3 Jahre verspätet melde, vernichten sie mich."** Vernünftig sind **Nachreichungen ohne vorherige Aufforderung**: Sanktionen halbiert, Prüfungsentdeckung vermieden.
### Wie wir es bei Exentax bearbeiten

Unser Prozess für 720/721, wenn ein Mandant mit LLC + europäischen Fintechs + Krypto kommt:

1. **Vollinventur** der Konten, Broker, Börsen und Wallets, mit klarer Zuordnung der verwaltenden Einheit und ihrer Jurisdiktion.
2. **Pflichtenprüfung** je Block und Schwelle, mit Trennung von rechtlicher und wirtschaftlicher Inhaberschaft.
3. **Abgleich** mit von der AEAT bereits empfangenen CRS-/DAC-Daten.
4. **Abgabe** des 720 und ggf. des 721, mit korrekter Codierung jedes Elements.
5. **Regularisierungsplan** für nicht erklärte Vorjahre, vorrangig Nachreichungen ohne Aufforderung.
...
## Formulare 720 und 721: die zwei Erklärungen, die die meisten Sanktionen für Spanien-Ansässige auslösen

Die Formulare 720 (Auslandsvermögen) und 721 (Auslandskrypto) sind die zwei Informationserklärungen, die für spanische Ansässige mit internationaler Struktur die meisten Sanktionsverfahren öffnen. Keine Steuer, aber Auslassung oder fehlerhafte Einreichung löst formale Sanktionen aus.
...
**Wenn die LLC disregarded ist, sind ihre Konten "meine" fürs 720?** Das Finanzamt liest es oft so. Besser erklären oder bereithalten.

**Krypto in eigenem Wallet (Ledger, Trezor) im 721?** Standardmäßig nicht: 721 deckt Drittverwahrung. Self-Custody: 714 (Vermögen) ab regionaler Schwelle.

Bei Exentax prüfen wir, was Sie erklären müssen, gemäß Ihrer echten Situation.
...
## Modelo 720 Schritt für Schritt einreichen: Formular, Felder und Rechenbeispiele
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Wenn%20Sie%20steuerlich%20in%20Spanien%20ans%C3%A4ssig%20sind%20und%20eine%20US-LLC%2C%20ein%20Wise-%20oder%20%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">50.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…re tres bloques separados, cada uno con su propio umbral de 50.000 € agregados: | Bloque |…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">20.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…bloque concreto se ha producido un **incremento superior a 20.000 €** respecto al saldo de…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…el 720 fue uno de los más severos del ordenamiento europeo: 5.000 € por dato omitido (míni…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…del ordenamiento europeo: 5.000 € por dato omitido (mínimo 10.000 €), imprescriptibilidad …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">150%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…patrimonial no justificada (art. 39.2 LIRPF) y sanción del 150% sobre la cuota. La **Sente…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">120.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…(art. 305 CP) si la cuota defraudada en un ejercicio supera 120.000 €. La sentencia europe…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">30.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…de la LLC no cambia la obligación informativa. 3. **&quot;Tengo 30.000 € en Wise y 25.000 € en …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">25.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…a la obligación informativa. 3. **&quot;Tengo 30.000 € en Wise y 25.000 € en Mercury, no llego …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">55.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…al es **agregado** dentro de cada bloque. 30.000 + 25.000 = 55.000 € → obligado a declarar…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">100%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ut, brokers extranjeros o cripto fuera de España y no estás 100% seguro de tu posición fre…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">301.770</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…r&quot;&gt;OCDE&lt;/a&gt; con sus Comentarios. - **EE. UU.** Treas. Reg. §301.7701-3 (clasificación chec…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.603</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…-3 (clasificación check-the-box), IRC §6038A y Treas. Reg. §1.6038A-2 (Form 5472), IRC §77…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">18.400</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…de un freelancer residente en Madrid con: Wise EUR balance 18.400 €, Mercury Personal Savi…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">22.300</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…id con: Wise EUR balance 18.400 €, Mercury Personal Savings 22.300 USD, broker Interactive…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">41.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…Savings 22.300 USD, broker Interactive Brokers con cartera 41.000 €, Kraken con 6.200 € en…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">6.200</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…broker Interactive Brokers con cartera 41.000 €, Kraken con 6.200 € en BTC y ETH. Bloque c…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">39.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…H. Bloque cuentas: 18.400 + 22.300 USD convertidos al BCE = 39.000 € aprox., por debajo de…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">35.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…mbral de 50.000 €, **no obliga**. Si al año siguiente añade 35.000 € a Mercury, el bloque …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">74.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…iguiente añade 35.000 € a Mercury, el bloque cuentas pasa a 74.000 € y dispara la obligaci…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">IRC §6038</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…U.** Treas. Reg. §301.7701-3 (clasificación check-the-box), IRC §6038A y Treas. Reg. §1.60…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">IRC §7701</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…-the-box), IRC §6038A y Treas. Reg. §1.6038A-2 (Form 5472), IRC §7701(a)(31) y normativa F…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…cación check-the-box), IRC §6038A y Treas. Reg. §1.6038A-2 (Form 5472), IRC §7701(a)(31) y…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">RD 1065/2007</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…reformó el Modelo 720 tras la STJUE C-788/19 de 27/01/2022, RD 1065/2007 (Modelos 232 y 72…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.boe.es" rel="nofollow noopener" target="_blank">www.boe.es</a>]</strong></li>
<li><span class="font-mono">DAC8</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…superior a 50.000 € → **Modelo 721**. Si además operas con DAC8 recientemente, el cruce se…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
<li><span class="font-mono">DAC6</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…13 en vigor desde 2019, Directiva 2011/16/UE modificada por DAC6, DAC7 y DAC8, y Modelo de…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://eur-lex.europa.eu" rel="nofollow noopener" target="_blank">eur-lex.europa.eu</a>]</strong></li>
