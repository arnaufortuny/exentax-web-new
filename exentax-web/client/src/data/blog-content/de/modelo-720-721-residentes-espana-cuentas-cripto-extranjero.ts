...
Modelo 720 und Modelo 721 sind Meldepflichten, keine Steuern. Sie kosten an sich nichts, ihre Unterlassung jedoch sehr wohl: Strafe nach Art. 198 LGT, Regularisierung der Steuerschulden mit Zuschlägen nach Art. 191 und – bei nicht gerechtfertigten Salden – der klassische Hebel des Art. 39 LIRPF (vom EuGH gemildert, aber nicht beseitigt). Der Abgleich mit CRS und aktuell mit DAC8 macht die Spur für die AEAT immer sichtbarer. Atmen Sie durch: bei Exentax ist das Routine, wir bringen Sie auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
...
- **Aktuelles Sanktionsregime.** Nach dem EuGH-Urteil von Januar 2022 (C-788/19) und der Reform wurde das alte 720-Spezialregime für unionsrechtswidrig erklärt. Aktuelle Sanktionen: allgemeines LGT-Regime. Genau deshalb halten wir bei Exentax Ihren Kalender bündig — Sie müssen nicht mehr an Fristen denken, wir schließen sie ab, bevor sie zubeißen.
...
kann disproportionale Sanktionen auslösen, die viel größer sind. Atmen Sie durch: bei Exentax ist das Routine, wir bringen Sie auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
