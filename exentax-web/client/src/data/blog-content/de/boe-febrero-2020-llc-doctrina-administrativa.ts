...
Mehr Details unter <a href="/de/blog/steuerliche-abzuge-fur-ihre-llc-was-sie-abziehen-konnen">abzugsfähige Aufwendungen Ihrer LLC</a>.
...
2. **Die Struktur so gestalten, dass sie effizient besteuert wird.** Entscheidungen: Kapitaleinlagen, zugewiesene Aufwendungen, Vergütung des Gesellschafters, andere mögliche Strukturen (spanische S.L. + operative LLC; deutsche GmbH + LLC; österreichische GmbH; Schweizer AG mit Beteiligung an LLC). Siehe <a href="/de/blog/gestaltung-einer-soliden-internationalen-steuerstruktur">Gestaltung einer soliden internationalen Struktur</a>.
3. **Ihre konkrete Tätigkeit berücksichtigen.** Unterschiedliches praktisches Regime für Dienstleistungen, E-Commerce, Lizenzen, Trading. Wir vertiefen das in <a href="/de/blog/llc-besteuerung-nach-wirtschaftlicher-aktivitat">Besteuerung der LLC nach wirtschaftlicher Tätigkeit</a>.
...
5. **Simulation und Gestaltungsmissbrauch vermeiden.** Wenn die LLC keine Substanz hat und die Dienstleistungen materiell von der ansässigen natürlichen Person erbracht werden, kann die AEAT Simulation nach Art. 16 LGT anwenden, was zu höheren Sanktionen und je nach Beträgen sogar zu strafrechtlicher Ableitung führen kann. Im DACH-Raum greifen § 42 AO (Deutschland), § 22 BAO (Österreich) und die bundesgerichtliche Praxis zur **Steuerumgehung** (Schweiz). Atme durch: bei Exentax ist das Routine, wir bringen dich auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.
...
Zum Abschluss eine verwandte Lektüre, die zum roten Faden dieses Artikels passt: <a href="/de/blog/internationale-besteuerung-fur-digitale-unternehmer">Internationale Besteuerung für digitale Unternehmer: alles, was Sie wissen müssen</a> ist ein nützlicher Beitrag, um den Kontext abzurunden.
...
- **Modelo 720 und Modelo 721.** Wenn die LLC Konten mit kombiniertem Saldo über 50.000 € hält, besteht in Spanien Erklärungspflicht, mit proportionaler Strafe begrenzt durch das EuGH-Urteil C-788/19. Die Beteiligung an der LLC selbst kann ebenfalls in den Anwendungsbereich des Modelo 720 fallen, wenn sie als Recht an einer ausländischen Einheit ausgestaltet ist. In Deutschland greift die Mitteilung nach § 138 Abs. 2 AO innerhalb von fünf Monaten nach Ablauf des Kalenderjahres, in dem die Beteiligung erworben wurde; in Österreich die Mitteilungspflicht nach § 121a BAO; in der Schweiz das Wertschriftenverzeichnis je Kanton. Jetzt ist der Moment, Hilfe zu holen. Bei Exentax eröffnen wir den Fall, reichen das Fehlende ein und antworten der Behörde für dich.
...
Möchten Sie dieses Vorgehen auf Ihren Fall anwenden? <a href="/de/buchen">Buchen Sie ein Gespräch mit dem Exentax-Team</a> und wir prüfen Ihre LLC mit echten Zahlen in dreißig Minuten, unverbindlich.
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Spanische%20Verwaltungsdoktrin%20zur%20US-LLC%20(Februar%202020)%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
