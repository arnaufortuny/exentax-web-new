...
5. **Simulation und Gestaltungsmissbrauch vermeiden.** Wenn die LLC keine Substanz hat und die Dienstleistungen materiell von der ansässigen natürlichen Person erbracht werden, kann die AEAT Simulation nach Art. 16 LGT anwenden, was zu höheren Sanktionen und je nach Beträgen sogar zu strafrechtlicher Ableitung führen kann. Im DACH-Raum greifen § 42 AO (Deutschland), § 22 BAO (Österreich) und die bundesgerichtliche Praxis zur **Steuerumgehung** (Schweiz).
...
- **Revolut Business**: Wenn das Konto an eine **US-amerikanische LLC** geknüpft ist, läuft es üblicherweise über Revolut Payments USA; europäische IBANs (litauisch, BE) **werden einer LLC nicht standardmäßig ausgegeben**: Sie werden europäischen Kunden der europäischen Bank der Gruppe ausgegeben. Wenn Ihnen ein europäischer IBAN angeboten wird, vergewissern Sie sich, an welche juristische Einheit dieses Konto gebunden ist und unter welchem Regime es meldet (Revolut Bank UAB in Litauen ist eine vollregulierte Bank und meldet CRS).
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Spanische%20Verwaltungsdoktrin%20zur%20US-LLC%20(Februar%202020)%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
