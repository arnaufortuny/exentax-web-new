...
5. **Sich auf "vom IRS kam nichts, alles gut" verlassen.** Der IRS warnt nicht vor Sanktionen. Jetzt ist der Moment, Hilfe zu holen. Bei Exentax eröffnen wir den Fall, reichen das Fehlende ein und antworten der Behörde für dich.
...
<!-- /exentax:cta-conv-v1 -->
  ...
  Die Sanktion bei Nichtabgabe oder verspäteter Abgabe beträgt **USD 25.000 pro Vorgang** (initial) nach **§6038A(d)(1)**, erhöht durch **Sec. 13301 des Tax Cuts and Jobs Act (Pub. L. 115-97 vom 22.12.2017)** — vor TCJA waren es nur USD 10.000. Bei Fortdauer nach 90-tägiger IRS-Aufforderung kommen **USD 25.000 pro 30-Tage-Periode** hinzu, ohne Höchstgrenze. Atme durch: bei Exentax ist das Routine, wir bringen dich auf den Stand und die nächste Prüfung schließt in einer Runde, ohne Drama.

  Aus deutscher Sicht entsteht ein paralleler Pflichtenkatalog: die **Anzeigepflicht nach §138 Abs. 2 AO** für Beteiligungen ≥ 10 % an ausländischen Gesellschaften (Frist 14 Monate nach Ende des Wirtschaftsjahres), die **erhöhten Mitwirkungspflichten nach §90 Abs. 2 AO** bei Auslandssachverhalten und ggf. die **Hinzurechnungsbesteuerung nach §§7–14 AStG** (ATAD-Umsetzung BGBl. I 2021 S. 4147), wenn die LLC als passive Zwischengesellschaft mit Niedrigbesteuerung unter 15 % qualifiziert wird. In **Österreich** greifen die **§§109, 124–126 BAO** und das **WiEReG (BGBl. I Nr. 136/2017)** mit Sanktionen bis €200.000. In der **Schweiz** greift das **AIA-Gesetz (SR 653.1)** für den automatischen Informationsaustausch und das **FATCA-Abkommen Modell 2 (SR 0.672.933.63 vom 14.02.2013)**, das die schweizerischen Finanzinstitute zur direkten Meldung an den IRS verpflichtet. Bei Exentax haben wir Mandanten in genau dieser Lage ohne Strafe geschlossen. Früh sprechen lohnt sich — und spart dir fünf Stellen.
...
- Spät einreichen. Die Strafe für ein versäumtes Form 5472 ist. Und falls doch eine Aufforderung kommt: bei Exentax liegt das Dossier bereit, du antwortest in Stunden, nicht in Wochen.
