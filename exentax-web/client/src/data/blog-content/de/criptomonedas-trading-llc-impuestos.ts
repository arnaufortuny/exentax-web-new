...
Zum Abschluss ein verwandter Beitrag, der unmittelbar an diesen Text anschließt: <a href="/de/blog/steuern-mit-internationalen-kunden-in-spanien-was-niemand">Steuern mit internationalen Kunden in Spanien: Was niemand Ihnen sagt</a> rundet den Kontext ab.
...
Bei Exentax sehen wir jede Woche Trader aus der DACH-Region, die ihre Krypto-Aktivität in eine LLC überführen wollen. Buchen Sie Ihre kostenlose Beratung: wir analysieren Ihren Fall und sagen Ihnen klar, was vor dem Finanzamt trägt und was nicht.
...
- **Einkunftsqualifikation.** In Spanien unterscheidet die AEAT Veräußerungsgewinn (Krypto-Kauf-Verkauf) zu Sparbasis (19-28%) und gewerbliche Einkünfte (gewohnheitsmäßiger Handel mit Mindestorganisation) zu Allgemeinbasis (bis 47 %). SMLLC-Betrieb ändert die Qualifikation nicht: organisiert und professionell = gewerblich; sporadisch = Veräußerungsgewinn.
- **Trading vs. langfristiges Investieren.** "Buy & Hold"-Profil mit 5-15 Trades/Jahr passt als Veräußerungsgewinn — nutzt Sparsätze, die Pass-Through-SMLLC bringt wenig außer operativer Ordnung. Daytrading-Profil mit 200+ Trades/Jahr in einer SMLLC braucht Gewerbeeinkunfts-Argumentation, eröffnet Ausgabenabzüge, zwingt aber zum Grenzsteuersatz.
- **DAC8 und Reporting.** aktuell melden europäische CASPs Positionen und Bewegungen ihrer Kunden an die AEAT. Nicht-EU-Exchanges (Coinbase US, Kraken US, Binance US) fallen nicht direkt unter DAC8, aber unter CARF (OECD Crypto Reporting Framework) und CRS, wenn Salden durch Banken laufen.
- **On-Chain als Beweis.** Bewegungen in eigenen Wallets sind nachverfolgbar und öffentlich. Die AEAT kann Anschaffungskosten- und Eigentumsnachweis verlangen. Detailliertes Logbuch (Koinly, Cointracking) ab erstem Move halten; 3 Jahre DEX-Trading später zu rekonstruieren ist unverhältnismäßig.

### Was wir am häufigsten gefragt werden

**Vermeide ich Modelo 721, wenn ich Krypto in der LLC handle?** Nein: Modelo 721 verpflichtet den Spanien-Steuerresidenten zur Erklärung von Auslands-Kryptowerten über 50.000 €. Nominaler Eigentum durch die LLC befreit nicht — die AEAT prüft Substanz, nicht Form.

**Sollte ich Krypto nach Portugal oder in die VAE verlegen?** Nur mit echtem Umzug und überwiegendem Aufenthalt. Portugal behält Befreiung für Halten >365 Tage, aber die Daytrading-Steuer von Januar 2023 begrenzt den Reiz für Profis. VAE bleibt ohne Krypto-Steuer, verlangt aber effektive Residenz.

Bei Exentax modellieren wir die Krypto-Erklärung am Wohnsitz, bereiten Modelo 721 und Koinly-Nachverfolgbarkeit vor und stellen, wo sinnvoll, einen Jurisdiktionswechsel mit 5-Jahres-Zahlen vor.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Wer%20aus%20Deutschland%20heraus%20Krypto%20handelt%2C%20kennt%20die%20Spielregeln%3A%20ein%20Jahr%20Ha%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">6.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…cias patrimoniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.0…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">19%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…moniales en la base del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">50.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…se del ahorro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 20…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ro del IRPF: - Hasta 6.000€: **19%** - 6.000€ – 50.000€: **21%** - 50.000€ – 200.000€: **2…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
...
<li><span class="font-mono">27%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…1%** - 50.000€ – 200.000€: **23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">28%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…**23%** - 200.000€ – 300.000€: **27%** - Más de 300.000€: **28%** Esto aplica a cada opera…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…a LLC para un trader? Depende de tu volumen: - **Menos de 10.000€/año en ganancias:** Prob…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">47 %</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…l con organización mínima) tributado en base general (hasta 47 %). Operar a través de SMLL…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
