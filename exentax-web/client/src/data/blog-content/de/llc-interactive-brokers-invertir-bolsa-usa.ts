export default `Eine der häufigsten Fragen, die Exentax-Kunden vor Abschluss stellen: „Kann ich Interactive Brokers auf den Namen meiner LLC eröffnen, um aus den USA zu investieren?". Die Antwort lautet: **Ja, das geht, und sauber strukturiert ergibt es Sinn**. In diesem Artikel erklären wir, wie es tatsächlich funktioniert, welche Broker für eine LLC eines Nicht-Residenten verfügbar sind, was sich steuerlich ändert und wie eine saubere Investitions-Operativa aus Ihrer LLC heraus konzipiert wird.
...
- **TastyTrade / Tradier**: akzeptieren US-LLCs, besonders nützlich für Optionen.
...
Weil wir LLCs aufsetzen, die vom ersten Tag an bereit sind, mit Brokern zu arbeiten. Konsistente Dokumentation, korrekte EIN, eingereichtes BOI, angepasstes Operating Agreement, vorbereitete W-8BEN-E. Wenn Sie IB, Tradovate oder Kraken eröffnen, treffen Sie nicht auf ein „kommen Sie morgen wieder": Sie eröffnen das Konto und legen los.
...
- **Wie das Setup funktioniert.** Single-member LLC (Wyoming für Privatsphäre), EIN, IBKR Pro-Konto auf den Namen der LLC mit W-8BEN-E (Abkommensbenefits bei DE, AT, CH, etc.). IBKR ist der Broker, der ausländische Entitäten und disregarded LLCs am besten akzeptiert; andere (Schwab, Fidelity) lehnen oft ab.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Eine%20der%20h%C3%A4ufigsten%20Fragen%2C%20die%20Exentax-Kunden%20vor%20Abschluss%20stellen%3A%20%E2%80%9EKann%20i%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">30 %</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…vía SMLLC disregarded. - **Dividendos US**: withholding del 30 % por defecto, reducible ví…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">15 %</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…**: withholding del 30 % por defecto, reducible vía treaty (15 % España, 15 % México, 15 %…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">10 %</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ucible vía treaty (15 % España, 15 % México, 15 % Colombia, 10 % Chile, 15 % Argentina). E…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">0 %</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…EN-E está presentada. - **Intereses portfolio (bonos US)**: 0 % bajo portfolio interest ex…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…sidente que fallece teniendo activos US-situs por encima de 60.000 USD (acciones US direct…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">0%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…pital gains de bolsa US para LLC propiedad de no residente: 0% federal (no efectivamente c…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">30%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ectivamente conectado, sin ETBUS). Dividendos US: retención 30% por defecto, reducida a 15…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">15%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…TBUS). Dividendos US: retención 30% por defecto, reducida a 15% (o 0% en casos específicos…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">IRC §865</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…lías de venta de acciones US **no son renta de fuente US** (IRC §865(a)(2)) salvo presenci…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
