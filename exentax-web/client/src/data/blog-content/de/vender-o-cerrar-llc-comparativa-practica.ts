...
| Aspekt | Schließen | Asset Sale | Equity Sale |
|---|---|---|---|
| Käufer nötig | Nein | Ja | Ja |
| Zeitrahmen | 2-4 Monate | 1-3 Monate | 2-6 Monate |
| Profi-Kosten | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD |
### Wann schließen
...
- Compliance aktuell (5472, BOI, Annual Report).
...
- **Equity Sale**: MIPA unterschreiben ohne Escrow, ohne starke Reps, ohne Prüfung.
### So machen wir es bei Exentax

Bei Exentax begleiten wir alle drei Wege. Buchen Sie eine kostenlose Erstsession über unsere Buchungsseite.
...
## Exentax-Update aktuell: mit Köpfchen entscheiden

Die Wahl zwischen **Verkauf** und **Schließung** einer LLC hat aktuell unterschiedliche steuerliche und operative Folgen:

- **Verkauf der LLC (membership interest).** Für Gebietsfremde ist der Gewinn meist FDAP/Capital Gain *foreign source* und löst - ohne US-PE oder physische Präsenz mit ECI - keine US-Bundessteuer aus. Im Wohnsitzland kann er besteuert werden (Veräußerungsgewinn). DBA prüfen.
- **Auflösung (closing).** Der Bundesstaat verlangt *Articles of Dissolution* + Kündigung des Registered Agent und teils ein *tax clearance certificate*. Die LLC muss **Final Form 1120 + 5472** mit „Final" eingereicht und die EIN per Brief an das IRS (Cincinnati) geschlossen werden. Unvollständige Schließung lässt die Steuerschuld bestehen.
- **Offene Vermögenswerte.** Bei Guthaben auf Mercury/Wise/Slash **vorab überweisen**, sonst Sperren. Gateways (Stripe, PayPal) explizit vor Auflösung schließen.
### Schnelle Entscheidungsmatrix

| Situation | Empfehlung |
|---|---|
| Käufer vorhanden, Bewertung > 1× ARR | Verkauf prüfen |
| Kein Käufer, geringe Operativität | Auflösen |
| Mitgliederwechsel | Restrukturieren (nicht schließen) |
| Geografische Verlagerung der Tätigkeit | Auflösen und neue im optimalen Bundesstaat |
...
Die Entscheidung, eine LLC zu verkaufen oder zu schließen, ist nie nur finanziell: sie hängt von der Steuerhistorie, dem offenen Banking und der Existenz einer übertragbaren Marke oder Kartei ab. Die Exentax-Methode schließt stets mit sauberer Akte, nie halbfertig.

- **Sauber schließen**: Auflösung im Bundesstaat, IRS final 5472 + 1120 mit "final" gekennzeichnet, Aufgabe-BOI, geordnete Kontoräumung und Akte für die nächsten 7 Jahre archiviert.
- **Sauber verkaufen**: Due Diligence beim Käufer, dokumentarische Membership-Übertragung mit Zustimmung des Operating Agreement, BOI-Update der neuen Eigentümer und geordnete Banking-Übergabe.
- **Keine Überraschungen**: keine Schulden, offene Bußgelder oder Gateways mit gesperrtem Saldo vor Unterschrift mitschleppen.

Um zu wissen, welcher Weg in Ihrem realen Fall passt, starten Sie den <strong>Exentax-Rechner</strong> oder buchen dreißig Minuten.
<!-- /exentax:execution-v2 -->

<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22In%20vielen%20LLCs%20kommt%20der%20Moment%2C%20in%20dem%20die%20Frage%20gleich%20lautet%3A%20schlie%C3%9Fen%20od%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">2.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…| 1-3 meses | 2-6 meses | | Coste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…| 2-6 meses | | Coste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…meses | | Coste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD |…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…oste profesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD | | Document…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
<li><span class="font-mono">10.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…rofesional típico | 800-2.500 USD | 1.500-5.000 USD | 3.000-10.000+ USD | | Documentación …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
...
<li><span class="font-mono">28%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…rticipación social y tributar como ganancia patrimonial (19-28%). Consulta caso a caso. &lt;!…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
