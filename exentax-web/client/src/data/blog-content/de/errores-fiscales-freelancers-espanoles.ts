...
Wenn Sie eine LLC in den Vereinigten Staaten haben (oder erwägen), gibt es ein Konzept, das Sie gut verstehen müssen: **Pass-Through Taxation.** Ihre Single-Member LLC als Nicht-Resident ist eine "Disregarded Entity" für den <a href="https://www.irs.gov" target="_blank" rel="noopener">IRS</a>, das bedeutet, dass die LLC keine Bundessteuer in den USA zahlt. Die Gewinne "fließen direkt durch" zu Ihnen als Eigentümer.
...
Zum Abschluss ein verwandter Beitrag, der unmittelbar an diesen Text anschließt: <a href="/de/blog/us-resident-vs-nicht-resident-llc-die-wichtigsten">US-Resident vs Nicht-Resident LLC: die wichtigsten Steuerunterschiede</a> rundet den Kontext ab.
...
- **OSS- oder IOSS-USt vergessen.** B2C-Digitalservices an EU-Verbraucher aus Autónomo oder LLC verlangen OSS (Services) oder IOSS (Waren <150 €) mit Quartalsabgaben. Ohne dies USt land-für-land mit kumulierten Sanktionen. AEAT vergleicht Plattformen (DAC7) seit 2024.
...
**Wie regularisiere ich freiwillig ohne Inspektionsauslöser?** Ergänzende Erklärung mit Zuschlag (15% binnen 12 Monaten, 20% danach) ohne Strafe. Vor der AEAT zu kommen ändert das Ergebnis komplett.
...
<!-- exentax:cta-v1 -->
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Rufen Sie uns unter <a href="tel:+34614916910">+34 614 916 910</a> an oder schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Der%20Ursprungsartikel%20wurde%20f%C3%BCr%20spanische%20Freelancer%20geschrieben%2C%20aber%20drei%20Vi%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">30%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…porcional de la vivienda** si trabajas desde casa (hasta el 30% de los suministros: luz, a…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">60.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…- **Asesoría fiscal y contable** Un freelancer que factura 60.000€/año y solo deduce 3.000…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…able** Un freelancer que factura 60.000€/año y solo deduce 3.000€ en gastos podría estar d…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">12.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…/año y solo deduce 3.000€ en gastos podría estar deduciendo 12.000-15.000€ si lleva un reg…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">15.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…solo deduce 3.000€ en gastos podría estar deduciendo 12.000-15.000€ si lleva un registro c…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">4.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…0€ si lleva un registro correcto. Eso puede suponer **3.000-4.000€ menos de IRPF al año**.…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">15%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…del IRPF**: algunos epígrafes están sujetos a retención del 15% en las facturas a empresas…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">20%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…cionado del IRPF) cada trimestre. El pago fraccionado es el 20% del rendimiento neto acumu…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://sede.agenciatributaria.gob.es" rel="nofollow noopener" target="_blank">sede.agenciatributaria.gob.es</a>]</strong></li>
<li><span class="font-mono">0%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…al desconocen: - **LLC en Estados Unidos:** Estructura con 0% de impuesto federal en EE.UU…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">20.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…e como autónomo. Un freelancer que factura 60.000€ y tiene 20.000€ en gastos deducibles de…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">40.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ene 20.000€ en gastos deducibles de la LLC solo tributa por 40.000€. Eso es una diferencia…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.500</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…cir gastos | 3.000-4.000€ | | Epígrafe IAE incorrecto | 500-1.500€ | | No aprovechar tarif…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.800</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…AE incorrecto | 500-1.500€ | | No aprovechar tarifa plana | 1.800€ (primer año) | | IVA in…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">6.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…nificar | variable | | No maximizar deducciones LLC | 3.000-6.000€ | | Asesor sin experien…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">5.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…C | 3.000-6.000€ | | Asesor sin experiencia internacional | 5.000-15.000€ | **Total potenc…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">45.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…a internacional | 5.000-15.000€ | **Total potencial: hasta 45.000€/año en errores evitable…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">1.210</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…encia. - **Mezclar IVA repercutido con beneficio.** Cobras 1.210 € (1.000 + 21% IVA) y con…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">1.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…**Mezclar IVA repercutido con beneficio.** Cobras 1.210 € (1.000 + 21% IVA) y consideras l…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">21%</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ar IVA repercutido con beneficio.** Cobras 1.210 € (1.000 + 21% IVA) y consideras los 1.21…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…es el &lt;a href=&quot;/es/blog/form-5472-que-es-como-presentarlo&quot;&gt;Form 5472&lt;/a&gt; ni el &lt;a href=&quot;/e…»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
