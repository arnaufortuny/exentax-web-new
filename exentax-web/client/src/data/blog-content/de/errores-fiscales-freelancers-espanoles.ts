export default `Nach der Beratung von Hunderten von spanischen Freiberuflern haben wir ein klares Muster erkannt: Dieselben steuerlichen Fehler wiederholen sich immer wieder. Und es handelt sich nicht um geringfügige Fehler. wir sprechen von Tausenden von Euro, die jedes Jahr durch Unwissenheit oder schlechte Beratung verloren gehen.
