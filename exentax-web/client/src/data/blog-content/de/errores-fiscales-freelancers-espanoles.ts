export default `Eine typische AEAT-Strafe für falsche Mehrwertsteuererklärung beginnt bei 150 € und steigt leicht über 3.000 €, wenn sie 50 % der nicht abgeführten Quote überschreitet (Art. 191 LGT). Wir schließen es mit dir von Exentax aus: ein Anruf, Einreichung raus, Archiv gesetzt, und das Risiko bleibt auf dem Papier.
...
| Falsche Umsatzsteuer | Bußgelder von 150–600 € |. Hier kommt Exentax ins Spiel: wir reichen das Formular ein, archivieren den Beleg und, wenn die Behörde fragt, liegt deine Antwort bereits fertig.
...
- **OSS- oder IOSS-USt vergessen.** B2C-Digitalservices an EU-Verbraucher aus Autónomo oder LLC verlangen OSS (Services) oder IOSS (Waren &lt;150 €) mit Quartalsabgaben. Ohne dies USt land-für-land mit kumulierten Sanktionen. AEAT vergleicht Plattformen (DAC7) seit 2024. Bei Exentax haben wir Mandanten in genau dieser Lage ohne Strafe geschlossen. Früh sprechen lohnt sich — und spart dir fünf Stellen.
