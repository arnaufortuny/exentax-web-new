...
|---|---|---|---|
| Einzelunternehmer / Freiberufler (DACH) | Keiner | Niedrig | Niedrig |
| GmbH (Deutschland/Österreich) oder AG (Schweiz) | Ja | Hoch | Hoch (Stammkapital 25.000€ DE, 35.000€ AT, 100.000 CHF) |
...
<!-- exentax:cta-conv-v1 -->
<p data-testid="cta-action-row">Möchten Sie es jetzt besprechen? Schreiben Sie uns auf <a href="https://wa.me/34614916910?text=Hallo%20Exentax%2C%20ich%20lese%20den%20Artikel%20%22Im%20deutschen%20Recht%20fungiert%20die%20GmbH%20als%20Haftungsfirewall%2C%20aber%20die%20Rechtspre%E2%80%A6%22%20und%20m%C3%B6chte%20mit%20einem%20Berater%20%C3%BCber%20meinen%20Fall%20sprechen.">WhatsApp</a>, wir antworten heute.</p>
...
<li><span class="font-mono">50,000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…o Imagina que tu LLC tiene un contrato con un cliente por $50,000. El cliente dice que no …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">10,000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…anda es contra la LLC, no contra ti. Si la LLC solo tiene $10,000 en su cuenta, eso es lo …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">200,000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…máximo que el cliente puede reclamar de la LLC. Tu casa de $200,000 y tus ahorros de $30,0…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">30,000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…e reclamar de la LLC. Tu casa de $200,000 y tus ahorros de $30,000 están protegidos. ### ¿…»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
<li><span class="font-mono">3.000</span> <span class="opacity-70">(Kennzahl)</span> <span class="text-xs italic">— «…ciedad Limitada (España) | Sí | Alta | Alto (capital mínimo 3.000€) | | LLC (EE.UU.) | Sí …»</span> <strong>[NICHT VERIFIZIERT]</strong></li>
...
<li><span class="font-mono">Form 5472</span> <span class="opacity-70">(Rechtsverweis)</span> <span class="text-xs italic">— «…* 4. **Cumplir con todas las obligaciones**: Annual Report, Form 5472, BOI Report 5. **No …»</span> <strong>[REVISIÓN MANUAL — vorgeschlagene Quelle: <a href="https://www.irs.gov" rel="nofollow noopener" target="_blank">www.irs.gov</a>]</strong></li>
