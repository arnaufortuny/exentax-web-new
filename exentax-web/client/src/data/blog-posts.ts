...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Separar finanzas personales y de tu LLC: por qué es imprescindible | Exentax",
    metaDescription: "Por qué mezclar dinero personal y de tu LLC rompe el velo corporativo, complica el Form 5472 y dispara tu riesgo de auditoría. Buenas prácticas y errores típicos.",
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Cómo abrir una cuenta Mercury para tu LLC desde el extranjero | Exentax",
    metaDescription: "Proceso paso a paso para abrir Mercury siendo no residente: Column NA, FDIC hasta $5M vía sweep, $0 wires domésticos, documentos, plazos y motivos de rechazo.",
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Pagar 0% de impuestos legalmente: 3 escenarios reales (no la regla general) | Exentax",
    metaDescription: "Cuándo es realmente posible pagar 0% combinando LLC pass-through con residencia favorable, Ley Beckham o régimen territorial, y por qué para la mayoría sigue siendo un mito.",
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Bancos tradicionales vs fintech para tu LLC: comparativa y criterios | Exentax",
    metaDescription: "Diferencias reales entre bancos tradicionales (Chase, BoA) y fintech (Mercury, Relay, Wise) para tu LLC: FDIC pass-through, requisitos de presencia, comisiones y a quién conviene cada modelo.",
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Ventajas y desventajas de una LLC para no residentes: análisis honesto | Exentax",
    metaDescription: "Lo bueno y lo malo de una LLC sin marketing: para quién compensa el coste anual, cuándo el compliance es excesivo y qué perfiles deberían descartarla. Análisis sin filtros.",
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Pass-through de la LLC: cómo funciona la transparencia fiscal paso a paso | Exentax",
    metaDescription: "El mecanismo del pass-through explicado: Disregarded Entity, atribución de rentas, por qué la LLC no paga federal y cómo el resultado llega a tu IRPF. Ejemplo numérico real.",
  ...
  },
  {
    ...
    publishedAt: "2026-03-05",
    updatedAt: "2026-04-15",
    metaTitle: "Por qué abrir una LLC en EE.UU. en 2026: los 5 pilares del modelo americano | Exentax",
    metaDescription: "Los 5 pilares estratégicos por los que una LLC supera a otras estructuras: jurisdicción, privacidad, infraestructura financiera, fiscalidad pass-through y reputación internacional.",
