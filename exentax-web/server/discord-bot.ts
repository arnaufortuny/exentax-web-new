...
//
// The manifest itself is plain data and lives in `discord-bot-manifest.ts`
// so the structural-validation regression in CI can import it without
// pulling in the bot's runtime dependencies (storage, db, handlers).
// We re-export it from here so existing imports of `buildSlashCommandManifest`
// keep working unchanged.
export { buildSlashCommandManifest } from "./discord-bot-manifest";
import { buildSlashCommandManifest } from "./discord-bot-manifest";
