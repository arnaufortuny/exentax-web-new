...
export const frTranslations: EmailTranslations = {
    ...
    calcDrip: {
      ...
      unsubNote: "Tu reçois ces e-mails parce que tu as utilisé le calculateur sur exentax.com. S'ils ne te sont pas utiles, un clic suffit pour te désinscrire.",
      steps: [
        {
          subject: "Le cas de Laura — elle est passée de 19 800 € à 3 200 € d'impôts",
          paragraphs: [
            "Il y a deux jours, tu as vu ta propre estimation d'économies. Aujourd'hui, je veux te montrer ce que cela donne dans la vraie vie.",
            "Laura est développeuse freelance à Paris. Elle facture environ 78 000 € par an à des clients aux États-Unis et au Canada. Quand elle est arrivée chez nous, elle payait 19 800 € entre impôt sur le revenu et cotisations de travailleur indépendant — plus de 25 % de ce qu'elle gagne. Elle était à bout.",
            "Nous avons monté sa LLC dans le Wyoming en moins de trois semaines. Nous avons restructuré sa façon de facturer. Nous avons basculé une partie de sa rémunération du salaire vers les dividendes. Sa première année s'est clôturée avec 3 200 € de charge fiscale totale — oui, cela inclut l'impôt français résiduel et la fiscalité de la LLC. De 19 800 € à 3 200 €.",
            "Ce n'est pas une astuce. C'est légal, entièrement déclaré en France, et cela fonctionne parce que son activité correspond au profil que la structure LLC est conçue pour optimiser. Ce qui a changé, c'est qu'elle a cessé de payer trop par méconnaissance du système.",
            "Si ta simulation t'a donné un chiffre similaire — la plupart de nos clients se situent entre 10 000 € et 25 000 € d'économies annuelles — tu es exactement là où Laura était. La question n'est pas de savoir si l'économie est réelle (ta simulation y a déjà répondu). La question, c'est quand tu décides de prendre 30 minutes pour en parler avec moi.",
          ],
        },
        {
          subject: "Les 3 doutes qu'on me pose TOUJOURS (et comment j'y réponds)",
          paragraphs: [
            "Après trois ans à monter des LLC pour des freelances et des PME françaises, j'entends les mêmes trois doutes dans 90 % des premiers appels. Je vais y répondre maintenant pour qu'ils ne te freinent plus.",
            "<strong>1. « Est-ce légal en France ? »</strong> Oui, totalement. La LLC est une entité reconnue par la convention fiscale entre la France et les États-Unis, et en tant que résident fiscal français tu continues à déclarer ici. Ce qui change, c'est la structure par laquelle passent tes revenus : au lieu de tout taxer comme revenu d'activité indépendante, on sépare la rémunération de l'associé (toujours imposée en France) du bénéfice de la société (avec un traitement fiscal beaucoup plus efficace). L'administration fiscale connaît ce dispositif, il est documenté, et des milliers de personnes le font chaque année.",
            "<strong>2. « Et si je suis contrôlé ? »</strong> C'est la question qui rassure le plus une fois la réponse donnée. Toute la structure est documentée dès le départ : procès-verbaux, contrats, formulaire 3916 (déclaration des comptes à l'étranger), comptes séparés, traçabilité de chaque opération. Si l'administration appelle, tu arrives avec tout en main. Et concrètement : les LLC bien montées ne déclenchent pas d'alertes, parce qu'elles sont déclarées exactement comme l'administration s'y attend.",
            "<strong>3. « Combien de temps et combien ça coûte à entretenir ? »</strong> Constitution : 3 à 4 semaines. Ensuite, environ 600 € par an — enregistrement de l'État, agent désigné, comptabilité de base. Si ton économie estimée est de 12 000 €, l'entretien représente moins de 5 %. L'investissement se rentabilise dès le premier mois.",
            "Si l'un de ces trois points te freine encore, dis-le pendant l'appel. C'est exactement à ça que sert la consultation — pour que tu repartes sans aucun doute, avec une décision claire dans un sens ou dans l'autre.",
          ],
        },
        {
          subject: "Dernière chose — on en parle 30 minutes cette semaine ?",
          paragraphs: [
            "Deux e-mails en respectant ton rythme, et je ne veux pas en faire trop. C'est le dernier de la série du calculateur.",
            "Ta simulation t'a donné un chiffre concret. Tu as vu le cas réel de Laura. Tu as vu comment je réponds aux trois doutes les plus fréquents. Si tu lis encore, c'est qu'il y a quelque chose qui colle.",
            "La consultation dure 30 minutes, elle est gratuite et sans engagement. Tu repars avec trois choses claires : si ton cas est viable, quelles économies réelles tu peux espérer (pas la simulation — le chiffre pour ta situation réelle), et les étapes exactes pour démarrer si tu le décides.",
            "Si ce n'est pas pour toi, on te le dit avec la même honnêteté. Nous écartons une bonne part de cas « ce n'est pas le moment » — et c'est tant mieux. Mieux vaut te dire d'attendre six mois que te facturer pour quelque chose qui ne t'apportera rien.",
          ],
          ps: "P.S. Si tu préfères poser tes questions par écrit avant de réserver, réponds à cet e-mail. Claudia le lit personnellement et te répond sous 24 h.",
        },
      ],
    },
    drip: {
      ...
      greeting: (name) => name ? `Bonjour ${name},` : "Bonjour,",
      sigClosing: "À bientôt,",
      unsubNote: "Tu as reçu ces emails parce que tu as demandé le guide gratuit ou réservé une consultation sur exentax.com.",
      steps: [
        {
