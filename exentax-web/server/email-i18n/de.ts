...
export const deTranslations: EmailTranslations = {
    booking: {
      ...
      ctaManage: "Meine Beratung verwalten",
    ...
    followup: {
      ...
      intro: (firstName: string) => `Ich melde mich kurz nach unserem letzten Austausch. Wenn Sie noch Fragen haben oder den nächsten Schritt gehen möchten, antworten Sie einfach auf diese E-Mail — ich bin gerne für Sie da.`,
      ctaLabel: "Weitere Beratung buchen",
      closing: "Wir sind für Sie da.",
      unsubNote: "Sie haben diese E-Mail erhalten, weil Sie exentax.com kontaktiert haben.",
    },
    incompleteBooking: {
    ...
    calcDrip: {
      ...
      steps: [
        ...
        },
        {
          ...
          paragraphs: [
            "Nach drei Jahren, in denen ich LLCs für deutsche Freiberufler und kleine Unternehmen aufsetze, höre ich in 90 % der Erstgespräche dieselben drei Zweifel. Ich beantworte sie jetzt, damit sie dich nicht bremsen.",
            "<strong>1. „Ist das in Deutschland legal?\"</strong> Ja, vollständig. Die LLC ist eine im Doppelbesteuerungsabkommen zwischen Deutschland und den USA anerkannte Gesellschaftsform, und als in Deutschland Steueransässiger erklärst du weiter hier. Was sich ändert, ist die Struktur, durch die deine Einkünfte fließen: Statt alles als selbstständige Einkünfte zu versteuern, trennen wir die Gesellschaftervergütung (weiter in Deutschland besteuert) vom Unternehmensgewinn (mit deutlich effizienterer Behandlung). Das Finanzamt kennt das, es ist dokumentiert, und Tausende Menschen machen es jedes Jahr.",
            "<strong>2. „Was, wenn ich geprüft werde?\"</strong> Das ist die Frage, die am meisten beruhigt, sobald die Antwort kommt. Die gesamte Struktur ist von Anfang an dokumentiert: Protokolle, Verträge, Anlage AUS in der Steuererklärung, getrennte Konten, jede Bewegung nachvollziehbar. Wenn das Finanzamt anruft, kommst du mit allem in der Hand an. Und in der Praxis: Gut aufgesetzte LLCs werfen keine Flaggen, weil sie genau so deklariert werden, wie es das Finanzamt erwartet.",
