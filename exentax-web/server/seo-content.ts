...
function buildI18nMeta(): Record<string, PageMeta> {
  ...
  const PAGE_DESCS: Record<RouteKey, Record<SupportedLang, string>> = {
    ...
    service_llc_nm: {
      es: "Cero impuesto estatal sobre la renta, sin informe anual y con anonimato real para nómadas digitales. EIN, banca y BOI llave en mano. Reserva tu llamada.",
      en: "The lowest-maintenance U.S. LLC for solo founders: no annual report, no franchise tax and full member anonymity. EIN, U.S. bank and BOI included. Get started.",
      fr: "Zéro déclaration annuelle, zéro franchise tax et anonymat total pour les freelances et nomades : la LLC la plus légère des USA. EIN inclus. Réservez un appel.",
      de: "Steueroptimiert für deutsche Selbstständige: keine State Income Tax, kein Jahresbericht und volle Gesellschafter-Anonymität. Mit EIN, Bank, BOI. Termin sichern.",
      pt: "A LLC americana mais enxuta para freelancers brasileiros: sem relatório anual, sem franchise tax e com anonimato real. EIN, banco e BOI inclusos. Comece hoje.",
      ca: "La LLC americana més lleugera per a autònoms catalans: sense informe anual, sense franchise tax i amb anonimat. EIN, banc i BOI inclosos. Comença avui.",
    },
    service_llc_wy: {
      es: "Blinda tu patrimonio con la única charging order exclusiva del país y anonimato societario probado. Compliance mínimo y caso law sólido. Habla con un experto.",
      en: "Shield your wealth with America's strongest charging-order statute and decades of pro-LLC case law. Anonymous filings and minimal compliance. Talk to an expert.",
      fr: "Protégez vos actifs avec la charging order la plus solide des USA et une jurisprudence décennale favorable aux associés. Confidentialité totale. À discuter.",
      de: "Vermögensschutz auf höchstem US-Niveau: exklusive Charging-Order-Regelung und gesellschafterfreundliche Rechtsprechung seit Jahrzehnten. Jetzt anfragen.",
      pt: "Blindagem patrimonial premium dos EUA: charging order exclusiva, jurisprudência consolidada e anonimato societário para seus ativos. Fale com especialista.",
      ca: "El blindatge patrimonial més fort dels EUA: charging order exclusiva, jurisprudència consolidada i anonimat societari per als teus actius. Parla amb un expert.",
    },
    service_llc_de: {
      es: "La jurisdicción que exigen fondos VC, business angels y compradores B2B en EE. UU.: contratos sólidos, Court of Chancery y series LLC. Habla con un experto.",
      en: "Built for founders raising capital: the jurisdiction VCs, angels and Fortune 500 buyers expect, with the famed Court of Chancery on your side. Get started.",
      fr: "La structure attendue par les fonds américains et les acheteurs B2B : Court of Chancery, séries LLC et contrats reconnus mondialement. Prenez rendez-vous.",
      de: "Maximale Rechtssicherheit für Wachstumsunternehmen: Delawares Court of Chancery, Series LLC und der Standard, den jeder US-Investor erwartet. Jetzt starten.",
      pt: "A jurisdição esperada por VCs, anjos e compradores B2B nos EUA: Court of Chancery e Series LLC para founders que vão captar. Fale com um especialista.",
      ca: "La jurisdicció que demanen fons VC i compradors B2B als EUA: Court of Chancery, series LLC i contractes reconeguts arreu del món. Reserva la teva trucada.",
    },
    service_llc_fl: {
      es: "Tu puerta de entrada al mercado hispano de Miami con presencia física real, banca en español y 0% de impuesto estatal. Con EIN y BOI. Reserva tu llamada.",
      en: "Land in Miami with a real U.S. footprint: bilingual banking, 0% state income tax and direct access to the Latin American consumer market. Book a call.",
      fr: "Posez le pied à Miami avec une vraie présence américaine, banque francophone et accès direct au marché latino-américain le plus dynamique. Réservez votre appel.",
      de: "Ihr Zugang zum lateinamerikanischen Markt über Miami: physische Präsenz, spanischsprachiges Banking und 0% State Income Tax. Mit EIN und BOI. Jetzt anfragen.",
      pt: "Sua ponte para o mercado hispano de Miami com presença real, banco em português e dolarização da receita americana. Inclui EIN e BOI. Agende sua chamada.",
      ca: "El teu pont entre Catalunya i el mercat llatí de Miami: presència física, banca en castellà i 0% d'impost estatal. Inclou EIN i BOI. Reserva la teva trucada.",
    },
    service_itin: {
      es: "Olvídate del consulado y del envío del pasaporte: nuestro Certifying Acceptance Agent tramita tu ITIN ante el IRS con seguimiento real. Empieza hoy.",
      en: "Skip the IRS office and the embassy queue: our Certifying Acceptance Agent files your ITIN remotely with no original passport mailed. Start today.",
      fr: "Évitez l'ambassade et l'envoi de votre passeport : notre Certifying Acceptance Agent dépose votre ITIN auprès de l'IRS et vous suit. Commencez ici.",
      de: "Kein Botschaftstermin, kein Reisepassversand: unser Certifying Acceptance Agent reicht Ihre ITIN beim IRS ein und begleitet Sie bis zur Vergabe. Termin sichern.",
      pt: "Evite o consulado e o envio do passaporte original: nosso Certifying Acceptance Agent registra seu ITIN no IRS e acompanha até a emissão. Solicite orçamento.",
      ca: "Sense consolat ni enviar el passaport original: el nostre Certifying Acceptance Agent presenta el teu ITIN davant l'IRS i et segueix sempre. Demana pressupost.",
    },
  };
